...
public class AlertDialogLayout extends aab {
    ...
    */
    public final void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L4c:
            ...
            aaa r6 = (defpackage.aaa) r6
            int r7 = r6.gravity
            if (r7 >= 0) goto L6f
            r7 = r3
        L6f:
            int r8 = defpackage.od.s(r9)
        ...
        if (mode2 != 1073741824) {
            ...
            for (int i12 = 0; i12 < childCount; i12++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    aaa aaaVar = (aaa) childAt3.getLayoutParams();
                    if (aaaVar.width == -1) {
                        int i13 = aaaVar.height;
                        aaaVar.height = childAt3.getMeasuredHeight();
