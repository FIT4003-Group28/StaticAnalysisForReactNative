...
public class SnackbarContentLayout extends LinearLayout implements dafg {
    public TextView a;
    public Button b;
    private int c;
    private int d;
    ...
    private final boolean c(int i, int i2, int i3) {
        ...
        if (od.T(textView)) {
            od.y(textView, od.w(textView), i2, od.x(textView), i3);
        } else {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, dafh.a);
