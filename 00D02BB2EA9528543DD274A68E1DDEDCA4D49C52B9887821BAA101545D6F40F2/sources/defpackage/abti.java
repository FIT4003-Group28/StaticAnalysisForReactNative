...
public final class abti implements brva {
    private final dzsj<Activity> a;
    private final dzsj<dxio<begg>> b;
    private final dzsj<brsc> c;

    public abti(dzsj<Activity> dzsjVar, dzsj<dxio<begg>> dzsjVar2, dzsj<brsc> dzsjVar3) {
        b(dzsjVar, 1);
        this.a = dzsjVar;
        b(dzsjVar2, 2);
        this.b = dzsjVar2;
    ...
    public final /* bridge */ /* synthetic */ brvb a(jba jbaVar, brrx brrxVar) {
        ...
        b(jbaVar, 4);
        b(brrxVar, 5);
        return new abth(activity, a, a2, jbaVar, brrxVar);
    }
}
