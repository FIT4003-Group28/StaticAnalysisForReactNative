...
public final class abwf {
    ...
    public final dzsj<abwb> h;

    public abwf(dzsj<bnjv> dzsjVar, dzsj<dxio<begg>> dzsjVar2, dzsj<Activity> dzsjVar3, dzsj<bvpe> dzsjVar4, dzsj<huc> dzsjVar5, dzsj<ahjq> dzsjVar6, dzsj<bvsl> dzsjVar7, dzsj<abwb> dzsjVar8) {
        a(dzsjVar, 1);
        this.a = dzsjVar;
        a(dzsjVar2, 2);
        this.b = dzsjVar2;
