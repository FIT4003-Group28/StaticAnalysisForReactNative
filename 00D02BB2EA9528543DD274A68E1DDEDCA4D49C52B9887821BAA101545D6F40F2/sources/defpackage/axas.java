...
final class axas implements awze<dviz> {
    static final axas a = new axas();
    ...
    */
    public final /* bridge */ /* synthetic */ defpackage.dviz a(defpackage.dviz r22, defpackage.awyw r23, defpackage.dmlb r24) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.axas.a(dssj, awyw, dmlb):dssj");
    }
    ...
    public final /* bridge */ /* synthetic */ boolean b(dviz dvizVar, awza awzaVar, dmlb dmlbVar) {
        ...
        if (!awzaVar.a(dqpeVar, dmlbVar)) {
            ...
            String format = String.format("%s.%s", "TOURIST_PLACES", "set");
