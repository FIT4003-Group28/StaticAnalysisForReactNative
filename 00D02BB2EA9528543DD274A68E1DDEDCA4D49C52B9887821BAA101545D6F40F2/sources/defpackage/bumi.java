...
/* compiled from: PG */
/* renamed from: bumi  reason: default package */
...
public final class bumi implements bumh {
    ...
    public bumi(dxio<btze> dxioVar, bvrb bvrbVar) {
        this.a = dxioVar;
        this.b = bvrbVar;
        buac a = buad.a();
        this.c = a;
        dunt duntVar = dunt.DELETE_REVIEW_REQUEST;
        a.i = btyk.GMM_SERVER;
        btyp bZ = btyq.h.bZ();
        if (bZ.c) {
            bZ.bF();
