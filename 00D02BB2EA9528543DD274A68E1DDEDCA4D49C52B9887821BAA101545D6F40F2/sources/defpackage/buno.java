package defpackage;
/* compiled from: PG */
/* renamed from: buno  reason: default package */
...
public final class buno implements bunn {
    ...
    public buno(dxio<btze> dxioVar, bvrb bvrbVar) {
        this.a = dxioVar;
        this.b = bvrbVar;
        buac a = buad.a();
        this.c = a;
        dunt duntVar = dunt.FOLLOW_PEOPLE_REQUEST;
        a.i = btyk.GMM_SERVER;
        btyp bZ = btyq.h.bZ();
        if (bZ.c) {
            bZ.bF();
