package defpackage;
/* compiled from: PG */
/* renamed from: buoo  reason: default package */
/* loaded from: classes.dex */
public final class buoo implements buon {
    public final dxio<btze> a;
    public final bvrb b;
    public final buac c;

    public buoo(dxio<btze> dxioVar, bvrb bvrbVar) {
        this.a = dxioVar;
        this.b = bvrbVar;
        buac a = buad.a();
        this.c = a;
        dunt duntVar = dunt.PASSIVE_ASSIST_REQUEST;
        a.i = btyk.GMM_SERVER;
        btyp bZ = btyq.h.bZ();
        if (bZ.c) {
            bZ.bF();
