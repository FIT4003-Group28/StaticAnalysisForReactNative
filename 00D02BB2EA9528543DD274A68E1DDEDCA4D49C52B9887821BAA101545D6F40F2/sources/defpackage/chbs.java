...
/* compiled from: PG */
/* renamed from: chbs  reason: default package */
/* loaded from: classes4.dex */
public class chbs extends cgym {
    private final Activity c;
    private final chai d;

    public chbs(Activity activity, cgsk cgskVar, bwrs<ilo> bwrsVar, List<dwrg> list, dwql dwqlVar, chak chakVar, cjqy cjqyVar, cgum cgumVar) {
        super(activity.getResources(), cgskVar, bwrsVar, list, dwqlVar, chakVar, cgumVar);
        this.c = activity;
        this.d = new chai(activity, activity.getString(R.string.UGC_TASKS_SUGGEST_EDIT_WEBSITE_PLACEHOLDER), 17, dtyd.ad, this.m, true, cqjg.a(), false, new chbr(this), cjqyVar, true, 1);
    }
