...
/* compiled from: PG */
/* renamed from: cpjz  reason: default package */
/* loaded from: classes5.dex */
public final class cpjz {
    ...
    private static cpjz c;
    private final Context d;

    public cpjz(Context context) {
        this.d = context.getApplicationContext();
    }

    public static cpjz a(Context context) {
        cnwc.a(context);
        synchronized (cpjz.class) {
            if (c == null) {
                c = new cpjz(context);
            }
        }
    ...
    public final boolean b() {
        ...
        try {
            packageInfo = cnyb.b(this.d).b("com.google.android.wearable.app.cn", 64);
