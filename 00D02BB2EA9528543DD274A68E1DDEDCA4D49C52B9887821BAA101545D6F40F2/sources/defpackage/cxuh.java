...
/* compiled from: PG */
/* renamed from: cxuh  reason: default package */
/* loaded from: classes5.dex */
final class cxuh implements Runnable {
    final /* synthetic */ Stopwatch a;
    final /* synthetic */ cxrb b;
    final /* synthetic */ cxui c;

    public cxuh(cxui cxuiVar, Stopwatch stopwatch, cxrb cxrbVar) {
        this.c = cxuiVar;
        this.a = stopwatch;
        this.b = cxrbVar;
    }
    ...
    public final void run() {
        ...
        if (g != 0) {
            ...
            if (cxsg.e()) {
                ...
                eaziVar3.b = 8;
                eaziVar3.a |= 1;
                long a2 = this.c.f.a("ACQueryToRender").a();
                if (bZ5.c) {
                    bZ5.bF();
                    bZ5.c = false;
                }
            ...
            eazcVar.a |= 1;
            eazcVar.b = size;
            long a3 = this.c.f.a("ACQueryToRender").a();
            if (bZ8.c) {
                bZ8.bF();
                bZ8.c = false;
            }
