...
public abstract class AbstractItemHierarchy {
    private final ArrayList<ItemGroup> a = new ArrayList<>();
    ...
    public final void a(int i) {
        ...
        ArrayList<ItemGroup> arrayList = this.a;
        int size = arrayList.size();
        for (int i3 = 0; i3 < size; i3++) {
            ItemGroup itemGroup = arrayList.get(i3);
    ...
    public AbstractItemHierarchy(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, dapf.b);
