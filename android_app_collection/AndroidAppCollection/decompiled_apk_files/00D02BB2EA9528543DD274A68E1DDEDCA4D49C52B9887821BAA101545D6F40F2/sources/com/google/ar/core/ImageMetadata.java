...
public class ImageMetadata {
    ...
    private final dbas sketchEntry;
    ...
    public ImageMetadata(long j, Session session) {
        ...
        this.sketchEntry = new dbas();
    }

    private void getMetdataEntry(int i, dbas dbasVar) {
        long nativeGetMetadataEntry = nativeGetMetadataEntry(this.session.nativeWrapperHandle, this.nativeHandle, i);
        dbasVar.a = nativeGetMetadataEntry;
        ...
        dbasVar.b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, nativeGetMetadataEntry);
        dbasVar.c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, dbasVar.a);
    }
    ...
    public byte getByte(int i) {
        ...
        dbas dbasVar = this.sketchEntry;
        if (dbasVar.b != 0 || dbasVar.c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i)));
        }
        byte nativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, dbasVar.a);
    ...
    public byte[] getByteArray(int i) {
        ...
        byte[] nativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, dbasVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public double getDouble(int i) {
        getMetdataEntry(i, this.sketchEntry);
        dbas dbasVar = this.sketchEntry;
        if (dbasVar.b != 4 || dbasVar.c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i)));
        }
        double nativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, dbasVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public double[] getDoubleArray(int i) {
        ...
        double[] nativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, dbasVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public float getFloat(int i) {
        getMetdataEntry(i, this.sketchEntry);
        dbas dbasVar = this.sketchEntry;
        if (dbasVar.b != 2 || dbasVar.c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i)));
        }
        float nativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, dbasVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public float[] getFloatArray(int i) {
        ...
        float[] nativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, dbasVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public int getInt(int i) {
        getMetdataEntry(i, this.sketchEntry);
        dbas dbasVar = this.sketchEntry;
        if (dbasVar.b != 1 || dbasVar.c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i)));
        }
        int nativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, dbasVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public int[] getIntArray(int i) {
        ...
        int[] nativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, dbasVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public long getLong(int i) {
        ...
        long nativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, dbasVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public long[] getLongArray(int i) {
        ...
        long[] nativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, dbasVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public Rational getRational(int i) {
        getMetdataEntry(i, this.sketchEntry);
        dbas dbasVar = this.sketchEntry;
        if (dbasVar.b != 5 || dbasVar.c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i)));
        }
        Rational nativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, dbasVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public Rational[] getRationalArray(int i) {
        ...
        Rational[] nativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, dbasVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
