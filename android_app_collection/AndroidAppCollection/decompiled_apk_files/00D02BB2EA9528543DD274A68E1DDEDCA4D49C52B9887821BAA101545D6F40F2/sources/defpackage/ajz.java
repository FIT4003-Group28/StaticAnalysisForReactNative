...
public final class ajz {
    ...
    static {
        ...
        L33:
            defpackage.ajz.c = r2
            java.lang.Class<?> r2 = defpackage.ajz.a
        ...
        Lb3:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ajz.<clinit>():void");
    }
    ...
    public static boolean a(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            try {
                ...
                ajy ajyVar = new ajy(activity);
                application.registerActivityLifecycleCallbacks(ajyVar);
                Handler handler = g;
                handler.post(new ajv(ajyVar, obj2));
                if (c()) {
                    f.invoke(obj, obj2, null, null, 0, false, null, null, false, false);
                } else {
                    activity.recreate();
                }
                handler.post(new ajw(application, ajyVar));
                return true;
    ...
    public static boolean b(Object obj, int i, Activity activity) {
        try {
            ...
            if (obj2 == obj && activity.hashCode() == i) {
                g.postAtFrontOfQueue(new ajx(b.get(activity), obj2));
                return true;
            }
        } catch (Throwable unused) {
        }
