...
/* compiled from: PG */
/* renamed from: atwt  reason: default package */
...
public final class atwt {
    ...
    public atwt(dzsj<Context> dzsjVar, dzsj<btrm> dzsjVar2, dzsj<btvo> dzsjVar3, dzsj<cref> dzsjVar4, dzsj<cqat> dzsjVar5, dzsj<cjqy> dzsjVar6, dzsj<cjqq> dzsjVar7, dzsj<dehq> dzsjVar8, dzsj<Executor> dzsjVar9, dzsj<atsr> dzsjVar10, dzsj<Boolean> dzsjVar11) {
        a(dzsjVar, 1);
        this.a = dzsjVar;
        a(dzsjVar2, 2);
        this.b = dzsjVar2;
