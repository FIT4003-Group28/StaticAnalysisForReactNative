package defpackage;
/* compiled from: PG */
/* renamed from: awzh  reason: default package */
/* loaded from: classes3.dex */
final class awzh implements awze<dvhw> {
    static final awzh a = new awzh();
    ...
    */
    public final /* bridge */ /* synthetic */ defpackage.dvhw a(defpackage.dvhw r18, defpackage.awyw r19, defpackage.dmlb r20) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.awzh.a(dssj, awyw, dmlb):dssj");
    }
    ...
    public final /* bridge */ /* synthetic */ boolean b(dvhw dvhwVar, awza awzaVar, dmlb dmlbVar) {
        ...
        if (!awzaVar.a(dqpeVar, dmlbVar)) {
            ...
            String format = String.format("%s.%s", "DISCOVERY_MAP_HIGHLIGHTS_SET", "set");
