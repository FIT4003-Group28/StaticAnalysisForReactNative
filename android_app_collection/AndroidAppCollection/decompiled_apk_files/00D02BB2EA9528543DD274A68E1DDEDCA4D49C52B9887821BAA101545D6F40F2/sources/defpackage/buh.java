...
public final class buh extends OutputStream {
    private final OutputStream a;
    private byte[] b;
    private final bxl c;
    private int d;

    public buh(OutputStream outputStream, bxl bxlVar) {
        this.a = outputStream;
        this.c = bxlVar;
        this.b = (byte[]) bxlVar.b(ImageMetadata.CONTROL_AE_ANTIBANDING_MODE, byte[].class);
    }
