package defpackage;
/* compiled from: PG */
/* renamed from: bvaj  reason: default package */
...
public final class bvaj implements bvai {
    ...
    public bvaj(dxio<btze> dxioVar, bvrb bvrbVar) {
        this.a = dxioVar;
        this.b = bvrbVar;
        buac a = buad.a();
        this.c = a;
        dunt duntVar = dunt.LOCAL_STREAM_VERIFY_AREA_REQUEST;
        a.i = btyk.GMM_SERVER;
        btyp bZ = btyq.h.bZ();
        if (bZ.c) {
            bZ.bF();
