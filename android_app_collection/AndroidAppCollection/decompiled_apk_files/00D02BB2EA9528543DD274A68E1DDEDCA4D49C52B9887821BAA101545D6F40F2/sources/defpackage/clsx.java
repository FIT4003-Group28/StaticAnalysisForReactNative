...
/* compiled from: PG */
/* renamed from: clsx  reason: default package */
...
final class clsx {
    ...
    public clsx(int i, int i2, float f, float f2, int i3) {
        this.r = i;
        this.a = i2;
        this.b = f;
        this.c = f2;
    ...
    private final void d(short[] sArr, int i, int i2) {
        short[] b = b(this.h, this.i, i2);
        this.h = b;
        int i3 = this.a;
        System.arraycopy(sArr, i * i3, b, this.i * i3, i3 * i2);
        this.i += i2;
    }
    ...
    private final int f(short[] sArr, int i, int i2, int i3) {
        int i4 = i * this.a;
        int i5 = 1;
        int i6 = 255;
        int i7 = 0;
    ...
    public final void c() {
                ...
                while (true) {
                    ...
                    if (i13 > 0) {
                        ...
                        if (this.a == i10 && i15 == i10) {
                            i = f(sArr, i12, this.s, this.t);
                        } else {
                            e(sArr, i12, i15);
                            int f6 = f(this.u, 0, this.s / i15, this.t / i15);
                            if (i15 != i10) {
                                int i16 = f6 * i15;
                                int i17 = i15 * 4;
                                int i18 = i16 - i17;
                                ...
                                if (this.a == i10) {
                                    i = f(sArr, i12, i18, i19);
                                } else {
                                    e(sArr, i12, i10);
                                    i = f(this.u, 0, i18, i19);
                                }
                            } else {
                                i = f6;
                            }
                        ...
                        if (d > 1.0d) {
                            ...
                            short[] b = b(this.h, this.i, i3);
                            this.h = b;
                            int i24 = i3;
                            g(i3, this.a, b, this.i, sArr2, i12, sArr2, i12 + i23);
                            this.i += i24;
                            i12 += i23 + i24;
                        } else {
                            int i25 = i23;
                            ...
                            int i26 = i25 + i2;
                            short[] b2 = b(this.h, this.i, i26);
                            this.h = b2;
                            int i27 = this.a;
                            System.arraycopy(sArr3, i12 * i27, b2, this.i * i27, i27 * i25);
        ...
        int i32 = this.i - i9;
        short[] b3 = b(this.v, this.j, i32);
        this.v = b3;
        short[] sArr5 = this.h;
        int i33 = this.a;
        System.arraycopy(sArr5, i9 * i33, b3, this.j * i33, i33 * i32);
        this.i = i9;
        this.j += i32;
        int i34 = 0;
        while (true) {
