...
/* compiled from: PG */
/* renamed from: deub  reason: default package */
/* loaded from: classes6.dex */
public final class deub {
    private final Context a;
    private final SharedPreferences b;
    private final boolean c;

    public deub(Context context, String str) {
        ApplicationInfo applicationInfo;
        context = Build.VERSION.SDK_INT >= 24 ? akm.e(context) : context;
        this.a = context;
