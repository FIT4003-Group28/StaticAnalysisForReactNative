...
final class eaho {
    ...
    public static final eaho c = new eaho();
    public final eahn d = new eahn();
    ...
    private eaho() {
        ...
        while (true) {
            ...
            if (i < 256) {
                int i2 = a[i];
                int i3 = bArr[i];
                eahn eahnVar = new eahn(i, i3);
                eahn eahnVar2 = this.d;
                while (i3 > 8) {
                    i3 -= 8;
                    int i4 = (i2 >>> i3) & 255;
                    eahn[] eahnVarArr = eahnVar2.a;
                    if (eahnVarArr != null) {
                        if (eahnVarArr[i4] == null) {
                            eahnVarArr[i4] = new eahn();
                        }
                        eahnVar2 = eahnVar2.a[i4];
                    } else {
