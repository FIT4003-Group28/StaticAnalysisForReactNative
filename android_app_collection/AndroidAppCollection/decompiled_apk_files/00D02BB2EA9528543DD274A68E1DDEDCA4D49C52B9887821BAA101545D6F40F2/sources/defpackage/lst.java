...
public final class lst {
    ...
    public final dzsj<jzp> f;
    public final dzsj<Executor> g;

    public lst(dzsj<btvo> dzsjVar, dzsj<bvsl> dzsjVar2, dzsj<cjqy> dzsjVar3, dzsj<cjqq> dzsjVar4, dzsj<btrm> dzsjVar5, dzsj<jzp> dzsjVar6, dzsj<Executor> dzsjVar7) {
        a(dzsjVar, 1);
        this.a = dzsjVar;
        a(dzsjVar2, 2);
        this.b = dzsjVar2;
