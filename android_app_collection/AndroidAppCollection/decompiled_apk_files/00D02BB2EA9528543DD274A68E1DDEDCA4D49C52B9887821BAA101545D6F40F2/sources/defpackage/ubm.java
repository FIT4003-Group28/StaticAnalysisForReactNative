...
public class ubm implements uan {
    private final tur a;
    ...
    public ubm(Activity activity, twk twkVar, tur turVar, final sux suxVar, cqat cqatVar, final tlv tlvVar, amve amveVar, boolean z) {
        this.a = turVar;
        zqx zqxVar = new zqx(activity, amveVar);
        this.f = zqxVar;
        this.b = new Runnable(suxVar, tlvVar) { // from class: ubl
            private final sux a;
            private final tlv b;
        ...
        this.e = twkVar.a(tlvVar, amveVar, dtxn.em, dtxn.el, z);
        this.g = vyb.u(amveVar, dtxn.ek);
