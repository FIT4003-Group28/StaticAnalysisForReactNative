...
final class xwp implements View.OnLayoutChangeListener {
    private final Rect a = new Rect();

    @Override // android.view.View.OnLayoutChangeListener
    public final void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ViewGroup viewGroup = (ViewGroup) view;
        zts ztsVar = (zts) cqkx.e(viewGroup, xwz.c, zts.class);
        if (ztsVar == null) {
            bvoo.h("Failed to find find legSchematicView", new Object[0]);
            return;
        }
        ViewGroup viewGroup2 = (ViewGroup) cqkx.e(viewGroup, xwz.d, ViewGroup.class);
        if (viewGroup2 == null) {
