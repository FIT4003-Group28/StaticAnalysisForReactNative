...
public class NestedScrollView extends FrameLayout implements kg, kd {
    ...
    private final void A(int i, int i2, int[] iArr) {
        ...
        this.A.i(0, scrollY2, 0, i - scrollY2, null, i2, iArr);
    }
    ...
    private final boolean J(MotionEvent motionEvent) {
        boolean z;
        if (kv.d(this.a) != 0.0f) {
            kv.e(this.a, 0.0f, motionEvent.getY() / getHeight());
            z = true;
        } else {
            z = false;
        }
        if (kv.d(this.b) != 0.0f) {
            kv.e(this.b, 0.0f, 1.0f - (motionEvent.getY() / getHeight()));
            return true;
        }
        return z;
    }
    ...
    public final boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr) {
        return this.A.h(i, i2, i3, i4, iArr);
    }
    ...
    final boolean kq(int i, int i2, int i3, int i4) {
        boolean z;
        getOverScrollMode();
    ...
    public final boolean l(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        return this.A.g(i, i2, iArr, iArr2, i3);
    }
    ...
    */
    ...
    public final void q(int i, int i2, int[] iArr, int i3, int[] iArr2) {
        this.A.i(0, i, 0, i2, iArr, i3, iArr2);
    }
    ...
    public class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator CREATOR = new cs(16);
        public int a;
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.u = new int[2];
        this.v = new int[2];
        this.a = kv.f(context, attributeSet);
        this.b = kv.f(context, attributeSet);
