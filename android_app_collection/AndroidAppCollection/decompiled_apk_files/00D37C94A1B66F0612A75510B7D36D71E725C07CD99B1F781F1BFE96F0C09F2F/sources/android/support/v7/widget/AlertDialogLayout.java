...
public class AlertDialogLayout extends wm {
    ...
    */
    public final void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L50:
            ...
            wl r6 = (defpackage.wl) r6
            int r7 = r6.gravity
            if (r7 >= 0) goto L73
            r7 = r3
        L73:
            int r8 = defpackage.lj.e(r9)
        ...
        if (mode2 != 1073741824) {
            ...
            for (int i12 = 0; i12 < childCount; i12++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    wl wlVar = (wl) childAt3.getLayoutParams();
                    if (wlVar.width == -1) {
                        int i13 = wlVar.height;
                        wlVar.height = childAt3.getMeasuredHeight();
