...
public class AppCompatSpinner extends Spinner {
    ...
    public final int getDropDownHorizontalOffset() {
        uv uvVar = this.b;
        return uvVar != null ? uvVar.a() : super.getDropDownHorizontalOffset();
    }

    @Override // android.widget.Spinner
    public final int getDropDownVerticalOffset() {
        uv uvVar = this.b;
        return uvVar != null ? uvVar.b() : super.getDropDownVerticalOffset();
    }
    ...
    public final CharSequence getPrompt() {
        uv uvVar = this.b;
        return uvVar != null ? uvVar.d() : super.getPrompt();
    }
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        viewTreeObserver.addOnGlobalLayoutListener(new uo(this));
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        wc wcVar = this.g;
        if (wcVar == null || !wcVar.onTouch(this, motionEvent)) {
    ...
    public final void setPopupBackgroundResource(int i) {
        setPopupBackgroundDrawable(po.b(this.a, i));
    }
    ...
    public class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator CREATOR = new cs(17);
        boolean a;
    ...
    public final void setAdapter(SpinnerAdapter spinnerAdapter) {
        ...
        this.b.e(new uq(spinnerAdapter, context.getTheme()));
    }
    ...
    */
    public AppCompatSpinner(android.content.Context r8, android.util.AttributeSet r9, int r10, int r11, android.content.res.Resources.Theme r12) {
        /*
            ...
            defpackage.zy.d(r7, r0)
            int[] r0 = defpackage.pm.u
            r1 = 0
            aad r0 = defpackage.aad.l(r8, r9, r0, r10, r1)
            ty r2 = new ty
            r2.<init>(r7)
            r7.f = r2
            if (r12 == 0) goto L29
        ...
        L6f:
            ...
            android.content.Context r4 = r7.a
            int[] r5 = defpackage.pm.u
            aad r4 = defpackage.aad.l(r4, r9, r5, r10, r1)
            r5 = 3
            r6 = -2
            int r5 = r4.e(r5, r6)
            r7.c = r5
