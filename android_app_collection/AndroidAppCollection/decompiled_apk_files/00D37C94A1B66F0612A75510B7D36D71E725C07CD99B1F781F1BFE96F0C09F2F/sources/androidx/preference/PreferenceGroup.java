...
public abstract class PreferenceGroup extends Preference {
    ...
    private final void ag(Preference preference) {
        synchronized (this) {
            ...
            if (this.b.remove(preference)) {
                ...
                if (str != null) {
                    this.a.put(str, Long.valueOf(preference.jQ()));
    ...
    public final Parcelable jO() {
        return new SavedState(super.jO(), this.c);
    }
    ...
    public class SavedState extends Preference.BaseSavedState {
        public static final Parcelable.Creator CREATOR = new asq(6);
        int a;
    ...
    public PreferenceGroup(Context context, AttributeSet attributeSet, int i, byte[] bArr) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, bkf.i, i, 0);
        this.e = ft.k(obtainStyledAttributes, 2, 2, true);
        if (obtainStyledAttributes.hasValue(1)) {
            ac(ft.n(obtainStyledAttributes, 1, 1));
        }
