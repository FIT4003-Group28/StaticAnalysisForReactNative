...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator i = new wd(7);
    private static final Interpolator j = new abb(4);
    private boolean A;
    private int B;
    private int C;
    private int D;
    ...
    private final void B(MotionEvent motionEvent) {
        ...
        if (motionEvent.getPointerId(actionIndex) == this.f73J) {
            int i2 = actionIndex == 0 ? 1 : 0;
            this.F = motionEvent.getX(i2);
            this.f73J = motionEvent.getPointerId(i2);
    ...
    private final boolean F(float f, float f2) {
        ...
        if (kv.d(this.e) != 0.0f) {
            e = -kv.e(this.e, -width, 1.0f - height);
        } else {
            e = kv.d(this.f) != 0.0f ? kv.e(this.f, width, height) : 0.0f;
        }
        ...
        float f5 = this.u * w;
        float f6 = this.v * w;
        bpk bpkVar = (bpk) this.l.get(0);
        bpk bpkVar2 = (bpk) this.l.get(arrayList.size() - 1);
        if (bpkVar.b != 0) {
            f5 = bpkVar.e * w;
            z = false;
        } else {
        ...
        if (scrollX < f5) {
            if (z) {
                kv.e(this.e, (f5 - scrollX) / w, 1.0f - (f2 / getHeight()));
            } else {
                z3 = z4;
            }
            z4 = z3;
            ...
            if (z2) {
                kv.e(this.f, (scrollX - f6) / w, f2 / getHeight());
            } else {
                z3 = z4;
            }
            z4 = z3;
    ...
    private final boolean G() {
        ...
        this.e.onRelease();
        this.f.onRelease();
        return !this.e.isFinished() || !this.f.isFinished();
    }
    ...
    private final bpk y() {
        ...
        while (i3 < this.l.size()) {
            bpk bpkVar2 = (bpk) this.l.get(i3);
            if (!z && bpkVar2.b != (i2 = i4 + 1)) {
                bpkVar2 = this.m;
                bpkVar2.e = f + f3 + f2;
                bpkVar2.b = i2;
                bpkVar2.d = 1.0f;
    ...
    public void addView(View view, int i2, ViewGroup.LayoutParams layoutParams) {
        ...
        bpl bplVar = (bpl) layoutParams;
        boolean z = bplVar.a | (view.getClass().getAnnotation(bpj.class) != null);
        bplVar.a = z;
        if (!this.w) {
            super.addView(view, i2, layoutParams);
        } else if (bplVar == null || !z) {
            bplVar.d = true;
    ...
    final bpk b(int i2, int i3) {
        bpk bpkVar = new bpk();
        bpkVar.b = i2;
        bpkVar.a = this.b.c(this, i2);
        bpkVar.d = 1.0f;
        if (i3 < 0 || i3 >= this.l.size()) {
            this.l.add(bpkVar);
        } else {
            this.l.add(i3, bpkVar);
        }
        return bpkVar;
    }

    final bpk c(View view) {
        for (int i2 = 0; i2 < this.l.size(); i2++) {
            bpk bpkVar = (bpk) this.l.get(i2);
            if (this.b.g(view, bpkVar.a)) {
                return bpkVar;
            }
        }
        return null;
    ...
    protected final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof bpl) && super.checkLayoutParams(layoutParams);
    }
    ...
    */
    ...
    public final void draw(Canvas canvas) {
        ...
        if (overScrollMode != 0 && (overScrollMode != 1 || (bpgVar = this.b) == null || bpgVar.j() <= 1)) {
            this.e.finish();
            this.f.finish();
            return;
        }
    ...
    public final void f() {
        ...
        while (i4 < this.l.size()) {
            bpk bpkVar = (bpk) this.l.get(i4);
            int k = this.b.k(bpkVar.a);
            if (k != -1) {
                if (k == -2) {
                    this.l.remove(i4);
                    i4--;
                    ...
                    this.b.d(this, bpkVar.b, bpkVar.a);
                    int i5 = this.c;
                    if (i5 == bpkVar.b) {
        ...
        if (z) {
            ...
            for (int i7 = 0; i7 < childCount; i7++) {
                bpl bplVar = (bpl) getChildAt(i7).getLayoutParams();
                if (!bplVar.a) {
                    bplVar.c = 0.0f;
                }
            }
    ...
    */
    ...
    public final ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        return new bpl(getContext(), attributeSet);
    }
    ...
    */
    ...
    public final void k(bpg bpgVar) {
        bpg bpgVar2 = this.b;
        if (bpgVar2 != null) {
            bpgVar2.n(null);
            this.b.f(this);
            ...
            while (i3 < getChildCount()) {
                if (!((bpl) getChildAt(i3).getLayoutParams()).a) {
                    removeViewAt(i3);
                    i3--;
                }
                i3++;
        ...
        for (int i4 = 0; i4 < size; i4++) {
            alop alopVar = (alop) this.h.get(i4);
            TabLayout tabLayout = alopVar.b;
            if (tabLayout.v == this) {
                tabLayout.i(bpgVar, alopVar.a);
            }
        }
    }
    ...
    final void o(int i2, boolean z, boolean z2, int i3) {
        bpg bpgVar = this.b;
        boolean z3 = false;
        if (bpgVar == null || bpgVar.j() <= 0) {
            D(false);
        } else if (z2 || this.c != i2 || this.l.size() == 0) {
            if (i2 < 0) {
                i2 = 0;
            } else if (i2 >= this.b.j()) {
                i2 = this.b.j() - 1;
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            this.I = y;
            this.G = y;
            this.f73J = motionEvent.getPointerId(0);
            this.A = false;
            this.s = true;
            ...
            if (this.U == 2 && Math.abs(this.r.getFinalX() - this.r.getCurrX()) > this.O) {
                ...
                H();
                q(1);
            } else if (kv.d(this.e) == 0.0f && kv.d(this.f) == 0.0f) {
                z(false);
                this.z = false;
            } else {
                this.z = true;
                q(1);
                if (kv.d(this.e) != 0.0f) {
                    kv.e(this.e, 0.0f, 1.0f - (this.G / getHeight()));
                }
                if (kv.d(this.f) != 0.0f) {
                    kv.e(this.f, 0.0f, this.G / getHeight());
                }
            }
        } else if (this.z) {
            return true;
    ...
    */
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        bpg bpgVar = this.b;
        if (bpgVar != null) {
            bpgVar.e(savedState.b, savedState.e);
    ...
    */
    ...
    final boolean u() {
        bpg bpgVar = this.b;
        if (bpgVar == null || this.c >= bpgVar.j() - 1) {
            return false;
        }
        m(this.c + 1, true);
        return true;
    ...
    final void v(Context context) {
        ...
        this.O = (int) (f + f);
        this.B = (int) (f * 16.0f);
        lj.M(this, new bpm(this));
        if (lj.c(this) == 0) {
            lj.V(this, 1);
        }
        lj.X(this, new bpi(this));
    }
    ...
    public class SavedState extends AbsSavedState {
        public static final Parcelable.Creator CREATOR = new yg(6);
        int a;
        Parcelable b;
        ClassLoader e;
