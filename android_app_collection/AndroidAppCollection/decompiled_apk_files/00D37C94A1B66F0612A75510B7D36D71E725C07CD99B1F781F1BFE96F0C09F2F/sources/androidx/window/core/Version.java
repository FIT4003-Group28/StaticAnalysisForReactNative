...
public final class Version implements Comparable {
    ...
    private final azqe bigInteger$delegate;
    ...
    private Version(int i, int i2, int i3, String str) {
        ...
        this.bigInteger$delegate = new azqi(new Version$bigInteger$2(this));
    }

    public /* synthetic */ Version(int i, int i2, int i3, String str, azsr azsrVar) {
        this(i, i2, i3, str);
    }
    ...
    public String toString() {
        String a = !ayme.h(this.description) ? azst.a("-", this.description) : "";
