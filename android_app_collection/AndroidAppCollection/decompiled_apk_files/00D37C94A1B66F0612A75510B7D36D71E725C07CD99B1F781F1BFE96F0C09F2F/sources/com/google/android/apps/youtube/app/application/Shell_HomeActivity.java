...
public final class Shell_HomeActivity extends eec implements amhk {
    private eet l;
        ...
        if (this.l == null) {
            ...
            try {
                ...
                try {
                    try {
                        Object lI = lI();
                        ite iteVar = (ite) ((dwq) lI).a.oj.get();
                        yrj yrjVar = (yrj) ((dwq) lI).a.as.get();
                        ohp ap = ((dwq) lI).a.ap();
                        euz euzVar = new euz((yni) ((dwq) lI).a.y.get(), (ett) ((dwq) lI).a.wC.get());
                        aacz aaczVar = (aacz) ((dwq) lI).a.D.get();
                        Activity a = ((dwq) lI).a();
                        if (a instanceof Shell_HomeActivity) {
                            this.l = new eet(iteVar, yrjVar, ap, euzVar, aaczVar, (Shell_HomeActivity) a, (alzn) ((dwq) lI).e.get(), ((dwq) lI).a.bc());
                            l.close();
                            return;
                        }
                        String valueOf = String.valueOf(eet.class);
    ...
    protected final boolean l(boolean z) {
        ...
        if (b == 0 || b == 1) {
            ...
            boolean z2 = apfnVar.b;
            aveq aveqVar2 = o.e.b().u;
            if (aveqVar2 == null) {
                aveqVar2 = aveq.a;
            }
            apgx apgxVar2 = aveqVar2.g;
            if (apgxVar2 == null) {
                apgxVar2 = apgx.a;
            }
            boolean z3 = apgxVar2.j;
            if (z2 && !z3 && o.b.o()) {
                o.a.n();
            }
        }
