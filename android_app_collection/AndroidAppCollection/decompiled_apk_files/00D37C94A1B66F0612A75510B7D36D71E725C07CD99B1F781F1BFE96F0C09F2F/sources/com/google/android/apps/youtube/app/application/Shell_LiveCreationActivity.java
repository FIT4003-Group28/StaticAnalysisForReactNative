...
public final class Shell_LiveCreationActivity extends eee implements amhk {
    private eeu l;
                ...
                try {
                    try {
                        ...
                        if (a instanceof Shell_LiveCreationActivity) {
                            this.l = new eeu((Shell_LiveCreationActivity) a, (gtd) ((dwq) lI).a.hn(), (alzn) ((dwq) lI).e.get(), ((dwq) lI).a.bc(), null, null);
                            l.close();
                            return;
                        }
                        String valueOf = String.valueOf(eeu.class);
