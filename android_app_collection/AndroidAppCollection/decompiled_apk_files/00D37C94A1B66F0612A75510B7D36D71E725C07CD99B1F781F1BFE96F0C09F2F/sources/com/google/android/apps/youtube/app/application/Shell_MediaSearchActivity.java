...
public final class Shell_MediaSearchActivity extends eeg implements amhk {
    private eev l;
                ...
                try {
                    try {
                        ...
                        if (a instanceof Shell_MediaSearchActivity) {
                            this.l = new eev(ap, (Shell_MediaSearchActivity) a, (alzn) ((dwq) lI).e.get(), ((dwq) lI).a.bc());
                            l.close();
                            return;
                        }
                        String valueOf = String.valueOf(eev.class);
