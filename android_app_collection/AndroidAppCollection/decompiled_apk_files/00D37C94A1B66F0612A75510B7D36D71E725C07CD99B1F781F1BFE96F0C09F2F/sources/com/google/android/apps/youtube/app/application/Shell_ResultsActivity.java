...
public final class Shell_ResultsActivity extends eei implements amhk {
    private eew l;
                ...
                try {
                    try {
                        ...
                        if (a instanceof Shell_ResultsActivity) {
                            this.l = new eew(ap, (Shell_ResultsActivity) a, (alzn) ((dwq) lI).e.get(), ((dwq) lI).a.bc());
                            l.close();
                            return;
                        }
                        String valueOf = String.valueOf(eew.class);
