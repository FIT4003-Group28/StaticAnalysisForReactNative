...
public final class Shell_UploadActivity extends eem implements amhk {
    private eey l;
                        ...
                        try {
                            try {
                                ...
                                if (a instanceof Shell_UploadActivity) {
                                    this.l = new eey((Shell_UploadActivity) a, (alzn) ((dwq) lI).e.get(), ((dwq) lI).a.bc());
                                    l.close();
                                    return;
                                }
                                String valueOf = String.valueOf(eey.class);
