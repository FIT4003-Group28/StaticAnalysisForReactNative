...
public class ClingView extends View {
    ...
    public ClingView(Context context, AttributeSet attributeSet) {
        ...
        this.d = new fox(this);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, fpb.a);
    ...
    public final void draw(Canvas canvas) {
        ...
        if (bitmap != null) {
            ...
            this.i.drawRect(0.0f, 0.0f, bitmap.getWidth(), bitmap.getHeight(), this.e);
            this.i.drawCircle(bitmap.getWidth() / 2, bitmap.getHeight() / 2, max2 / 2, this.f);
