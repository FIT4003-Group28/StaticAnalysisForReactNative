...
public class ChipCloudView extends ViewGroup {
    ...
    private final void c(Context context, AttributeSet attributeSet) {
        ...
        try {
            typedArray = context.obtainStyledAttributes(attributeSet, fwq.a, 0, 0);
            try {
                this.f = typedArray.getInteger(0, 0);
                this.d = zew.i(context.getResources().getDisplayMetrics(), (int) typedArray.getDimension(2, 8.0f));
                this.e = zew.i(context.getResources().getDisplayMetrics(), (int) typedArray.getDimension(1, 8.0f));
                if (typedArray == null) {
                    return;
                }
                typedArray.recycle();
