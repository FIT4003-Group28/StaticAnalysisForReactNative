...
public class ActiveItemIndicatorView extends View {
    ...
    public final void b(int i) {
        ...
        this.a = i;
        this.f.setColor(zhn.j(getContext(), i == 2 ? R.attr.ytStaticBrandRed : R.attr.ytStaticWhite).orElse(0));
        this.g.setColor(zhn.j(getContext(), i == 2 ? R.attr.ytIconDisabled : R.attr.ytOverlayButtonInactive).orElse(0));
        invalidate();
    }
