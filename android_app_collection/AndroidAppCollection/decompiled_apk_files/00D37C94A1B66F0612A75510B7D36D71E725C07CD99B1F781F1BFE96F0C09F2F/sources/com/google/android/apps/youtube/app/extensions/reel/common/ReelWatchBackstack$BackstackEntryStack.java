...
public final class ReelWatchBackstack$BackstackEntryStack implements Parcelable {
    public static final Parcelable.Creator CREATOR = new gta(3);
    public final List a;
    ...
    public final ReelWatchBackstack$BackstackEntry c() {
        ...
        return (ReelWatchBackstack$BackstackEntry) arey.s(this.a);
    }

    public final ReelWatchBackstack$BackstackEntry d() {
        if (!this.a.isEmpty()) {
            List list = this.a;
            return (ReelWatchBackstack$BackstackEntry) list.remove(list.size() - 1);
        }
