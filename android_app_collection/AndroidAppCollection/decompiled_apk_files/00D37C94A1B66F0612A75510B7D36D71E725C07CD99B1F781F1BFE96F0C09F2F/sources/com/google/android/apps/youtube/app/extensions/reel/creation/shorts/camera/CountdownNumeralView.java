...
public class CountdownNumeralView extends TextSwitcher {
    ...
    public CountdownNumeralView(final Context context, AttributeSet attributeSet) {
        ...
        final ajgo f = ajgo.f(0);
        setInAnimation(getContext(), R.anim.countdown_numeral_in);
        setFactory(new ViewSwitcher.ViewFactory() { // from class: gvu
            ...
            public final View makeView() {
                ...
                youTubeTextView.setTextColor(zhn.j(context2, R.attr.ytStaticWhite).orElse(context2.getResources().getColor(R.color.yt_white1)));
                youTubeTextView.setTypeface(ajgoVar.c(context2));
