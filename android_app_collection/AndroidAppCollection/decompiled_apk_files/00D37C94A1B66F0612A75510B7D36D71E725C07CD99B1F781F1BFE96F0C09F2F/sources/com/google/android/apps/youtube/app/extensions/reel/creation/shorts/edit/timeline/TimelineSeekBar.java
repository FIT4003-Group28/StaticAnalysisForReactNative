...
public class TimelineSeekBar extends hby implements SeekBar.OnSeekBarChangeListener {
    public Drawable a;
    public final int b;
    ...
    protected final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        view.post(new Runnable() { // from class: hcl
    ...
    public TimelineSeekBar(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.d = new Runnable() { // from class: hck
            @Override // java.lang.Runnable
            public final void run() {
                TimelineSeekBar.this.g();
            }
        };
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, hbz.a, i, i2);
        try {
            ...
            int color = obtainStyledAttributes.getColor(0, context.getResources().getColor(17170443));
            this.i = color;
            ...
            this.f.c().q(zna.t(this.g.a())).as(new hcj(this, 1));
            this.e.c().q(zna.t(this.g.a())).as(new hcj(this));
            this.e.d().q(zna.t(this.g.a())).as(new hcj(this, 2));
        } catch (Throwable th) {
            obtainStyledAttributes.recycle();
            throw th;
        }
