...
public final class DspSeekBar extends SeekBar {
    ...
    private final float a(long j) {
        Long l;
        hfz hfzVar = this.a;
        long longValue = (hfzVar == null || (l = hfzVar.e) == null) ? 0L : l.longValue();
        if (longValue > 0) {
    ...
    private final void b() {
        this.c = po.b(this.b, R.drawable.shorts_music_ui_dsp_seek_bar_primary_dsp);
        this.d = po.b(this.b, R.drawable.shorts_music_ui_dsp_seek_bar_secondary_dsp);
        this.e = po.b(this.b, R.drawable.shorts_music_ui_dsp_seek_bar_thumb);
        this.f = po.b(this.b, R.drawable.shorts_music_ui_dsp_seek_bar_thumb_selected_dsp);
    }
    ...
    protected final synchronized void onDraw(Canvas canvas) {
        ...
        auuo auuoVar = this.a.c;
        Long valueOf = auuoVar != null ? Long.valueOf(auuoVar.c) : null;
        ...
        hfz hfzVar2 = this.a;
        if (hfzVar2.b.isEmpty()) {
            amukVar = amuk.q();
        } else {
            amukVar = (amuk) Collection.EL.stream(hfzVar2.b).map(glk.i).collect(amsf.a);
        }
        int size = amukVar.size();
        for (int i = 0; i < size; i++) {
            Long l = (Long) amukVar.get(i);
