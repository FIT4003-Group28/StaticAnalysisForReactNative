...
public final class AutoValue_ReelEditModel extends ReelEditModel {
    ...
    public AutoValue_ReelEditModel(amuk amukVar, int i, ReelEditModel.DeletedItem deletedItem) {
        this.a = amukVar;
        this.b = i;
        this.c = deletedItem;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof ReelEditModel) {
            ...
            if (amxp.v(this.a, reelEditModel.d()) && this.b == reelEditModel.a() && ((deletedItem = this.c) != null ? deletedItem.equals(reelEditModel.c()) : reelEditModel.c() == null)) {
                return true;
            }
        }
        return false;
