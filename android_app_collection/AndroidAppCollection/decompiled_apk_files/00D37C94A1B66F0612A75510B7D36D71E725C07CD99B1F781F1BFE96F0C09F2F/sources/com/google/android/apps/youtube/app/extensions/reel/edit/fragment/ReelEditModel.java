...
public abstract class ReelEditModel implements Parcelable {
    public static final Parcelable.Creator CREATOR = new gta(6);

    /* compiled from: PG */
    /* loaded from: classes2.dex */
    public abstract class DeletedItem implements Parcelable {
        public static final Parcelable.Creator CREATOR = new gta(7);
    ...
    public abstract hnx b();

    public abstract DeletedItem c();

    public abstract amuk d();
