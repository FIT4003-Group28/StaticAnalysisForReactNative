...
public class ShortsRecordButtonView extends FrameLayout {
    ...
    public ShortsRecordButtonView(Context context, AttributeSet attributeSet) {
        ...
        this.a = frameLayout;
        frameLayout.setAccessibilityDelegate(new hpm());
        c();
    ...
    public final void b() {
        if (this.o) {
            ...
            if (!this.n) {
                ...
                int i2 = this.l;
                ofFloat6.addUpdateListener(new hpo(this, i2, i2));
    ...
    public final void f() {
        ...
        if (!this.n) {
            ...
            ofFloat4.setDuration(200L);
            ofFloat4.setInterpolator(new apq());
            ofFloat2.addUpdateListener(new hpo(this, this.l, this.k));
            AnimatorSet animatorSet = new AnimatorSet();
            ...
            ofFloat9.setInterpolator(new apq());
            ofFloat6.addUpdateListener(new hpo(this, this.l, this.k));
            AnimatorSet animatorSet2 = new AnimatorSet();
