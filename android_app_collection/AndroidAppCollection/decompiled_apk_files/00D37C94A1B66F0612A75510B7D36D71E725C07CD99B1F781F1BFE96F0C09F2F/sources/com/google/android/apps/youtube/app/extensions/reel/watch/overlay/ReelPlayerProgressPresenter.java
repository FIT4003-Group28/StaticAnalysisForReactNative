...
public class ReelPlayerProgressPresenter extends View {
    ...
    public ReelPlayerProgressPresenter(Context context) {
        ...
        this.w = new Paint(1);
        this.x = new RectF();
        this.y = new Runnable() { // from class: iev
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:35:0x00f2 A[LOOP:0: B:33:0x00ed->B:35:0x00f2, LOOP_END] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:74:0x00fb A[EDGE_INSN: B:74:0x00fb->B:36:0x00fb ?: BREAK  , SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public final void b(defpackage.aulw r17, boolean r18, int r19, int r20, int r21, float r22) {
        /*
            Method dump skipped, instructions count: 502
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.apps.youtube.app.extensions.reel.watch.overlay.ReelPlayerProgressPresenter.b(aulw, boolean, int, int, int, float):void");
    }
}
