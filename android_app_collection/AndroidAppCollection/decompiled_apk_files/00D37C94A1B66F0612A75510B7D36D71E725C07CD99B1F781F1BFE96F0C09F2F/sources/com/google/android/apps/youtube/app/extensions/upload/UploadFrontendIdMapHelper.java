...
public class UploadFrontendIdMapHelper implements Parcelable {
    public static final Parcelable.Creator CREATOR = new gta(11);
    public Map a;
    public Set b;
    ...
    public final void b(String str, akyh akyhVar) {
        ...
        akyhVar.e(str, avum.UPLOAD_PROCESSOR_ABANDONMENT_REASON_NOT_OPENABLE_VIDEO);
        this.b.add(str);
    }

    public final void c(String str, albf albfVar) {
        if (e(str) || akzg.f(str)) {
            return;
        }
        albfVar.e(str, null, avum.UPLOAD_PROCESSOR_ABANDONMENT_REASON_NOT_OPENABLE_VIDEO);
        this.b.add(str);
    }
