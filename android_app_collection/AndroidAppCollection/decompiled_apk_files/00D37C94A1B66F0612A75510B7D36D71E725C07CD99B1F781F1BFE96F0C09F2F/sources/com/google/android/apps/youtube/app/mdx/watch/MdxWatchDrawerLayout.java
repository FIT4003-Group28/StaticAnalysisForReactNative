...
public class MdxWatchDrawerLayout extends ixs implements View.OnClickListener, izc {
    public final Set a;
    public izb b;
    public Optional c;
    public View d;
    ...
    private final void m(float f) {
        ...
        int i = this.i;
        int i2 = (int) (i + (f * (this.h - i)));
        if (!this.c.isPresent()) {
            return;
        }
        View view = this.d;
        if (!((amk) this.c.get()).l(view, view.getLeft(), i2)) {
            return;
        }
        lj.G(this);
    }
    ...
    public final void computeScroll() {
        if (!this.c.isPresent() || !((amk) this.c.get()).n()) {
            return;
        }
        lj.G(this);
    }
    ...
    public final void h() {
        ...
        this.w = Optional.of(new izf(this.e, i, i2, 0.0f, 1.0f));
        int i3 = (int) (i - (measuredHeight * 0.9f));
        this.x = Optional.of(new izf(view, i3, i3 + measuredHeight, 1.0f, 0.0f));
        this.y = Optional.of(new izg(imageView, i3, i2));
    }
    ...
    public final void j(int i, boolean z) {
        ...
        if (z || i != this.g) {
            ...
            if (this.w.isPresent() && this.x.isPresent() && (view = this.e) != null && (view2 = this.q) != null) {
                ((izf) this.w.get()).b(this.g);
                ((izf) this.x.get()).b(this.g);
    ...
    protected final void onFinishInflate() {
        ...
        lj.M(this, new izd(this));
        Optional of = Optional.of(amk.c(this, 10.0f, new ize(this)));
        this.c = of;
        ((amk) of.get()).b = getResources().getDisplayMetrics().density * 400.0f;
        ...
        imageView.getClass();
        this.t = imageView;
        Drawable a = akf.a(getContext(), 2131233352);
        if (a != null) {
            a.mutate();
            a.setColorFilter(zhn.d(getContext(), R.attr.ytTextPrimary), PorterDuff.Mode.SRC_ATOP);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (this.c.isPresent()) {
            ...
            if (actionMasked != 3 && actionMasked != 1) {
                return (l(motionEvent) && ((amk) this.c.get()).k(motionEvent)) || super.onInterceptTouchEvent(motionEvent);
            }
            ((amk) this.c.get()).d();
            return false;
        }
    ...
    public class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator CREATOR = new gta(17);
        boolean a;
