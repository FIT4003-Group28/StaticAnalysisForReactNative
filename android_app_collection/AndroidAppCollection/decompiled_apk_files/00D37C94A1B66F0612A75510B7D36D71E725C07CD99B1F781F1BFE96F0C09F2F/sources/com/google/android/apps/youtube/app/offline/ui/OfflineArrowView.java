...
public class OfflineArrowView extends jqd {
    public int a;
    public int b;
    ...
    private final void m(int i, boolean z) {
        ...
        } else if (!z || (colorStateList = this.o) == null) {
            if (i == this.k) {
                tintableImageView.a(TintableImageView.a);
            } else if (i != this.l) {
                tintableImageView.a(null);
            } else {
                tintableImageView.a(ColorStateList.valueOf(zhn.d(getContext(), R.attr.ytTextPrimary)));
            }
        } else {
    ...
    private final void n(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, jqc.a);
        this.k = obtainStyledAttributes.getResourceId(2, 2131233372);
        this.r = obtainStyledAttributes.getResourceId(8, 2131231737);
        this.s = obtainStyledAttributes.getResourceId(0, R.drawable.ic_offline_progress);
        this.l = obtainStyledAttributes.getResourceId(1, 2131233228);
        this.a = obtainStyledAttributes.getResourceId(4, 2131231740);
        this.b = obtainStyledAttributes.getResourceId(7, 2131232633);
        this.m = obtainStyledAttributes.getResourceId(5, 2131231720);
        this.c = obtainStyledAttributes.getColorStateList(6);
        this.o = obtainStyledAttributes.getColorStateList(3);
        obtainStyledAttributes.recycle();
        this.j = akf.a(context, R.drawable.offline_progress_bar);
        this.q = akf.a(context, R.drawable.offline_progress_bar_v2);
        ...
        this.g = progressBar;
        progressBar.setIndeterminateDrawable(new tpj(-1.0f, resources.getDimensionPixelSize(R.dimen.offline_progress_bar_thickness), resources.getDimensionPixelSize(R.dimen.offline_progress_bar_inset_radius), new int[]{color}));
    ...
    public final void g() {
        if (this.d == 2) {
            ...
            CircularImageView circularImageView = this.p;
            zag.o(tintableImageView, false);
            zag.o(lottieAnimationView, true);
            zag.o(circularImageView, true);
        ...
        AnimationDrawable animationDrawable = this.h;
        if (animationDrawable == null) {
            Drawable a = akf.a(getContext(), this.s);
            a.getClass();
    ...
    public OfflineArrowView(Context context, AttributeSet attributeSet) {
        ...
        this.d = 1;
        n(zhn.n(context, attributeSet, 0), attributeSet);
    }
