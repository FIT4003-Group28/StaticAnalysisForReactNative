...
public class PlaylistThumbnailView extends ViewGroup {
    ...
    private final void g(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.p = true;
        this.d = new yzh(context);
        Resources resources = getResources();
        this.h = resources.getFraction(R.fraction.rounded_aspect_ratio_16_9, 1, 1);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, ksf.a, i, i2);
        ...
        int d = zhn.d(context, R.attr.ytOverlayTextPrimary);
        this.o = d;
    ...
    private final void h(Drawable drawable, Rect rect, int i) {
        ...
        if (i4 == 4 || i4 == 6) {
            ...
            i2 = i3;
            Gravity.apply(i, i3, i2, rect, this.t, lj.e(this));
    ...
    /* JADX WARN: Removed duplicated region for block: B:35:0x010c A[LOOP:0: B:35:0x010c->B:41:0x011d, LOOP_START, PHI: r8 
      PHI: (r8v1 int) = (r8v0 int), (r8v2 int) binds: [B:34:0x010a, B:41:0x011d] A[DONT_GENERATE, DONT_INLINE]] */
