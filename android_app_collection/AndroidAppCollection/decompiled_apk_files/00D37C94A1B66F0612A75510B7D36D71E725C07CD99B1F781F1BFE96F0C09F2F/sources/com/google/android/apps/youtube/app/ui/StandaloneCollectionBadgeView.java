...
public class StandaloneCollectionBadgeView extends ViewGroup {
    ...
    public final void onFinishInflate() {
        ...
        this.c = new HashMap();
        this.d = zew.i(getResources().getDisplayMetrics(), 8);
    }
    ...
    protected final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i8 = 0; i8 < childCount; i8++) {
            ...
            if (childAt.getVisibility() != 8 && this.c.containsKey(childAt)) {
                ltr ltrVar = (ltr) this.c.get(childAt);
                if (lj.e(this) == 1) {
                    i5 = i7 - ltrVar.b;
                    i6 = i7 - ltrVar.a;
                } else {
    ...
    protected final void onMeasure(int i, int i2) {
        ...
        if (visibility == 0) {
            ...
            a(textView, i10, textView.getMeasuredWidth() + i10);
        }
