...
public class SwipeToContainerFrameLayout extends nfh {
    public ayoi a;
    ...
    private final void l(long j) {
        ...
        nfr nfrVar = this.f;
        if (nfrVar != null) {
            nfrVar.r(this.d, 1.0f);
        }
    }

    private final void m(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, nfi.a);
        boolean z = false;
        this.d = obtainStyledAttributes.getResourceId(0, 0);
        this.k = obtainStyledAttributes.getResourceId(1, 0);
        obtainStyledAttributes.recycle();
        aqxo.q(this.d != 0, "containerViewId must be specified");
        aqxo.q(this.k != 0, "watchWhileRootViewId must be specified");
        aacz aaczVar = this.j;
        if (aaczVar != null && this.b != null) {
            asxj asxjVar = aaczVar.b().e;
            if (asxjVar == null) {
                asxjVar = asxj.a;
            }
            if (asxjVar.H && this.b.getBoolean("enable_swipe_container", false)) {
                z = true;
            }
        }
        this.h = z;
        if (z) {
            this.e = new yzl(getContext());
            this.q = new nft(this);
        }
    }
    ...
    */
    private final boolean p() {
        /*
            ...
            boolean r2 = defpackage.elk.k(r2)
            gbq r3 = r0.f
            boolean r3 = r3.B()
            r4 = 1
            if (r3 == 0) goto L48
            gbq r3 = r0.f
            com.google.android.apps.youtube.app.common.ui.navigation.PaneDescriptor r3 = r3.c()
            if (r3 == 0) goto L48
            gbq r3 = r0.f
            com.google.android.apps.youtube.app.common.ui.navigation.PaneDescriptor r3 = r3.c()
            apzg r3 = r3.e()
            java.lang.String r3 = defpackage.jfw.h(r3)
        ...
        L49:
            ezh r5 = r0.g
            ezx r5 = r5.g()
            ezx r6 = defpackage.ezx.NONE
            if (r5 == r6) goto L60
            ezh r5 = r0.g
            ezx r5 = r5.g()
            ezx r6 = defpackage.ezx.INLINE_MINIMAL
            if (r5 != r6) goto L5e
            goto L60
        L5e:
            r5 = 0
        ...
        L77:
            eo r6 = r6.mL()
            r7 = 2131430494(0x7f0b0c5e, float:1.848269E38)
            dp r6 = r6.e(r7)
            boolean r7 = r6 instanceof defpackage.hnu
            if (r7 == 0) goto L87
            goto L75
        L87:
            boolean r7 = r6 instanceof defpackage.hmc
            if (r7 == 0) goto L98
            hmc r6 = (defpackage.hmc) r6
            boolean r7 = r6.aS()
            if (r7 != 0) goto L75
            boolean r6 = r6.ak
            if (r6 != 0) goto L98
    ...
    protected final void onAttachedToWindow() {
        this.l.c();
        if (this.h) {
            this.l.d(this.a.as(new ayqb() { // from class: nfs
                @Override // defpackage.ayqb
                public final void a(Object obj) {
                    nfj nfjVar = (nfj) obj;
                    yzl yzlVar = SwipeToContainerFrameLayout.this.e;
                    if (yzlVar != null) {
                        yzlVar.f();
                    }
                }
    ...
    */
    ...
    public final class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator CREATOR = new gta(18);
        public boolean a;
