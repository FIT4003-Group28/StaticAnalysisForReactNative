...
public class WatchHistoryListIterator extends gav implements Parcelable {
    public static final Parcelable.Creator CREATOR = new gta(19);
    ...
    public WatchHistoryListIterator(byte[] bArr) {
    }
