...
public final class EmbedsBackgroundTaskWorker extends ListenableWorker {
    ...
    public final ankt b() {
        ...
        Set c = c();
        this.l = c;
        aqxo.z(c.size() == 2, "Incorrect number of background task tags");
        Bundle b = yln.b(a());
        this.m = b;
        if (b == null) {
            return anlz.q(adz.g());
        ...
        return aed.c(new agr() { // from class: oqc
            ...
            public final Object a(agp agpVar) {
                ...
                for (String str : embedsBackgroundTaskWorker.l) {
                    if (!akzj.i(EmbedsBackgroundTaskWorker.f, str)) {
                        oon.n(new oqf(agpVar, str, embedsBackgroundTaskWorker.m), new Handler(Looper.getMainLooper()), embedsBackgroundTaskWorker.a, embedsBackgroundTaskWorker.j, embedsBackgroundTaskWorker.h, embedsBackgroundTaskWorker.i, embedsBackgroundTaskWorker.k, embedsBackgroundTaskWorker.g, 1);
                    }
                }
