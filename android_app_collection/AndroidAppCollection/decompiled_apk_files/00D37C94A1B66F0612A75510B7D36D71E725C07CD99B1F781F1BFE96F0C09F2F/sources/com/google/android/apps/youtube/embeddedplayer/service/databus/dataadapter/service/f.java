...
public final class f implements ynl {
    ...
    private static Optional d(ahhw ahhwVar) {
        if (ahhwVar == null) {
            return Optional.empty();
        }
        return Optional.ofNullable(ahhwVar.b());
    }
    ...
    */
    public final void a() {
        ...
        L5:
            aika r0 = r0.c()
            aika r1 = defpackage.aika.PLAYBACK_PENDING
            r2 = 0
            r3 = 1
            r4 = 2
            r5 = 3
    ...
    public final void c(int i, long j) {
        ...
        if (playbackEventData != null && TextUtils.equals(((AutoValue_PlaybackEventData) playbackEventData).b, B) && ((AutoValue_PlaybackEventData) this.f).a == i) {
            return;
        }
        ...
        if (empty2.isPresent()) {
            asan asanVar = ((asaj) empty2.get()).h;
            if (asanVar == null) {
                asanVar = asan.a;
            }
            f = asanVar.m;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Class[] ky(java.lang.Class r7, java.lang.Object r8, int r9) {
        /*
            r6 = this;
            r7 = -1
            r0 = 3
        ...
        L8c:
            ...
            r3[r7] = r8
            java.lang.Class<ahhx> r7 = defpackage.ahhx.class
            r3[r2] = r7
            java.lang.Class<ahia> r7 = defpackage.ahia.class
            r3[r1] = r7
        L9b:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.apps.youtube.embeddedplayer.service.databus.dataadapter.service.f.ky(java.lang.Class, java.lang.Object, int):java.lang.Class[]");
    }
}
