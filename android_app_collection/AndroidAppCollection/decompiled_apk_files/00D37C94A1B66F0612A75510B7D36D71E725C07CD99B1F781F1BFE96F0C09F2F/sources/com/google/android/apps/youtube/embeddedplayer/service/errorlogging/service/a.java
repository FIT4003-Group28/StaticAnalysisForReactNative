...
public final class a extends com.google.android.apps.youtube.embeddedplayer.service.errorlogging.shared.b {
    ...
    public final void a(RemoteEmbedExceptionData remoteEmbedExceptionData) {
        ...
        if (th2 != null) {
            ...
            afus.c(2, 4, valueOf.length() != 0 ? "Error throwing Remote Crash Exception in Service from package: ".concat(valueOf) : new String("Error throwing Remote Crash Exception in Service from package: "), th2);
        }
    }
}
