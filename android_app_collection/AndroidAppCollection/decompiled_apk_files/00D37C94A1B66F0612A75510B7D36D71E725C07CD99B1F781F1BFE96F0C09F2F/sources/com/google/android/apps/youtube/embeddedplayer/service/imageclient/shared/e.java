...
public final class e extends dvd implements f {
    ...
    public final void b(BitmapKey bitmapKey, Bitmap bitmap) {
        Set<yiw> set = (Set) this.a.get(bitmapKey);
        if (set == null) {
            return;
        }
        for (yiw yiwVar : set) {
            yiwVar.b(bitmapKey, bitmap);
        }
        set.clear();
    ...
    public final void c() {
        ...
        this.c.post(new Runnable() { // from class: com.google.android.apps.youtube.embeddedplayer.service.imageclient.remoteloaded.a
            ...
            public final void run() {
                e eVar = e.this;
                for (BitmapKey bitmapKey : new HashSet(eVar.a.keySet())) {
                    eVar.b(bitmapKey, null);
                }
            }
        });
    }
    ...
    protected final boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
        ...
        if (i == 1) {
            ...
            a((BitmapKey) dve.a(parcel, BitmapKey.CREATOR), (Bitmap) dve.a(parcel, Bitmap.CREATOR));
        }
