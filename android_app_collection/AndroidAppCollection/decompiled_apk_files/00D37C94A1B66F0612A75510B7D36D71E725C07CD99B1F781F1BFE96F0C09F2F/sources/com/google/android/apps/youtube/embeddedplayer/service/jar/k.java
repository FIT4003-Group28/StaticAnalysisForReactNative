...
import com.google.android.apps.youtube.embeddedplayer.service.jar.client.as;
...
public final class k implements com.google.android.apps.youtube.embeddedplayer.service.databus.remoteloaded.c {
    ...
    public final void b(BusSupported$Data busSupported$Data) {
        ...
        } else if (!busSupported$Data.d().equals(com.google.android.apps.youtube.embeddedplayer.service.model.b.ERROR_DATA) || !(busSupported$Data instanceof ErrorData)) {
        } else {
