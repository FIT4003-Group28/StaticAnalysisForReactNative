...
public final class h implements k {
    public static final amvn a = amvn.w("com.google.android.googlequicksearchbox", "com.google.android.apps.magazines", "com.google.android.apps.newsstand_exp", "com.google.android.apps.newsstand_internal", "com.google.android.apps.newsstand_staging", "com.google.android.apps.newsstanddev", "com.google.android.play.games");
    public static final amvn b = amvn.w("com.android.vending", "com.google.android.apps.magazines", "com.google.android.apps.newsstand_exp", "com.google.android.apps.newsstand_internal", "com.google.android.apps.newsstand_staging", "com.google.android.apps.newsstanddev", "com.google.android.googlequicksearchbox", "com.google.android.music", "com.google.android.play.games");
    private String A;
    public final View c;
    public final j d;
    ...
    private h(View view, com.google.android.apps.youtube.embeddedplayer.service.jar.a aVar, j jVar, c cVar) {
        ...
        this.d = jVar;
        this.e = random;
        aqxo.q(true, "normalMinimumPeriod must be >= 0");
        aqxo.q(true, "normalMaximumPeriod must be >= 0");
        aqxo.q(true, "recheckMinimumPeriod must be >= 0");
        aqxo.q(true, "recheckMaximumPeriod must be >= 0");
    ...
    public static h b(View view, com.google.android.apps.youtube.embeddedplayer.service.jar.a aVar, j jVar, c cVar) {
        ...
        hVar.p.d(com.google.android.apps.youtube.embeddedplayer.service.jar.c.a.b.ae(azpj.c()).X(aypa.a()).as(new e(hVar)));
        return hVar;
    }
    ...
    public final void c() {
        if (!j()) {
            ...
            aqvb.l(valueOf.length() != 0 ? "Video playback stopped because of an unauthorized overlay on top of player. ".concat(valueOf) : new String("Video playback stopped because of an unauthorized overlay on top of player. "), new Object[0]);
        } else if (!i()) {
            String valueOf2 = String.valueOf(this.A);
            aqvb.l(valueOf2.length() != 0 ? "Video playback stopped because the player view is too small. ".concat(valueOf2) : new String("Video playback stopped because the player view is too small. "), new Object[0]);
        } else if (l()) {
        } else {
            String valueOf3 = String.valueOf(this.l);
            aqvb.l(valueOf3.length() != 0 ? "Video playback stopped because the player view is not visible. ".concat(valueOf3) : new String("Video playback stopped because the player view is not visible. "), new Object[0]);
        }
    }
    ...
    public final boolean j() {
        ...
        View findViewById = d.getDecorView().findViewById(16908290);
