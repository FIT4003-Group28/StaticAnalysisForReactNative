...
public class MutedAutoplayState implements BusSupported$Data {
    ...
    public static final Parcelable.Creator CREATOR = new com.google.android.apps.youtube.embeddedplayer.service.innertube.model.a(13);
    ...
    public final boolean equals(Object obj) {
        ...
        return akzj.f(this.e, mutedAutoplayState.e) && akzj.f(this.f, mutedAutoplayState.f) && akzj.f(this.d, mutedAutoplayState.d) && TextUtils.equals(this.c, mutedAutoplayState.c) && mutedAutoplayState.b == this.b && mutedAutoplayState.g == this.g;
    }
