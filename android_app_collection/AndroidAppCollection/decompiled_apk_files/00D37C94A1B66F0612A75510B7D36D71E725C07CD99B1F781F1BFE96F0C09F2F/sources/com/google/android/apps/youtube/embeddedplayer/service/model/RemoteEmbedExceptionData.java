...
public class RemoteEmbedExceptionData implements Parcelable {
    public static final Parcelable.Creator CREATOR = new com.google.android.apps.youtube.embeddedplayer.service.innertube.model.a(18);
    ...
    public final Throwable a(String str) {
        ...
        try {
            ...
            sb.append(" ");
            sb.append(message);
            Throwable th3 = (Throwable) Class.forName(zgh.h(canonicalName)).getConstructor(String.class).newInstance(zgh.h(sb.toString()));
