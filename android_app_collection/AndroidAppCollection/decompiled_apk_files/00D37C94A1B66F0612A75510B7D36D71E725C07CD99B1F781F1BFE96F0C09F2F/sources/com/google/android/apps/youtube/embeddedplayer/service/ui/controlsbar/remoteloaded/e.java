...
public final class e extends g {
    ...
    public e(Context context) {
        ...
        this.p = new RectF();
        this.q = new RectF();
        Drawable a = akf.a(context, 2131230900);
        a.getClass();
        this.o = a;
        Drawable a2 = akf.a(context, 2131230901);
        a2.getClass();
        this.n = a2;
        Drawable a3 = akf.a(context, 2131230903);
        a3.getClass();
        this.m = a3;
        a3.getPadding(rect);
    }
    ...
    protected final void a() {
        int i = this.i;
        int i2 = 0;
        int i3 = i <= 1 ? 0 : i >= 99 ? 98 : i - 1;
        this.l.set(this.s.left, this.s.top, this.s.left + ((this.s.width() * i3) / 98), this.s.bottom);
        int i4 = this.j;
        int i5 = i4 <= 1 ? 0 : i4 >= 99 ? 98 : i4 - 1;
        if (i5 > i3) {
            i2 = ((i5 - i3) * this.s.width()) / 98;
        }
        this.n.setBounds(this.l.right, this.s.top, this.l.right + i2, this.s.bottom);
    }
