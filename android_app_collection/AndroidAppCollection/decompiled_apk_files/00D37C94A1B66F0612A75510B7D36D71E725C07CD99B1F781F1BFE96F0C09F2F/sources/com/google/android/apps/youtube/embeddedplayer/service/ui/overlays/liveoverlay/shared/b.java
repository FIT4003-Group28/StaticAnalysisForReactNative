...
public final class b extends dvd implements c {
    ...
    public b(ahzm ahzmVar, Handler handler) {
    ...
    protected final boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
        ...
        switch (i) {
            case 1:
                ...
                return true;
            case 2:
                j(dve.b(parcel), dve.b(parcel), dve.j(parcel), dve.b(parcel), parcel.readInt(), dve.b(parcel), parcel.readInt());
                parcel2.writeNoException();
                return true;
            case 3:
                k(dve.b(parcel), dve.b(parcel), dve.b(parcel));
                parcel2.writeNoException();
                return true;
            case 4:
                g();
