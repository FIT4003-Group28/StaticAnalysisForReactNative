...
public final class b extends dvd implements c {
    ...
    public b(aiau aiauVar, Handler handler) {
    ...
    protected final boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
        switch (i) {
            ...
            case 4:
                ...
                break;
            case 5:
                i((SubtitlesStyle) dve.a(parcel, SubtitlesStyle.CREATOR));
                break;
            case 6:
    ...
    @Override // com.google.android.apps.youtube.embeddedplayer.service.ui.overlays.subtitlesoverlay.shared.c
    public final void f() {
        this.b.post(new com.google.android.apps.youtube.embeddedplayer.service.ui.overlays.subtitlesoverlay.remoteloaded.b(this));
    }
