...
public final class SubscribeButton extends YouTubeButton {
    ...
    public final void a() {
        ...
        if (i == 0) {
            ...
            setBackgroundColor(getResources().getColor(R.color.subscribe_button_disabled_background));
            setTextColor(getResources().getColor(R.color.subscribe_button_disabled_text));
        } else if (i != 2) {
            if (i == 3) {
