...
public final class AutoValue_SubscriptionNotificationMenuItem extends SubscriptionNotificationMenuItem {
    ...
    public AutoValue_SubscriptionNotificationMenuItem(int i, boolean z, int i2, String str, String str2, aoob aoobVar) {
        this.b = i;
        this.a = z;
        this.c = i2;
        this.d = str;
    ...
    public final int hashCode() {
        ...
        return ((hashCode ^ i2) * 1000003) ^ this.f.hashCode();
    }
