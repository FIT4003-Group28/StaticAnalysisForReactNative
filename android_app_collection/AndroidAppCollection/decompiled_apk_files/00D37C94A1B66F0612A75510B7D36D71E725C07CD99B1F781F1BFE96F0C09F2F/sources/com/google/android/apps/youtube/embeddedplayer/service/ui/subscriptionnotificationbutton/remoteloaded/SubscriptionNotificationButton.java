...
public class SubscriptionNotificationButton extends TouchImageView implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        if (!this.f.equals(SubscriptionNotificationMenuData.a)) {
            this.d.a(this.e.c().I());
            this.a.a(this.f, this.e.b(), this, new ji() { // from class: com.google.android.apps.youtube.embeddedplayer.service.ui.subscriptionnotificationbutton.remoteloaded.a
            ...
            amuk amukVar = this.f.b;
            int size = amukVar.size();
            for (int i = 0; i < size; i++) {
                this.d.c(((SubscriptionNotificationMenuItem) amukVar.get(i)).c().I());
            }
        }
    }
}
