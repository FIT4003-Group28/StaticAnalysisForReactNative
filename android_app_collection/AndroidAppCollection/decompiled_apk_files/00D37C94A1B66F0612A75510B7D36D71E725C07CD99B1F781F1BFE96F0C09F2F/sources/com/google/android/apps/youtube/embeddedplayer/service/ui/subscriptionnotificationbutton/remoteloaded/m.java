...
public final class m implements i {
    ...
    private final Drawable d(int i) {
        ...
        if (i != 1) {
            if (i == 2) {
                return resources.getDrawable(2131232337);
            }
            if (i == 3) {
                return resources.getDrawable(2131232335);
            }
            return null;
        }
        return resources.getDrawable(2131232338);
    }

    @Override // com.google.android.apps.youtube.embeddedplayer.service.ui.subscriptionnotificationbutton.remoteloaded.i
    public final void a(SubscriptionNotificationMenuData subscriptionNotificationMenuData, int i, final View view, final ji jiVar) {
        Window window;
        SubscriptionNotificationMenuItem subscriptionNotificationMenuItem;
        final amuk amukVar = subscriptionNotificationMenuData.b;
        b();
        ViewGroup viewGroup = null;
        final ViewGroup viewGroup2 = (ViewGroup) View.inflate(this.d, R.layout.subscription_notification_menu, null);
        int i2 = -1;
        int i3 = 0;
        while (i3 < amukVar.size()) {
            final SubscriptionNotificationMenuItem subscriptionNotificationMenuItem2 = (SubscriptionNotificationMenuItem) amukVar.get(i3);
                ...
                public final void onClick(View view2) {
                    ...
                    view4.postDelayed(new Runnable() { // from class: com.google.android.apps.youtube.embeddedplayer.service.ui.subscriptionnotificationbutton.remoteloaded.l
                        ...
                        public final void run() {
                            ...
                            mVar2.b();
                            if (!z4) {
                                jiVar3.accept(subscriptionNotificationMenuItem4);
                            }
                        }
                    }, 500L);
                }
        ...
        if (i2 == -1) {
            aqvb.k("Could not find the item for the current state!", new Object[0]);
            return;
        }
        viewGroup2.measure(View.MeasureSpec.makeMeasureSpec(zew.l(this.d), CellularSignalStrengthError.ERROR_NOT_SUPPORTED), View.MeasureSpec.makeMeasureSpec(zew.j(this.d), CellularSignalStrengthError.ERROR_NOT_SUPPORTED));
        int i6 = 0;
        ...
        this.b = popupWindow;
        popupWindow.setElevation(zew.i(this.d.getResources().getDisplayMetrics(), 4));
        ...
        ji jiVar2 = new ji() { // from class: com.google.android.apps.youtube.embeddedplayer.service.ui.subscriptionnotificationbutton.remoteloaded.j
        ...
        if (decorView == null) {
            jiVar2.accept(Integer.valueOf(height));
            return;
        }
        Rect rect = new Rect();
    ...
    public final void c(View view, SubscriptionNotificationMenuItem subscriptionNotificationMenuItem, boolean z) {
        ...
        if (z) {
            ...
            Resources resources = this.d.getResources();
            if (a == 1) {
                drawable = resources.getDrawable(2131232622);
            } else if (a != 2) {
                drawable = a != 3 ? null : resources.getDrawable(2131232614);
            } else {
                drawable = resources.getDrawable(2131232617);
            }
