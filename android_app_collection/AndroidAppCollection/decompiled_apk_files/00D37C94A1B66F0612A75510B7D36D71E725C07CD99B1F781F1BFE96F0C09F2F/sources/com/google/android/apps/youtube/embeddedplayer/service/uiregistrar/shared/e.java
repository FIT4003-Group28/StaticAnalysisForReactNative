...
public final class e extends dvd implements f {
    ...
    private e(Handler handler, rvx rvxVar, byte[] bArr) {
    ...
    public static e d(List list, Handler handler, rvx rvxVar) {
        final e eVar = new e(handler, rvxVar, null);
