...
public final class b {
    private static final amuk a = amuk.u("youtube.com", "www.youtube.com", "m.youtube.com", "youtu.be");
    private static final amuk b = amuk.s("start", "t");
    ...
    public static Optional a(String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            if (host == null || !a.contains(akzj.g(host))) {
                empty = Optional.empty();
            } else {
    ...
    private static int e(Uri uri) {
        ...
        int i3 = 0;
        while (i2 < i) {
            i3 = c(uri, (String) amukVar.get(i2));
            i2++;
            if (i3 != 0) {
                break;
            }
