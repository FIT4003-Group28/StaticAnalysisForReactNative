...
public final class MediaFormat implements Parcelable {
    public static final Parcelable.Creator CREATOR = new m(10);
    ...
    public MediaFormat(Parcel parcel) {
        ...
        this.o = parcel.readInt() != 0 ? parcel.createByteArray() : bArr;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            if (this.g == mediaFormat.g && this.c == mediaFormat.c && this.d == mediaFormat.d && this.e == mediaFormat.e && this.h == mediaFormat.h && this.i == mediaFormat.i && this.l == mediaFormat.l && this.m == mediaFormat.m && this.j == mediaFormat.j && this.k == mediaFormat.k && this.q == mediaFormat.q && this.r == mediaFormat.r && this.s == mediaFormat.s && this.t == mediaFormat.t && this.u == mediaFormat.u && this.w == mediaFormat.w && pcx.p(this.a, mediaFormat.a) && pcx.p(this.v, mediaFormat.v) && pcx.p(this.b, mediaFormat.b) && this.f.size() == mediaFormat.f.size() && pcx.p(this.p, mediaFormat.p) && Arrays.equals(this.o, mediaFormat.o) && this.n == mediaFormat.n) {
