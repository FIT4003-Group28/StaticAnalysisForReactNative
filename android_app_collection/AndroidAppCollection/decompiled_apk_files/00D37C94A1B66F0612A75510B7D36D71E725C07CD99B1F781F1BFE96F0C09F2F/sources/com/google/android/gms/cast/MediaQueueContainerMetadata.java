...
public class MediaQueueContainerMetadata extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new qjl(9);
    public int a;
    public String b;
    public List c;
    public List d;
    ...
    public final boolean equals(Object obj) {
        ...
        return this.a == mediaQueueContainerMetadata.a && TextUtils.equals(this.b, mediaQueueContainerMetadata.b) && tnk.j(this.c, mediaQueueContainerMetadata.c) && tnk.j(this.d, mediaQueueContainerMetadata.d) && this.e == mediaQueueContainerMetadata.e;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        List list = this.c;
        List list2 = null;
        tqj.J(parcel, 4, list == null ? null : Collections.unmodifiableList(list));
        List list3 = this.d;
        if (list3 != null) {
            list2 = Collections.unmodifiableList(list3);
        }
        tqj.J(parcel, 5, list2);
