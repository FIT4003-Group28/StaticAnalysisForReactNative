...
public class MediaQueueItem extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new qjl(11);
    public MediaInfo a;
    public int b;
    public boolean c;
    public double d;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        tqj.p(parcel, 7, this.f);
        tqj.C(parcel, 8, this.g);
