...
public class CastSeekBar extends View {
    ...
    public CastSeekBar(Context context, AttributeSet attributeSet, int i) {
        ...
        setAccessibilityDelegate(new qou(this));
        ...
        this.a = qotVar;
        qotVar.b = 1;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, qlp.a, R.attr.castExpandedControllerStyle, R.style.CastExpandedController);
