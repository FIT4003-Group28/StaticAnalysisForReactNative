...
public class DeviceStatus extends AbstractSafeParcelable {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.a == deviceStatus.a && this.b == deviceStatus.b && this.c == deviceStatus.c && qpl.j(this.d, deviceStatus.d) && this.e == deviceStatus.e) {
            EqualizerSettings equalizerSettings = this.f;
            if (qpl.j(equalizerSettings, equalizerSettings) && this.g == deviceStatus.g) {
                return true;
            }
        }
        return false;
