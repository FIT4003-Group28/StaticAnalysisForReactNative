...
public class PlayLoggerContext extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new qpm(3);
    ...
    public PlayLoggerContext(String str, int i, String str2, String str3, int i2, EnumSet enumSet) {
        ...
        this.c = -1;
        this.g = str2;
        this.d = true != enumSet.contains(qqg.ACCOUNT_NAME) ? null : str3;
        this.e = null;
        this.f = enumSet.contains(qqg.ANDROID_ID);
        this.h = enumSet.equals(qqg.f);
        int i3 = i2 - 1;
        if (i2 != 0) {
            this.i = i3;
            this.j = null;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof PlayLoggerContext) {
            ...
            if (tnk.j(this.a, playLoggerContext.a) && this.b == playLoggerContext.b && this.c == playLoggerContext.c && tnk.j(this.g, playLoggerContext.g) && tnk.j(this.d, playLoggerContext.d) && tnk.j(this.e, playLoggerContext.e) && this.f == playLoggerContext.f && this.h == playLoggerContext.h && this.i == playLoggerContext.i && tnk.j(this.j, playLoggerContext.j) && this.k == playLoggerContext.k && this.l == playLoggerContext.l) {
                return true;
            }
        }
        return false;
