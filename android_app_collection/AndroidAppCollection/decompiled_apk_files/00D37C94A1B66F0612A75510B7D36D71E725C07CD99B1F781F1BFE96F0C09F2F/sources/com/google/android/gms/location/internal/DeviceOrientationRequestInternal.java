...
public class DeviceOrientationRequestInternal extends AbstractSafeParcelable {
    ...
    public static final Parcelable.Creator CREATOR = new rfn(6);
    ...
    public final boolean equals(Object obj) {
        ...
        return tnk.j(this.c, deviceOrientationRequestInternal.c) && tnk.j(this.d, deviceOrientationRequestInternal.d) && tnk.j(this.e, deviceOrientationRequestInternal.e);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        int m = tqj.m(parcel);
        tqj.E(parcel, 1, this.c, i);
        tqj.J(parcel, 2, this.d);
        tqj.F(parcel, 3, this.e);
        tqj.n(parcel, m);
    }
}
