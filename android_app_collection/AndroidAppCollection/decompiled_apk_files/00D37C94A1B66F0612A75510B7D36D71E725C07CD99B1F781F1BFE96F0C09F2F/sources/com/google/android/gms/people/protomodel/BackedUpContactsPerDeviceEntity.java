...
public class BackedUpContactsPerDeviceEntity extends AbstractSafeParcelable implements BackedUpContactsPerDevice {
    public static final Parcelable.Creator CREATOR = new rsz();
    ...
    public final boolean equals(Object obj) {
        ...
        return tnk.j(f(), backedUpContactsPerDevice.f()) && tnk.j(b(), backedUpContactsPerDevice.b()) && tnk.j(g(), backedUpContactsPerDevice.g()) && tnk.j(e(), backedUpContactsPerDevice.e()) && tnk.j(d(), backedUpContactsPerDevice.d()) && tnk.j(c(), backedUpContactsPerDevice.c()) && tnk.j(a(), backedUpContactsPerDevice.a());
    }
    ...
    public final List g() {
        ...
        if (this.h == null && (list = this.g) != null) {
            ...
            for (SourceStats sourceStats : this.g) {
                this.h.add(sourceStats);
            }
        }
        return this.h;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        tqj.D(parcel, 5, this.d);
        tqj.D(parcel, 6, this.e);
        tqj.D(parcel, 7, this.b);
        tqj.E(parcel, 8, this.f, i);
        tqj.n(parcel, m);
    }
}
