...
public class Configurations extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = new rsz(13);
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof Configurations) {
            ...
            if (rug.a(this.a, configurations.a) && rug.a(this.c, configurations.c) && this.e.equals(configurations.e) && this.f == configurations.f && Arrays.equals(this.b, configurations.b) && this.g == configurations.g) {
                return true;
            }
        }
        return false;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        tqj.I(parcel, 4, this.d, i);
        tqj.o(parcel, 5, this.f);
        tqj.w(parcel, 6, this.b);
