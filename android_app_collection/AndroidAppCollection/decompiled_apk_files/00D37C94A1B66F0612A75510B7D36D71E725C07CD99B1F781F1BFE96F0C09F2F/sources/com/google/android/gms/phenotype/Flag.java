...
public class Flag extends AbstractSafeParcelable implements Comparable {
    public static final Parcelable.Creator CREATOR = new rsz(16);
    ...
    public final String a(StringBuilder sb) {
        ...
        if (i == 1) {
            ...
            sb.append("'");
            sb.append(Base64.encodeToString((byte[]) qnm.b(this.f), 3));
            sb.append("'");
        } else {
            String str2 = this.a;
    ...
    */
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof Flag) {
            Flag flag = (Flag) obj;
            if (rug.a(this.a, flag.a) && (i = this.g) == flag.g && this.h == flag.h) {
                if (i != 1) {
                    if (i == 2) {
