...
public final class ExperienceJni {
    public static final amzy a = amzy.l("com/google/android/libraries/ar/faceviewer/runtime/ExperienceJni");
    public long b;
    ...
    protected final void finalize() {
        if (this.b != 0) {
            ((amzw) ((amzw) a.f()).i("com/google/android/libraries/ar/faceviewer/runtime/ExperienceJni", "finalize", 82, "ExperienceJni.java")).q("ExperienceJni finalized with non-null nativeHandle.");
        }
    }
