...
public abstract class JSController {
    ...
    final class CppProxy extends JSController {
        ...
        private native void native_registerController(long j, String str, String str2, JSStateUpdateHandler jSStateUpdateHandler);
        ...
        @Override // com.google.android.libraries.elements.interfaces.JSController
        public void registerController(String str, String str2, JSStateUpdateHandler jSStateUpdateHandler) {
            native_registerController(this.nativeRef, str, str2, jSStateUpdateHandler);
        }
    ...
    public abstract void registerController(String str, String str2, JSStateUpdateHandler jSStateUpdateHandler);
