...
public class BinderBitmap implements Parcelable {
    public static final Parcelable.Creator CREATOR = new rxi(9);
    ...
    public BinderBitmap(Bitmap bitmap) {
        this.a = bitmap;
        tjm tjmVar = new tjm(bitmap);
        this.c = tjmVar;
        Bundle bundle = new Bundle();
        this.b = bundle;
        bundle.putBinder("binder", tjmVar);
    }
    ...
    public BinderBitmap(Parcel parcel) {
        ...
        bitmap = readBundle2 != null ? (Bitmap) readBundle2.getParcelable("bitmap") : bitmap;
        obtain.recycle();
        obtain2.recycle();
        this.a = bitmap;
    }
