...
public final class VisibilityChangeEventData implements Parcelable {
    public static final Parcelable.Creator CREATOR = new rxi(11);
    public final tjz a;
    ...
    public VisibilityChangeEventData(double d, double d2, double d3, boolean z, Rect rect, Rect rect2, Rect rect3, Rect rect4) {
        this(new tjz(d, d2, rect, rect2, rect3, rect4), d3, z);
    }

    public VisibilityChangeEventData(tjz tjzVar, double d, boolean z) {
        this.a = tjzVar;
        this.b = d;
        this.c = z;
    }
    ...
    public VisibilityChangeEventData(Parcel parcel) {
        ...
        this.a = new tjz(readDouble, readDouble2, new Rect(parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readInt()), new Rect(parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readInt()), new Rect(parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readInt()), new Rect(parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readInt()));
    }
}
