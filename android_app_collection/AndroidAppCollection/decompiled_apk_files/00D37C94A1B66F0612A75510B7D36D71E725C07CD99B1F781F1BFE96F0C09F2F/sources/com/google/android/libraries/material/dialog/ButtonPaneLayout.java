...
public class ButtonPaneLayout extends ViewGroup {
    ...
    private final void b(View view, Rect rect) {
        ...
        if ((getParent() instanceof View) && (touchDelegate = (view2 = (View) getParent()).getTouchDelegate()) != (tpeVar = this.t)) {
            tpeVar.b = touchDelegate;
            view2.setTouchDelegate(tpeVar);
        }
    }
    ...
    private final void e() {
        this.r = false;
        if (g()) {
            lj.Y(this, this.e, this.f, this.g, this.h);
        } else {
            lj.Y(this, this.a, this.b, this.c, this.d);
        }
    }
    ...
    public ButtonPaneLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, tpf.a, i, 2132083191);
