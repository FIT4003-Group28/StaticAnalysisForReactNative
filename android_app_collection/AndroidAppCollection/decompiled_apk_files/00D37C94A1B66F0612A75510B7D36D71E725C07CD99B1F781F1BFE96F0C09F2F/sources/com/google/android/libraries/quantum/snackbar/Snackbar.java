...
public class Snackbar extends LinearLayout implements vet {
    public final veu a;
    ...
    public final void c() {
        ...
        ofPropertyValuesHolder.addListener(new vfe(this));
        veuVar.a();
        if (veuVar.a.b()) {
            return;
        }
    ...
    public Snackbar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.c = textView2;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, vfc.a, i, R.style.Snackbar);
