...
public final class LicenseActivity extends oa {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (str2.isEmpty()) {
            str = vgh.c(this, "third_party_licenses", j, i);
        } else {
            try {
                String b = vgh.b(new BufferedInputStream(new FileInputStream(str2)), j, i);
                if (b != null) {
                    if (!b.isEmpty()) {
                        str = b;
                    }
    ...
    public final void onRestoreInstanceState(Bundle bundle) {
        ...
        if (i != 0) {
            scrollView.post(new Runnable() { // from class: vge
