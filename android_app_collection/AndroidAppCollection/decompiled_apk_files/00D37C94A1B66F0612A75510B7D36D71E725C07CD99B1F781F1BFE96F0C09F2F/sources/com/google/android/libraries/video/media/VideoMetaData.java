...
public class VideoMetaData implements Parcelable {
    public static final Parcelable.Creator CREATOR = new rxi(16);
    public final Uri a;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof VideoMetaData) {
            return uwp.l(this.a, ((VideoMetaData) obj).a);
        }
        return false;
    }
    ...
    public final String toString() {
        ...
        int[] iArr = this.j;
        Object obj = "null";
        String valueOf2 = String.valueOf(iArr != null ? Integer.valueOf(iArr.length) : obj);
