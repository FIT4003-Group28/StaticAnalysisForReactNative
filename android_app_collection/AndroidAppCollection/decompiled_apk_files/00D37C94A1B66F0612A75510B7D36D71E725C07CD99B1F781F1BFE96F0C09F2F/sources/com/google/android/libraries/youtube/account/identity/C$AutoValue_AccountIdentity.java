...
public abstract class C$AutoValue_AccountIdentity extends AccountIdentity {
    ...
    @Override // com.google.android.libraries.youtube.account.identity.AccountIdentity, defpackage.afvm
    public final String b() {
        return this.g;
    }
    ...
    public final String toString() {
        ...
        StringBuilder sb = new StringBuilder(length + 222 + length2 + length3 + length4 + String.valueOf(num).length() + str5.length());
