...
public class CodeInputView extends RelativeLayout implements View.OnClickListener, wid {
    ...
    public static final int i(CodeInputEditText codeInputEditText) {
        aqxo.q(codeInputEditText.getTag() instanceof Integer, "Digit tag should be an integer.");
    ...
    private final void j(Context context, AttributeSet attributeSet, int i) {
        ...
        int i2 = 0;
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, wiq.a, i, 0);
        try {
            ...
            while (true) {
                ...
                this.a[i3].addTextChangedListener(new wie(this, i3));
                this.a[i3].a = this;
                i3++;
            }
            while (true) {
                ...
                if (i2 < 6) {
                    ...
                    zgd.t(this.j[i2], zgd.h(this.g), ViewGroup.LayoutParams.class);
                    i2++;
                } else {
    ...
    public final void f(int i) {
        ...
        while (true) {
            ...
            if (i2 < 6) {
                ...
                zgd.t(this.j[i2], zgd.h(i2 == i ? this.f : this.g), ViewGroup.LayoutParams.class);
                i2++;
            } else {
                return;
            }
