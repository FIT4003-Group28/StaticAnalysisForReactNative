...
public final class SkipAdButton extends FrameLayout {
    ...
    private final void d(Context context) {
        ...
        this.i = ake.d(context, R.color.skip_ad_button_background_color);
        this.j = ake.d(context, R.color.skip_ad_button_inverted_background_color);
        this.r.setColor(this.i);
        this.r.setStyle(Paint.Style.FILL);
        this.s.setColor(ake.d(context, R.color.skip_ad_button_border_color));
        ...
        this.h = ake.d(context, R.color.skip_ad_button_inverted_foreground_color);
        TextView textView2 = this.f;
        this.b = new xhv(textView2, this.c, this.g, textView2.getTextSize(), this.f.getBackground(), this.f.getAlpha());
        this.k = new ColorDrawable(this.i);
        LinearLayout linearLayout = this.q;
        this.a = new xhx(linearLayout, this.k, linearLayout.getAlpha());
        b(this.t);
    ...
    public final void b(boolean z) {
        this.t = z;
        this.b.c(ake.d(getContext(), true != z ? R.color.skip_ad_button_foreground_color : R.color.skip_ad_button_high_contrast_foreground_color));
    }
