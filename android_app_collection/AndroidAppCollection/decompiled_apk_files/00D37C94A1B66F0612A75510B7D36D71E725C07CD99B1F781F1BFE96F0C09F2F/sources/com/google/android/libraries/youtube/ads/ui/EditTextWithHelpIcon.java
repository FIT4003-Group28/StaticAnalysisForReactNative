...
public class EditTextWithHelpIcon extends ue {
    public xjh a;
    private Context b;
    private View c;
    private Drawable d;
    ...
    private final void c() {
        ...
        zag.o(imageView, this.d != null);
        this.e.setImageDrawable(this.d);
        if (this.a == null) {
            return;
        }
        this.e.setOnClickListener(new View.OnClickListener() { // from class: xjg
    ...
    public final void b(Drawable drawable, xjh xjhVar) {
        Drawable drawable2;
        if (drawable != null) {
            drawable.mutate();
            drawable2 = iy.l(drawable);
