...
public class ImagePreviewSelectView extends FrameLayout {
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (this.f != null) {
            ...
            int i3 = (int) (d * 0.8d);
            this.o = i3;
            zgd.t(this.q, zgd.s(i3, i3), ViewGroup.LayoutParams.class);
            ...
            if (pair != null) {
                zgd.t(this.a, zgd.s(((Integer) pair.first).intValue(), ((Integer) pair.second).intValue()), ViewGroup.LayoutParams.class);
            }
