...
public class SwipeLayout extends FrameLayout {
    private static final int[] i = {16842910, 16842919};
    ...
    private final void t(Context context, AttributeSet attributeSet, int i2, int i3) {
        ...
        this.a = zew.i(getResources().getDisplayMetrics(), 40);
        this.b = viewConfiguration.getScaledMinimumFlingVelocity();
        this.k = zew.i(getResources().getDisplayMetrics(), 5);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, zcr.a, i2, i3);
    ...
    private final void u(View view, zcx zcxVar, float f) {
        if (view == null) {
            return;
        }
        if (view.getWidth() == 0) {
            view.getViewTreeObserver().addOnGlobalLayoutListener(new zcu(this, view, zcxVar, f));
        } else {
            m(((Integer) zcxVar.a()).intValue(), f);
        }
    }
    ...
    public final anf e() {
        if (this.p == null) {
            ...
            angVar.e(1500.0f);
            anfVar.n = angVar;
            anfVar.g(new ana() { // from class: zcs
