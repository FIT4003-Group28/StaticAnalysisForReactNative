...
public class CameraFocusOverlay extends FrameLayout {
    ...
    public final void a(int i, int i2) {
        ...
        zgd.t(imageView, zgd.b(zgd.l(i - (imageView.getWidth() / 2)), zgd.p(i2 - (this.a.getHeight() / 2))), ViewGroup.MarginLayoutParams.class);
        ImageView imageView2 = this.b;
        zgd.t(imageView2, zgd.b(zgd.l(i - (imageView2.getWidth() / 2)), zgd.p(i2 - (this.b.getHeight() / 2))), ViewGroup.MarginLayoutParams.class);
