...
public class DurationMsSeekBar extends AppCompatSeekBar implements SeekBar.OnSeekBarChangeListener {
    ...
    private final void n(Context context) {
        ...
        setAccessibilityDelegate(new zxo(this));
        i(0);
    }
    ...
    private final void o(int i, int i2, int i3, int i4, int i5) {
        ...
        this.j.setColor(zhn.j(getContext(), R.attr.ytTextDisabled).orElse(getResources().getColor(R.color.yt_grey3)));
        ...
        this.k.setColor(zhn.j(getContext(), R.attr.ytThemedBlue).orElse(getResources().getColor(R.color.yt_dark_blue)));
    ...
    public final synchronized void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        Rect copyBounds = ((ClipDrawable) ((LayerDrawable) getProgressDrawable()).findDrawableByLayerId(16908301)).copyBounds();
        this.m = copyBounds;
    ...
    public final void onProgressChanged(SeekBar seekBar, int i, boolean z) {
        ...
        if (i >= i2 || i == getMax()) {
            ...
            gyg gygVar = (gyg) zxpVar;
            gygVar.r.a(i3);
            gygVar.b.a(actj.SHORTS_CREATION_TIMER_RECORDING_DURATION_SLIDER).f();
            return;
        }
    ...
    public final void onStopTrackingTouch(SeekBar seekBar) {
        ...
        gyg gygVar = (gyg) zxpVar;
        if (!gygVar.d || (pklVar = (hewVar = gygVar.c).j) == null || pklVar.m() != 3 || !hewVar.j.D()) {
            return;
        }
        long j = progress;
        long a = (gygVar.c.a() + j) - 2000;
        if (j < 2000) {
            a = gygVar.c.a();
        }
        gygVar.c.c(Math.max(0L, a));
    }
