...
public class SegmentedControl extends FrameLayout {
    ...
    public final void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        if (view instanceof SegmentedControlSegment) {
            ...
            if (segmentedControlSegment.isChecked()) {
                segmentedControlSegment.post(new zyf(this, segmentedControlSegment, 1));
            }
            segmentedControlSegment.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: zyd
                ...
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    ...
                    segmentedControlSegment2.post(new zyf(segmentedControl, segmentedControlSegment2));
                }
            });
            if (a() != 1) {
                return;
            }
            view.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: zyc
        ...
        } else if (view.getId() == R.id.segmented_control_internal_layout || view.getId() == R.id.segmented_control_internal_selected_item_image) {
    ...
    public final void d(int i, boolean z, boolean z2) {
        ...
        if (!z || i3 == -1) {
            ...
            this.i.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: zyb
            ...
            this.i.addListener(new zyg(this));
            this.i.start();
        }
        zyh zyhVar = this.g;
        if (zyhVar != null && z2) {
    ...
    */
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        if (parcelable instanceof Bundle) {
            ...
            post(new Runnable() { // from class: zye
    ...
    public SegmentedControl(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().getTheme().obtainStyledAttributes(attributeSet, zjf.a, 0, 0);
            try {
        ...
        addView(this.b);
        LinearLayout linearLayout = new LinearLayout(new ContextThemeWrapper(getContext(), (int) R.style.SegmentedControlButtonsLayoutStyle));
        this.a = linearLayout;
