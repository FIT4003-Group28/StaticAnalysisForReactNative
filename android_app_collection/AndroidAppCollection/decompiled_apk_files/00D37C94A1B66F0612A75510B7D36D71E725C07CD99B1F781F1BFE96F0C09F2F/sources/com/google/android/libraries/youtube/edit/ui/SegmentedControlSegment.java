...
public class SegmentedControlSegment extends vd {
    private float a;
    private float b;
    private int c;
    private int d;
    ...
    private final void d(AttributeSet attributeSet) {
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().getTheme().obtainStyledAttributes(attributeSet, zjf.b, 0, 0);
            try {
        ...
        setAccessibilityDelegate(new zyi());
    }
