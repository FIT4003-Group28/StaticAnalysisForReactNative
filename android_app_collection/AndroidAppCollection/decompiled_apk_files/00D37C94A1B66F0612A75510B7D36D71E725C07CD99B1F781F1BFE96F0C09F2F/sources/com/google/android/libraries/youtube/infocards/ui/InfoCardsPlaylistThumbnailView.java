...
public class InfoCardsPlaylistThumbnailView extends ViewGroup {
    ...
    private final void a(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, zyw.a, i, i2);
        this.j = obtainStyledAttributes.getBoolean(5, false);
        this.b.setTextSize(0, obtainStyledAttributes.getDimension(2, resources.getDimension(R.dimen.large_font_size)));
        this.b.setTextColor(obtainStyledAttributes.getColor(1, zhn.j(context, R.attr.ytTextPrimary).orElse(0)));
        int resourceId = obtainStyledAttributes.getResourceId(0, 0);
        if (resourceId != 0) {
            this.k = akf.a(context, resourceId);
        }
    ...
    protected final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (rect.width() != 0 && rect.height() != 0) {
            ...
            Gravity.apply(49, width, height, rect, this.l, lj.e(this));
