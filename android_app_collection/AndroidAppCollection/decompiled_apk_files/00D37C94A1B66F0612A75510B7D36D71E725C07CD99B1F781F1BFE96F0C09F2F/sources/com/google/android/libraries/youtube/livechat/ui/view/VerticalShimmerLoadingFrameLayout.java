...
public class VerticalShimmerLoadingFrameLayout extends LoadingFrameLayout {
    ...
    public VerticalShimmerLoadingFrameLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.i = view;
        view.setBackgroundColor(zhn.j(context, R.attr.liveChatShimmerLoadingFrameOverlayColor).orElse(0));
        addView(view, -1, -1);
        View view2 = new View(context);
        this.a = view2;
        view2.setBackgroundColor(zhn.j(context, R.attr.liveChatShimmerLoadingFrameBackgroundColor).orElse(0));
        addView(this.a, -1, -1);
        GradientDrawable gradientDrawable = new GradientDrawable(GradientDrawable.Orientation.BOTTOM_TOP, new int[]{zhn.j(context, R.attr.liveChatShimmerLoadingFrameShimmerStartColor).orElse(0), zhn.j(context, R.attr.liveChatShimmerLoadingFrameShimmerMiddleColor).orElse(0), zhn.j(context, R.attr.liveChatShimmerLoadingFrameShimmerEndColor).orElse(0)});
        ...
        ofFloat.addListener(new abqx(this));
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: abqw
