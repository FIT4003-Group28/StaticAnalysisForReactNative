...
public final class VolumeIndicatorView extends View implements AudioRecord.OnRecordPositionUpdateListener {
    ...
    public VolumeIndicatorView(Context context) {
        ...
        this.h = new acge(this, 1);
        this.r = new acge(this);
        this.s = new acge(this, 2);
        this.i = new acge(this, 3);
        this.t = new acge(this, 4);
        ...
        paint.setColor(ake.d(context2, R.color.screencast_volume_inactive_color));
        Paint paint2 = new Paint();
        this.k = paint2;
        paint2.setStyle(Paint.Style.FILL);
        paint2.setColor(ake.d(context2, R.color.screencast_volume_active_color));
        Paint paint3 = new Paint();
        this.m = paint3;
        paint3.setStyle(Paint.Style.FILL);
        paint3.setColor(ake.d(context2, R.color.screencast_volume_loud_color));
        Paint paint4 = new Paint();
        this.n = paint4;
        paint4.setStyle(Paint.Style.FILL);
        paint4.setColor(ake.d(context2, R.color.screencast_volume_too_loud_color));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i = 1;
        if (measuredWidth > 0) {
            i = 1 + (measuredWidth / (this.o + this.p));
        }
        double d = this.e;
        double d2 = i;
        Double.isNaN(d2);
