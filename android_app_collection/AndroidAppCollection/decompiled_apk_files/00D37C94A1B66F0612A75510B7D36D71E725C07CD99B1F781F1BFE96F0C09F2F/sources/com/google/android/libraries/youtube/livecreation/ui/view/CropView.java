...
public class CropView extends FrameLayout {
    ...
    public CropView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, achf.b);
        try {
            ...
            this.n = zgh.d(obtainStyledAttributes.getText(0));
            obtainStyledAttributes.recycle();
            int i2 = this.b;
            aqxo.s(i2 > 0, "Width ratio must be positive. Was %s.", i2);
            int i3 = this.c;
            aqxo.s(i3 > 0, "Height ratio must be positive. Was %s.", i3);
            int i4 = this.m;
            int i5 = this.k;
            aqxo.v(i4 <= i5, "A double mask width ratio must be smaller or equal to a single mask width ratio. %s > %s", i4, i5);
            int i6 = this.d;
            if (i6 != 0 && (i = this.e) != 0 && (i6 * this.c) - (i * this.b) != 0) {
                z = false;
            }
            aqxo.q(z, "Min width and height must match the given width and height ratio");
            this.i = new Matrix();
            this.s = new Matrix();
            this.z = 0;
        } catch (Throwable th) {
    ...
    */
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (width <= 0 || height <= 0) {
            zep.b("Crop rectangle width and height must be positive.");
        } else {
            double d = width;
            double d2 = height;
            Double.isNaN(d);
            ...
            zgd.v(this.p, width, height);
            this.p.setVisibility(0);
            int i3 = this.m;
            if (i3 > 0.0f && this.k > i3) {
                int i4 = (width - ((i3 * height) / this.l)) / 2;
                zgd.t(this.q, zgd.r(i4), ViewGroup.LayoutParams.class);
                this.q.setVisibility(0);
                zgd.t(this.r, zgd.r(i4), ViewGroup.LayoutParams.class);
