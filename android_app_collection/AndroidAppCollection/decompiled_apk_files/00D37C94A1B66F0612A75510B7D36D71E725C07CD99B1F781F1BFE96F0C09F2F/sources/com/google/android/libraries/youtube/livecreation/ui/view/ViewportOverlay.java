...
public class ViewportOverlay extends View {
    ...
    private final void b(Context context, AttributeSet attributeSet, int i) {
        int d = ake.d(context, R.color.lc_default_viewport_overlay_color);
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, achf.d, i, 0);
            try {
    ...
    protected final void onDraw(Canvas canvas) {
        ...
        int i = iArr2[0];
        canvas.drawRect(i, iArr2[1] + height, i + width, getMeasuredHeight(), this.a);
    }
