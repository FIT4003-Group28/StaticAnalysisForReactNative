...
public class BestFitImageView extends ImageView {
    ...
    public final void setScaleType(ImageView.ScaleType scaleType) {
        zep.b("setScaleType() is not supported for BestFitImageView");
    }

    @Override // android.view.View
    public final void setScaleX(float f) {
        zep.b("setScaleX()  is not supported for BestFitImageView");
    }

    @Override // android.view.View
    public final void setScaleY(float f) {
        zep.b("setScaleY() is not supported for BestFitImageView");
    }
