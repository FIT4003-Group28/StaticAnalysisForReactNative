...
public class TimeBar extends aibs {
    private boolean A;
    private int B;
    private String C;
    ...
    public TimeBar(Context context, AttributeSet attributeSet) {
        ...
        float i = zew.i(displayMetrics, 12);
        Rect rect = new Rect();
        this.D = rect;
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, aheg.b, 0, 0);
        this.C = I(0L);
        this.F = PrivateKeyType.INVALID;
        int color = obtainStyledAttributes.hasValue(6) ? obtainStyledAttributes.getColor(6, -1) : -1;
        Paint paint2 = new Paint(1);
        this.o = paint2;
        paint2.setTypeface(ajgo.ROBOTO_REGULAR.c(context));
        ...
        this.p = paint3;
        paint3.setTypeface(ajgo.ROBOTO_REGULAR.c(context));
        ...
        this.v = obtainStyledAttributes.getDimensionPixelOffset(3, zew.i(displayMetrics, 13));
        this.w = obtainStyledAttributes.getDimensionPixelOffset(4, zew.i(displayMetrics, 8));
        this.a = obtainStyledAttributes.getDimensionPixelOffset(5, zew.i(displayMetrics, 42));
        int dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(2, zew.i(displayMetrics, 12));
        this.x = dimensionPixelOffset;
        int dimensionPixelOffset2 = obtainStyledAttributes.getDimensionPixelOffset(1, zew.i(displayMetrics, 20));
        this.y = dimensionPixelOffset2;
        obtainStyledAttributes.recycle();
        this.q = new aibv(this, dimensionPixelOffset, dimensionPixelOffset2);
        Vibrator vibrator = (Vibrator) context.getSystemService("vibrator");
        this.d = new aica();
        l();
        kP(new aiby() { // from class: aibu
    ...
    private final void h(int i, int i2) {
        ...
        this.h.set(paddingLeft, i4, (i - paddingRight) - this.B, i3 + i4);
    }

    private final boolean i() {
        return this.r.t() && kJ() > 0;
    }

    private final boolean j() {
        return this.r.u() && kJ() > 0;
    }
    ...
    public final void B() {
        ...
        aibv aibvVar = this.q;
        if (!aibvVar.e.isEnabled()) {
            aibvVar.a.cancel();
            return;
        }
        boolean z = !aibvVar.e.kM();
        if (!aibvVar.a.isRunning() && aibvVar.a() == aibvVar.d && !z) {
            aibvVar.a.start();
            aibvVar.b = false;
        } else if (!aibvVar.a.isRunning() && aibvVar.a() == aibvVar.c && z) {
            aibvVar.a.reverse();
            aibvVar.b = true;
        } else if (!aibvVar.a.isRunning() || z == aibvVar.b) {
        } else {
            aibvVar.a.reverse();
            aibvVar.b = z;
        }
    ...
    public final long c() {
        ...
        return ((((this.G + (this.q.c / 2)) - this.h.left) * kJ()) / this.h.width()) + j;
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (i()) {
            if (!aibxVar.o()) {
                canvas.drawText(I(kO()), getWidth() - ((this.B * 3) / 7), (getHeight() / 2) + (this.E.height() / 2), this.p);
            }
        } else if (j()) {
            float f3 = (this.B * 3) / 7;
        ...
        Map k = aibxVar.k();
        long kJ = kJ();
        if (!aibxVar.q() || k == null || kJ <= 0 || (timelineMarkerArr = (TimelineMarker[]) k.get(aicb.AD_MARKER)) == null) {
            return;
        }
        for (TimelineMarker timelineMarker : timelineMarkerArr) {
            this.b.left = this.h.left + ((int) (((this.h.width() * Math.min(kJ, Math.max(0L, timelineMarker.a))) / kJ) - 2));
            Rect rect = this.b;
    ...
    public final void kL() {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            setSystemGestureExclusionRects(amuk.r(this.g));
        }
        aibx aibxVar = this.r;
        long kJ = kJ();
        long E = E();
        ...
        String I = I(((aibt) this.r).a);
        this.C = I;
        this.o.getTextBounds(I, 0, I.length(), this.D);
        if (kJ > 0) {
            this.i.right = this.h.left + ((int) ((this.h.width() * kI()) / kJ));
            this.j.right = this.h.left + ((int) ((this.h.width() * E) / kJ));
            this.G = (this.h.left - (this.q.c / 2)) + ((int) ((this.h.width() * F) / kJ));
        } else {
        ...
        this.m.setColor(aibxVar.d());
        this.n.setColor(aibxVar.f());
        this.l.setColor(aibxVar.a());
        this.k.setColor(aibxVar.c());
        boolean p = aibxVar.p();
        if (this.z != p) {
            this.z = p;
            if (!p && kM()) {
    ...
    public TimeBar(Context context, aiby aibyVar) {
