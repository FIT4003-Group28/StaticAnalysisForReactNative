...
public class TapBloomView extends View {
    ...
    private final void a(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, aifx.a);
            int color = obtainStyledAttributes.getColor(2, 2146365166);
            int color2 = obtainStyledAttributes.getColor(0, 16777215);
            i3 = obtainStyledAttributes.getDimensionPixelSize(3, (int) zew.g(displayMetrics, 40.0f));
            i2 = obtainStyledAttributes.getDimensionPixelSize(1, (int) zew.g(displayMetrics, 400.0f));
