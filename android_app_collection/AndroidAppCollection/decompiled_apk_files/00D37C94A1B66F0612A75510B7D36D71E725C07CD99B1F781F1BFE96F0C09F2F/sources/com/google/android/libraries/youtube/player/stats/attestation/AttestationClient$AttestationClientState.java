...
public final class AttestationClient$AttestationClientState implements Parcelable {
    public static final Parcelable.Creator CREATOR = new aiqg(10);
    public final atzm a;
    ...
    public AttestationClient$AttestationClientState(Parcel parcel) {
        ...
        if (parcelableMessageLite == null) {
            ...
            atzmVar = (atzm) parcelableMessageLite.a(atzm.a);
        }
        this.a = atzmVar;
        this.b = (TrackingUrlModel) parcel.readParcelable(classLoader);
        this.c = amps.d(parcel.readString());
        this.d = parcel.readInt();
        this.e = parcel.readInt() != 1 ? false : true;
    }

    public AttestationClient$AttestationClientState(atzm atzmVar, TrackingUrlModel trackingUrlModel, String str, int i, boolean z) {
        this.a = atzmVar;
