...
public final class SubtitleWindowSettings implements Parcelable {
    public static final Parcelable.Creator CREATOR = new aiqg(12);
    ...
    public SubtitleWindowSettings(int i, int i2, int i3, boolean z, boolean z2) {
        boolean z3 = true;
        aqxo.s(i2 >= 0 && i2 <= 100, "invalid anchorHorizontalPos: %s", i2);
        aqxo.s((i3 < 0 || i3 > 100) ? false : z3, "invalid anchorVerticalPos: %s", i3);
        this.b = i;
        this.c = i2;
        this.d = i3;
        this.e = z;
