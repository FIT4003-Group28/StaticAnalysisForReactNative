...
public class SubtitlesStyle implements Parcelable {
    public static final Parcelable.Creator CREATOR = new aiqg(14);
    public final int a;
    public final int b;
    public final int c;
    public final int d;
    ...
    public SubtitlesStyle(CaptioningManager.CaptionStyle captionStyle, aacz aaczVar) {
        atzt D;
        this.a = captionStyle.backgroundColor;
        this.c = captionStyle.edgeColor;
        if (Build.VERSION.SDK_INT < 26 || ((D = aiix.D(aaczVar)) != null && D.m)) {
