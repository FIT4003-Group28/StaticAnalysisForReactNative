...
public class ConversationIconView extends ViewGroup {
    ...
    public ConversationIconView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, akkj.b);
        obtainStyledAttributes.getColor(1, -1);
        obtainStyledAttributes.getColor(0, -1728053248);
        obtainStyledAttributes.getDimensionPixelSize(2, zew.i(displayMetrics, 12));
        this.f = obtainStyledAttributes.getDimensionPixelSize(4, zew.i(displayMetrics, 1));
    ...
    protected final void onMeasure(int i, int i2) {
        ...
        for (int i3 = 0; i3 < this.a.size(); i3++) {
            ...
            ViewGroup.LayoutParams layoutParams = ((View) this.a.valueAt(i3)).getLayoutParams();
