...
public class HideBottomViewOnScrollBehavior extends ajc {
    ...
    private final void t(View view, int i, long j, TimeInterpolator timeInterpolator) {
        this.a = view.animate().translationY(i).setInterpolator(timeInterpolator).setDuration(j).setListener(new alix(this));
    }
    ...
    public final void d(CoordinatorLayout coordinatorLayout, View view, View view2, int i, int i2, int i3, int i4, int i5, int[] iArr) {
        if (i2 > 0) {
            ...
            this.c = 1;
            t(view, this.b, 175L, alhv.c);
        } else if (i2 >= 0 || this.c == 2) {
        } else {
