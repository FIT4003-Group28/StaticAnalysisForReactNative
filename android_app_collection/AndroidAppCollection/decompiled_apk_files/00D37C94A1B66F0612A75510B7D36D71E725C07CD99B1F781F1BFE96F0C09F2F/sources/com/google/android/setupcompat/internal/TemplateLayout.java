...
public class TemplateLayout extends FrameLayout {
    ...
    private final void a(int i, int i2, AttributeSet attributeSet, int i3) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, alvn.f, i3, 0);
        if (i == 0) {
    ...
    public final View h(LayoutInflater layoutInflater, int i, int i2) {
        ...
        if (i != 0) {
            layoutInflater = LayoutInflater.from(new alvp(layoutInflater.getContext(), i));
        }
        return layoutInflater.inflate(i2, (ViewGroup) this, false);
    }

    public final alwk i(Class cls) {
        return (alwk) this.d.get(cls);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final void j(Class cls, alwk alwkVar) {
        this.d.put(cls, alwkVar);
    }
