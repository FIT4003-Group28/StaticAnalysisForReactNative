...
public final class MetricKey implements Parcelable {
    public static final Parcelable.Creator CREATOR = new alwc();
    ...
    public static MetricKey b(String str, Activity activity) {
        ...
        apwt.j(str, "MetricKey.name", 5, 30);
        apwt.l(a.matcher(str).matches(), "Invalid MetricKey, only alpha numeric characters are allowed.");
    ...
    public final boolean equals(Object obj) {
        ...
        return aqgn.k(this.b, metricKey.b) && aqgn.k(this.c, metricKey.c);
    }
