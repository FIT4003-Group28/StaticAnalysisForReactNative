...
public class HeaderRecyclerView extends RecyclerView {
    ...
    private final void a(AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, alwr.h, i, 0);
        this.aa = obtainStyledAttributes.getResourceId(0, 0);
        obtainStyledAttributes.recycle();
    }

    @Override // android.support.v7.widget.RecyclerView
    public final void ad(xo xoVar) {
        if (this.W != null && xoVar != null) {
            alxl alxlVar = new alxl(xoVar);
            alxlVar.d = this.W;
            xoVar = alxlVar;
        }
        super.ad(xoVar);
    ...
    public final void ag(xw xwVar) {
        super.ag(xwVar);
        if (xwVar == null || this.W != null || this.aa == 0) {
            return;
        }
