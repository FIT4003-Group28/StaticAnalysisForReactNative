...
public class NavigationBarButton extends Button {
    ...
    private final void a() {
        ...
        for (int i = 0; i < compoundDrawablesRelative.length; i++) {
            ...
            if (drawable != null) {
                compoundDrawablesRelative[i] = alxn.a(drawable);
            }
        }
        ...
        if (textColors != null) {
            ...
            for (int i = 0; i < 6; i++) {
                ...
                if (drawable instanceof alxn) {
                    alxn alxnVar = (alxn) drawable;
                    alxnVar.a = textColors;
                    if (alxnVar.b()) {
                        alxnVar.invalidateSelf();
                    }
                }
            }
            invalidate();
    ...
    public final void setCompoundDrawables(Drawable drawable, Drawable drawable2, Drawable drawable3, Drawable drawable4) {
        if (drawable != null) {
            drawable = alxn.a(drawable);
        }
        if (drawable2 != null) {
            drawable2 = alxn.a(drawable2);
        }
        if (drawable3 != null) {
            drawable3 = alxn.a(drawable3);
        }
        if (drawable4 != null) {
            drawable4 = alxn.a(drawable4);
        }
