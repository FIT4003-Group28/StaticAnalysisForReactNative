...
public class EglFactory implements GLSurfaceView.EGLContextFactory, GLSurfaceView.EGLWindowSurfaceFactory {
    ...
    public EGLSurface createWindowSurface(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig eGLConfig, Object obj) {
        try {
            return egl10.eglCreateWindowSurface(eGLDisplay, eGLConfig, obj, (!this.useProtected || !supportsProtectedContent(egl10, eGLDisplay)) ? null : new int[]{EGL_PROTECTED_CONTENT_EXT, 1, 12344});
