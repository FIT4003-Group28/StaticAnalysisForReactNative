...
public class CameraSource {
    ...
    public class FrameProcessingRunnable implements Runnable {
        ...
        public FrameProcessingRunnable(rvy rvyVar) {
            this.detector = rvyVar;
        }
                        ...
                        if (this.pendingFrameData == null) {
                            ...
                            if (byteBuffer != null) {
                                if (byteBuffer.capacity() >= i2 * i3) {
                                    ...
                                    rvzVar.b = i3;
                                    rvzVar.f = 17;
                                    rvzVar.c = this.pendingFrameId;
                                    rvzVar.d = this.pendingTimeMillis;
                                    rwaVar.a.e = CameraSource.this.rotation;
                                    if (rwaVar.b != null) {
                                        ByteBuffer byteBuffer2 = this.pendingFrameData;
                                        this.pendingFrameData = null;
                                        try {
                                            rvy rvyVar = this.detector;
                                            rvz rvzVar2 = new rvz(rwaVar.a);
                                            if (rvzVar2.e % 2 != 0) {
                                                int i4 = rvzVar2.a;
                                                rvzVar2.a = rvzVar2.b;
                                                rvzVar2.b = i4;
                                            ...
                                            rvzVar2.e = 0;
                                            SparseArray a = rvyVar.a(rwaVar);
                                            rvyVar.c();
                                            rvx rvxVar = new rvx(a);
                                            synchronized (rvyVar.a) {
                                                rwc rwcVar = rvyVar.b;
                                                if (rwcVar != null) {
                                                    SparseArray sparseArray = rvxVar.a;
                                                    for (int i5 = 0; i5 < sparseArray.size(); i5++) {
                                                        int keyAt = sparseArray.keyAt(i5);
                                                        Object valueAt = sparseArray.valueAt(i5);
                                                        if (rwcVar.a.get(keyAt) == null) {
                                                            rwb rwbVar = new rwb();
                                                            rwbVar.a = rwcVar.b.create(valueAt);
                                                            rwbVar.a.onNewItem(keyAt, valueAt);
                                                            rwcVar.a.append(keyAt, rwbVar);
                                                        }
                                                    }
                                                    SparseArray sparseArray2 = rvxVar.a;
                                                    HashSet<Integer> hashSet = new HashSet();
                                                    for (int i6 = 0; i6 < rwcVar.a.size(); i6++) {
                                                        int keyAt2 = rwcVar.a.keyAt(i6);
                                                        if (sparseArray2.get(keyAt2) == null) {
                                                            rwb rwbVar2 = (rwb) rwcVar.a.valueAt(i6);
                                                            int i7 = rwbVar2.b + 1;
                                                            rwbVar2.b = i7;
                                                            if (i7 < 3) {
                                                                rwbVar2.a.onMissing(rvxVar);
                                                            } else {
                                                                rwbVar2.a.onDone();
                                                    ...
                                                    for (Integer num : hashSet) {
                                                        rwcVar.a.delete(num.intValue());
                                                    }
                                                    SparseArray sparseArray3 = rvxVar.a;
                                                    for (int i8 = 0; i8 < sparseArray3.size(); i8++) {
                                                        int keyAt3 = sparseArray3.keyAt(i8);
                                                        Object valueAt2 = sparseArray3.valueAt(i8);
                                                        rwb rwbVar3 = (rwb) rwcVar.a.get(keyAt3);
                                                        rwbVar3.b = 0;
                                                        rwbVar3.a.onUpdate(rvxVar, valueAt2);
                                                    }
                                                } else {
    ...
    public class SizePair {
        private qwg picture;
        private final qwg preview;

        public SizePair(Camera.Size size, Camera.Size size2) {
            this.preview = new qwg(size.width, size.height);
            if (size2 != null) {
                this.picture = new qwg(size2.width, size2.height);
            }
        }

        public qwg pictureSize() {
            return this.picture;
        }

        public qwg previewSize() {
            return this.preview;
        }
    }

    public CameraSource(Context context, rvy rvyVar) {
        if (context == null) {
            ...
            this.frameProcessor = new FrameProcessingRunnable(rvyVar);
        }
    }
    ...
    private Camera createCamera() {
        ...
        qwg pictureSize = selectSizePair.pictureSize();
        ...
        qwg qwgVar = this.previewSize;
        parameters.setPreviewSize(qwgVar.a, qwgVar.b);
    ...
    private byte[] createPreviewBuffer(qwg qwgVar) {
        double bitsPerPixel = qwgVar.b * qwgVar.a * ImageFormat.getBitsPerPixel(17);
    ...
    private static SizePair selectSizePair(Camera camera, int i, int i2) {
        ...
        for (SizePair sizePair2 : generateValidPreviewSizeList(camera)) {
            qwg previewSize = sizePair2.previewSize();
