...
public final class Thing extends AbstractSafeParcelable implements ReflectedParcelable, anwz {
    public static final Parcelable.Creator CREATOR = new alwc(11);
    public final int a;
    ...
    public class Metadata extends AbstractSafeParcelable {
        public static final Parcelable.Creator CREATOR = new alwc(8);
        ...
        public final boolean equals(Object obj) {
            ...
            return tnk.j(Boolean.valueOf(this.a), Boolean.valueOf(metadata.a)) && tnk.j(Integer.valueOf(this.b), Integer.valueOf(metadata.b)) && tnk.j(this.c, metadata.c) && Thing.c(this.d, metadata.d) && Thing.c(this.e, metadata.e);
        }
    ...
    public final boolean equals(Object obj) {
        ...
        return tnk.j(Integer.valueOf(this.a), Integer.valueOf(thing.a)) && tnk.j(this.d, thing.d) && tnk.j(this.e, thing.e) && tnk.j(this.c, thing.c) && c(this.b, thing.b);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        int m = tqj.m(parcel);
        tqj.v(parcel, 1, this.b);
        tqj.E(parcel, 2, this.c, i);
        tqj.F(parcel, 3, this.d);
