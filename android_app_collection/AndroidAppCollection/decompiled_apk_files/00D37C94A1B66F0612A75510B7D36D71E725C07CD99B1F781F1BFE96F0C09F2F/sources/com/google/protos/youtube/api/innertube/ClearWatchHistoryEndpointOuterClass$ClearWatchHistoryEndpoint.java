...
public final class ClearWatchHistoryEndpointOuterClass$ClearWatchHistoryEndpoint extends aopi implements aoqv {
    public static final ClearWatchHistoryEndpointOuterClass$ClearWatchHistoryEndpoint a;
    private static volatile aorb c;
    public static final aopg clearWatchHistoryEndpoint;
    private byte d = 2;
    ...
    static {
        ...
        aopi.registerDefaultInstance(ClearWatchHistoryEndpointOuterClass$ClearWatchHistoryEndpoint.class, clearWatchHistoryEndpointOuterClass$ClearWatchHistoryEndpoint);
        clearWatchHistoryEndpoint = aopi.newSingularGeneratedExtension(apzg.a, clearWatchHistoryEndpointOuterClass$ClearWatchHistoryEndpoint, clearWatchHistoryEndpointOuterClass$ClearWatchHistoryEndpoint, null, 63121550, aosj.MESSAGE, ClearWatchHistoryEndpointOuterClass$ClearWatchHistoryEndpoint.class);
    }
