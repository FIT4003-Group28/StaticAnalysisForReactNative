...
public final class LensWatchNextRequestContinuationCommandOuterClass$LensWatchNextRequestContinuationCommand extends aopi implements aoqv {
    public static final LensWatchNextRequestContinuationCommandOuterClass$LensWatchNextRequestContinuationCommand a;
    private static volatile aorb c;
    public static final aopg lensWatchNextRequestContinuationCommand;
    public String b = "";
    private int d;
    ...
    static {
        ...
        aopi.registerDefaultInstance(LensWatchNextRequestContinuationCommandOuterClass$LensWatchNextRequestContinuationCommand.class, lensWatchNextRequestContinuationCommandOuterClass$LensWatchNextRequestContinuationCommand);
        lensWatchNextRequestContinuationCommand = aopi.newSingularGeneratedExtension(apzg.a, lensWatchNextRequestContinuationCommandOuterClass$LensWatchNextRequestContinuationCommand, lensWatchNextRequestContinuationCommandOuterClass$LensWatchNextRequestContinuationCommand, null, 274848447, aosj.MESSAGE, LensWatchNextRequestContinuationCommandOuterClass$LensWatchNextRequestContinuationCommand.class);
    }
