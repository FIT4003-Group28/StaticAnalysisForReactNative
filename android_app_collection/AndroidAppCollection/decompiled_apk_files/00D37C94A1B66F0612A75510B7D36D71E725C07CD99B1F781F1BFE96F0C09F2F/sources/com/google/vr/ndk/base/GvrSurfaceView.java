...
public class GvrSurfaceView extends SurfaceView implements SurfaceHolder.Callback2 {
            ...
            if (gvrSurfaceView == null) {
                ...
                if (gvrSurfaceView.mAppContextListener != null) {
                    ...
                    if (eGLContext2 == null || eGLContext2 == EGL10.EGL_NO_CONTEXT) {
                        ...
                        axdx axdxVar = (axdx) gvrSurfaceView.mEGLContextFactory;
                        int i = gvrSurfaceView.mAppContextListener.b;
                        axdxVar.f = eGLContext2;
                        axdxVar.d = (i & 8) == 0;
                        axdxVar.e = gvrSurfaceView.mAppContextListener.c;
                    }
                }
    ...
    /* compiled from: PG */
    /* loaded from: classes3.dex */
    public class GLThread extends Thread implements axdy {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:38:0x008d, code lost:
            if (r0.mPreserveEGLContextOnPause == false) goto L26;
         */
