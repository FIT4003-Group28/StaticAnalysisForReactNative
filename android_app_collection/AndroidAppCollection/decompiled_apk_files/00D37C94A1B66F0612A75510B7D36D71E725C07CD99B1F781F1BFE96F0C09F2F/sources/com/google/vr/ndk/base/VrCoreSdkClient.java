...
public class VrCoreSdkClient {
    ...
    private final ServiceConnection serviceConnection = new ServiceConnection() { // from class: com.google.vr.ndk.base.VrCoreSdkClient.1
        /* JADX WARN: Code restructure failed: missing block: B:33:0x009e, code lost:
            if (r3.this$0.isResumed != false) goto L35;
         */
        /* JADX WARN: Code restructure failed: missing block: B:34:0x00a0, code lost:
            r3.this$0.resumeTracking(r0);
         */
        /* JADX WARN: Code restructure failed: missing block: B:40:0x00d1, code lost:
            if (r3.this$0.isResumed == false) goto L36;
         */
    ...
    /* compiled from: PG */
    /* loaded from: classes3.dex */
    public final class DaydreamListenerImpl extends axfk {
    ...
    */
    ...
    private void doUnbind() {
        ...
        axfn axfnVar = this.daydreamManager;
        if (axfnVar != null) {
            try {
                axfnVar.q(this.componentName);
    ...
    public int prepareVr(HeadTrackingState headTrackingState) {
        ...
        if (pendingIntent == null) {
            ...
            if (!(context instanceof axff) && (k = axds.k(context)) != null && k.getIntent() != null) {
    ...
    private void warnIfIncompatibleClient() {
        ...
        if (alertDialog != null) {
            ...
            this.helpCenterDialog = axfe.b(this.context, this.closeVrRunnable);
        }
    }
    ...
    public axgo getLoggingService() {
        return this.loggingService;
    }

    public void onExitingFromVr() {
        axfn axfnVar = this.daydreamManager;
        if (axfnVar != null && this.vrCoreClientApiVersion >= 16) {
            try {
                axfnVar.h();
            } catch (RemoteException e) {
                String valueOf = String.valueOf(e);
