...
public class CardboardViewNativeImpl implements CardboardViewApi, axdt {
    ...
    private final axdu glSurfaceView;
    ...
    public CardboardViewNativeImpl(Context context) {
        ...
        axdu axduVar = new axdu(context, this);
        this.glSurfaceView = axduVar;
        GvrLayout gvrLayout = new GvrLayout(context);
        this.gvrLayout = gvrLayout;
        gvrLayout.setPresentationView(axduVar);
