...
public class GvrViewerParams {
    ...
    public CardboardDevice$DeviceParams toProtobuf() {
        CardboardDevice$DeviceParams.Builder newBuilder;
        CardboardDevice$DeviceParams cardboardDevice$DeviceParams = this.originalDeviceProto;
        if (cardboardDevice$DeviceParams != null) {
            newBuilder = (CardboardDevice$DeviceParams.Builder) cardboardDevice$DeviceParams.mo52toBuilder();
        } else {
            newBuilder = CardboardDevice$DeviceParams.newBuilder();
        }
        ...
        return (CardboardDevice$DeviceParams) newBuilder.mo39build();
    }
