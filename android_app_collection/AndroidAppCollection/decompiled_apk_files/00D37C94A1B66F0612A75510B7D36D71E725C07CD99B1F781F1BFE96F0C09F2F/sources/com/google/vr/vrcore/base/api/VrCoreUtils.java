    ...
    */
    public static int a(android.content.Context r6) {
        ...
        Le:
            ...
            android.content.pm.Signature r5 = defpackage.axfi.a     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L56
            r4[r2] = r5     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L56
            boolean r4 = defpackage.axfi.a(r3, r4)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L56
            if (r4 == 0) goto L32
            goto L50
        L32:
            java.lang.Boolean r4 = defpackage.axij.c     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L56
            if (r4 == 0) goto L3d
            java.lang.Boolean r4 = defpackage.axij.c     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L56
            boolean r4 = r4.booleanValue()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L56
            goto L41
        L3d:
            boolean r4 = defpackage.axij.i(r6)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L56
        L41:
            if (r4 == 0) goto L51
            android.content.pm.Signature[] r4 = new android.content.pm.Signature[r0]     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L56
            android.content.pm.Signature r5 = defpackage.axfi.b     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L56
            r4[r2] = r5     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L56
            boolean r6 = defpackage.axfi.a(r3, r4)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L56
            if (r6 != 0) goto L50
            goto L51
        L50:
            return r2
