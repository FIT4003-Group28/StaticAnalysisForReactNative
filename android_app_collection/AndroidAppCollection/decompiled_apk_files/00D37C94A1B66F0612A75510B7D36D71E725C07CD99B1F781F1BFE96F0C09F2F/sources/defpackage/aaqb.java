...
final class aaqb {
    ...
    public static void b(OutputStream outputStream, aoqu aoquVar) {
        if (aoquVar == null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: Type inference failed for: r5v2, types: [java.lang.Object, aoqu] */
    public final aoqu a(aoqu aoquVar) {
        byte[] bArr = this.a;
        int i = this.b;
        int i2 = ((bArr[i + 2] & 255) << 16) | (bArr[i] & 255) | ((bArr[i + 1] & 255) << 8);
        this.b = i + 3;
        ?? o = aoquVar.getParserForType().o(this.a, this.b, i2);
        this.b += i2;
        return o;
    }
}
