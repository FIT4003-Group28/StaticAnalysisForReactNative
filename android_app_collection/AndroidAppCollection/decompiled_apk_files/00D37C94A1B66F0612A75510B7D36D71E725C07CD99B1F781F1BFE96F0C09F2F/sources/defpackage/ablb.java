...
public class ablb extends dh implements axoo {
    ...
    protected final void aF() {
        if (!this.ah) {
            ...
            eao eaoVar = (eao) lI();
            ablkVar.ae = (aaza) eaoVar.b.xo.get();
            ablkVar.af = (abks) eaoVar.b.xt.get();
            ablkVar.ag = (abky) eaoVar.b.xv.get();
            ablkVar.ah = (ajxz) eaoVar.b.lV.get();
            ablkVar.ai = (ajyi) eaoVar.c.cR.get();
        }
    }
