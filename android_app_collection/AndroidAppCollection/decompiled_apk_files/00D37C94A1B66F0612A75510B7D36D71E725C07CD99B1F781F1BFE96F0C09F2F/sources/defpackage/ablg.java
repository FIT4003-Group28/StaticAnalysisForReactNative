...
class ablg extends dh implements axoo {
    ...
    protected final void aF() {
        if (!this.ah) {
            ...
            eao eaoVar = (eao) lI();
            ablwVar.af = (ajyi) eaoVar.c.nc.get();
            ablwVar.ag = (ajyi) eaoVar.c.cx.get();
            ablwVar.ah = (abks) eaoVar.b.xt.get();
            ablwVar.ai = eaoVar.c.hk();
        }
    }
