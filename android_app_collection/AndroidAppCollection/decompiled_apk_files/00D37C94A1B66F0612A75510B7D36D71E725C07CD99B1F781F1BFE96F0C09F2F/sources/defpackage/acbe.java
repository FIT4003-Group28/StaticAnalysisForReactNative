...
public abstract class acbe extends MediaCodec.Callback implements acbt {
    ...
    public acbe(MediaFormat mediaFormat, acbw acbwVar) {
        String str;
        this.g = mediaFormat;
    ...
    public boolean d() {
        ...
        if (this.e == 1) {
            try {
                ...
                String valueOf2 = String.valueOf(this.a);
                if (valueOf2.length() != 0) {
                    "Starting encoder failed: ".concat(valueOf2);
                }
            }
            return this.e == 2;
        }
        String valueOf3 = String.valueOf(this.a);
        Log.e("ScreencastBaseEncoder", valueOf3.length() != 0 ? "Cannot start once stopped or released: ".concat(valueOf3) : new String("Cannot start once stopped or released: "));
        return false;
    }
    ...
    public boolean e() {
        ...
        if (j()) {
            try {
                ...
                String valueOf2 = String.valueOf(this.a);
                if (valueOf2.length() != 0) {
                    "Stopping encoder failed: ".concat(valueOf2);
                }
            }
            return this.e == 5;
        }
        String valueOf3 = String.valueOf(this.a);
        Log.e("ScreencastBaseEncoder", valueOf3.length() != 0 ? "Encoder not active: ".concat(valueOf3) : new String("Encoder not active: "));
        return false;
    }
}
