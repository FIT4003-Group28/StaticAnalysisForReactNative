...
public final class acbm implements acbw {
    ...
    public acbm(String str, boolean z) {
    ...
    public final void g(Context context, acbv acbvVar) {
        acbvVar.getClass();
        MediaScannerConnection.scanFile(context, new String[]{this.b}, new String[]{"video/avc", "video/mp4v-es"}, new acbl(acbvVar));
    }
