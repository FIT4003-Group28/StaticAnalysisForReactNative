...
/* compiled from: PG */
/* renamed from: acge  reason: default package */
/* loaded from: classes.dex */
public final class acge implements Runnable {
    final /* synthetic */ VolumeIndicatorView a;
    private final /* synthetic */ int b;

    public acge(VolumeIndicatorView volumeIndicatorView) {
        this.a = volumeIndicatorView;
    }

    public acge(VolumeIndicatorView volumeIndicatorView, int i) {
        this.b = i;
        this.a = volumeIndicatorView;
    }
