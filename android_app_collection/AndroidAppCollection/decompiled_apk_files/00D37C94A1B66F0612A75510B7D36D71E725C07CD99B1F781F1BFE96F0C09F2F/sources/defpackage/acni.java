...
public final class acni implements SeekBar.OnSeekBarChangeListener {
    final /* synthetic */ TextView a;
    final /* synthetic */ DeveloperPanel b;
    private final /* synthetic */ int c;

    public acni(DeveloperPanel developerPanel, TextView textView) {
        this.b = developerPanel;
        this.a = textView;
    }

    public acni(DeveloperPanel developerPanel, TextView textView, int i) {
        this.c = i;
        this.b = developerPanel;
        this.a = textView;
    }
