...
public final class adap extends DefaultHandler {
    public String b;
    private boolean h;
    ...
    public final ampq a() {
        ...
        return ampq.j(new adis(str, 7, Duration.ofMillis(Long.decode(str2).longValue())));
    }
    ...
    public final void endElement(String str, String str2, String str3) {
        if (TextUtils.equals(str2, "state")) {
            ...
            if (lowerCase.startsWith("installable")) {
                ...
                this.c = 2;
            } else if (!TextUtils.equals(lowerCase, "hidden")) {
            } else {
                this.c = 3;
            }
