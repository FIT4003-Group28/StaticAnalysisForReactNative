...
/* compiled from: PG */
/* renamed from: adbs  reason: default package */
/* loaded from: classes.dex */
public final class adbs {
    public static final String a = zep.a("MDX.WakeOnLan");
    public final long b;
    public final adwc c;
    ...
    private final Runnable i = new adbr(this);
    public final adbq d = new adbp();

    public adbs(adwc adwcVar, String str, acwu acwuVar) {
        this.c = adwcVar;
        this.e = str;
        int i = acwuVar.X;
        this.b = i > 0 ? i : 50L;
    ...
    public final void a() {
        synchronized (this) {
            ...
            try {
                ...
                zep.f(a, "Error creating magic packet", e);
            }
        }
    }
