...
final class adsl implements RecognitionListener {
    final /* synthetic */ adso a;

    public adsl(adso adsoVar) {
        this.a = adsoVar;
    }
    ...
    public final void onError(int i) {
        zep.f(adso.a, "Speech recognition error", new adsp(i));
        this.a.f();
        adsg adsgVar = (adsg) this.a.b;
        if (adsgVar.C) {
            return;
        }
        if (i == 6 || i == 7) {
            ...
            View view = adsgVar.m;
            if (view != null) {
                aloh.n(view, R.string.mdx_smart_remote_generic_error_message).g();
                adsgVar.h.n(new acte(acuo.b(63268)));
            }
        }
        adsgVar.d.postDelayed(new adsb(adsgVar), 3500L);
        adsgVar.C = true;
        adsgVar.n(5, false, true);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0046, code lost:
        if (defpackage.akzj.f(r0.g, r0.f) == false) goto L16;
     */
    @Override // android.speech.RecognitionListener
    /*
    ...
    */
    public final void onPartialResults(android.os.Bundle r7) {
        ...
        L2c:
            ...
            boolean r0 = defpackage.akzj.f(r0, r2)
            if (r0 == 0) goto L48
            adso r0 = r6.a
            java.lang.String r2 = r0.g
            java.lang.String r0 = r0.f
            boolean r0 = defpackage.akzj.f(r2, r0)
            if (r0 != 0) goto L9f
        L48:
            adso r0 = r6.a
        ...
        L9f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.adsl.onPartialResults(android.os.Bundle):void");
    }
    ...
    public final void onRmsChanged(float f) {
        MicrophoneView microphoneView = ((adsg) this.a.b).v;
