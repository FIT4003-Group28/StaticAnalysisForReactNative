...
final class adut extends WebViewClient {
    ...
    public final void onPageFinished(WebView webView, String str) {
        ...
        if (str.contains("oauth/consent")) {
            this.a.e.n(new acte(acuo.b(36385)));
            this.a.e.n(new acte(acuo.b(36386)));
        }
    }
    ...
    public final void onReceivedHttpError(WebView webView, WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
        ...
        aduv aduvVar = this.a;
        aduvVar.c(2, aduvVar.f.rb().getString(R.string.mdx_tv_signin_error_snackbar_message));
    }
