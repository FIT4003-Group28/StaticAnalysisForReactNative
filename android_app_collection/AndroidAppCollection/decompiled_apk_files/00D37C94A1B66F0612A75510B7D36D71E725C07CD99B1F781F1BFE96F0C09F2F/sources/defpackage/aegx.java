...
/* compiled from: PG */
/* renamed from: aegx  reason: default package */
/* loaded from: classes.dex */
public final class aegx {
    public static final aegx a = new aegx(-1, -1);
    public final int b;
    public final int c;
    public final int d;

    public aegx(int i, int i2) {
        this(i, i2, 0);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.b == aegxVar.b && this.c == aegxVar.c;
    }
    ...
    public aegx(int i, int i2, int i3) {
        afms.b(i >= i2);
        this.b = i;
        this.c = i2;
        this.d = i3;
