...
/* compiled from: PG */
/* renamed from: aekd  reason: default package */
...
public final class aekd {
    ...
    public final poh e;
    public final aant f;
    final /* synthetic */ aekg g;
    private Uri h;
    private String i;
    private long j;
    private boolean k;

    public aekd(aekg aekgVar, Uri uri, aant aantVar) {
        this.g = aekgVar;
        afms.a(uri);
        this.a = uri;
        this.e = (poh) aekgVar.b.get();
        this.i = null;
        this.j = 0L;
        this.b = 0L;
        this.c = 0L;
