...
final class aepi implements atk {
    final /* synthetic */ aepj a;

    public aepi(aepj aepjVar) {
        this.a = aepjVar;
    }

    @Override // defpackage.atk
    public final void a(asv asvVar, asy asyVar, boolean z, int i) {
        synchronized (this.a) {
            if (!this.a.b.contains(asvVar)) {
                this.a.a(asvVar, asyVar, z, i);
            }
        }
    }

    @Override // defpackage.atk
    public final void b(asv asvVar, asy asyVar, boolean z) {
        synchronized (this.a) {
            if (!this.a.b.contains(asvVar)) {
                this.a.b(asvVar, asyVar, z);
            }
        }
    }

    /* JADX WARN: Removed duplicated region for block: B:31:0x008f A[Catch: all -> 0x0098, TryCatch #0 {, blocks: (B:4:0x0003, B:6:0x0018, B:8:0x0025, B:10:0x002d, B:13:0x0036, B:15:0x0042, B:29:0x0089, B:31:0x008f, B:16:0x004b, B:17:0x0056, B:19:0x005d, B:21:0x0069, B:24:0x0076, B:26:0x007c, B:27:0x0080, B:22:0x0072, B:28:0x0085, B:32:0x0096), top: B:39:0x0003 }] */
    @Override // defpackage.atk
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public final void c(defpackage.asv r6, defpackage.asy r7, boolean r8) {
        /*
            r5 = this;
            aepj r8 = r5.a
            monitor-enter(r8)
            aepj r0 = r5.a     // Catch: java.lang.Throwable -> L98
            java.util.Set r0 = r0.b     // Catch: java.lang.Throwable -> L98
            r0.remove(r6)     // Catch: java.lang.Throwable -> L98
            aepj r0 = r5.a     // Catch: java.lang.Throwable -> L98
            aant r0 = r0.a     // Catch: java.lang.Throwable -> L98
            com.google.android.libraries.youtube.innertube.model.media.PlayerConfigModel r0 = r0.get()     // Catch: java.lang.Throwable -> L98
            boolean r0 = r0.aI()     // Catch: java.lang.Throwable -> L98
            if (r0 == 0) goto L96
            android.net.Uri r7 = r7.a     // Catch: java.lang.Throwable -> L98
            java.util.Set r0 = defpackage.aank.c()     // Catch: java.lang.Throwable -> L98
        ...
        L36:
            ...
            if (r3 != 0) goto L4b
            int r7 = defpackage.ovm.a(r7)     // Catch: java.lang.Throwable -> L98
            java.lang.Integer r7 = java.lang.Integer.valueOf(r7)     // Catch: java.lang.Throwable -> L98
            goto L89
        L4b:
            r7 = 47
            amqf r7 = defpackage.amqf.b(r7)     // Catch: java.lang.Throwable -> L98
        ...
        L76:
            ...
            if (r1 != 0) goto L80
            int r2 = defpackage.ovm.a(r7)     // Catch: java.lang.Throwable -> L98
        L80:
        ...
        L89:
            ...
            if (r7 != 0) goto L96
            aepj r7 = r5.a     // Catch: java.lang.Throwable -> L98
        ...
        L9c:
            goto L9b
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aepi.c(asv, asy, boolean):void");
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:46:0x0080 A[Catch: all -> 0x00b5, TRY_ENTER, TryCatch #0 {, blocks: (B:4:0x0003, B:6:0x000d, B:8:0x000f, B:10:0x0013, B:12:0x0021, B:13:0x0023, B:15:0x0029, B:17:0x002f, B:18:0x0031, B:46:0x0080, B:48:0x008a, B:50:0x008e, B:51:0x0090, B:57:0x009c, B:58:0x00ac, B:22:0x0038, B:24:0x0041, B:25:0x0043, B:26:0x0045, B:40:0x006e, B:29:0x004d, B:32:0x0054, B:34:0x005c, B:37:0x0063, B:60:0x00ae, B:61:0x00b3), top: B:69:0x0003 }] */
    @Override // defpackage.atk
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public final void d(defpackage.asv r10, defpackage.asy r11, boolean r12) {
        /*
            r9 = this;
            aepj r0 = r9.a
            monitor-enter(r0)
            aepj r1 = r9.a     // Catch: java.lang.Throwable -> Lb5
            ...
            return
        Lf:
            boolean r1 = r10 instanceof defpackage.poh     // Catch: java.lang.Throwable -> Lb5
            if (r1 == 0) goto Lae
            aepj r1 = r9.a     // Catch: java.lang.Throwable -> Lb5
            aant r1 = r1.a     // Catch: java.lang.Throwable -> Lb5
            com.google.android.libraries.youtube.innertube.model.media.PlayerConfigModel r1 = r1.get()     // Catch: java.lang.Throwable -> Lb5
            atzv r2 = r1.c     // Catch: java.lang.Throwable -> Lb5
            asun r2 = r2.G     // Catch: java.lang.Throwable -> Lb5
            if (r2 != 0) goto L23
            asun r2 = defpackage.asun.a     // Catch: java.lang.Throwable -> Lb5
        L23:
        ...
        L38:
            r2 = r10
            poh r2 = (defpackage.poh) r2     // Catch: java.lang.Throwable -> Lb5
            atzv r5 = r1.c     // Catch: java.lang.Throwable -> Lb5
            aqwu r5 = r5.e     // Catch: java.lang.Throwable -> Lb5
            if (r5 != 0) goto L43
            aqwu r5 = defpackage.aqwu.b     // Catch: java.lang.Throwable -> Lb5
        L43:
        ...
        L7c:
            ...
            if (r2 == 0) goto Lae
            atzv r11 = r1.c     // Catch: java.lang.Throwable -> Lb5
            int r12 = r11.b     // Catch: java.lang.Throwable -> Lb5
            r12 = r12 & 2
            r1 = 1065353216(0x3f800000, float:1.0)
            if (r12 == 0) goto L93
            aqwu r11 = r11.e     // Catch: java.lang.Throwable -> Lb5
            if (r11 != 0) goto L90
            aqwu r11 = defpackage.aqwu.b     // Catch: java.lang.Throwable -> Lb5
        L90:
        ...
        L9b:
            r1 = r11
        L9c:
            aepj r11 = r9.a     // Catch: java.lang.Throwable -> Lb5
        ...
        Lb9:
            goto Lb8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aepi.d(asv, asy, boolean):void");
    }
}
