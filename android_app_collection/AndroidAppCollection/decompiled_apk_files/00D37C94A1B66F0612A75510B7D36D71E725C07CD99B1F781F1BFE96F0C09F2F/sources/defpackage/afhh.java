...
public final class afhh {
    public static final afhh a = new afhh(PlayerConfigModel.b, VideoStreamingData.a, null, null);
    private final int A;
    private final int B;
    private boolean C;
    ...
    public afhh(PlayerConfigModel playerConfigModel, VideoStreamingData videoStreamingData, Runnable runnable, Handler handler) {
        int i;
        adyd adydVar = adyd.k;
        this.r = Long.MAX_VALUE;
        this.t = Long.MAX_VALUE;
        this.D = new afhg(this);
        ...
        if (!videoStreamingData.B() || !videoStreamingData.C()) {
            this.e = asuk.LIVE_ONLY_PEG_STRATEGY_DO_NOT_PEG;
        } else if (!videoStreamingData.G()) {
            this.e = playerConfigModel.P();
            this.C = true;
        } else {
            this.e = asuk.LIVE_ONLY_PEG_STRATEGY_DO_NOT_PEG;
        }
        ...
        afms.a(this.e);
        afms.a(atazVar);
        if (this.e.equals(asuk.LIVE_ONLY_PEG_STRATEGY_SEEK_ON_REBUFFER_ESTIMATE_DURATION)) {
            ataz atazVar2 = ataz.MDE_STREAM_OPTIMIZATIONS_RENDERER_LATENCY_UNKNOWN;
            int ordinal = atazVar.ordinal();
            j = ordinal != 2 ? ordinal != 3 ? 15000 : 4000 : 6000;
        }
        this.z = j;
        atzv atzvVar = playerConfigModel.c;
        if ((atzvVar.c & 32768) != 0) {
            asun asunVar = atzvVar.G;
            i = (int) ((asunVar == null ? asun.a : asunVar).b * 1000.0d);
        } else {
            i = 12000;
        }
        this.y = i;
    ...
    private final void o() {
        if (this.k.aH()) {
            if (this.n != ataz.MDE_STREAM_OPTIMIZATIONS_RENDERER_LATENCY_ULTRA_LOW) {
                int i = this.y;
                if (this.x < i * this.p) {
    ...
    public final void g() {
        ataz atazVar = ataz.MDE_STREAM_OPTIMIZATIONS_RENDERER_LATENCY_UNKNOWN;
        asuk asukVar = asuk.LIVE_ONLY_PEG_STRATEGY_UNKNOWN;
        if (this.e.ordinal() == 3) {
            boolean z = true;
    ...
    */
    public final boolean l(long r14, long r16, long r18) {
        /*
            ...
            goto L81
        L11:
            ataz r3 = defpackage.ataz.MDE_STREAM_OPTIMIZATIONS_RENDERER_LATENCY_UNKNOWN
            asuk r3 = defpackage.asuk.LIVE_ONLY_PEG_STRATEGY_UNKNOWN
            asuk r3 = r0.e
            int r3 = r3.ordinal()
            r5 = 3
            r6 = 1
        ...
        L81:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.afhh.l(long, long, long):boolean");
    }
