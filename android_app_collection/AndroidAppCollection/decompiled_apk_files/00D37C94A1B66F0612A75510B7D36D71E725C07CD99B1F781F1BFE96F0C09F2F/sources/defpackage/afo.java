...
public final class afo extends Drawable {
    public float a;
    public float b;
    ...
    public afo(ColorStateList colorStateList, float f) {
        this.a = f;
        a(colorStateList);
        this.f = new RectF();
        this.g = new Rect();
    ...
    public final void b(Rect rect) {
        ...
        this.g.set(rect);
        if (this.c) {
            float b = afp.b(this.b, this.a, this.d);
            this.g.inset((int) Math.ceil(afp.a(this.b, this.a, this.d)), (int) Math.ceil(b));
            this.f.set(this.g);
        }
    }
