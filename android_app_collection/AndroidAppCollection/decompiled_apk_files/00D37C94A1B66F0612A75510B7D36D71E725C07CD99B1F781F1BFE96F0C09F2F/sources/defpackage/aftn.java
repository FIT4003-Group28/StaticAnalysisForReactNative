...
public abstract class aftn {
    ...
    public static Uri e(JSONObject jSONObject, String str) {
        try {
            if (!jSONObject.isNull(str)) {
                return zgt.i(jSONObject.getString(str));
            }
            return null;
        } catch (MalformedURLException e) {
            zep.d("Malformed URL", e);
    ...
    public static final JSONArray k(List list) {
        ...
        while (it.hasNext()) {
            ...
            jSONArray.put(aftoVar == null ? JSONObject.NULL : aftoVar.h().l());
        }
        return jSONArray;
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public static void o(JSONObject jSONObject, String str, afto aftoVar) {
        jSONObject.put(str, aftoVar == null ? JSONObject.NULL : aftoVar.h().l());
    }
    ...
    public static final List p(JSONObject jSONObject, String str) {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            if (jSONArray.isNull(i)) {
                ...
                try {
                    arrayList.add(zgt.i(jSONArray.getString(i)));
                } catch (MalformedURLException e) {
                    zep.d("Malformed URL", e);
                    throw new JSONException("Malformed URL Exception");
                }
