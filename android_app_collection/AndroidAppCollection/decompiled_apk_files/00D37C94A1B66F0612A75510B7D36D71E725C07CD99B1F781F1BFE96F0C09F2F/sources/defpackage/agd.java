    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof agd) {
            ...
            for (int i = 0; i < this.j; i++) {
                Object f2 = f(i);
                Object i2 = i(i);
                Object obj2 = agdVar.get(f2);
                if (i2 == null) {
                    if (obj2 != null || !agdVar.containsKey(f2)) {
                        return false;
                    }
    ...
    public void k(agd agdVar) {
        ...
        if (this.j != 0) {
            for (int i2 = 0; i2 < i; i2++) {
                put(agdVar.f(i2), agdVar.i(i2));
            }
        } else if (i > 0) {
            System.arraycopy(agdVar.h, 0, this.h, 0, i);
            System.arraycopy(agdVar.i, 0, this.i, 0, i + i);
            this.j = i;
        }
    }
