...
public final class age implements Cloneable {
    ...
    public final age clone() {
        try {
            age ageVar = (age) super.clone();
            ageVar.e = (int[]) this.e.clone();
            ageVar.b = (Object[]) this.b.clone();
            return ageVar;
