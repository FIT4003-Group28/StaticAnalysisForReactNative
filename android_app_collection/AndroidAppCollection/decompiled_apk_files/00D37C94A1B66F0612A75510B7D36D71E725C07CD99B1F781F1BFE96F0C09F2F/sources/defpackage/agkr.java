...
public final class agkr {
    ...
    public agkr(boolean z, boolean z2, int i, int i2, long j, long j2, boolean z3, int i3, boolean z4) {
        this.a = z;
        this.i = z2;
        this.b = i;
        this.c = i2;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof agkr) {
            ...
            if (this.a == agkrVar.a && this.i == agkrVar.i && this.b == agkrVar.b && this.c == agkrVar.c && this.d == agkrVar.d && this.e == agkrVar.e && this.f == agkrVar.f && this.g == agkrVar.g && this.h == agkrVar.h) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        ...
        long j = this.d;
        long j2 = this.e;
        int i6 = (((((((((((((i2 ^ i3) * 1000003) ^ i4) * 1000003) ^ i5) * 1000003) ^ ((int) ((j >>> 32) ^ j))) * 1000003) ^ ((int) ((j2 >>> 32) ^ j2))) * 1000003) ^ (true != this.f ? 1237 : 1231)) * 1000003) ^ this.g) * 1000003;
        if (true == this.h) {
            i = 1231;
        }
        return i6 ^ i;
