...
final class aglx implements ymu {
        ...
        switch (this.a) {
            ...
            case 11:
                ...
                while (it.hasNext()) {
                    ...
                    if (update != 1) {
                        zep.e("Unexpected number of rows affected (%d) when populating streams URI column for (%s, %s)", new Object[]{Integer.valueOf(update), strArr[0], strArr[1]});
                    }
                }
                return;
            case 12:
