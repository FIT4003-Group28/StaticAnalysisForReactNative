...
public final class ahag implements aegj {
    public String a;
    public long b;
    public long c;
    private long e;
    ...
    public ahag(snc sncVar, agmc agmcVar, ahaf ahafVar) {
        this.i = sncVar;
        this.j = agmcVar;
        this.k = ahafVar;
    }
    ...
    public final void g(FormatStreamModel formatStreamModel, long j) {
        ...
        if (this.d < 0 || round - i >= 1.0d || j2 - this.e >= 16777216 || j == formatStreamModel.j()) {
            long c = this.i.c();
            long j3 = this.f;
            double d4 = 0.0d;
            if (j3 < c) {
            ...
            this.j.f(this.a, formatStreamModel.e(), j);
