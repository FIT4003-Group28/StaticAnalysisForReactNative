...
final class ahkd implements CardboardView.Renderer {
    ...
    public final void onDrawEye(CardboardView.Eye eye) {
        ...
        if (eye.getEyeType() == 0) {
            this.a.onDrawEye(new ahkc(eye, 1, this.c.getHeadView()));
        } else {
            this.a.onDrawEye(new ahkc(eye, 2, this.c.getHeadView()));
        }
    }
