...
/* compiled from: PG */
/* renamed from: ahmm  reason: default package */
/* loaded from: classes.dex */
final class ahmm implements Runnable {
    final /* synthetic */ ahmp a;

    public ahmm(ahmp ahmpVar) {
        this.a = ahmpVar;
    }
    ...
    public final void run() {
        ...
        int i;
        ahmm ahmmVar = this;
        ahmp ahmpVar = ahmmVar.a;
        if (!ahmpVar.b.isEmpty()) {
            ArrayList arrayList = new ArrayList(ahmpVar.b);
            ahmpVar.b.clear();
            double d = ahmpVar.c;
            Double.isNaN(d);
            double d2 = d / 1000.0d;
            ...
            ahmpVar.m.post(new ahmo(ahmpVar, d2, d4, Base64.encodeToString(Arrays.copyOf(bArr5, i9), 10)));
            ahmmVar = this;
        }
        if (!ahmmVar.a.i) {
            ahmmVar.a.c(30000L);
