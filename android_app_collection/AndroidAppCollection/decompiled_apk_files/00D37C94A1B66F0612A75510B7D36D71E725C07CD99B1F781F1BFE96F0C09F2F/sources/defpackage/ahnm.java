...
public final class ahnm extends ahlb implements ahoe, ahoc {
    private final ahof a;
    private final ahjv b;
    private final ahni c;
    private float e;

    public ahnm(Context context, ahof ahofVar) {
        this.a = ahofVar;
        float f = ahoj.a;
        float[] fArr = {-ahoj.a, ahoj.a * (-0.7f), ahoj.a * (-0.4f), ahoj.a * (-0.1f), ahoj.a * 0.2f, ahoj.a * 0.4f, ahoj.a * 0.6f, ahoj.a * 0.8f, ahoj.a};
        aqxo.p(true);
        aqxo.p(true);
        ...
        ahon ahonVar = new ahon(fArr2, new float[694], 5);
        ahoo b = ahoo.b();
        ...
        ahjv ahjvVar = new ahjv(ahonVar, b, fArr4, ahofVar.a.a());
        this.b = ahjvVar;
        ahni ahniVar = new ahni(BitmapFactory.decodeResource(context.getResources(), R.raw.vr_video_shadow), ahon.a(1.0f, 1.0f, ahon.c), ahofVar.c.clone(), ahofVar.a.b());
        this.c = ahniVar;
        ahofVar.c(this);
        ahofVar.f.add(this);
        c(ahofVar.h, ahofVar.i);
        q(ahjvVar);
        q(ahniVar);
    }
    ...
    public final void c(float f, float f2) {
        ...
        this.c.n(0.0f, this.e - f5, 0.0f);
        this.e = f5;
        this.c.rT(f3, f4, 1.0f);
    }
