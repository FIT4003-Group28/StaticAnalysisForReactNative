package defpackage;
/* compiled from: PG */
/* renamed from: ahon  reason: default package */
...
public final class ahon {
    ...
    public ahon(float[] fArr, float[] fArr2, int i) {
        fArr.getClass();
        fArr2.getClass();
        ...
        aqxo.p(1 == ((length2 & 1) ^ 1));
        int i2 = length / 3;
        aqxo.p(i2 == (length2 >> 1) ? true : z);
        this.f = i2;
        this.g = i;
        this.d = new ahoq(fArr, 3);
        this.e = new ahoq(fArr2, 2);
    }

    public static ahon a(float f, float f2, float[] fArr) {
        int max;
        int i;
        if (f > f2) {
        ...
        float f5 = -f3;
        float f6 = -f4;
        return new ahon(d(new float[]{f5, f6, 0.0f, f5, f4, 0.0f, f3, f6, 0.0f, f3, f4, 0.0f}, 3, max, i), d(fArr, 2, max, i), 5);
    }

    public static ahon c(float f) {
        ...
        return new ahon(fArr, new float[44], 6);
    }
