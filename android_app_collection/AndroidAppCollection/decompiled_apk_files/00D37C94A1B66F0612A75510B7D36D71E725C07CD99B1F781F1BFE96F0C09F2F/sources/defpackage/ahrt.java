...
public final class ahrt {
    ...
    private final int h;
    private ahpj j;
    private final ahrn k;
    private final int[] f = new int[3];
    private int i = -1;

    public ahrt(ahrp ahrpVar, boolean z) {
        if (z) {
            for (int i = 0; i < 3; i++) {
                this.f[i] = ahrpVar.f(d[i]);
            }
            this.g = ahrpVar.f("uColorConversion");
            this.e = -1;
        } else {
            this.e = ahrpVar.f("uTexture");
            this.g = -1;
        }
        this.h = ahrpVar.f("uCropRight");
        this.k = new ahrn(ahrpVar);
    }

    public static String a(ahrz ahrzVar, boolean z) {
        String str = true != z ? "" : "#define ENABLE_YUV\n";
        String a2 = ahrzVar.a(R.raw.gl_rgb_and_yuv_program_ext_frag);
        return a2.length() != 0 ? str.concat(a2) : new String(str);
    }

    public static String b(ahrz ahrzVar) {
        return ahrzVar.a(R.raw.gl_rgb_and_yuv_program_ext_vert);
    }
    ...
    */
    public final void e(defpackage.ahor r8) {
        /*
            r7 = this;
            int r0 = r8.j()
            r1 = 2
        ...
        L33:
            ...
            goto L46
        L3e:
            androidx.media3.common.ColorInfo r6 = r0.b
            androidx.media3.common.ColorInfo r5 = r5.b
            boolean r5 = r6.equals(r5)
        L46:
            if (r5 == 0) goto L54
            goto L4e
        ...
        L4e:
            ...
            goto Lb5
        L54:
            float[] r5 = defpackage.ahrt.b
            if (r4 == r2) goto L5e
            if (r4 == r1) goto L5b
            goto L60
        L5b:
            float[] r5 = defpackage.ahrt.c
            goto L60
        L5e:
            float[] r5 = defpackage.ahrt.a
        L60:
            int r1 = r7.g
        ...
        L99:
            ...
            r0.c(r8)
        Lb5:
            java.lang.Boolean r8 = defpackage.ahom.a
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ahrt.e(ahor):void");
    }

    public final void f(int i, int i2, int i3, int i4) {
        ahrn ahrnVar = this.k;
        if (ahrnVar.n != i || ahrnVar.o != i2 || ahrnVar.p != i4) {
            ahrnVar.k = true;
        }
        ahrnVar.n = i;
        ahrnVar.o = i2;
