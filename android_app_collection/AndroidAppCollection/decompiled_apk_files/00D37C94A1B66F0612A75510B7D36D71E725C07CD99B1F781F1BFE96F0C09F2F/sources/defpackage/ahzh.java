...
final class ahzh extends AnimationDrawable {
    ...
    public ahzh(ImageView imageView, int i, int i2, boolean z) {
        this.a = imageView;
        this.b = i;
        this.c = i2;
        if (!z) {
    ...
    private final Drawable c() {
        if (this.d == null) {
            this.d = akf.a(this.a.getContext(), this.c);
        }
        return this.d;
    }
    ...
    private final void d() {
        ...
        Drawable a = akf.a(this.a.getContext(), this.b);
