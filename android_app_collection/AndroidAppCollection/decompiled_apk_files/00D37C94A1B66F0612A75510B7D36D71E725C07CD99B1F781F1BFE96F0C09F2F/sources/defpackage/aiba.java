...
public class aiba extends aize implements aiau {
    ...
    public aiba(Context context) {
        ...
        this.g = new SubtitlesStyle(i2, i4, i6, i8, i10, aiyv.values()[3].i);
        f();
    }
    ...
    private final void d(SubtitleWindowView subtitleWindowView) {
        ...
        if (Math.abs(subtitleWindowView.d - f) >= 0.01f) {
            ...
            for (aiyp aiypVar : subtitleWindowView.a) {
                aiypVar.f(f);
            }
        }
        int i = this.g.a;
        if (subtitleWindowView.h != i) {
            ...
            for (aiyp aiypVar2 : subtitleWindowView.a) {
                aiypVar2.setBackgroundColor(i);
            }
        ...
        if (subtitleWindowView.c != i2) {
            ...
            for (aiyp aiypVar3 : subtitleWindowView.a) {
                aiypVar3.e(i2);
            }
            subtitleWindowView.invalidate();
        }
        Typeface a = aiyv.a(getContext(), this.g);
        if (!akzj.f(subtitleWindowView.e, a)) {
            subtitleWindowView.e = a;
            subtitleWindowView.b.g(a);
            for (aiyp aiypVar4 : subtitleWindowView.a) {
                aiypVar4.g(a);
            }
            subtitleWindowView.invalidate();
        ...
        if (subtitleWindowView.f != i3) {
            ...
            for (aiyp aiypVar5 : subtitleWindowView.a) {
                aiypVar5.b(i3);
            }
            subtitleWindowView.invalidate();
        }
        ...
        for (aiyp aiypVar6 : subtitleWindowView.a) {
            aiypVar6.c(i4);
        }
        subtitleWindowView.invalidate();
        subtitleWindowView.requestLayout();
    ...
    */
    protected final void onLayout(boolean r9, int r10, int r11, int r12, int r13) {
        ...
        L8a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aiba.onLayout(boolean, int, int, int, int):void");
    }
    ...
    */
    protected final void onMeasure(int r8, int r9) {
        ...
        L8e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aiba.onMeasure(int, int):void");
    }
}
