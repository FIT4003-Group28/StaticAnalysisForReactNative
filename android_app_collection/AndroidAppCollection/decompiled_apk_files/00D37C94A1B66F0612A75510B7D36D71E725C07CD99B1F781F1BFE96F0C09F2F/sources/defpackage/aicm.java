...
public final class aicm extends aizc implements aicn {
    public boolean a;
    public boolean b;
    public long c;
    ...
    private final void j() {
        if (this.f == null || this.g == null) {
            ...
            this.j = zew.g(displayMetrics, -24.0f);
            this.k = zew.g(displayMetrics, -48.0f);
            this.l = zew.g(displayMetrics, -16.0f);
    ...
    private final void k() {
        ...
        int i = true != this.h ? 2132083724 : 2132083732;
        this.g.setMaxWidth(dimensionPixelSize);
        kz.s(this.g, i);
        this.g.setTextColor(ake.d(getContext(), R.color.yt_white1));
    ...
    public final void e(int i) {
        ...
        if (imageView != null) {
            if (i != 0) {
                imageView.setImageDrawable(akf.a(getContext(), i));
    ...
    public final void h() {
        ...
        zdg.c(context, textView, textView.getText());
        addOnLayoutChangeListener(new aicl(this));
    ...
    public aicm(Context context, boolean z) {
        super(context);
        this.h = false;
        this.i = false;
        this.a = false;
        this.b = false;
        this.m = new aick(this);
        this.e = z;
