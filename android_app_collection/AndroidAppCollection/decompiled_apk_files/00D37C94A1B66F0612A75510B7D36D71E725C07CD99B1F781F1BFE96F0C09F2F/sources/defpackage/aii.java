...
public final class aii extends ViewGroup.MarginLayoutParams {
    public int A;
    public int B;
    public int C;
    public float D;
    ...
    public final void a() {
        ...
        this.Z = true;
        this.aa = true;
        if (!(this.aq instanceof ahk)) {
            this.aq = new ahk();
        }
        ((ahk) this.aq).c(this.U);
    }
    ...
    */
    public final void resolveLayoutDirection(int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aii.resolveLayoutDirection(int):void");
    }
    ...
    public aii(Context context, AttributeSet attributeSet) {
        ...
        this.aq = new ahh();
        this.ar = false;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, aix.b);
        int indexCount = obtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = obtainStyledAttributes.getIndex(i);
            int i2 = aih.a.get(index);
            switch (i2) {
                case 1:
                ...
                default:
                    switch (i2) {
                        case 44:
                            ais.f(this, obtainStyledAttributes.getString(index));
                            continue;
                        case 45:
                        ...
                        case 47:
                            ...
                            continue;
                        case 48:
                            this.f50J = obtainStyledAttributes.getInt(index, 0);
                            continue;
                        case 49:
                        ...
                        default:
                            switch (i2) {
                                case 64:
                                    ais.e(this, obtainStyledAttributes, index, 0);
                                    continue;
                                case 65:
                                    ais.e(this, obtainStyledAttributes, index, 1);
                                    continue;
                                case 66:
    ...
    public aii(ViewGroup.LayoutParams layoutParams) {
        super(layoutParams);
        this.a = -1;
        this.b = -1;
        this.c = -1.0f;
