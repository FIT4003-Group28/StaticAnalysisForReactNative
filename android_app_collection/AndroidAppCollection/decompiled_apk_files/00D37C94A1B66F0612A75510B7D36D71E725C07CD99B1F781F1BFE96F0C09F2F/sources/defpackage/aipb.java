...
/* compiled from: PG */
/* renamed from: aipb  reason: default package */
...
public final class aipb {
    ...
    private aipb(long j, long j2, long j3, boolean z) {
        this.a = j;
        this.b = j2;
        this.c = j3;
        this.e = z;
    ...
    public static aipb a(Header header, long j) {
        long j2 = j - 1;
        if (header == null) {
            return new aipb(0L, j2, j, false);
        }
        ...
        return new aipb(parseLong, j2, j, true);
    }
    ...
    */
    public final boolean b(org.apache.http.HttpResponse r9) {
        ...
        L61:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aipb.b(org.apache.http.HttpResponse):boolean");
    }
}
