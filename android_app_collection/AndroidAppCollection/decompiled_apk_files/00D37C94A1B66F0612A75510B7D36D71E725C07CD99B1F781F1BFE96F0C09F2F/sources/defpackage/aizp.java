...
/* compiled from: PG */
/* renamed from: aizp  reason: default package */
...
public final class aizp {
    ...
    public float k = 1.0f;
    private aalc u = new aalc();
    public orw q = orw.AUDIO_ROUTE_UNSPECIFIED;
    ...
    public final void c(aizo aizoVar) {
        this.a.add(aizoVar);
    }
    ...
    public final void m(CharSequence charSequence, CharSequence charSequence2) {
        CharSequence d = zgh.d(charSequence);
        CharSequence d2 = zgh.d(charSequence2);
