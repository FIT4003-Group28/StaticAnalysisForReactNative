...
public final class ajtl {
    ...
    public ajtl(ajru ajruVar, long j, Runnable runnable, Runnable runnable2) {
        this.a = ajruVar;
        this.b = j;
        this.c = runnable;
        this.d = runnable2;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof ajtl) {
            ...
            if (this.a.equals(ajtlVar.a) && this.b == ajtlVar.b && this.c.equals(ajtlVar.c) && this.d.equals(ajtlVar.d)) {
                return true;
            }
        }
        return false;
