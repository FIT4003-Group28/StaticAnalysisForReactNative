...
public final class ajwp extends ReplacementSpan {
    ...
    public ajwp(String str, float f, float f2, float f3, int i) {
    ...
    public ajwp(String str, float f, float f2, float f3, int i, byte[] bArr) {
        this.a = str;
        this.c = f;
        this.d = f2;
        this.e = f3;
