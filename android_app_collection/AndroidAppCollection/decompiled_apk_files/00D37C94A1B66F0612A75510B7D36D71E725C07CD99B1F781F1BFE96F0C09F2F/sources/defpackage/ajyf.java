...
public final class ajyf implements View.OnLayoutChangeListener {
    ...
    public ajyf(View view, View view2) {
        this.a = view;
        this.b = view2;
    ...
    private final void a() {
        ...
        View view = this.a;
        View view2 = this.b;
        zdf.b(view, view2, new ajye(this.d, view2));
    }
