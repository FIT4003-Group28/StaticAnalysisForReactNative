...
public final class akhr implements akgs {
    String a;
    String b;
    String c;
    String d;
    ...
    public final akic a() {
        ...
        if (!TextUtils.isEmpty(this.e) || (!TextUtils.isEmpty(this.a) && !TextUtils.isEmpty(this.b) && this.d != null)) {
            if (!this.f || this.d.equals("")) {
                ...
                akic akicVar = new akic(concat, this.r);
                akicVar.c = this.v;
                if (z) {
                    String valueOf24 = String.valueOf(this.g);
                    akicVar.t("Authorization", valueOf24.length() != 0 ? "Bearer ".concat(valueOf24) : new String("Bearer "));
                    if (!TextUtils.isEmpty(this.h)) {
                        akicVar.t("X-Goog-PageId", this.h);
                    }
                } else if (!TextUtils.isEmpty(this.i)) {
                    akicVar.t("X-Goog-Visitor-Id", this.i);
                }
                return akicVar;
            }
