...
public class aljo extends ov {
    ...
    */
    public aljo(android.content.Context r4, int r5) {
        /*
            r3 = this;
            r0 = 1
            if (r5 != 0) goto L1b
            ...
            goto L1b
        L18:
            r5 = 2132083766(0x7f150436, float:1.9807684E38)
        L1b:
            r3.<init>(r4, r5)
            r3.d = r0
            r3.e = r0
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aljo.<init>(android.content.Context, int):void");
    }
    ...
    private final View f(int i, View view, ViewGroup.LayoutParams layoutParams) {
        ...
        coordinatorLayout.findViewById(R.id.touch_outside).setOnClickListener(new aljk(this));
        lj.M(this.c, new aljl(this));
        this.c.setOnTouchListener(new gia(5));
        return this.a;
    }
