...
public final class alka extends Drawable {
    ...
    private final alne i = alnd.a;
    private final Path j = new Path();
    private final Rect k = new Rect();
    private final RectF l = new RectF();
    private final RectF m = new RectF();
    private final aljz n = new aljz(this);
    public boolean g = true;

    public alka(alnc alncVar) {
        this.h = alncVar;
    ...
    public final void draw(Canvas canvas) {
        if (this.g) {
            ...
            paint.setShader(new LinearGradient(0.0f, rect.top, 0.0f, rect.bottom, new int[]{gy.e(this.c, this.o), gy.e(this.d, this.o), gy.e(gy.f(this.d, 0), this.o), gy.e(gy.f(this.f, 0), this.o), gy.e(this.f, this.o), gy.e(this.e, this.o)}, new float[]{0.0f, height, 0.5f, 0.5f, 1.0f - height, 1.0f}, Shader.TileMode.CLAMP));
            this.g = false;
        }
