...
public class alla extends wm {
    ...
    public alla(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public alla(Context context, AttributeSet attributeSet, int i) {
        ...
        this.a = true;
        this.b = false;
        TypedArray a = alli.a(context, attributeSet, allc.a, i, 0, new int[0]);
