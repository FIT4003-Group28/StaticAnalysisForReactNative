...
public final class alli {
    ...
    public static void c(Context context, AttributeSet attributeSet, int i, int i2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, allc.b, i, i2);
    ...
    */
    public static void d(android.content.Context r5, android.util.AttributeSet r6, int[] r7, int r8, int r9, int... r10) {
        ...
        L48:
            goto L47
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.alli.d(android.content.Context, android.util.AttributeSet, int[], int, int, int[]):void");
    }
