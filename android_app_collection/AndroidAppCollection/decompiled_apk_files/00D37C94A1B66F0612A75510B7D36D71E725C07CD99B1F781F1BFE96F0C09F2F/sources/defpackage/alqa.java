...
public final class alqa {
    ...
    public alqa(TextInputLayout textInputLayout) {
    ...
    private final void r(List list, boolean z, TextView textView, int i, int i2, int i3) {
        ...
        ofFloat2.setInterpolator(alhv.d);
        list.add(ofFloat2);
    }
    ...
    public final void c() {
        ...
        boolean i = almu.i(this.a);
        lj.Y(this.q, p(i, R.dimen.material_helper_text_font_1_3_padding_horizontal, lj.i(editText)), p(i, R.dimen.material_helper_text_font_1_3_padding_top, this.a.getResources().getDimensionPixelSize(R.dimen.material_helper_text_default_padding_top)), p(i, R.dimen.material_helper_text_font_1_3_padding_horizontal, lj.h(editText)), 0);
    }
    ...
    public final void l(int i, int i2, boolean z) {
        ...
        if (z) {
            ...
            animatorSet.addListener(new alpz(this, i2, q(i), i, q(i2)));
            animatorSet.start();
        } else if (i != i2) {
    ...
    public final boolean n(TextView textView, CharSequence charSequence) {
        return lj.al(this.b) && this.b.isEnabled() && (this.e != this.d || textView == null || !TextUtils.equals(textView.getText(), charSequence));
    }
