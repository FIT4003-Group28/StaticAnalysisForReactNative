...
public final class alwj implements View.OnClickListener {
    public final int a;
    public final CharSequence b;
    public int c;

    public alwj(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, alvn.b);
