...
public final class alwl implements alwk {
    private final alvm a;
    private StatusBarBackgroundLayout b;
    private LinearLayout c;
    private final View d;

    public alwl(alvm alvmVar, Window window, AttributeSet attributeSet, int i) {
        this.a = alvmVar;
        View findViewById = alvmVar.findViewById(R.id.suc_layout_status);
        ...
        TypedArray obtainStyledAttributes = alvmVar.getContext().obtainStyledAttributes(attributeSet, alvn.d, i, 0);
        boolean z = obtainStyledAttributes.getBoolean(0, Build.VERSION.SDK_INT < 23 || (decorView.getSystemUiVisibility() & 8192) == 8192);
        if (Build.VERSION.SDK_INT >= 23) {
            if (alvmVar.f()) {
                Context context = alvmVar.getContext();
                z = alwg.f(context).j(context, alwe.CONFIG_LIGHT_STATUS_BAR, false);
            }
            if (z) {
    ...
    public final void a(Drawable drawable) {
        if (this.a.f() && !this.a.g()) {
            ...
            drawable = alwg.f(context).d(context, alwe.CONFIG_STATUS_BAR_BACKGROUND);
        }
