...
public final class alxb implements alwk {
    public final TemplateLayout a;
    private final int b;
    private final ImageView.ScaleType c;
    private final Context d;

    public alxb(TemplateLayout templateLayout, AttributeSet attributeSet, int i) {
        ImageView b;
        ImageView b2;
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, alwr.i, i, 0);
        ...
        if (b4 != null) {
            ...
            layoutParams.height = !z ? this.b : b4.getMaxHeight();
