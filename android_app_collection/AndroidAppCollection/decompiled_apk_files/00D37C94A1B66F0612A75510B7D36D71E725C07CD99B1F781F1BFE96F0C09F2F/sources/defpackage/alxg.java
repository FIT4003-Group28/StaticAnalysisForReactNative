...
public final class alxg implements ViewTreeObserver.OnPreDrawListener {
    final /* synthetic */ ImageView a;

    public alxg(ImageView imageView) {
        this.a = imageView;
    }
    ...
    public final boolean onPreDraw() {
        ...
        if (!aqgn.l() || this.a.getDrawable() == null || (this.a.getDrawable() instanceof VectorDrawable) || (this.a.getDrawable() instanceof bpb)) {
            return true;
        }
