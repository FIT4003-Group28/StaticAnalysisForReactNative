...
public final class am {
    ...
    static {
        ...
        try {
            if (System.getSecurityManager() != null) {
                resourceAsStream = (InputStream) AccessController.doPrivileged(new an(ao.class));
            } else {
                resourceAsStream = ao.class.getResourceAsStream("/android/icumessageformat/ICUConfig.properties");
            }
    ...
    public static String a() {
        ...
        if (System.getSecurityManager() != null) {
            try {
                str = (String) AccessController.doPrivileged(new al());
