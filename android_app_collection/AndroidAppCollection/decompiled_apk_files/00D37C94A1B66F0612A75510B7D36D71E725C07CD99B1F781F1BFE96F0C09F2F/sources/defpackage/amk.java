...
public final class amk {
    private static final Interpolator c = new abb(3);
    public int a;
    public float b;
    private int d;
    private float[] f;
    ...
    private int e = -1;
    private final Runnable v = new ami(this);

    private amk(Context context, ViewGroup viewGroup, amj amjVar) {
        if (amjVar != null) {
            this.u = viewGroup;
            this.r = amjVar;
    ...
    public static amk b(ViewGroup viewGroup, amj amjVar) {
        return new amk(viewGroup.getContext(), viewGroup, amjVar);
    }

    public static amk c(ViewGroup viewGroup, float f, amj amjVar) {
        amk b = b(viewGroup, amjVar);
        b.a = (int) (b.a * (1.0f / f));
        return b;
    }
    ...
    */
    public final void f(android.view.MotionEvent r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.amk.f(android.view.MotionEvent):void");
    }
    ...
    */
    public final boolean k(android.view.MotionEvent r17) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.amk.k(android.view.MotionEvent):boolean");
    }
