...
public final class amqn {
    private static final amqm a;
    private static final amqm b;
    ...
    static {
        ...
        aqxo.m(173, hashSet2);
        aqxo.n(1536, 1539, hashSet2);
        aqxo.m(1757, hashSet2);
        aqxo.m(1807, hashSet2);
        aqxo.n(6068, 6069, hashSet2);
        aqxo.n(8203, 8207, hashSet2);
        aqxo.n(8234, 8238, hashSet2);
        aqxo.n(8288, 8292, hashSet2);
        aqxo.n(8298, 8303, hashSet2);
        aqxo.m(65279, hashSet2);
        aqxo.n(65529, 65531, hashSet2);
        aqxo.n(119155, 119162, hashSet2);
        aqxo.m(917505, hashSet2);
        aqxo.n(917536, 917631, hashSet2);
        aqxo.m(0, hashSet2);
        aqxo.m(10, hashSet2);
        aqxo.m(13, hashSet2);
        aqxo.n(8232, 8233, hashSet2);
        aqxo.m(133, hashSet2);
        aqxo.m(Character.codePointAt("'", 0), hashSet2);
        aqxo.m(Character.codePointAt("\"", 0), hashSet2);
        aqxo.m(Character.codePointAt("&", 0), hashSet2);
        aqxo.m(Character.codePointAt("<", 0), hashSet2);
        aqxo.m(Character.codePointAt(">", 0), hashSet2);
        aqxo.m(Character.codePointAt("=", 0), hashSet2);
        aqxo.m(Character.codePointAt("\\", 0), hashSet2);
        amqm l = aqxo.l(hashSet2);
        a = l;
        HashSet hashSet3 = new HashSet();
        aqxo.m(Character.codePointAt("\"", 0), hashSet3);
        aqxo.m(Character.codePointAt("\\", 0), hashSet3);
        aqxo.n(0, 31, hashSet3);
        amqm l2 = aqxo.l(hashSet3);
        b = l2;
