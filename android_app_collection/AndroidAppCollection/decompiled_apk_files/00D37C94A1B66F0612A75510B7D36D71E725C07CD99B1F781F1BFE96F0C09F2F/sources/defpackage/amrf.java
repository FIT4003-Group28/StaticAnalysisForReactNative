...
final class amrf extends amri implements NavigableMap {
    final /* synthetic */ amro c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public amrf(amro amroVar, NavigableMap navigableMap) {
        super(amroVar, navigableMap);
        this.c = amroVar;
    }
    ...
    final Map.Entry c(Iterator it) {
        ...
        it.remove();
        return amxp.l(entry.getKey(), Collections.unmodifiableList(a));
    }
    ...
    public final NavigableSet descendingKeySet() {
        return ((amrf) descendingMap()).keySet();
    }

    @Override // java.util.NavigableMap
    public final NavigableMap descendingMap() {
        return new amrf(this.c, h().descendingMap());
    }
    ...
    public final NavigableSet i() {
        return new amrg(this.c, h());
    }

    @Override // defpackage.amri, defpackage.amrb, defpackage.amxb, java.util.AbstractMap, java.util.Map
    /* renamed from: f */
    ...
    @Override // defpackage.amri, java.util.SortedMap, java.util.NavigableMap
    ...
    public final NavigableMap headMap(Object obj, boolean z) {
        return new amrf(this.c, h().headMap(obj, z));
    }

    @Override // java.util.NavigableMap
    public final NavigableMap subMap(Object obj, boolean z, Object obj2, boolean z2) {
        return new amrf(this.c, h().subMap(obj, z, obj2, z2));
    }

    @Override // java.util.NavigableMap
    public final NavigableMap tailMap(Object obj, boolean z) {
        return new amrf(this.c, h().tailMap(obj, z));
    }
}
