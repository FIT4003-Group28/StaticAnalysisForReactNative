...
public abstract class amub extends AbstractCollection implements Serializable {
    private static final Object[] WM = new Object[0];
    ...
    public amuk g() {
        return isEmpty() ? amuk.q() : amuk.i(toArray());
    }
