package defpackage;
/* compiled from: PG */
/* renamed from: ando  reason: default package */
/* loaded from: classes.dex */
public class ando extends andm {
    ...
    static {
        ...
        Le:
            java.lang.String r0 = "\n"
        L10:
            defpackage.ando.a = r0
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ando.<clinit>():void");
    }
    ...
    public static int b(String str, int i) {
        while (i < str.length()) {
            ...
            if (str.charAt(i) != '%') {
                ...
                throw andn.c("trailing unquoted '%' character", str, i2 - 1);
            }
        }
        return -1;
    }
