...
final class aned extends anef {
    private aned(aneb anebVar, Character ch) {
        super(anebVar, ch);
        aqxo.p(anebVar.b.length == 64);
    }
    ...
    public aned(String str, String str2, Character ch) {
