...
public final class antb implements anme {
    private static final ThreadLocal a = new ansz();
    private static final ThreadLocal b = new anta();
    private final byte[] c;
    private final byte[] d;
    private final SecretKeySpec e;
    private final int f;

    public antb(byte[] bArr, int i) {
        if (anpf.e(1)) {
            if (i == 12 || i == 16) {
                this.f = i;
                anus.a(bArr.length);
