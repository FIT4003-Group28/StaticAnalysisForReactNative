...
public final class antk implements annc {
    private final ECPublicKey a;
    private final String b;
    private final int c;

    public antk(ECPublicKey eCPublicKey, int i, int i2) {
        if (!anpf.e(2)) {
    ...
    public final void a(byte[] bArr, byte[] bArr2) {
        ...
        if (this.c == 1) {
            ...
            int i2 = length >> 1;
            byte[] g = antz.g(Arrays.copyOf(bArr, i2));
            byte[] g2 = antz.g(Arrays.copyOfRange(bArr, i2, length));
            ...
            System.arraycopy(g2, 0, bArr3, i7 + 1, length3);
            bArr = bArr3;
        }
        if (!antz.f(bArr)) {
            throw new GeneralSecurityException("Invalid signature");
        }
        Signature signature = (Signature) anub.c.a(this.b);
