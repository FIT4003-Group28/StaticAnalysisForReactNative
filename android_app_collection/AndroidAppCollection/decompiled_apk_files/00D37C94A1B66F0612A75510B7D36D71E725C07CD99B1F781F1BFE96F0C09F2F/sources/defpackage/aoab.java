...
public final class aoab {
    ...
    public final synchronized aoaa a(String str, String str2, String str3) {
        return aoaa.a(this.a.getString(g(str, str2, str3), null));
    }
    ...
    public final synchronized void c(String str, String str2, String str3, String str4, String str5) {
        String b = aoaa.b(str4, str5, System.currentTimeMillis());
        if (b == null) {
            return;
        }
