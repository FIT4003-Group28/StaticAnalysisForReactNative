...
final class aoag {
    ...
    private aoag(FileChannel fileChannel, FileLock fileLock) {
        this.a = fileChannel;
        this.b = fileLock;
    }
    ...
    */
    public static defpackage.aoag b(android.content.Context r5) {
        /*
            ...
            aoag r2 = new aoag     // Catch: java.nio.channels.OverlappingFileLockException -> L21 java.lang.Error -> L23 java.io.IOException -> L25
        ...
        L4a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aoag.b(android.content.Context):aoag");
    }
