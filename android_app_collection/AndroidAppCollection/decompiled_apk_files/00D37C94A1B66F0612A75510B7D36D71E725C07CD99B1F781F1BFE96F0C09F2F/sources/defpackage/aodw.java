...
public final class aodw extends aodu {
    ...
    public final String b(ByteBuffer byteBuffer, int i, int i2) {
        if (!byteBuffer.hasArray()) {
            ...
            while (i < i3) {
                ...
                if (aoex.g(b2)) {
                    ...
                    if (i5 < i3) {
                        i = i5 + 1;
                        aoex.f(b2, byteBuffer.get(i5), cArr, i4);
                        i4++;
                    } else {
                    ...
                    if (i5 < i3 - 1) {
                        int i6 = i5 + 1;
                        aoex.e(b2, byteBuffer.get(i5), byteBuffer.get(i6), cArr, i4);
                        i = i6 + 1;
                        i4++;
                    } else {
                        throw new IllegalArgumentException("Invalid UTF-8");
                    ...
                    int i7 = i5 + 1;
                    int i8 = i7 + 1;
                    aoex.c(b2, byteBuffer.get(i5), byteBuffer.get(i7), byteBuffer.get(i8), cArr, i4);
                    i4 += 2;
                    i = i8 + 1;
                } else {
                    throw new IllegalArgumentException("Invalid UTF-8");
        ...
        while (arrayOffset < i9) {
            ...
            if (aoex.g(b5)) {
                ...
                if (i11 < i9 - 1) {
                    int i12 = i11 + 1;
                    aoex.e(b5, array[i11], array[i12], cArr2, i10);
                    arrayOffset = i12 + 1;
                    i10++;
                } else {
                    throw new IllegalArgumentException("Invalid UTF-8");
                ...
                int i13 = i11 + 1;
                int i14 = i13 + 1;
                aoex.c(b5, array[i11], array[i13], array[i14], cArr2, i10);
                i10 += 2;
                arrayOffset = i14 + 1;
            } else {
                throw new IllegalArgumentException("Invalid UTF-8");
    ...
    */
    public final void c(java.lang.CharSequence r12, java.nio.ByteBuffer r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aodw.c(java.lang.CharSequence, java.nio.ByteBuffer):void");
    }
}
