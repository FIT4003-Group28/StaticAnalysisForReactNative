...
public final class aoib implements GLSurfaceView.Renderer {
    private int h;
    private int i;
    private int j;
    private int k;
    ...
    public final void onDrawFrame(GL10 gl10) {
        ...
        if (textureFrame2 != null) {
            ...
            GLES20.glVertexAttribPointer(1, 2, 5126, false, 0, (Buffer) aoij.a);
            int i = this.a;
            ...
            float f9 = fArr[2];
            float f10 = fArr[3];
            FloatBuffer b = aoio.b(f7, f9, f8, f9, f7, f10, f8, f10);
    ...
    public final void onSurfaceCreated(GL10 gl10, EGLConfig eGLConfig) {
        ...
        int d = aoio.d(this.d != 36197 ? "varying mediump vec2 sample_coordinate;\nuniform sampler2D video_frame;\n\nvoid main() {\n  gl_FragColor = texture2D(video_frame, sample_coordinate);\n}" : "#extension GL_OES_EGL_image_external : require\nvarying mediump vec2 sample_coordinate;\nuniform samplerExternalOES video_frame;\n\nvoid main() {\n  gl_FragColor = texture2D(video_frame, sample_coordinate);\n}", hashMap);
        this.c = d;
