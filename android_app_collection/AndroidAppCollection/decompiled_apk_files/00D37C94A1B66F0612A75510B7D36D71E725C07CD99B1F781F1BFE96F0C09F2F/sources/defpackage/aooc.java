...
public final class aooc extends aoog {
    ...
    public aooc(byte[] bArr, int i, int i2) {
        this.f = bArr;
        this.g = i2 + i;
        this.i = i;
        this.j = i;
    ...
    public final String z() {
        ...
        if (k > 0) {
            ...
            int i2 = this.i;
            if (k <= i - i2) {
                String str = new String(this.f, i2, k, aopv.a);
                this.i += k;
                return str;
            }
        }
    ...
    */
    public final int k() {
        ...
        L6c:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aooc.k():int");
    }
