...
public final class aooe extends aoog {
    ...
    public aooe(InputStream inputStream) {
        aopv.i(inputStream, "input");
        this.f = inputStream;
    ...
    public final String z() {
        ...
        if (k > 0) {
            ...
            int i2 = this.j;
            if (k <= i - i2) {
                String str = new String(this.g, i2, k, aopv.a);
                this.j += k;
                return str;
            }
        }
        ...
        if (k <= this.h) {
            S(k);
            String str2 = new String(this.g, this.j, k, aopv.a);
            this.j += k;
            return str2;
        }
        return new String(V(k), aopv.a);
    }
    ...
    */
    public final int k() {
        ...
        L6c:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aooe.k():int");
    }
