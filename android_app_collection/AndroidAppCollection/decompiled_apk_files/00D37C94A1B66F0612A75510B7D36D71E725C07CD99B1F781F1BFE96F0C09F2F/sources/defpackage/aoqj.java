...
public final class aoqj extends aonn implements RandomAccess, aopt, aorc {
    public static final aoqj b;
    private long[] c;
    private int d;

    static {
        aoqj aoqjVar = new aoqj(new long[0], 0);
        b = aoqjVar;
        aoqjVar.b();
    }
    ...
    public final boolean addAll(Collection collection) {
        sg();
        aopv.h(collection);
        if (!(collection instanceof aoqj)) {
            return super.addAll(collection);
        }
        aoqj aoqjVar = (aoqj) collection;
        int i = aoqjVar.d;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(aoqjVar.c, 0, this.c, this.d, aoqjVar.d);
            this.d = i3;
            this.modCount++;
            return true;
        }
    ...
    /* renamed from: d */
    public final aopt e(int i) {
        if (i >= this.d) {
            return new aoqj(Arrays.copyOf(this.c, i), this.d);
        }
