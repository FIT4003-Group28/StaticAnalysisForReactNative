...
final class aos extends InputStream implements DataInput {
    ...
    public aos(InputStream inputStream) {
    ...
    public aos(InputStream inputStream, ByteOrder byteOrder) {
    ...
    public aos(InputStream inputStream, byte[] bArr) {
        this(inputStream);
    ...
    public aos(byte[] bArr, byte[] bArr2) {
        this(bArr);
        this.a.mark(Integer.MAX_VALUE);
    }
}
