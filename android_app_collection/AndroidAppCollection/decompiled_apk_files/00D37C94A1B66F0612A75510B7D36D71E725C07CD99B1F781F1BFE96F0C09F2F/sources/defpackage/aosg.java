...
public final class aosg {
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aosg.<clinit>():void");
    }
    ...
    public static Unsafe k() {
        try {
            return (Unsafe) AccessController.doPrivileged(new aosc());
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    public static void m(Throwable th) {
        Logger logger = Logger.getLogger(aosg.class.getName());
