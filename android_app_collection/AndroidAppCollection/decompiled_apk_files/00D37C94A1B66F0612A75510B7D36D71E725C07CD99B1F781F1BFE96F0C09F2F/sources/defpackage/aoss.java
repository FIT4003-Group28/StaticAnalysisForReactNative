...
/* compiled from: PG */
/* renamed from: aoss  reason: default package */
/* loaded from: classes.dex */
final class aoss extends aoos {
    public aoss() {
        super(null);
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    private static final aopg f(aoqu aoquVar, int i) {
        char c;
        String name = aoquVar.getClass().getName();
    ...
    public final aopg d(aoqu aoquVar, int i) {
        String name = aoquVar.getClass().getName();
        if (((name.hashCode() == 3005672 && name.equals("aunb")) ? (char) 0 : (char) 65535) == 0) {
            switch (i) {
                case 46659098:
