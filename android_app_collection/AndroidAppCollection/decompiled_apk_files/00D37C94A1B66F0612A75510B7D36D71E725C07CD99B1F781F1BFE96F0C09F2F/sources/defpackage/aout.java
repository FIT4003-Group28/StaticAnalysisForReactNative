...
public enum aout implements aopm {
    SUBTYPE_NONE(0),
    SUBTYPE_BASE(512),
    SUBTYPE_IME(1),
    SUBTYPE_TRANSLIT(2),
    ...
    SUBTYPE_PERSONAL_ACTION_FROM_OPA(476),
    SUBTYPE_OPA_SIMON_ACTION(487),
    ...
    public static aout b(int i) {
        switch (i) {
            ...
            case 476:
                return SUBTYPE_PERSONAL_ACTION_FROM_OPA;
            case 477:
            ...
            case 487:
                return SUBTYPE_OPA_SIMON_ACTION;
            case 488:
    ...
    public final String toString() {
        return Integer.toString(this.iU);
    }
}
