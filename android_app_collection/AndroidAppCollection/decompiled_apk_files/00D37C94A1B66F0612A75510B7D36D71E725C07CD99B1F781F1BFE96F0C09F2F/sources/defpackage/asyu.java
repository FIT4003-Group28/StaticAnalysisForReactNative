...
/* compiled from: PG */
/* renamed from: asyu  reason: default package */
/* loaded from: classes2.dex */
final class asyu extends aajr {
    @Override // defpackage.aajh
    public final /* bridge */ /* synthetic */ abga a(byte[] bArr) {
        try {
            asyx asyxVar = (asyx) aopi.parseFrom(asyx.a, bArr, aoos.b());
            if ((asyxVar.c & 1) != 0) {
                return new asyt(asyxVar.mo52toBuilder());
            }
