...
public enum ausi implements aopm {
    UNKNOWN(0),
    ...
    CAPTION_STYLE_SECTION(R.styleable.AppCompatTheme_windowNoTitle),
    ...
    PLAYBACK_SPEED(R.styleable.AppCompatTheme_windowFixedWidthMinor),
    PLAYBACK_QUALITY(R.styleable.AppCompatTheme_windowMinWidthMajor),
    PLAYBACK_AUDIO_TRACK(R.styleable.AppCompatTheme_windowMinWidthMinor),
