...
public final class avz {
    ...
    public avz(String str, String str2, String str3, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z2) {
        ptx.a(str);
        this.a = str;
        this.b = str2;
        this.c = str3;
    ...
    public static Point a(MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i2) {
        ...
        return new Point(pxi.b(i, widthAlignment) * widthAlignment, pxi.b(i2, heightAlignment) * heightAlignment);
    }

    /* JADX WARN: Code restructure failed: missing block: B:24:0x0053, code lost:
        if (r11.isFeatureSupported("secure-playback") != false) goto L26;
     */
    ...
    */
    public static defpackage.avz g(java.lang.String r8, java.lang.String r9, java.lang.String r10, android.media.MediaCodecInfo.CodecCapabilities r11, boolean r12) {
        /*
            avz r7 = new avz
            r0 = 1
            r1 = 0
            if (r11 == 0) goto L3d
            int r2 = defpackage.pxi.a
            ...
            r3 = 22
            if (r2 > r3) goto L3b
            java.lang.String r2 = defpackage.pxi.d
        ...
        L59:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.avz.g(java.lang.String, java.lang.String, java.lang.String, android.media.MediaCodecInfo$CodecCapabilities, boolean):avz");
    }
    ...
    public final pmw b(Format format, Format format2) {
        int i = true != pxi.M(format.l, format2.l) ? 8 : 0;
        if (this.g) {
            ...
            if (!pxi.M(format.x, format2.x)) {
                i |= 2048;
            }
            String str = this.a;
            if (pxi.d.startsWith("SM-T230") && "OMX.MARVELL.VIDEO.HW.CODA7542DECODER".equals(str) && !format.e(format2)) {
                i |= 2;
            }
            if (i == 0) {
                return new pmw(this.a, format, format2, true != format.e(format2) ? 2 : 3, 0);
            }
        } else {
            ...
            if (i == 0 && "audio/mp4a-latm".equals(this.b)) {
                Pair a = awn.a(format);
                Pair a2 = awn.a(format2);
                if (a != null && a2 != null) {
                    int intValue = ((Integer) a.first).intValue();
                    int intValue2 = ((Integer) a2.first).intValue();
                    if (intValue == 42 && intValue2 == 42) {
                        return new pmw(this.a, format, format2, 3, 0);
                    }
                }
            }
            if (!format.e(format2)) {
            ...
            if (i == 0) {
                return new pmw(this.a, format, format2, 1, 0);
            }
        }
        return new pmw(this.a, format, format2, 0, i);
    }
    ...
    public final boolean c(Format format) {
        ...
        String str = format.i;
        int i2 = 16;
        if (str != null && this.b != null && (e = pwl.e(str)) != null) {
            if (!this.b.equals(e)) {
                ...
                if (a != null) {
                    ...
                    if (pxi.a <= 23 && "video/x-vnd.on2.vp9".equals(this.b) && f.length == 0) {
        ...
        if (this.g) {
            int i4 = format.q;
            if (i4 <= 0 || (i = format.r) <= 0) {
                return true;
            }
            int i5 = pxi.a;
            return e(i4, i, format.s);
        }
        int i6 = pxi.a;
        int i7 = format.z;
        if (i7 != -1) {
        ...
        if (codecCapabilities3 == null) {
            ...
            if (audioCapabilities2 == null) {
                ...
                if (maxInputChannelCount <= 1 && ((pxi.a < 26 || maxInputChannelCount <= 0) && !"audio/mpeg".equals(str5) && !"audio/3gpp".equals(str5) && !"audio/amr-wb".equals(str5) && !"audio/mp4a-latm".equals(str5) && !"audio/vorbis".equals(str5) && !"audio/opus".equals(str5) && !"audio/raw".equals(str5) && !"audio/flac".equals(str5) && !"audio/g711-alaw".equals(str5) && !"audio/g711-mlaw".equals(str5) && !"audio/gsm".equals(str5))) {
    ...
    public final boolean e(int i, int i2, double d) {
        ...
        if (videoCapabilities == null) {
            ...
            if (i < i2 && ((!"OMX.MTK.VIDEO.DECODER.HEVC".equals(this.a) || !"mcv5a".equals(pxi.b)) && i(videoCapabilities, i2, i, d))) {
