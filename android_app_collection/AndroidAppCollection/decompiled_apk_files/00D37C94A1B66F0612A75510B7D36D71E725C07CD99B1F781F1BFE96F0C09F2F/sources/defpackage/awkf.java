...
/* compiled from: PG */
/* renamed from: awkf  reason: default package */
/* loaded from: classes2.dex */
public final class awkf extends aajr {
    @Override // defpackage.aajh
    public final /* bridge */ /* synthetic */ abga a(byte[] bArr) {
        try {
            awki awkiVar = (awki) aopi.parseFrom(awki.a, bArr, aoos.b());
            if ((awkiVar.c & 1) != 0) {
                return new awke(awkiVar.mo52toBuilder());
            }
