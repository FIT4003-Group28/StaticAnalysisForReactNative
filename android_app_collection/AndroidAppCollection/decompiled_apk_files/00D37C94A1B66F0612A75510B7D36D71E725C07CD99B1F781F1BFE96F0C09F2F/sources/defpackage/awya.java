...
/* compiled from: PG */
/* renamed from: awya  reason: default package */
...
public final class awya {
    ...
    public final String toString() {
        ...
        Collections.sort(arrayList, ahdo.e);
        StringBuilder sb = new StringBuilder("{");
        ampm b = ampm.b(", ");
        ...
        try {
            if (it.hasNext()) {
                ...
                sb.append(ampm.g(entry.getKey()));
                sb.append((CharSequence) "=");
                sb.append(ampm.g(entry.getValue()));
                while (it.hasNext()) {
                    sb.append((CharSequence) b.b);
                    Map.Entry entry2 = (Map.Entry) it.next();
                    sb.append(ampm.g(entry2.getKey()));
                    sb.append((CharSequence) "=");
                    sb.append(ampm.g(entry2.getValue()));
                }
            }
            sb.append('}');
            return sb.toString();
