...
public final class axdq {
    public static final String a = "axdq";
        ...
        if (a() && activity.getPackageManager().hasSystemFeature("android.software.vr.mode")) {
            try {
                ...
                if (a() && activity.getPackageManager().hasSystemFeature("android.hardware.vr.high_performance")) {
                    ...
                    if (!awwd.h()) {
                        if (c == 65535) {
                            c(activity, R.string.dialog_vr_core_not_installed, R.string.go_to_playstore_button, new axdp(activity, 1));
                        } else if (c == 65534) {
                            c(activity, R.string.dialog_vr_core_not_enabled, R.string.go_to_vr_listeners_settings_button, new axdp(activity));
                        }
                    }
    ...
    private static void c(Context context, int i, int i2, DialogInterface.OnClickListener onClickListener) {
        ...
        builder.setMessage(i).setTitle(R.string.dialog_title_warning).setPositiveButton(i2, onClickListener).setNegativeButton(R.string.cancel_button, new gzj(17));
        builder.create().show();
    }
}
