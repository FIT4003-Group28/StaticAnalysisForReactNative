...
/* compiled from: PG */
/* renamed from: axdw  reason: default package */
/* loaded from: classes2.dex */
public final class axdw implements axfg {
    private static final String a = "axdw";
    ...
    public axdw(ContentProviderClient contentProviderClient, String str) {
        if (str == null || str.isEmpty()) {
            throw new IllegalArgumentException("Authority key must be non-null and non-empty");
        }
        this.b = contentProviderClient;
        this.c = awwd.c(str, "device_params");
        this.d = awwd.c(str, "user_prefs");
        this.e = awwd.c(str, "phone_params");
        this.f = awwd.c(str, "sdk_configuration_params");
        this.g = awwd.c(str, "recent_headsets");
    }

    private final aoqu h(aoqt aoqtVar, Uri uri, String str) {
        byte[] i = i(uri, str);
        if (i == null) {
            return null;
        }
        try {
            return aoqtVar.mo35mergeFrom(i).mo39build();
        } catch (aopx e) {
    ...
    */
    private final byte[] i(android.net.Uri r8, java.lang.String r9) {
        ...
        L1f:
            ...
            return r8
        L23:
            java.lang.String r1 = defpackage.axdw.a     // Catch: android.os.RemoteException -> L4d java.lang.IllegalArgumentException -> L4f android.database.CursorIndexOutOfBoundsException -> L51 java.lang.Throwable -> L68
        ...
        L5a:
            r9 = r0
        L5b:
            java.lang.String r1 = defpackage.axdw.a     // Catch: java.lang.Throwable -> L68
        ...
        L6f:
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.axdw.i(android.net.Uri, java.lang.String):byte[]");
    }
    ...
    public final anfs a(SdkConfiguration$SdkConfigurationRequest sdkConfiguration$SdkConfigurationRequest) {
        return (anfs) h(SdkConfigurationReader.DEFAULT_PARAMS.mo52toBuilder(), this.f, Base64.encodeToString(sdkConfiguration$SdkConfigurationRequest.toByteArray(), 0));
    }
