...
/* compiled from: PG */
/* renamed from: axeo  reason: default package */
/* loaded from: classes2.dex */
public final class axeo implements GLSurfaceView.Renderer {
    public GvrSurfaceView a;
    private final GvrApi b;

    public axeo(GvrApi gvrApi) {
        if (gvrApi != null) {
            this.b = gvrApi;
            return;
        }
    ...
    public final void onDrawFrame(GL10 gl10) {
        ...
        if (renderReprojectionThread != null) {
            axeq.a(new axen(this, renderReprojectionThread.x, renderReprojectionThread.y));
        }
    }
