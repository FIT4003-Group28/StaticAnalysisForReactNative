...
/* compiled from: PG */
/* renamed from: axeu  reason: default package */
/* loaded from: classes2.dex */
public final class axeu extends FrameLayout implements View.OnTouchListener {
    public int a;
    public boolean b;
    public Runnable c;
    public Runnable d;
    ...
    public axeu(Context context) {
        ...
        findViewById(R.id.transition_switch_action).setOnClickListener(new axer(this, 1));
        ((ImageView) findViewById(R.id.transition_icon)).setOnClickListener(new axer(this));
        h();
    ...
    public final void f(boolean z) {
        ...
        alphaAnimation.setAnimationListener(new axet(this));
    ...
    private final void h() {
        ...
        this.f.setOnClickListener(new axer(this, 2));
    }
    ...
    public final void setVisibility(int i) {
        ...
        if (visibility != i) {
            if (i != 0) {
                ...
                axes axesVar = new axes(this, getContext());
                this.e = axesVar;
                axesVar.enable();
            }
        }
