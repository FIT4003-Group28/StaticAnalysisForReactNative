...
public final class axfc {
    ...
    public axfc(Context context) {
        this.a = context;
        this.b = new axfb(this, context);
        c(R.layout.ui_layer);
    }
    ...
    public final void c(int i) {
        this.p = i;
        axeu axeuVar = this.h;
        boolean z = (axeuVar == null || axeuVar.getParent() == null) ? false : true;
        this.h = null;
    ...
    public final void d(float f) {
        ...
        this.t = f;
        axeq.a(new axev(this, f));
    }

    public final void e(boolean z) {
        this.s = z;
        axeq.a(new axez(this, z, 1));
    }
