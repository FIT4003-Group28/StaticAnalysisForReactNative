...
public abstract class axfk extends dvd implements axfl {
    public axfk() {
    ...
    protected boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
        switch (i) {
            ...
            case 2:
                ...
                parcel2.writeNoException();
                dve.h(parcel2, requestStopTracking);
                return true;
            case 3:
            ...
            case 5:
                ...
                return true;
            case 6:
                resumeHeadTracking((HeadTrackingState) dve.a(parcel, HeadTrackingState.CREATOR));
                return true;
            case 7:
                invokeCloseAction();
                return true;
