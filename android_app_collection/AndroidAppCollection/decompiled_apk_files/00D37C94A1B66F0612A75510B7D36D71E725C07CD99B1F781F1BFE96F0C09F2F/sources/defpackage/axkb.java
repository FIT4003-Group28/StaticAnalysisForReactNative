...
/* compiled from: PG */
@axkh(a = 64, b = {5})
/* renamed from: axkb  reason: default package */
/* loaded from: classes2.dex */
public final class axkb extends axkc {
    ...
    private static final int d(axkd axkdVar) {
        int a2 = axkdVar.a(5);
        return a2 == 31 ? axkdVar.a(6) + 32 : a2;
    }
    ...
    */
    public final void a(java.nio.ByteBuffer r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.axkb.a(java.nio.ByteBuffer):void");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.A == axkbVar.A && this.z == axkbVar.z && this.B == axkbVar.B && this.d == axkbVar.d && this.g == axkbVar.g && this.u == axkbVar.u && this.t == axkbVar.t && this.q == axkbVar.q && this.p == axkbVar.p && this.f133J == axkbVar.f133J && this.h == axkbVar.h && this.m == axkbVar.m && this.v == axkbVar.v && this.C == axkbVar.C && this.l == axkbVar.l && this.k == axkbVar.k && this.o == axkbVar.o && this.s == axkbVar.s && this.D == axkbVar.D && this.P == axkbVar.P && this.Q == axkbVar.Q && this.R == axkbVar.R && this.O == axkbVar.O && this.M == axkbVar.M && this.L == axkbVar.L && this.N == axkbVar.N && this.I == axkbVar.I && this.H == axkbVar.H && this.E == axkbVar.E && this.w == axkbVar.w && this.y == axkbVar.y && this.x == axkbVar.x && this.G == axkbVar.G && this.F == axkbVar.F && this.S == axkbVar.S && this.j == axkbVar.j && this.n == axkbVar.n && this.f == axkbVar.f && this.e == axkbVar.e && this.i == axkbVar.i && this.r == axkbVar.r && this.K == axkbVar.K && Arrays.equals(this.c, axkbVar.c);
    }

    public final int hashCode() {
        byte[] bArr = this.c;
        return ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((bArr != null ? Arrays.hashCode(bArr) : 0) * 31) + this.d) * 31) + this.e) * 31) + this.f) * 31) + this.g) * 31) + this.h) * 31) + this.i) * 31) + this.j) * 31) + this.k) * 31) + this.l) * 31) + this.m) * 31) + this.n) * 31) + this.o) * 31) + this.p) * 31) + this.q) * 31) + this.r) * 31) + this.s) * 31) + this.t) * 31) + this.u) * 31) + this.v) * 31) + this.w) * 31) + this.x) * 31) + this.y) * 31) + this.z) * 31) + this.A) * 31) + this.B) * 31) + this.C) * 31) + (this.D ? 1 : 0)) * 31) + this.E) * 31) + this.F) * 31) + this.G) * 31) + this.H) * 31) + this.I) * 31) + this.f133J) * 31) + this.K) * 31) + this.L) * 31) + this.M) * 31) + this.N) * 31) + this.O) * 31) + this.P) * 31) + this.Q) * 31) + this.R) * 31) + (this.S ? 1 : 0);
    }
