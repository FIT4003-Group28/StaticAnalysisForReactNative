...
/* compiled from: PG */
@axkh(b = {4})
/* renamed from: axkf  reason: default package */
/* loaded from: classes2.dex */
public final class axkf extends axkc {
    private static final Logger k = Logger.getLogger(axkf.class.getName());
    public int a;
    public int b;
    public int c;
    public int d;
    ...
    public final void a(ByteBuffer byteBuffer) {
        ...
        if (byteBuffer.remaining() > 2) {
            ...
            if (a instanceof axkg) {
                this.g = (axkg) a;
            }
            if (a instanceof axkb) {
                this.h = (axkb) a;
            }
        }
        while (byteBuffer.remaining() > 2) {
            int position3 = byteBuffer.position();
            axkc a2 = axkm.a(this.a, byteBuffer);
