...
/* compiled from: PG */
/* renamed from: aybs  reason: default package */
/* loaded from: classes2.dex */
public final class aybs implements ayas {
        ...
        while (true) {
            ...
            if (i2 < length2) {
                if (bArr[i2] == 37 && i2 + 2 < length2) {
                    try {
                        allocate.put((byte) Integer.parseInt(new String(bArr, i2 + 1, 2, amoz.a), 16));
                        i2 += 3;
                ...
                return new String(allocate.array(), 0, allocate.position(), amoz.c);
            }
        }
    }
    ...
    public final /* bridge */ /* synthetic */ byte[] b(Object obj) {
        byte[] bytes = ((String) obj).getBytes(amoz.c);
        int i = 0;
        while (true) {
