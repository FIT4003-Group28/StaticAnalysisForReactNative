...
/* compiled from: PG */
/* renamed from: aycz  reason: default package */
/* loaded from: classes2.dex */
public final class aycz implements ServiceConnection, aycf {
    private static final Logger a = Logger.getLogger(aycz.class.getName());
    ...
    public aycz(Executor executor, Context context, Intent intent, ayce ayceVar) {
        synchronized (this) {
            this.b = intent;
            this.c = 1;
            this.d = ayceVar;
    ...
    public final synchronized void a() {
        ...
        if (this.g == 1) {
            ...
            if (!withDescription.f()) {
                this.g = 4;
                this.e.execute(new aycy(this, withDescription, 1));
            }
        }
    }
    ...
    public final void c(Status status) {
        ...
        this.e.execute(new aycy(this, status));
        if (context != null) {
