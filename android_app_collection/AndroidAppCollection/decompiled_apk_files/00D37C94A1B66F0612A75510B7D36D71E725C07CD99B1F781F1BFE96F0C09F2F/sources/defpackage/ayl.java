...
public final class ayl {
    ...
    public ayl(int i, byte[] bArr, long j, long j2) {
        try {
            ...
            long j3 = blockSize;
            int i2 = (int) (j2 % j3);
            cipher.init(i, new SecretKeySpec(bArr, pxi.aa(cipher.getAlgorithm(), "/")[0]), new IvParameterSpec(ByteBuffer.allocate(16).putLong(j).putLong(j2 / j3).array()));
            if (i2 == 0) {
                return;
            }
