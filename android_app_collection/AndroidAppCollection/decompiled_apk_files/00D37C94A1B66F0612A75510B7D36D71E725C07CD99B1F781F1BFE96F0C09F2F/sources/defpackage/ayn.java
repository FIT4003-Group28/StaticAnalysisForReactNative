...
public final class ayn {
    ...
    public static Format c(pwu pwuVar, String str, String str2, DrmInitData drmInitData) {
        int i = b[(pwuVar.i() & 192) >> 6];
        int i2 = pwuVar.i();
        int i3 = d[(i2 & 56) >> 3];
        if ((i2 & 4) != 0) {
            i3++;
    ...
    public static Format d(pwu pwuVar, String str, String str2, DrmInitData drmInitData) {
        pwuVar.H(2);
        int i = b[(pwuVar.i() & 192) >> 6];
        int i2 = pwuVar.i();
        int i3 = d[(i2 & 14) >> 1];
        ...
        if (((pwuVar.i() & 30) >> 1) > 0 && (2 & pwuVar.i()) != 0) {
            i3 += 2;
        }
        String str3 = (pwuVar.a() <= 0 || (pwuVar.i() & 1) == 0) ? "audio/eac3" : "audio/eac3-joc";
        pis pisVar = new pis();
        pisVar.a = str;
        pisVar.k = str3;
        pisVar.x = i3;
