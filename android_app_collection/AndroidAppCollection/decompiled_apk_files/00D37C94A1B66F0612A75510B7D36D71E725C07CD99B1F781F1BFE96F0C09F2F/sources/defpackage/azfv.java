...
/* compiled from: PG */
/* renamed from: azfv  reason: default package */
/* loaded from: classes2.dex */
public final class azfv extends AtomicInteger implements ayom, aypg {
    ...
    public azfv(ayom ayomVar, ayqe ayqeVar) {
        this.a = ayomVar;
        this.e = ayqeVar;
    }
    ...
    public final void c(Object obj) {
        try {
            ayof ayofVar = (ayof) this.e.a(obj);
            ayrd.b(ayofVar, "The mapper returned a null MaybeSource");
            this.c.getAndIncrement();
            azfu azfuVar = new azfu(this);
            if (this.h || !this.b.d(azfuVar)) {
                return;
            }
            ayofVar.X(azfuVar);
        } catch (Throwable th) {
