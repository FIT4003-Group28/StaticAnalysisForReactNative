...
public final class azml implements ayrm {
    ...
    public azml(int i) {
        int c = azos.c(Math.max(8, i));
        int i2 = c - 1;
        AtomicReferenceArray atomicReferenceArray = new AtomicReferenceArray(c + 1);
        this.g = atomicReferenceArray;
        this.f = i2;
        this.d = Math.min(c / 4, a);
