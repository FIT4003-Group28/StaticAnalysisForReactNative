...
public final class azui extends azvj {
    public static final azui b = new azui();
    ...
    static {
        ...
        if (str == null) {
            ...
            if (num == null || num.intValue() <= 0) {
                throw new IllegalStateException(azst.a("Expected positive number in kotlinx.coroutines.default.parallelism, but has ", str).toString());
            }
    ...
    private final int e() {
        ...
        return azst.f(Runtime.getRuntime().availableProcessors() - 1, 1);
    }

    /* JADX WARN: Removed duplicated region for block: B:25:0x0040 A[Catch: all -> 0x009c, TRY_ENTER, TRY_LEAVE, TryCatch #3 {, blocks: (B:3:0x0001, B:5:0x0005, B:7:0x000b, B:46:0x0096, B:14:0x001c, B:15:0x0022, B:25:0x0040, B:33:0x005f, B:45:0x0092), top: B:64:0x0001 }] */
    ...
    */
    private final synchronized java.util.concurrent.Executor f() {
        /*
            r6 = this;
            monitor-enter(r6)
            java.util.concurrent.Executor r0 = defpackage.azui.pool     // Catch: java.lang.Throwable -> L9c
            if (r0 != 0) goto L9a
        ...
        L1a:
            ...
            goto L96
        L22:
            int r2 = defpackage.azui.d     // Catch: java.lang.Throwable -> L9c
            r3 = 0
            if (r2 >= 0) goto L6a
        ...
        L3d:
            ...
            goto L6a
        L40:
            ajsy r4 = defpackage.ajsy.h     // Catch: java.lang.Throwable -> L9c
        ...
        L6a:
            ...
            azui r4 = defpackage.azui.b     // Catch: java.lang.Throwable -> L8f
        ...
        L90:
            ...
            java.util.concurrent.ExecutorService r0 = r6.g()     // Catch: java.lang.Throwable -> L9c
        L96:
            defpackage.azui.pool = r0     // Catch: java.lang.Throwable -> L9c
            monitor-exit(r6)
            return r0
        L9a:
            monitor-exit(r6)
        ...
        La0:
            goto L9f
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.azui.f():java.util.concurrent.Executor");
    }

    private final ExecutorService g() {
        return Executors.newFixedThreadPool(e(), new baps(new AtomicInteger(), 1));
    }
