...
public final class baee implements Runnable {
    final /* synthetic */ CronetBidirectionalStream a;
    private final /* synthetic */ int b;

    public baee(CronetBidirectionalStream cronetBidirectionalStream) {
        this.a = cronetBidirectionalStream;
    }

    public baee(CronetBidirectionalStream cronetBidirectionalStream, int i) {
        this.b = i;
        this.a = cronetBidirectionalStream;
    }
    ...
    public final void run() {
        if (this.b == 0) {
            try {
                ...
                bacc.d(CronetUrlRequestContext.b, "Exception in onCanceled method", e);
                return;
            }
        }
