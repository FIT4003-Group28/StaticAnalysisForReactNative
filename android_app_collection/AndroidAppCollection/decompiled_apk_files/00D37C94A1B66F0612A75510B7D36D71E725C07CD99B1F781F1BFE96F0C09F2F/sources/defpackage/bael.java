...
public abstract class bael extends ICronetEngineBuilder {
    ...
    */
    public final void e(int r6, long r7) {
        ...
        L42:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bael.e(int, long):void");
    }
        ...
        if (str != null) {
            ...
            if (o.matcher(str).matches()) {
                ...
                try {
                    ...
                    this.c.add(new baej(ascii, (byte[][]) hashMap.values().toArray(new byte[hashMap.size()]), z, date));
                    return;
