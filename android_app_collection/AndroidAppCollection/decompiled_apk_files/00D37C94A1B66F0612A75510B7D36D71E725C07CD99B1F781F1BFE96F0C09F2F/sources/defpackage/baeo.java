...
public final class baeo implements Runnable {
    final /* synthetic */ CronetUploadDataStream a;
    private final /* synthetic */ int b;

    public baeo(CronetUploadDataStream cronetUploadDataStream) {
        this.a = cronetUploadDataStream;
    }

    public baeo(CronetUploadDataStream cronetUploadDataStream, int i) {
        this.b = i;
        this.a = cronetUploadDataStream;
    }
    ...
    public final void run() {
        ...
        if (i == 0) {
            ...
            try {
                ...
                bacc.d(CronetUploadDataStream.a, "Exception thrown when closing", e2);
            }
        } else {
            synchronized (this.a.g) {
