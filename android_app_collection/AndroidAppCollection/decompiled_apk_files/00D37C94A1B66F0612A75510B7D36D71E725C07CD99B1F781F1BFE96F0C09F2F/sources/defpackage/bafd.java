...
/* compiled from: PG */
/* renamed from: bafd  reason: default package */
/* loaded from: classes2.dex */
public final class bafd extends baei {
    private final String b;
    private final ExecutorService c;

    public bafd(bael baelVar) {
        int a = baelVar.a(9);
        this.b = baelVar.e;
        this.c = new ThreadPoolExecutor(10, 20, 50L, TimeUnit.SECONDS, new LinkedBlockingQueue(), new bafb(a));
    }
    ...
    public final bagm b(String str, UrlRequest.Callback callback, Executor executor, int i, Collection collection, boolean z, boolean z2, boolean z3, boolean z4, int i2, boolean z5, int i3, RequestFinishedInfo.Listener listener, int i4) {
        return new bagd(callback, this.c, executor, str, this.b, z3, z4, i2, z5, i3);
    }
    ...
    public final String getVersionString() {
        return "CronetHttpURLConnection/" + bajw.i();
    }
