...
public final class bafu implements Runnable {
    ...
    public bafu(VersionSafeCallbacks$UrlRequestStatusListener versionSafeCallbacks$UrlRequestStatusListener, int i) {
        this.a = versionSafeCallbacks$UrlRequestStatusListener;
        this.b = i;
    }

    public bafu(VersionSafeCallbacks$UrlRequestStatusListener versionSafeCallbacks$UrlRequestStatusListener, int i, int i2) {
        this.c = i2;
        this.a = versionSafeCallbacks$UrlRequestStatusListener;
        this.b = i;
    }
