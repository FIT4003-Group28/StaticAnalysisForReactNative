...
/* compiled from: PG */
/* renamed from: bagl  reason: default package */
/* loaded from: classes2.dex */
public final class bagl extends RequestFinishedInfo {
    ...
    public bagl(String str, Collection collection, RequestFinishedInfo.Metrics metrics, int i, UrlResponseInfo urlResponseInfo, CronetException cronetException) {
        this.a = str;
        this.b = collection;
        this.c = metrics;
        this.d = i;
