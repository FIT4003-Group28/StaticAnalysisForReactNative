...
public final class bahf extends HttpURLConnection {
    public final bahk a;
    public UrlRequest b;
    public final bahh c;
    public bahi d;
    ...
    public bahf(URL url, CronetEngine cronetEngine) {
        super(url);
        this.h = cronetEngine;
        this.a = new bahk();
        this.c = new bahh(this);
    ...
    */
    private final void n() {
        ...
        L5:
            ...
            r2.<init>(r5)
            bahk r3 = r5.a
            org.chromium.net.UrlRequest$Builder r0 = r0.mo551newUrlRequestBuilder(r1, r2, r3)
        ...
        L2e:
            ...
            bahk r3 = r5.a
            r0.mo569setUploadDataProvider(r1, r3)
        ...
        L7e:
            ...
            r0.mo563addHeader(r3, r2)
            goto L7e
        L96:
            boolean r1 = r5.getUseCaches()
            if (r1 != 0) goto L9f
            r0.mo566disableCache()
        L9f:
            java.lang.String r1 = r5.method
            r0.mo567setHttpMethod(r1)
            boolean r1 = r5.j
            r2 = -1
            r3 = 1
            if (r1 == 0) goto Lab
        ...
        Ldc:
            org.chromium.net.ExperimentalUrlRequest r0 = r0.mo565build()
            r5.b = r0
            r0.start()
            r5.connected = r3
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bahf.n():void");
    }
    ...
    public final OutputStream getOutputStream() {
        if (this.d == null && this.doOutput) {
            ...
            if (o()) {
                this.d = new bahb(this.chunkLength, this.a);
                n();
            } else {
                long h = h();
                if (h != -1) {
                    this.d = new bahd(h, this.a);
                    n();
                } else {
                    ...
                    if (requestProperty == null) {
                        ...
                        this.d = new bagz(Long.parseLong(requestProperty));
                    }
                }
            }
        }
