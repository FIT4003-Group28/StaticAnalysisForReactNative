...
public abstract class baht implements Serializable {
    public static final baht a = new balz("UTC", "UTC", 0, 0);
    public static Set b = null;
    public static baly d = null;
    private static bama e = null;
    private static volatile baht f = null;
    private static bakk g = null;
    ...
    static {
        /*
            ...
            bama r2 = (defpackage.bama) r2     // Catch: java.lang.Exception -> L1e
            goto L2b
        L1e:
            r2 = move-exception
        ...
        L2b:
            if (r2 != 0) goto L40
            bamc r3 = new bamc     // Catch: java.lang.Exception -> L34
        ...
        L47:
            ...
            if (r4 == 0) goto L9d
            baht r4 = defpackage.baht.a
            baht r1 = r2.b(r1)
            boolean r1 = r4.equals(r1)
            if (r1 == 0) goto L95
            defpackage.baht.e = r2
            defpackage.baht.b = r3
            ...
            baly r1 = (defpackage.baly) r1     // Catch: java.lang.Exception -> L7d
            r0 = r1
            goto L8b
        L7d:
            r1 = move-exception
        ...
        La5:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.baht.<clinit>():void");
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public baht(String str) {
        if (str != null) {
            this.c = str;
            return;
        }
    ...
    public static String h(int i2) {
        ...
        int i3 = i2 / 3600000;
        balf.d(stringBuffer, i3, 2);
        int i4 = i2 - (i3 * 3600000);
        int i5 = i4 / 60000;
        stringBuffer.append(':');
        balf.d(stringBuffer, i5, 2);
        int i6 = i4 - (i5 * 60000);
        if (i6 == 0) {
        ...
        int i7 = i6 / 1000;
        stringBuffer.append(':');
        balf.d(stringBuffer, i7, 2);
        int i8 = i6 - (i7 * 1000);
        if (i8 == 0) {
            return stringBuffer.toString();
        }
        stringBuffer.append('.');
        balf.d(stringBuffer, i8, 3);
        return stringBuffer.toString();
    }

    public static baht i(String str) {
        if (str == null) {
            return k();
        }
        if (str.equals("UTC")) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:41:0x00ab A[Catch: all -> 0x00b1, TRY_ENTER, TryCatch #0 {, blocks: (B:6:0x0007, B:9:0x000c, B:11:0x0014, B:16:0x001f, B:18:0x0025, B:41:0x00ab, B:42:0x00ad, B:19:0x002b, B:21:0x0037, B:22:0x003a, B:24:0x0040, B:26:0x0048, B:29:0x0052, B:31:0x005e, B:33:0x0066, B:35:0x0076, B:36:0x0079, B:37:0x0082, B:38:0x00a7, B:43:0x00af), top: B:51:0x0007 }] */
    /* JADX WARN: Removed duplicated region for block: B:52:0x001f A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static defpackage.baht k() {
        /*
            baht r0 = defpackage.baht.f
            if (r0 != 0) goto Lb4
            java.lang.Class<baht> r1 = defpackage.baht.class
            monitor-enter(r1)
            baht r0 = defpackage.baht.f     // Catch: java.lang.Throwable -> Lb1
            if (r0 != 0) goto Laf
            r0 = 0
            java.lang.String r2 = "user.timezone"
            java.lang.String r2 = java.lang.System.getProperty(r2)     // Catch: java.lang.RuntimeException -> L1c java.lang.Throwable -> Lb1
            if (r2 == 0) goto L1c
            baht r2 = i(r2)     // Catch: java.lang.RuntimeException -> L1c java.lang.Throwable -> Lb1
            goto L1d
        L19:
            goto La9
        L1c:
        ...
        L1d:
            ...
            if (r3 != 0) goto L2b
            baht r0 = k()     // Catch: java.lang.IllegalArgumentException -> La8 java.lang.Throwable -> Lb1
            goto La9
        L2b:
            ...
            if (r5 == 0) goto L3a
            baht r0 = defpackage.baht.a     // Catch: java.lang.IllegalArgumentException -> La8 java.lang.Throwable -> Lb1
            goto La9
        L3a:
            java.lang.String r5 = p(r4)     // Catch: java.lang.IllegalArgumentException -> La8 java.lang.Throwable -> Lb1
            if (r5 == 0) goto L46
            bama r0 = defpackage.baht.e     // Catch: java.lang.IllegalArgumentException -> La8 java.lang.Throwable -> Lb1
            baht r0 = r0.b(r5)     // Catch: java.lang.IllegalArgumentException -> La8 java.lang.Throwable -> Lb1
        L46:
            if (r0 != 0) goto L4e
            bama r0 = defpackage.baht.e     // Catch: java.lang.IllegalArgumentException -> La8 java.lang.Throwable -> Lb1
            baht r0 = r0.b(r4)     // Catch: java.lang.IllegalArgumentException -> La8 java.lang.Throwable -> Lb1
        L4e:
            if (r0 != 0) goto La9
            if (r5 != 0) goto L82
        ...
        L79:
            ...
            baht r0 = q(r3, r0)     // Catch: java.lang.IllegalArgumentException -> La8 java.lang.Throwable -> Lb1
            goto La9
        L82:
        ...
        La9:
            if (r0 != 0) goto Lad
            baht r0 = defpackage.baht.a     // Catch: java.lang.Throwable -> Lb1
        Lad:
            defpackage.baht.f = r0     // Catch: java.lang.Throwable -> Lb1
        Laf:
        ...
        Lb4:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.baht.k():baht");
    }
    ...
    private static int o(String str) {
        ...
        bakk r = r();
        if (r.c != bahrVar) {
            r = new bakk(r.a, r.b, bahrVar, r.d);
        }
        bala balaVar = r.b;
        if (balaVar == null) {
            throw new UnsupportedOperationException("Parsing not supported");
        }
        bald baldVar = new bald(r.b(r.c));
        int c = balaVar.c(baldVar, str, 0);
        if (c < 0) {
            c ^= -1;
        } else if (c >= str.length()) {
            return -((int) baldVar.g(str));
        }
        throw new IllegalArgumentException(balf.c(str, c));
    }

    private static synchronized String p(String str) {
        String str2;
        synchronized (baht.class) {
            Map map = i;
            if (map == null) {
                map = new HashMap();
                map.put("GMT", "UTC");
    ...
    private static synchronized baht q(String str, int i2) {
        baht bahtVar;
        synchronized (baht.class) {
            if (i2 == 0) {
                return a;
            ...
            if (reference != null && (bahtVar = (baht) reference.get()) != null) {
                return bahtVar;
            }
            balz balzVar = new balz(str, null, i2, i2);
            h.put(str, new SoftReference(balzVar));
            return balzVar;
        }
    }

    private static synchronized bakk r() {
        bakk bakkVar;
        synchronized (baht.class) {
            if (g == null) {
                bakz bakzVar = new bakz();
                bakzVar.s(null, true, 4);
                g = bakzVar.a();
            }
            bakkVar = g;
        }
    ...
    */
    public final long n(long r10, long r12) {
        ...
        L56:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.baht.n(long, long):long");
    }
    ...
    protected Object writeReplace() {
        return new bahs(this.c);
    }

    public static baht j(int i2) {
