...
abstract class baiz extends baiw {
    ...
    private static final long[] f137J = new long[12];
    ...
    public baiz(bahl bahlVar, int i) {
        super(bahlVar, i);
    }
    ...
    */
    public final int U(long r13, int r15) {
        ...
        La9:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.baiz.U(long, int):int");
    }
