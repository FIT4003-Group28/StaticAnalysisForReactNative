...
class baja extends bajy {
    private final baiw a;
    private final int c;
    private final int d;

    public baja(baiw baiwVar) {
        super(bahp.i, 2629746000L);
        this.a = baiwVar;
        this.c = 12;
        this.d = 2;
    }
    ...
    public final int a(long j) {
        baiw baiwVar = this.a;
        return baiwVar.U(j, baiwVar.Z(j));
    }
    ...
    public final long h(long j, int i) {
        bajw.e(this, i, 1, this.c);
        int Z = this.a.Z(j);
        baiw baiwVar = this.a;
        int O = baiwVar.O(j, Z, baiwVar.U(j, Z));
        int S = this.a.S(Z, i);
        if (O > S) {
            O = S;
        }
