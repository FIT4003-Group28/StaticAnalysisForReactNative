...
final class bajg {
    ...
    private bajg(Locale locale) {
        DateFormatSymbols c = bahq.c(locale);
        this.a = c.getEras();
    ...
    public static bajg a(Locale locale) {
        if (locale == null) {
            locale = Locale.getDefault();
        }
        ConcurrentMap concurrentMap = n;
        bajg bajgVar = (bajg) concurrentMap.get(locale);
        if (bajgVar == null) {
            bajgVar = new bajg(locale);
            bajg bajgVar2 = (bajg) concurrentMap.putIfAbsent(locale, bajgVar);
            if (bajgVar2 != null) {
                return bajgVar2;
            }
        }
