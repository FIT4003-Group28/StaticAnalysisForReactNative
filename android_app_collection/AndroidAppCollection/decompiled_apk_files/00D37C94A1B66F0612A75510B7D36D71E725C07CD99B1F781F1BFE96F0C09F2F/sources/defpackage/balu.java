...
public final class balu extends baht {
    private static final long serialVersionUID = 6941492635554961361L;
    final int e;
    final balx f;
    final balx g;

    public balu(String str, int i, balx balxVar, balx balxVar2) {
        super(str);
        this.e = i;
        this.f = balxVar;
        this.g = balxVar2;
    ...
    private final balx o(long j) {
        long j2;
        int i = this.e;
        balx balxVar = this.f;
        balx balxVar2 = this.g;
        try {
            j2 = balxVar.a(j, i, balxVar2.c);
        } catch (ArithmeticException | IllegalArgumentException unused) {
            j2 = j;
        }
        try {
            j = balxVar2.a(j, i, balxVar.c);
        } catch (ArithmeticException | IllegalArgumentException unused2) {
        }
        return j2 > j ? balxVar : balxVar2;
    }
    ...
    */
    public final long e(long r9) {
        ...
        L2e:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.balu.e(long):long");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof balu) {
            ...
            if (this.c.equals(baluVar.c) && this.e == baluVar.e && this.f.equals(baluVar.f) && this.g.equals(baluVar.g)) {
                return true;
            }
        }
        return false;
    ...
    */
    public final long f(long r9) {
        ...
        L32:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.balu.f(long):long");
    }
