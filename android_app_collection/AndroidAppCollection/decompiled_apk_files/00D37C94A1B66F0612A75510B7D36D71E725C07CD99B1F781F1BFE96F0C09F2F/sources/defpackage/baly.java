    ...
    public final synchronized String[] a(Locale locale, String str, String str2) {
        ...
        if (locale != null) {
            ...
            if (map2 == null) {
                map2 = c();
                map.put(str, map2);
                Object[][] zoneStrings = bahq.c(Locale.ENGLISH).getZoneStrings();
                ...
                Object[][] zoneStrings2 = bahq.c(locale).getZoneStrings();
    ...
    public final synchronized String[] b(Locale locale, String str, boolean z) {
        ...
        if (locale != null) {
            ...
            if (map2 == null) {
                map2 = c();
                map.put(str, map2);
                String[][] zoneStrings = bahq.c(Locale.ENGLISH).getZoneStrings();
                int length = zoneStrings.length;
                int i = 0;
                while (true) {
                    if (i >= length) {
                ...
                String[][] zoneStrings2 = bahq.c(locale).getZoneStrings();
                int length2 = zoneStrings2.length;
                int i2 = 0;
                while (true) {
                    if (i2 < length2) {
