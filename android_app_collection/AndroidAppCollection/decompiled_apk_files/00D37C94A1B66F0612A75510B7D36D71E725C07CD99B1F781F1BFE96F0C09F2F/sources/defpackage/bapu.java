...
/* compiled from: PG */
/* renamed from: bapu  reason: default package */
/* loaded from: classes2.dex */
public final class bapu extends Thread {
    public volatile boolean a;
    final /* synthetic */ WebRtcAudioTrack b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public bapu(WebRtcAudioTrack webRtcAudioTrack) {
        ...
        while (this.a) {
            ...
            if (write != capacity) {
                ...
                if (write < 0) {
                    ...
                    bapv.f("WebRtcAudioTrackExternal", webRtcAudioTrack2.b, webRtcAudioTrack2.c);
                    acpf acpfVar = webRtcAudioTrack2.g;
                    if (acpfVar != null) {
                        String valueOf3 = String.valueOf(sb3);
                        zep.c("PeerConnectionClient", valueOf3.length() != 0 ? "onWebRtcAudioTrackError: ".concat(valueOf3) : new String("onWebRtcAudioTrackError: "));
