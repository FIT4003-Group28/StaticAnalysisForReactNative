...
public final class bfu extends bgg {
    final String a;
    ...
    private final Runnable o = new Runnable() { // from class: bfs
    ...
    public bfu(MediaRouter2.RoutingController routingController, String str) {
        Bundle controlHints;
        ...
        this.c = messenger2;
        this.d = messenger2 != null ? new Messenger(new bft(this)) : messenger;
