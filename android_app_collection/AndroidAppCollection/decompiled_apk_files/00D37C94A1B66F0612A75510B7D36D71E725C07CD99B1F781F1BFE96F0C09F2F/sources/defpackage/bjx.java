...
final class bjx {
    ...
    public static final Preference a(XmlPullParser xmlPullParser, PreferenceGroup preferenceGroup, Context context, Object[] objArr, bkb bkbVar, String[] strArr) {
        synchronized (objArr) {
                ...
                try {
                    ...
                    if (next == 2) {
                        ...
                        if (preferenceGroup == null) {
                            preferenceGroup2.A(bkbVar);
                            preferenceGroup = preferenceGroup2;
                        }
                        b(xmlPullParser, preferenceGroup, asAttributeSet, context, objArr, bkbVar, strArr);
                    } else if (next == 1) {
    ...
    private static final void b(XmlPullParser xmlPullParser, Preference preference, AttributeSet attributeSet, Context context, Object[] objArr, bkb bkbVar, String[] strArr) {
            ...
            if (next != 1) {
                if (next == 2) {
                    ...
                    if ("intent".equals(name)) {
                        ...
                        b(xmlPullParser, d, attributeSet, context, objArr, bkbVar, strArr);
                    }
                }
            } else {
                return;
