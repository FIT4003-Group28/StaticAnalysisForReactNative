...
public final class bm implements Cloneable {
        ...
        while (i < str.length()) {
            ...
            if (charAt > 255) {
                if (charAt >= 8206) {
                    ...
                    } else if (((ap.c[ap.b[(charAt - 8192) >> 5]] >> (charAt & 31)) & 1) != 0) {
                        break;
                    }
                } else {
                    continue;
    ...
    private final int l(int i) {
        String str = this.a;
        byte[] bArr = ap.a;
        while (i < str.length() && ap.a(str.charAt(i))) {
            i++;
        }
        return i;
    }
    ...
    */
    private final void q(int r8, int r9, boolean r10) {
        ...
        L8d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bm.q(int, int, boolean):void");
    }

    private final boolean r(int i) {
        return i > 0 || ((bl) this.b.get(0)).e == 1;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:441:0x07b2, code lost:
        r1 = defpackage.ao.a(r5).toLowerCase(java.util.Locale.ENGLISH);
        r2 = n(r3);
    ...
    /* JADX WARN: Type inference failed for: r18v0, types: [bm] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    private final int t(int r19, int r20, int r21, int r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bm.t(int, int, int, int):int");
    }

    private final void u(int i, int i2, int i3, int i4, int i5) {
        ((bl) this.b.get(i)).d = this.b.size();
        v(i2, i3, i4, i5);
    }

    private final void v(int i, int i2, int i3, int i4) {
        this.b.add(new bl(i, i2, i3, i4));
    }
    ...
    public final double a(bl blVar) {
        ...
        return ((Double) this.c.get(blVar.c)).doubleValue();
    }
    ...
    public final bl d(int i) {
        return (bl) this.b.get(i);
    }

    public final bm e() {
        try {
            bm bmVar = (bm) super.clone();
            bmVar.b = (ArrayList) this.b.clone();
            ArrayList arrayList = this.c;
            if (arrayList != null) {
                bmVar.c = (ArrayList) arrayList.clone();
            }
            bmVar.g = false;
            return bmVar;
    ...
    public final boolean equals(Object obj) {
        ...
        return i == i2 && ((str = this.a) != null ? str.equals(bmVar.a) : bmVar.a == null) && this.b.equals(bmVar.b);
    }

    public final String f(bl blVar) {
        int i = blVar.a;
        return this.a.substring(i, blVar.b + i);
    }

    public final boolean g(bl blVar, String str) {
        return this.a.regionMatches(blVar.a, str, 0, blVar.b);
    }

    public final int h(int i) {
        return ((bl) this.b.get(i)).e;
    }
