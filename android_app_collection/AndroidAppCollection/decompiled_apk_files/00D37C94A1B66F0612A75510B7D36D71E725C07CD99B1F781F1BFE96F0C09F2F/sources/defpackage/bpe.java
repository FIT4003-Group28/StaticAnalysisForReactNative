...
public final class bpe {
    ...
    public bpe(Parcel parcel) {
        this(parcel, parcel.dataPosition(), parcel.dataSize(), "", new agd(), new agd(), new agd());
    }
    ...
    public final bpf c() {
        ...
        try {
            ...
            if (method == null) {
                method = Class.forName(n, true, bpe.class.getClassLoader()).getDeclaredMethod("read", bpe.class);
                this.a.put(n, method);
            }
            return (bpf) method.invoke(null, m);
    ...
    public final void k(bpf bpfVar) {
        if (bpfVar != null) {
            try {
                r(v(bpfVar.getClass()).getName());
                bpe m = m();
                try {
                    Class<?> cls = bpfVar.getClass();
                    Method method = (Method) this.b.get(cls.getName());
                    if (method == null) {
                        method = v(cls).getDeclaredMethod("write", cls, bpe.class);
                        this.b.put(cls.getName(), method);
                    }
                    method.invoke(null, bpfVar, m);
                    m.o();
                    return;
                } catch (ClassNotFoundException e) {
                    throw new RuntimeException(e);
                ...
                throw new RuntimeException(bpfVar.getClass().getSimpleName() + " does not have a Parcelizer", e5);
            }
        }
        r(null);
    }
    ...
    protected final bpe m() {
        ...
        int i2 = i;
        return new bpe(parcel, dataPosition, i2, this.h + "  ", this.a, this.b, this.c);
    }
    ...
    public final bpf t(bpf bpfVar) {
        return !s(1) ? bpfVar : c();
    }

    public final void u(bpf bpfVar) {
        p(1);
        k(bpfVar);
    }

    private bpe(Parcel parcel, int i, int i2, String str, agd agdVar, agd agdVar2, agd agdVar3) {
        this.a = agdVar;
        this.b = agdVar2;
        this.c = agdVar3;
