...
public final class br extends ViewGroup.MarginLayoutParams {
    public float A;
    public float B;
    public int C;
    public int D;
    ...
    public br(Context context, AttributeSet attributeSet) {
        ...
        for (int i2 = 0; i2 < indexCount; i2++) {
            ...
            if (index == 83) {
                ...
                this.f142J = obtainStyledAttributes.getDimensionPixelSize(76, this.f142J);
            }
        }
