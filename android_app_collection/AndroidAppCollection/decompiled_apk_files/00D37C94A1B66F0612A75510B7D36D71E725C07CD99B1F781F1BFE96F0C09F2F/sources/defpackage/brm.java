...
public final class brm extends bla {
    final Context c;
    ...
    public final void a(blv blvVar) {
        ...
        if (sharedPreferences.contains("reschedule_needed") || sharedPreferences.contains("last_cancel_all_time_ms")) {
            ...
            blvVar.d();
            try {
                blvVar.l(new Object[]{"last_cancel_all_time_ms", Long.valueOf(j2)});
                blvVar.l(new Object[]{"reschedule_needed", Long.valueOf(j)});
        ...
        if (sharedPreferences2.contains("next_job_scheduler_id") || sharedPreferences2.contains("next_job_scheduler_id")) {
            ...
            blvVar.d();
            try {
                blvVar.l(new Object[]{"next_job_scheduler_id", Integer.valueOf(i)});
                blvVar.l(new Object[]{"next_alarm_manager_id", Integer.valueOf(i2)});
