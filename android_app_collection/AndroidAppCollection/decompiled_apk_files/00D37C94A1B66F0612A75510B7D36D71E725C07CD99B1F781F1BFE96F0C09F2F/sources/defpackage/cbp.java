...
public final class cbp {
    ...
    public cbp(bwq bwqVar) {
        this.a = bwqVar;
    }

    public static String c(String str, cbo cboVar, boolean z) {
        String replaceAll = str.replaceAll("\\W+", "");
        String str2 = cboVar.c;
        if (z) {
    ...
    public final File b(String str, InputStream inputStream, cbo cboVar) {
        File file = new File(a(), c(str, cboVar, true));
        try {
