...
public abstract class ccw implements Closeable {
    ...
    public static ccw e(baba babaVar) {
        return new ccx(babaVar);
    }
    ...
    public final void m(int i) {
        ...
        if (i2 == length) {
            if (i2 == 256) {
                ...
                throw new cct(valueOf.length() != 0 ? "Nesting too deep at ".concat(valueOf) : new String("Nesting too deep at "));
            }
