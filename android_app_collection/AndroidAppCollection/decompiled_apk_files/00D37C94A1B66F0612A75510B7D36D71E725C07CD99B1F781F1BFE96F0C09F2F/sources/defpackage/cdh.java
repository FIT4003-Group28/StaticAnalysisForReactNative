...
public final class cdh {
    private static final ThreadLocal b = new cdd();
    private static final ThreadLocal c = new cde();
    private static final ThreadLocal d = new cdf();
    public static final ThreadLocal a = new cdg();
    ...
    public static void g(Path path, bys bysVar) {
        if (bysVar == null || bysVar.a) {
            return;
        }
        h(path, ((bza) bysVar.b).k() / 100.0f, ((bza) bysVar.c).k() / 100.0f, ((bza) bysVar.d).k() / 360.0f);
    }
    ...
    public static void h(Path path, float f2, float f3, float f4) {
        ...
        if (f2 != 1.0f || f3 != 0.0f) {
            ...
            if (min >= length && max >= length) {
                min = cdc.d(min, length);
                max = cdc.d(max, length);
            }
            if (min < 0.0f) {
                min = cdc.d(min, length);
            }
