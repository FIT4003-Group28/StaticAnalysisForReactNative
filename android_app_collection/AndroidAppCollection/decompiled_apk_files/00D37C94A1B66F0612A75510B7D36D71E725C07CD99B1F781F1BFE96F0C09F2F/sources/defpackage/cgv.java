...
public final class cgv implements cgr {
    ...
    public cgt f = new cgt();

    public cgv(cqw cqwVar, cgt cgtVar, ByteBuffer byteBuffer, int i) {
        this.j = cqwVar;
        c(cgtVar, byteBuffer, i);
    }
    ...
    private final Bitmap e() {
        ...
        cqw cqwVar = this.j;
        Bitmap b = cqwVar.a.b(this.t, this.s, config);
        b.setHasAlpha(true);
        return b;
    }
    ...
    */
    public final synchronized android.graphics.Bitmap a() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cgv.a():android.graphics.Bitmap");
    }
    ...
    public final synchronized void c(cgt cgtVar, ByteBuffer byteBuffer, int i) {
        int[] iArr;
        if (i <= 0) {
        ...
        if (clbVar == null) {
            ...
            iArr = (int[]) clbVar.a(i4, int[].class);
        }
        this.d = iArr;
    }
}
