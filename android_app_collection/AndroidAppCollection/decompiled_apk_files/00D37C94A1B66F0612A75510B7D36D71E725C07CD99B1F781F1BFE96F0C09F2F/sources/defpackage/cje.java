...
public final class cje implements cil {
    private final Uri a;
    private final cjg b;
    private InputStream c;

    public cje(Uri uri, cjg cjgVar) {
        this.a = uri;
        this.b = cjgVar;
    }

    public static cje f(Context context, Uri uri, cjf cjfVar) {
        return new cje(uri, new cjg(cfk.b(context).c.b(), cjfVar, cfk.b(context).d, context.getContentResolver()));
    }
    ...
    */
    public final void d(defpackage.cfv r9, defpackage.cik r10) {
        /*
            r8 = this;
            cjg r9 = r8.b     // Catch: java.io.FileNotFoundException -> Ld7
            android.net.Uri r0 = r8.a     // Catch: java.io.FileNotFoundException -> Ld7
            r1 = 0
            cjf r2 = r9.a     // Catch: java.lang.Throwable -> L27 java.lang.SecurityException -> L2e
        ...
        L9c:
            r0 = -1
            if (r9 == 0) goto Lc8
            cjg r2 = r8.b     // Catch: java.io.FileNotFoundException -> Ld7
            ...
            clb r2 = r2.b     // Catch: java.lang.Throwable -> Lb9 java.lang.Throwable -> Lbb
            int r2 = defpackage.acz.h(r3, r1, r2)     // Catch: java.lang.Throwable -> Lb9 java.lang.Throwable -> Lbb
            if (r1 == 0) goto Lc9
        ...
        Lc9:
            if (r2 == r0) goto Ld1
            cir r0 = new cir     // Catch: java.io.FileNotFoundException -> Ld7
        ...
        Ld7:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cje.d(cfv, cik):void");
    }
