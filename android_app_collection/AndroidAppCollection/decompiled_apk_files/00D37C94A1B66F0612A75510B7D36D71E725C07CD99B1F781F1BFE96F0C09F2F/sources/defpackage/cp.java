...
public final class cp {
        ...
        try {
            ...
            do {
                ...
                if (randomAccessFile.readInt() == reverseBytes) {
                    ...
                    randomAccessFile.skipBytes(2);
                    cq cqVar = new cq();
                    cqVar.b = Integer.reverseBytes(randomAccessFile.readInt()) & 4294967295L;
                    cqVar.a = Integer.reverseBytes(randomAccessFile.readInt()) & 4294967295L;
                    CRC32 crc32 = new CRC32();
                    long j2 = cqVar.b;
                    randomAccessFile.seek(cqVar.a);
    ...
    */
    public static java.util.List d(java.io.File r17, java.io.File r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cp.d(java.io.File, java.io.File):java.util.List");
    }
    ...
    public static void f(Context context, long j, long j2, List list) {
        ...
        while (it.hasNext()) {
            co coVar = (co) it.next();
            edit.putLong("dex.crc." + i, coVar.a);
            edit.putLong("dex.time." + i, coVar.lastModified());
            i++;
        }
        edit.commit();
    }
