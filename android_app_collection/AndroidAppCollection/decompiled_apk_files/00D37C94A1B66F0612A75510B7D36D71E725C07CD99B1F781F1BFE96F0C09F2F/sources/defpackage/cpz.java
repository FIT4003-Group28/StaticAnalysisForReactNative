...
public final class cpz extends FilterInputStream {
    ...
    public cpz(InputStream inputStream, clb clbVar) {
        super(inputStream);
        this.d = -1;
        this.f = clbVar;
        this.a = (byte[]) clbVar.a(65536, byte[].class);
    }
    ...
    */
    private final int c(java.io.InputStream r6, byte[] r7) {
        ...
        L61:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cpz.c(java.io.InputStream, byte[]):int");
    }
