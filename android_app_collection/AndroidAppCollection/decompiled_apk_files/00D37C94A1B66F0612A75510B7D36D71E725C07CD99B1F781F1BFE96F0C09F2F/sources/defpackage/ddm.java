...
public final class ddm {
    ...
    public static ddm a(ddm ddmVar) {
        return new ddm(ddmVar);
    }
    ...
    private static void p(String str, ddk ddkVar, Map map) {
    ...
    public final void h(ddm ddmVar) {
        List list;
        List list2;
        Map map;
        Map b = ddmVar.b();
        ...
        HashSet hashSet = ddmVar.f;
        ArrayList arrayList = new ArrayList();
        if (hashSet != null && (map = ddmVar.e) != null) {
            arrayList.addAll(map.keySet());
            int size = arrayList.size();
            for (int i = 0; i < size; i++) {
                String str2 = (String) arrayList.get(i);
                if (!hashSet.contains(str2)) {
                    ddmVar.e.remove(str2);
                }
            }
        }
        q(ddmVar.f());
        ...
        Map map7 = this.g;
        if (map7 == null) {
            this.g = new HashMap(ddmVar.g);
        } else {
            map7.putAll(ddmVar.g);
        }
    }
    ...
    public final synchronized void i(List list, String str) {
        ...
        for (List list2 : map.values()) {
            int size = list2.size();
            for (int i = 0; i < size; i++) {
                czu.v((dee) list2.get(i), list, str);
            }
        }
        this.c = null;
    }
    ...
    public final synchronized void m(String str, ddk ddkVar, boolean z) {
        t();
        p(str, ddkVar, this.a);
        if (z) {
            s();
    ...
    */
    public ddm(defpackage.ddm r8) {
        ...
        Ld2:
            goto Ld1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ddm.<init>(ddm):void");
    }
}
