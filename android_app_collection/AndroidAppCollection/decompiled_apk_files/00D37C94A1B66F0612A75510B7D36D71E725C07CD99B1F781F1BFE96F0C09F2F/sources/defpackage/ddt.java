...
public final class ddt extends TouchDelegate {
    public final age b;
    public age c;
    private static final Rect d = new Rect();
    public static final jl a = new jl(4);

    public ddt(ComponentHost componentHost) {
    ...
    */
    public final boolean onTouchEvent(android.view.MotionEvent r10) {
        ...
        L7f:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ddt.onTouchEvent(android.view.MotionEvent):boolean");
    }
}
