...
public abstract class dna {
    ...
    public abstract void H(YogaJustify yogaJustify);

    public abstract void I(YogaEdge yogaEdge, float f);
    ...
    public abstract void O(YogaMeasureFunction yogaMeasureFunction);
    ...
    public abstract void U(YogaEdge yogaEdge, float f);

    public abstract void V(YogaEdge yogaEdge, float f);

    public abstract void W(YogaEdge yogaEdge, float f);

    public abstract void X(YogaPositionType yogaPositionType);
    ...
    public abstract void aa(YogaWrap yogaWrap);
    ...
    public abstract YogaDirection j();

    public abstract dna k();

    public abstract dna l(int i);

    public abstract dna m();

    public abstract dnc n();

    public abstract dnc o();

    public abstract Object p();

    public abstract void q(dna dnaVar, int i);
    ...
    public abstract void z(YogaDirection yogaDirection);
}
