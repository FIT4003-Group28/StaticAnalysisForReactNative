...
public final class doh implements Runnable {
    ...
    public doh(Context context, long j, long j2, dod dodVar) {
        this.l = context;
        this.k = j;
        this.j = j2;
        this.e = dodVar;
        ...
        if (this.d == 0) {
            this.d = sharedPreferences.getLong("end_of_interval", dop.a() + j);
        }
    ...
    public static doh a(Context context) {
        synchronized (h) {
            if (i == null) {
                try {
                    i = new doh(context, f, g, new dod(context));
                } catch (Exception e) {
