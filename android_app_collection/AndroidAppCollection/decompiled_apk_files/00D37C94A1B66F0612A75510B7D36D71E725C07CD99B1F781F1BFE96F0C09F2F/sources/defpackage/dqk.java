...
public class dqk {
    ...
    public dqk(String str, long j, Map map) {
        this.a = str;
        this.b = j;
    ...
    /* renamed from: b */
    public dqk clone() {
        return new dqk(this.a, this.b, new HashMap(this.c));
    }
    ...
    public boolean equals(Object obj) {
        ...
        dqk dqkVar = (dqk) obj;
        if (this.b != dqkVar.b || !this.a.equals(dqkVar.a)) {
            return false;
        }
        return this.c.equals(dqkVar.c);
    }
