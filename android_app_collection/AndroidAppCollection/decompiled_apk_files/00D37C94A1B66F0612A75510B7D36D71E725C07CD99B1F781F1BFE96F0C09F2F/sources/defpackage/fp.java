...
public final class fp implements Handler.Callback, ServiceConnection {
    ...
    */
    private final void b(defpackage.fo r10) {
        /*
            r9 = this;
        ...
        L4f:
            ...
            goto Lb0
        L5a:
            fb r3 = r10.e     // Catch: android.os.RemoteException -> L97 android.os.DeadObjectException -> Laf
        ...
        Lbf:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fp.b(fo):void");
    }

    private final void c(fo foVar) {
        if (this.a.hasMessages(3, foVar.a)) {
            return;
        }
        int i = foVar.d + 1;
        foVar.d = i;
        if (i > 6) {
            Log.w("NotifManCompat", "Giving up on delivering " + foVar.c.size() + " tasks to " + foVar.a + " after " + foVar.d + " retries");
            foVar.c.clear();
            return;
        }
        this.a.sendMessageDelayed(this.a.obtainMessage(3, foVar.a), (1 << (i - 1)) * 1000);
    }
    ...
    public final boolean handleMessage(Message message) {
        ...
        if (i != 0) {
            if (i != 1) {
                if (i == 2) {
                    fo foVar = (fo) this.d.get((ComponentName) message.obj);
                    if (foVar != null) {
                        a(foVar);
                    }
                    return true;
                    ...
                    fo foVar2 = (fo) this.d.get((ComponentName) message.obj);
                    if (foVar2 != null) {
                        b(foVar2);
                    }
                    return true;
            ...
            ComponentName componentName = fnVar.a;
            IBinder iBinder = fnVar.b;
            fo foVar3 = (fo) this.d.get(componentName);
            if (foVar3 != null) {
                if (iBinder == null) {
                    fbVar = null;
                } else {
                    IInterface queryLocalInterface = iBinder.queryLocalInterface("android.support.v4.app.INotificationSideChannel");
                    if (queryLocalInterface == null || !(queryLocalInterface instanceof fb)) {
                        fbVar = new fb(iBinder);
                    } else {
                        fbVar = (fb) queryLocalInterface;
                    }
                }
                foVar3.e = fbVar;
                foVar3.d = 0;
        ...
        if (!b.equals(this.e)) {
            ...
            for (ComponentName componentName3 : hashSet) {
                if (!this.d.containsKey(componentName3)) {
                    this.d.put(componentName3, new fo(componentName3));
                }
            }
