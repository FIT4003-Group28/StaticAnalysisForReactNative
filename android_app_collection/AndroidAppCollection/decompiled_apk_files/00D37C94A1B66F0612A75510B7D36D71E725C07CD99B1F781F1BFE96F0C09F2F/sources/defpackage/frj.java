...
public final class frj implements View.OnClickListener {
    ...
    public frj(TextView textView, int i, int i2) {
        this.b = textView;
        this.c = i;
        this.f = i2;
        ...
        ofInt.addListener(new fri(this));
        textView.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: frh
            @Override // android.view.View.OnLayoutChangeListener
            public final void onLayoutChange(View view, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10) {
                frj frjVar = frj.this;
                if (frjVar.b.getLineCount() == frjVar.e) {
                    return;
                }
                frjVar.e = frjVar.b.getLineCount();
                if (frjVar.a.isRunning()) {
                    return;
                }
                frjVar.a.setIntValues(frjVar.c, frjVar.a());
            }
        });
        c();
    }
