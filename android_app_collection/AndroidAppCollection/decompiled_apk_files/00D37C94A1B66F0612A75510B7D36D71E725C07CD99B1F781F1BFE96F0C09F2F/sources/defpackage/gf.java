...
public class gf extends ContentProvider {
                        ...
                        while (true) {
                            ...
                            if (next == 1) {
                                ...
                                if ("root-path".equals(name)) {
                                    ...
                                    File[] k = ake.k(context);
                                    if (k.length > 0) {
                                        file = k[0];
                                    }
                                } else if ("external-cache-path".equals(name)) {
                                    File[] a2 = ake.a(context);
                                    if (a2.length > 0) {
                                        file = a2[0];
                                    }
                                ...
                                if (file != null) {
                                    ...
                                    if (!TextUtils.isEmpty(attributeValue)) {
                                        try {
                                            geVar.b.put(attributeValue, file.getCanonicalFile());
                                        } catch (IOException e) {
