...
public final class gqf extends lpi implements nnc, ynl {
    private final gqe a;

    public gqf(ajyi ajyiVar, yni yniVar, yzj yzjVar, ajin ajinVar, snc sncVar, iub iubVar, ampq ampqVar, ajxt ajxtVar, aari aariVar, acti actiVar, akam akamVar, ampq ampqVar2) {
        super(ajyiVar, yniVar, yzjVar, ajinVar, sncVar, iubVar, ampqVar, ajxtVar, aariVar, actiVar, akamVar);
        aqxo.p(ampqVar2.h());
        this.a = (gqe) ampqVar2.c();
    }
