...
public final class gqy extends srn {
    private final BitmapShader g;
    private final int h;
    private final Path i;

    public gqy(Bitmap bitmap, ImageView.ScaleType scaleType, teb tebVar, DisplayMetrics displayMetrics) {
        super(bitmap, scaleType, tebVar);
        this.g = new BitmapShader(bitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        this.h = zew.i(displayMetrics, 4);
        this.i = new Path();
    }
