...
public final class gva {
    ...
    public gva(ImageView imageView, int i, int i2, actj actjVar, acti actiVar) {
    ...
    */
    public static final boolean a(defpackage.axal r3) {
        /*
            int r0 = r3.d
            int r0 = defpackage.awwd.a(r0)
            r1 = 0
            if (r0 != 0) goto La
            goto L60
        La:
        ...
        L60:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.gva.a(axal):boolean");
    }

    private static final boolean b(axam axamVar) {
        int i = axamVar.b;
        if ((i & 1) == 0 || (i & 2) == 0) {
            zep.b("[ShortsCreation][Android][Guidelines]X or Y coordinate not set.");
            return false;
        }
        float f = axamVar.c;
        if (f >= 0.0f && f <= 1.0f) {
