...
final class gx {
    ...
    static {
        ...
        float f16 = fArr8[0];
        a = new gx(c2, (f16 + f16 + fArr8[1] + (f15 * 0.05f)) * pow, pow, pow, fArr6, cbrt, (float) Math.pow(cbrt, 0.25d), ((float) sqrt) + 1.48f);
    }

    private gx(float f, float f2, float f3, float f4, float[] fArr, float f5, float f6, float f7) {
        this.f = f;
        this.b = f2;
        this.c = f3;
        this.d = f4;
