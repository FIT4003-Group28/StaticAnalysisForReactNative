...
public final class hb {
    ...
    public hb(hb hbVar) {
        this.a = hbVar.a;
        float[] fArr = hbVar.b;
        this.b = iy.x(fArr, fArr.length);
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    public static void a(hb[] hbVarArr, Path path) {
        int i;
        int i2;
        float[] fArr;
        char c;
        ...
        float f11;
        float f12;
        hb[] hbVarArr2 = hbVarArr;
        float[] fArr2 = new float[6];
        char c2 = 'm';
        char c3 = 0;
        char c4 = 'm';
        int i4 = 0;
        while (i4 < hbVarArr2.length) {
            hb hbVar = hbVarArr2[i4];
            char c5 = hbVar.a;
            float[] fArr3 = hbVar.b;
            float f13 = fArr2[c3];
            float f14 = fArr2[1];
