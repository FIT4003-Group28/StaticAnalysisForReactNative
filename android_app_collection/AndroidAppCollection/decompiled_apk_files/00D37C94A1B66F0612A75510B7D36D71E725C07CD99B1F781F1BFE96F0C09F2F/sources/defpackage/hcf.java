...
abstract class hcf extends View.AccessibilityDelegate {
    private final Context a;
    final /* synthetic */ TextTrackView b;
    private final int c;

    public hcf(TextTrackView textTrackView, Context context, int i) {
    ...
    protected final String d(long j) {
        return fcw.i(this.a, j, this.b.g());
    }
    ...
    public final boolean performAccessibilityAction(View view, int i, Bundle bundle) {
        ...
        vfy vfyVar = textTrackView.g;
        Resources resources = textTrackView.getResources();
        Object[] objArr = new Object[2];
        if (this.b.d != null) {
            string = this.a.getResources().getString(this.c, this.b.d.a);
        } else {
            string = this.a.getResources().getString(this.c, "");
        }
        objArr[0] = string;
        objArr[1] = d(a());
        vfyVar.b(view, resources.getString(R.string.a11y_object_moved_to, objArr));
        return true;
    }
}
