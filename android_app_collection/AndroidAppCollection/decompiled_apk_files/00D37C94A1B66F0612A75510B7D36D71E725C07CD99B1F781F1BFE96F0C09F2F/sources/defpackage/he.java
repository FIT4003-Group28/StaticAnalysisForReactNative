...
final class he extends hk {
                ...
                try {
                    if (iy.s(o, resources, i2)) {
                        ...
                        try {
                            ...
                            if (mappedByteBuffer != null || !h(g, mappedByteBuffer, gnVar.e, gnVar.b, gnVar.c)) {
                                return null;
                            }
                        } catch (Throwable th) {
                            try {
    ...
    public final Typeface b(Context context, CancellationSignal cancellationSignal, ald[] aldVarArr, int i) {
        ...
        for (ald aldVar : aldVarArr) {
            Uri uri = aldVar.a;
            ByteBuffer byteBuffer = (ByteBuffer) agdVar.get(uri);
            if (byteBuffer == null) {
                byteBuffer = iy.p(context, cancellationSignal, uri);
                agdVar.put(uri, byteBuffer);
            }
            if (byteBuffer == null || !h(g, byteBuffer, aldVar.b, aldVar.c, aldVar.d)) {
                return null;
            }
        }
        Typeface f = f(g);
