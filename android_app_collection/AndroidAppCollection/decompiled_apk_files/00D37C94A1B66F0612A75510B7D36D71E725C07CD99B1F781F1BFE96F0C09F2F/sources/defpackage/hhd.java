...
public final class hhd {
    ...
    private final void g(long j, long j2, float f, amuk amukVar) {
        float f2 = (float) j;
        ...
        for (int i = 0; i < size; i++) {
            this.c.add(Integer.valueOf((int) (((float) ((Long) amukVar.get(i)).longValue()) / this.e)));
        }
    }
    ...
    public final void c() {
        ...
        h(this.j, zhn.d(this.i, R.attr.ytBrandLinkText));
        h(this.k, zhn.d(this.i, R.attr.ytIconInactive));
        h(this.l, zhn.d(this.i, R.attr.ytIconDisabled));
        h(this.m, zhn.d(this.i, R.attr.ytBrandLinkText));
    }
    ...
    public final void e(long j, long j2, float f, byte[] bArr, int i, amuk amukVar) {
        g(j, j2, f, amukVar);
