...
public class hia extends dp implements axoo {
    ...
    protected final void n() {
        if (!this.d) {
            ...
            eao eaoVar = (eao) lI();
            hidVar.a = eaoVar.c.h();
            hidVar.b = (MusicSearchResultsController) eaoVar.w.get();
            hidVar.c = (SfvAudioItemPlaybackController) eaoVar.c.go.get();
            hidVar.d = (acth) eaoVar.c.L.get();
            hidVar.e = (MusicSearchSuggestionsController) eaoVar.x.get();
            hidVar.ae = (hkl) eaoVar.b.yP.get();
            hidVar.af = (akho) eaoVar.c.lV.get();
        }
    }
