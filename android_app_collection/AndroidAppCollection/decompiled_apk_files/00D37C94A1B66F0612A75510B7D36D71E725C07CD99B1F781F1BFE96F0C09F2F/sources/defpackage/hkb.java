...
public abstract class hkb extends View.AccessibilityDelegate {
    final /* synthetic */ ShortsVideoTrimView2 c;

    public hkb(ShortsVideoTrimView2 shortsVideoTrimView2) {
    ...
    public final boolean performAccessibilityAction(View view, int i, Bundle bundle) {
        ...
        shortsVideoTrimView2.f.b(view, shortsVideoTrimView2.getResources().getString(R.string.a11y_object_moved_to, c(), b(TimeUnit.MICROSECONDS.toMillis(a()))));
        return true;
    }
}
