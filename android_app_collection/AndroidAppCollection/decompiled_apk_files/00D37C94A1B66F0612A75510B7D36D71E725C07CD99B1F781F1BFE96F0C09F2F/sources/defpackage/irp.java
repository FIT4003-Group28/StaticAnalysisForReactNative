...
final class irp {
    ...
    public irp(Object obj, Object obj2, PanelsBackStack panelsBackStack, Fragment$SavedState fragment$SavedState, Fragment$SavedState fragment$SavedState2, PanelDescriptor panelDescriptor, PanelDescriptor panelDescriptor2) {
        this.a = obj;
        this.b = obj2;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof irp) {
            irp irpVar = (irp) obj;
            Object obj2 = this.a;
            if (obj2 != null ? obj2.equals(irpVar.a) : irpVar.a == null) {
                Object obj3 = this.b;
                if (obj3 != null ? obj3.equals(irpVar.b) : irpVar.b == null) {
                    PanelsBackStack panelsBackStack = this.c;
                    if (panelsBackStack != null ? panelsBackStack.equals(irpVar.c) : irpVar.c == null) {
                        Fragment$SavedState fragment$SavedState = this.d;
                        if (fragment$SavedState != null ? fragment$SavedState.equals(irpVar.d) : irpVar.d == null) {
                            Fragment$SavedState fragment$SavedState2 = this.e;
                            if (fragment$SavedState2 != null ? fragment$SavedState2.equals(irpVar.e) : irpVar.e == null) {
                                PanelDescriptor panelDescriptor = this.f;
                                if (panelDescriptor != null ? panelDescriptor.equals(irpVar.f) : irpVar.f == null) {
                                    PanelDescriptor panelDescriptor2 = this.g;
                                    PanelDescriptor panelDescriptor3 = irpVar.g;
    ...
    public final int hashCode() {
        ...
        PanelDescriptor panelDescriptor2 = this.g;
        if (panelDescriptor2 != null) {
            i = panelDescriptor2.hashCode();
        }
        return hashCode6 ^ i;
    }
