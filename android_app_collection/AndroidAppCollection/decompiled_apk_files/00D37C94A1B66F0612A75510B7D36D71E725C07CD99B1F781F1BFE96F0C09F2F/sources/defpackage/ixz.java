...
public final class ixz implements ajru, ixu {
    public final ajmy a;
    ...
    public ixz(Context context, ajmy ajmyVar) {
        this.b = context;
        this.a = ajmyVar;
        ...
        textView.setTextColor(zhn.d(context, R.attr.ytTextPrimary));
        textView2.setTextColor(zhn.d(context, R.attr.ytTextPrimary));
    ...
    public final /* bridge */ /* synthetic */ void oK(ajrs ajrsVar, Object obj) {
        ...
        ixvVar.b(ixvVar.e);
        ixvVar.c(ixvVar.d);
        ixvVar.d(ixvVar.c, ixvVar.g);
        Optional of = Optional.of(ixvVar.a);
        this.k = of;
