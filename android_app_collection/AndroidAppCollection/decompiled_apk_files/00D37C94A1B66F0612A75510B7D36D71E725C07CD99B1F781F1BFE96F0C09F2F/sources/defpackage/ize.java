...
public final class ize extends amj {
    final /* synthetic */ MdxWatchDrawerLayout a;

    public ize(MdxWatchDrawerLayout mdxWatchDrawerLayout) {
    ...
    public final void d(int i) {
        ...
        if (!z) {
            if (mdxWatchDrawerLayout.m) {
                if (zdg.e(mdxWatchDrawerLayout.getContext())) {
                    ...
                    zdg.b(mdxWatchDrawerLayout.getContext(), obtain);
            ...
            if (zdg.e(mdxWatchDrawerLayout2.getContext())) {
                ...
                zdg.b(mdxWatchDrawerLayout2.getContext(), obtain2);
    ...
    public final void i(View view, int i, int i2, int i3) {
        MdxWatchDrawerLayout mdxWatchDrawerLayout = this.a;
        izb izbVar = mdxWatchDrawerLayout.b;
        if (izbVar != null) {
            izbVar.b(1.0f - (i2 / mdxWatchDrawerLayout.h));
        }
        this.a.j(i2, false);
    }
    ...
    public final void e(View view, float f, float f2) {
        ...
        if (!this.a.c.isPresent() || !((amk) this.a.c.get()).j(0, i)) {
            return;
        }
        lj.G(this.a);
    }
