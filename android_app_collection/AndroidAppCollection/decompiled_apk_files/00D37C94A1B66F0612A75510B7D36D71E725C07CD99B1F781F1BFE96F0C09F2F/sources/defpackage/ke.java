...
public final class ke {
    ...
    public final boolean d(float f, float f2, boolean z) {
        ...
        return ja.C(viewParent, this.d, f, f2, z);
    }
    ...
    public final boolean e(float f, float f2) {
        ...
        return ja.D(viewParent, this.d, f, f2);
    }
    ...
    public final boolean m(int i, int i2) {
        if (!k(i2)) {
            ...
            for (ViewParent parent = this.d.getParent(); parent != null; parent = parent.getParent()) {
                if (!ja.E(parent, view, this.d, i, i2)) {
                    if (parent instanceof View) {
                        view = (View) parent;
                    }
                } else {
                    o(i2, parent);
                    ja.A(parent, view, this.d, i, i2);
                    return true;
                }
            }
            return false;
    ...
    public final boolean i(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        ...
        ja.z(n, this.d, i6, i7, i8, i4, i5, iArr3);
        if (iArr != null) {
            this.d.getLocationInWindow(iArr);
            iArr[0] = iArr[0] - i9;
            iArr[1] = iArr[1] - i10;
