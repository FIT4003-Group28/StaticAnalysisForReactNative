...
public final class kxl implements ViewTreeObserver.OnPreDrawListener {
    final /* synthetic */ boolean a;
    final /* synthetic */ int b;
    final /* synthetic */ List c;
    public final /* synthetic */ kxm d;

    public kxl(kxm kxmVar, boolean z, int i, List list) {
        this.d = kxmVar;
        this.a = z;
        this.b = i;
        this.c = list;
    ...
    public final boolean onPreDraw() {
        ...
        wrappingTextViewForClarifyBox.d = new kxk(this, this.a);
