...
class lcb extends dh implements axoo {
    ...
    protected final void aF() {
        if (!this.ah) {
            ...
            ldi ldiVar = (ldi) this;
            eao eaoVar = (eao) lI();
            ldiVar.ao = (acgf) eaoVar.b.a.T.get();
            ldiVar.ae = (aafo) eaoVar.c.H.get();
            ldiVar.af = (afvn) eaoVar.b.au.get();
            ldiVar.ag = (acrr) eaoVar.b.aw.get();
            ldiVar.ap = (apwt) eaoVar.c.jK.get();
        }
    }
