...
public abstract class lfi extends lin implements axoo {
    ...
    protected final void aJ() {
        if (!this.ae) {
            ...
            eao eaoVar = (eao) lI();
            billingsAndPaymentsPrefsFragment.c = (akjl) eaoVar.c.mw.get();
            billingsAndPaymentsPrefsFragment.d = (SettingsDataAccess) eaoVar.c.jt.get();
        }
    }
