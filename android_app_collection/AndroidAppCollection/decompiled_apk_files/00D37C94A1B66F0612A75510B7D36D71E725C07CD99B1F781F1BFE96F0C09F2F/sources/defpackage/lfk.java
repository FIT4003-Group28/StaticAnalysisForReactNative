...
public abstract class lfk extends lin implements axoo {
    ...
    protected final void aJ() {
        if (!this.ae) {
            ...
            eao eaoVar = (eao) lI();
            notificationPrefsFragment.c = (acth) eaoVar.c.L.get();
            notificationPrefsFragment.d = (akjl) eaoVar.c.mw.get();
            notificationPrefsFragment.e = (SettingsDataAccess) eaoVar.c.jt.get();
        }
    }
