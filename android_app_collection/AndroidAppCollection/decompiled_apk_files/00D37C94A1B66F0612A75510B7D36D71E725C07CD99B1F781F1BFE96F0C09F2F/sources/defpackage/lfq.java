...
public abstract class lfq extends lin implements axoo {
    ...
    protected final void aJ() {
        if (!this.ae) {
            ...
            eao eaoVar = (eao) lI();
            thirdPartyPrefsFragment.c = (akjl) eaoVar.c.mw.get();
            thirdPartyPrefsFragment.d = (SettingsDataAccess) eaoVar.c.jt.get();
        }
    }
