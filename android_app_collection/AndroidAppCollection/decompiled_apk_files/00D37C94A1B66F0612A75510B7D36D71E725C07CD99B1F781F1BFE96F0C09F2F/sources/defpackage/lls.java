...
public abstract class lls extends lio implements axoo {
    ...
    protected final void aJ() {
        if (!this.ae) {
            ...
            eao eaoVar = (eao) lI();
            videoQualityPrefsFragment.aE = eaoVar.aS();
            videoQualityPrefsFragment.aF = (yzj) eaoVar.b.je.get();
            videoQualityPrefsFragment.c = new llw((yve) eaoVar.b.fW.get(), (snc) eaoVar.b.v.get(), (aadd) eaoVar.b.K.get(), (acth) eaoVar.c.L.get());
            videoQualityPrefsFragment.d = (aadd) eaoVar.b.K.get();
        }
    }
