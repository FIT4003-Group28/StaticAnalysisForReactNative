...
public final class mh {
    ...
    private mh(AccessibilityNodeInfo accessibilityNodeInfo) {
    ...
    public static mh c(AccessibilityNodeInfo accessibilityNodeInfo) {
        return new mh(accessibilityNodeInfo);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        } else if (!accessibilityNodeInfo.equals(mhVar.b)) {
            return false;
        }
        return this.d == mhVar.d && this.c == mhVar.c;
    }
    ...
    public final CharSequence f() {
        ...
        for (int i = 0; i < g.size(); i++) {
            spannableString.setSpan(new mc(((Integer) g4.get(i)).intValue(), this, a().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY")), ((Integer) g.get(i)).intValue(), ((Integer) g2.get(i)).intValue(), ((Integer) g3.get(i)).intValue());
        }
    ...
    public final void i(mf mfVar) {
        this.b.addAction((AccessibilityNodeInfo.AccessibilityAction) mfVar.j);
    }
    ...
    public final void t(Object obj) {
        this.b.setCollectionInfo((AccessibilityNodeInfo.CollectionInfo) ((aonf) obj).a);
    }
    ...
    public final String toString() {
        ...
        if (actionList != null) {
            ...
            for (int i = 0; i < size; i++) {
                emptyList.add(new mf(actionList.get(i), 0, null, null, null));
            }
        } else {
            emptyList = Collections.emptyList();
        }
        for (int i2 = 0; i2 < emptyList.size(); i2++) {
            mf mfVar = (mf) emptyList.get(i2);
            int a2 = mfVar.a();
            if (a2 == 1) {
                str = "ACTION_FOCUS";
            } else if (a2 != 2) {
            ...
            if (str.equals("ACTION_UNKNOWN") && mfVar.b() != null) {
                str = mfVar.b().toString();
            }
            sb.append(str);
    ...
    public final void u(Object obj) {
        this.b.setCollectionItemInfo((AccessibilityNodeInfo.CollectionItemInfo) ((mg) obj).a);
    }
