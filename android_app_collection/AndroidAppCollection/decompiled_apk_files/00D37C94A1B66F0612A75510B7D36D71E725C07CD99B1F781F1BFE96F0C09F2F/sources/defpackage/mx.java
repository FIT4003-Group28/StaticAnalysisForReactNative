    ...
    */
    private final float d(int r4, float r5, float r6, float r7) {
        ...
        L58:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.mx.d(int, float, float, float):float");
    }
    ...
    private final void f() {
        ...
        int i2 = (int) (currentAnimationTimeMillis - mvVar.e);
        int i3 = mvVar.b;
        if (i2 > i3) {
            i = i3;
        } else if (i2 >= 0) {
        ...
        mvVar.i = i;
        mvVar.h = mvVar.a(currentAnimationTimeMillis);
        mvVar.g = currentAnimationTimeMillis;
    }
    ...
    */
    public final boolean onTouch(android.view.View r6, android.view.MotionEvent r7) {
        ...
        L7d:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.mx.onTouch(android.view.View, android.view.MotionEvent):boolean");
    }
}
