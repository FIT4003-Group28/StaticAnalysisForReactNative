...
public final class nal {
    ...
    public nal(nam namVar, int i) {
        this.k = namVar;
        View inflate = LayoutInflater.from(namVar.a).inflate(i, namVar.k, false);
        this.h = inflate;
        ...
        mxk mxkVar = new mxk();
        this.a = mxkVar;
        nck nckVar = new nck(namVar.a, namVar.c, namVar.h, namVar.f, namVar.g, namVar.i, namVar.j, inflate, findViewById2, findViewById3, namVar.l, findViewById9, findViewById10, findViewById11, new View.OnClickListener() { // from class: nah
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                nal.this.d.a();
            }
        }, new ncg() { // from class: naj
            @Override // defpackage.ncg
            public final void a(boolean z) {
                nal.this.c.f(!z);
            }
        }, new ncj() { // from class: nak
            @Override // defpackage.ncj
            public final void a(boolean z, boolean z2) {
                nan nanVar = nal.this.c;
                boolean z3 = false;
                if (!z && !z2) {
                    z3 = true;
                }
        ...
        this.b = nckVar;
        this.c = new nan(namVar.b, namVar.d, namVar.e, inflate, findViewById2, false, namVar.m, namVar.o);
        mvo mvoVar = new mvo(nckVar, (ViewStub) inflate.findViewById(R.id.muted_ad_view_stub), new mvn() { // from class: nai
    ...
    public final void a(nam namVar, boolean z) {
        if (!this.f) {
            return;
        }
        if (z) {
