...
public abstract class njr extends akas implements axoo {
    ...
    protected final void aF() {
        if (!this.ah) {
            ...
            nkf nkfVar = (nkf) this;
            eao eaoVar = (eao) lI();
            nkfVar.ae = (aadd) eaoVar.b.K.get();
            nkfVar.af = (acth) eaoVar.c.L.get();
            nkfVar.ag = (jyz) eaoVar.c.en.get();
            nkfVar.ah = (jzb) eaoVar.c.ep.get();
        }
    }
