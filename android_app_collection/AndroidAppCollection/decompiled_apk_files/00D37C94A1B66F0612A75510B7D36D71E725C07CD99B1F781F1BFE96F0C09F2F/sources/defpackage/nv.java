...
public final class nv {
    ...
    public int r = 0;
    int y = -1;
    public final View.OnClickListener H = new nl(this);

    public nv(Context context, ov ovVar, Window window) {
        this.a = context;
        this.b = ovVar;
        this.c = window;
        this.G = new nt(ovVar);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, pm.e, R.attr.alertDialogStyle, 0);
