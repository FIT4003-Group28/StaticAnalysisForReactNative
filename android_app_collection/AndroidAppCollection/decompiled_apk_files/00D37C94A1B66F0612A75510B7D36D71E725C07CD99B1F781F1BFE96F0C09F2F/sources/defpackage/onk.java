...
public final class onk extends FrameLayout {
    ...
    private static void f(NumberPicker numberPicker, List list) {
        ...
        numberPicker.setMaxValue(((amxx) list).c - 1);
        ampf e = anhk.a.e();
        list.getClass();
        numberPicker.setDisplayedValues((String[]) arey.x(new ampd(e, list), String.class));
    }
