...
public class oud extends ots {
    ...
    public oud(Context context, oui ouiVar, otm otmVar, long j, owy owyVar, boolean z, Handler handler, ouc oucVar, int i) {
        super(ouiVar, otmVar, owyVar, z, handler, oucVar);
        this.i = new our(context.getApplicationContext());
        this.j = 1000 * j;
        this.a = oucVar;
        this.k = i;
        this.o = -1L;
    ...
    private final void N() {
        ...
        handler.post(new oua(this, this.l));
        this.m = true;
    }
    ...
    private final void P() {
        ...
        int i4 = this.v;
        float f = this.w;
        handler.post(new otz(this, i2, i3));
        this.x = i2;
        this.y = i3;
        this.z = i4;
        this.A = f;
    ...
    public boolean i() {
        if (!super.i() || (!this.n && ((ots) this).e != null && ((ots) this).f != 2)) {
            if (this.o == -1) {
                return false;
            }
    ...
    public void n(MediaCodec mediaCodec, boolean z, android.media.MediaFormat mediaFormat, MediaCrypto mediaCrypto) {
        ...
        if (!mediaFormat.containsKey("max-input-size")) {
            ...
            if (c != 0 && c != 1) {
                ...
                } else if (!"BRAVIA 4K 2015".equals(pcx.d)) {
    ...
    public void pO(int i, long j, boolean z) {
        ...
        ourVar.i = false;
        if (ourVar.a != null) {
            ourVar.b.c.sendEmptyMessage(1);
            oup oupVar = ourVar.c;
            if (oupVar != null) {
                oupVar.a.registerDisplayListener(oupVar, null);
            }
            ourVar.a();
        }
    }
    ...
    public void q() {
        ...
        if (ourVar.a != null) {
            oup oupVar = ourVar.c;
            if (oupVar != null) {
                oupVar.a.unregisterDisplayListener(oupVar);
            }
            ourVar.b.c.sendEmptyMessage(2);
        }
        super.q();
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // defpackage.ots
    public void s(oue oueVar) {
        super.s(oueVar);
        MediaFormat mediaFormat = oueVar.a;
    ...
    @Override // defpackage.ots
    protected final boolean x(otm otmVar, MediaFormat mediaFormat) {
        String str = mediaFormat.b;
        return pcu.f(str) && ("video/x-unknown".equals(str) || otmVar.a(str, false) != null);
    }
    ...
    */
    protected final boolean y(long r25, long r27, android.media.MediaCodec r29, java.nio.ByteBuffer r30, android.media.MediaCodec.BufferInfo r31, int r32, boolean r33) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.oud.y(long, long, android.media.MediaCodec, java.nio.ByteBuffer, android.media.MediaCodec$BufferInfo, int, boolean):boolean");
    }
}
