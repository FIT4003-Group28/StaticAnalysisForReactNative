...
public final class ouz {
    ...
    private final boolean u() {
        int i;
        return pcx.a < 23 && ((i = this.k) == 5 || i == 6);
    }
    ...
    */
    public final int a(java.nio.ByteBuffer r18, int r19, int r20, long r21) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ouz.a(java.nio.ByteBuffer, int, int, long):int");
    }
    ...
    public final int c(int i) {
        ...
        throw new oux(state, this.h, this.i, this.c);
    }
            ...
            if (c != 0) {
                ...
                if (!u() && nanoTime - this.s >= 500000) {
                    ...
                    if (this.t != null && !this.l) {
                        try {
                            Object[] objArr = null;
                            long intValue = (((Integer) method.invoke(this.g, null)).intValue() * 1000) - this.d;
                            this.A = intValue;
    ...
    public final void g() {
        if (n()) {
            ...
            long q = q();
            ouuVar.d = ouuVar.b();
            ouuVar.b = SystemClock.elapsedRealtime() * 1000;
            ouuVar.e = q;
            ouuVar.a.stop();
        }
    }
    ...
    public ouz(byte[] bArr) {
        ...
        if (pcx.a >= 23) {
            ...
            this.f = pcx.a >= 19 ? new ouv() : new ouu();
        }
        this.e = new long[10];
        this.b = 3;
        this.B = 1.0f;
    ...
    */
    public final void e(java.lang.String r11, int r12, int r13, int r14, int r15) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ouz.e(java.lang.String, int, int, int, int):void");
    }
}
