...
final class pad extends pab {
    ...
    public final void a(pct pctVar) {
        ...
        if (pctVar.a() > 0) {
            ...
            byte[] bArr2 = pctVar.a;
            this.h += pctVar.a();
            this.b.f(pctVar, pctVar.a());
            int i6 = i4;
            while (true) {
                int a2 = pcr.a(bArr2, i4, i5, this.e);
                if (a2 == i5) {
                    break;
                }
                int i7 = a2 + 3;
                int i8 = pctVar.a[i7] & 255;
                if (!this.c) {
                    int i9 = a2 - i6;
                    if (i9 > 0) {
                    ...
                    } else if (pacVar.c == 0 && i8 == 181) {
                        pacVar.c = pacVar.b;
                        bArr = bArr2;
                        i8 = 181;
                    } else {
                        int i11 = pacVar.b - i10;
                        pacVar.b = i11;
                        pacVar.a = false;
                        byte[] copyOf = Arrays.copyOf(pacVar.d, i11);
                        byte b = copyOf[4];
