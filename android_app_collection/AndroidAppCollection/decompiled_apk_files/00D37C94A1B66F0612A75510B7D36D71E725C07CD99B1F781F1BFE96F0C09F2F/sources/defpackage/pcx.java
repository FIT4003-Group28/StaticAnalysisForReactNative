...
public final class pcx {
    ...
    public static pbn j(pbn pbnVar, int i) {
        if (i == 0) {
            return pbnVar;
        }
        long j = pbnVar.e;
        ...
        Uri uri = pbnVar.a;
        long j3 = pbnVar.d + i;
        return new pbn(uri, j3, j3, j2, pbnVar.f, pbnVar.g);
    }
    ...
    public static ExecutorService m(String str) {
        return Executors.newSingleThreadExecutor(new pxh(str, 1));
    }

    public static void n(pbl pblVar) {
        if (pblVar != null) {
            try {
                pblVar.c();
