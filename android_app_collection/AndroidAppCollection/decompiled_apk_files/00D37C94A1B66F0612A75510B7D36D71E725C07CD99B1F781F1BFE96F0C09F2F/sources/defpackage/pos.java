...
public final class pos extends poo {
    private static final Pattern a = Pattern.compile("(.+?)='(.*?)';", 32);
    private final CharsetDecoder b = amoz.c.newDecoder();
    private final CharsetDecoder c = amoz.b.newDecoder();
    ...
    */
    protected final com.google.android.exoplayer2.metadata.Metadata b(defpackage.pol r9, java.nio.ByteBuffer r10) {
        /*
            r8 = this;
            ...
            return r9
        L21:
            java.util.regex.Pattern r3 = defpackage.pos.a
        ...
        L29:
            ...
            if (r4 == 0) goto L6a
            java.lang.String r4 = defpackage.akzj.g(r4)
            int r6 = r4.hashCode()
        ...
        L6f:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.pos.b(pol, java.nio.ByteBuffer):com.google.android.exoplayer2.metadata.Metadata");
    }
}
