...
final class pss {
    ...
    public final SpannableString a() {
        ...
        while (i < this.a.size()) {
            ...
            int i8 = psrVar.c;
            i++;
            if (i8 != (i < this.a.size() ? ((psr) this.a.get(i)).c : length)) {
                if (i2 != -1 && !z2) {
    ...
    public final psg b(int i) {
        float f;
        int i2 = this.e + this.f;
        int i3 = 32 - i2;
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        for (int i4 = 0; i4 < this.b.size(); i4++) {
            spannableStringBuilder.append(pxi.x((CharSequence) this.b.get(i4), i3));
            spannableStringBuilder.append('\n');
        }
        spannableStringBuilder.append(pxi.x(a(), i3));
        ...
        psfVar.c = Layout.Alignment.ALIGN_NORMAL;
        psfVar.b(i6, 1);
        psfVar.f = f;
        psfVar.g = i;
        return psfVar.a();
    ...
    public final void d() {
        ...
        if (length > 0) {
            ...
            while (true) {
                size--;
                if (size < 0 || (i = (psrVar = (psr) this.a.get(size)).c) != length) {
                    return;
                }
                psrVar.c = i - 1;
            }
    ...
    public final void f(int i, boolean z) {
        this.a.add(new psr(i, z, this.c.length()));
    }
