...
public final class pwl {
    ...
    public static int b(String str) {
        ...
        for (int i = 0; i < size; i++) {
            sfl sflVar = (sfl) a.get(i);
            String str2 = sflVar.b;
            if (str.equals(null)) {
                int i2 = sflVar.c;
                return 0;
            }
    ...
    static pwk c(String str) {
        ...
        try {
            return new pwk(Integer.parseInt(group, 16), group2 != null ? Integer.parseInt(group2) : 0);
    ...
    public static String e(String str) {
        ...
        if (g.startsWith("mp4a")) {
            if (g.startsWith("mp4a.") && (c = c(g)) != null) {
                str2 = f(c.a);
            }
            return str2 == null ? "audio/mp4a-latm" : str2;
        } else if (g.startsWith("mha1")) {
            return "audio/mha1";
        } else {
            if (g.startsWith("mhm1")) {
                return "audio/mhm1";
            }
            if (g.startsWith("ac-3") || g.startsWith("dac3")) {
                return "audio/ac3";
            }
            ...
            if (g.startsWith("dtsc")) {
                return "audio/vnd.dts";
            }
            if (g.startsWith("dtse")) {
                return "audio/vnd.dts.hd;profile=lbr";
            }
            if (g.startsWith("dtsh") || g.startsWith("dtsl")) {
                return "audio/vnd.dts.hd";
            }
            if (g.startsWith("dtsx")) {
            ...
            if (g.startsWith("stpp")) {
                return "application/ttml+xml";
            }
            if (g.startsWith("wvtt")) {
                return "text/vtt";
            }
            if (g.contains("cea708")) {
                return "application/cea-708";
            }
            if (g.contains("eia608") || g.contains("cea608")) {
            ...
            while (true) {
                ...
                sfl sflVar = (sfl) a.get(i);
                String str3 = sflVar.a;
                if (g.startsWith(null)) {
                    String str4 = sflVar.b;
                    break;
                }
                i++;
            }
