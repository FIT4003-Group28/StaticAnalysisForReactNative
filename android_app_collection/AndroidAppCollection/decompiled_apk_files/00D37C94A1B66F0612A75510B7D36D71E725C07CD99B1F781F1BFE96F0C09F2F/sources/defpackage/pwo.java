...
public final class pwo {
    ...
    */
    public static defpackage.pwn c(byte[] r18, int r19, int r20) {
        /*
            Method dump skipped, instructions count: 370
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.pwo.c(byte[], int, int):pwn");
    }
    ...
    public static pwm f(byte[] bArr, int i) {
        pwv pwvVar = new pwv(bArr, 3, i);
        pwvVar.f(8);
        int b2 = pwvVar.b();
        pwvVar.b();
        pwvVar.e();
