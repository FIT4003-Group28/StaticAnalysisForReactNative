...
public final class pwu {
    ...
    public pwu(byte[] bArr, int i) {
        this.a = bArr;
        this.c = i;
    }

    public final void A(pwt pwtVar, int i) {
        B(pwtVar.a, 0, i);
        pwtVar.j(0);
    }
    ...
    public final String u(int i) {
        ...
        int i2 = this.b;
        int i3 = (i2 + i) - 1;
        String B = pxi.B(this.a, i2, (i3 >= this.c || this.a[i3] != 0) ? i : i - 1);
        this.b += i;
        return B;
    }
