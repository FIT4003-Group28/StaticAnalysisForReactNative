...
public enum qiz {
    ...
    public static final qiz a(String str) {
        qiz[] values;
        qiz qizVar = UNKNOWN;
        for (qiz qizVar2 : values()) {
            if (true == qizVar2.ag.equals(str)) {
                qizVar = qizVar2;
            }
        }
        return qizVar;
    ...
    public static boolean b(qiz qizVar) {
        return BAD_AUTHENTICATION.equals(qizVar) || CAPTCHA.equals(qizVar) || NEED_PERMISSION.equals(qizVar) || NEED_REMOTE_CONSENT.equals(qizVar) || NEEDS_BROWSER.equals(qizVar) || USER_CANCEL.equals(qizVar) || DEVICE_MANAGEMENT_REQUIRED.equals(qizVar) || DM_INTERNAL_ERROR.equals(qizVar) || DM_SYNC_DISABLED.equals(qizVar) || DM_ADMIN_BLOCKED.equals(qizVar) || DM_ADMIN_PENDING_APPROVAL.equals(qizVar) || DM_STALE_SYNC_REQUIRED.equals(qizVar) || DM_DEACTIVATED.equals(qizVar) || DM_REQUIRED.equals(qizVar) || THIRD_PARTY_DEVICE_MANAGEMENT_REQUIRED.equals(qizVar) || DM_SCREENLOCK_REQUIRED.equals(qizVar);
    }
}
