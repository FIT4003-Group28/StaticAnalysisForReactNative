...
public final class qts implements Application.ActivityLifecycleCallbacks, ComponentCallbacks2 {
    ...
    public static void b(Application application) {
        ...
        synchronized (qtsVar) {
            if (!qtsVar.e) {
                application.registerActivityLifecycleCallbacks(qtsVar);
                application.registerComponentCallbacks(qtsVar);
                qtsVar.e = true;
            }
        }
    }
