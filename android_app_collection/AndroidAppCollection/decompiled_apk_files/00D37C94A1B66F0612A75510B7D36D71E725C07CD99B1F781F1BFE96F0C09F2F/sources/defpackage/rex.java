...
public final class rex extends qxb {
    public rex(Context context, Looper looper, qwu qwuVar, qsv qsvVar, qsw qswVar) {
        super(context, looper, 50, qwuVar, qsvVar, qswVar);
    }
    ...
    public final /* bridge */ /* synthetic */ IInterface b(IBinder iBinder) {
        ...
        if (queryLocalInterface instanceof rew) {
            return (rew) queryLocalInterface;
        }
        return new rew(iBinder);
    }
