...
public final class rjw extends rmk {
    public Boolean a;
    public long b;
    private long c;
    private String d;
    ...
    public final boolean e() {
        ...
        if (ake.c(I(), "android.permission.GET_ACCOUNTS") != 0) {
            aG().g.a("Permission error checking for dasher/unicorn accounts");
        ...
        try {
            ...
            aG().d.b("Exception checking account types", e);
        }
