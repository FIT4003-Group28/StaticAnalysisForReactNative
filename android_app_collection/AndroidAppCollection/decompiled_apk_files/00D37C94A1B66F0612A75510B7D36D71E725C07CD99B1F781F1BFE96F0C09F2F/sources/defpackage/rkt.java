...
public final class rkt {
    ...
    public rkt(String str, String str2, Bundle bundle, long j) {
        this.a = str;
        this.b = str2;
        this.d = bundle;
        this.c = j;
    ...
    public static rkt b(EventParcel eventParcel) {
        return new rkt(eventParcel.a, eventParcel.c, eventParcel.b.a(), eventParcel.d);
    }
