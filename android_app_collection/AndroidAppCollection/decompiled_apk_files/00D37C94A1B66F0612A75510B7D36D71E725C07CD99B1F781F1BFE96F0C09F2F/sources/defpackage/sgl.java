...
public final class sgl {
    ...
    public final void a(CharSequence charSequence, Canvas canvas, float f, float f2, Rect rect, TextPaint textPaint, Paint.Align align, int i, float f3, boolean z) {
        float[] fArr;
        sgm a = sgm.a(charSequence);
        sgj b = b(a, textPaint, align, i, f3);
    ...
    */
    public final defpackage.sgj b(java.lang.CharSequence r18, android.text.TextPaint r19, android.graphics.Paint.Align r20, int r21, float r22) {
        /*
            Method dump skipped, instructions count: 1331
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.sgl.b(java.lang.CharSequence, android.text.TextPaint, android.graphics.Paint$Align, int, float):sgj");
    }
}
