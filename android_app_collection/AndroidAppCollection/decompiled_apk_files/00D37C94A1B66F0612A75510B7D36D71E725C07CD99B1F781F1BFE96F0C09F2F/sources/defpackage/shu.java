...
public final class shu implements skq {
    public final amqi a;
    public final shv b;
    public int d = 0;
    public final ArrayList c = new ArrayList(Collections.nCopies(1800, 0));

    public shu(amqu amquVar) {
        amqi d = amqi.d(amquVar);
        this.a = d;
        d.e();
        this.b = new shv();
    }
    ...
    public final anvn a() {
        ...
        int d2 = d(0.9d);
        a.copyOnWrite();
        ((anvo) a.instance).n(d2);
        int d3 = d(0.95d);
        a.copyOnWrite();
        ((anvo) a.instance).o(d3);
        int d4 = d(0.99d);
        a.copyOnWrite();
        ((anvo) a.instance).p(d4);
