...
public final class svb extends Drawable {
    private final Rect a;
    private final int b;
    private final int c;
    private Drawable d;

    private svb(Rect rect, int i, int i2) {
        this.a = rect;
        this.b = i;
        this.c = i2;
    }
    ...
    public static svb a(int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        svb svbVar = new svb(rect, max3, max4);
        svbVar.setBounds(rect2);
        return svbVar;
    }
