...
public final class sw extends rt implements Menu {
    private final hv c;

    public sw(Context context, hv hvVar) {
        super(context);
        this.c = hvVar;
    }
    ...
    public final void removeGroup(int i) {
        if (this.b != null) {
            ...
            while (true) {
                ...
                if (((hw) agdVar.f(i2)).getGroupId() == i) {
                    this.b.g(i2);
                    i2--;
                }
                i2++;
    ...
    public final void removeItem(int i) {
        if (this.b != null) {
            ...
            while (true) {
                ...
                if (i2 >= agdVar.j) {
                    break;
                } else if (((hw) agdVar.f(i2)).getItemId() == i) {
                    this.b.g(i2);
                    break;
                } else {
                    i2++;
    ...
    public final MenuItem add(int i, int i2, int i3, CharSequence charSequence) {
        return a(((sf) this.c).c(i, i2, i3, charSequence));
    }
