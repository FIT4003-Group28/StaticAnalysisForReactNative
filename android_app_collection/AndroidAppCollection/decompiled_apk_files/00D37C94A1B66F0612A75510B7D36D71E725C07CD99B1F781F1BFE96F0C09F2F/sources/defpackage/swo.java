...
public final class swo extends swd {
    private final float a;
    private final Paint b;
    private final teb c;
    private Path d;

    public swo(int i, float f, teb tebVar) {
        this.a = f;
            ...
            try {
                ...
                if (i3 == min) {
                    if (spanEnd < layout2.getLineEnd(min)) {
                        ...
                        if (length != 0) {
                            int i5 = length - 1;
                            if (((dmi[]) spanned.getSpans(i5, i5, dmi.class)).length > 0) {
                            }
                        }
                ...
                path = path2;
                int length5 = ((swd[]) spanned.getSpans(0, spanned.length(), swd.class)).length;
