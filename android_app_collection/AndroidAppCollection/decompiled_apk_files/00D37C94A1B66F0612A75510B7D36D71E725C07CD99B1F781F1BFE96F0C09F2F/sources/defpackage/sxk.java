...
public final class sxk extends srn {
    sxl g;
    aodt h;
    ...
    public sxk(Bitmap bitmap, ImageView.ScaleType scaleType, float f, int i, float f2, boolean z, teb tebVar) {
    ...
    public final boolean c() {
        ...
        if (!aodq.r(aodtVar, 4) && !aodq.r(this.h, 6) && !aodq.r(this.h, 10) && !aodq.r(this.h, 8) && !aodq.r(this.h, 12) && !aodq.r(this.h, 14) && !aodq.r(this.h, 16) && !aodq.r(this.h, 18)) {
            return true;
        }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.l) {
            ...
            sxl sxlVar = this.g;
            if (sxlVar != null && (linearGradient4 = sxlVar.a) != null) {
            ...
            if (c()) {
                ...
                sxl sxlVar2 = this.g;
                if (sxlVar2 != null && (linearGradient3 = sxlVar2.a) != null) {
            ...
            sxl sxlVar3 = this.g;
            if (sxlVar3 != null && (linearGradient2 = sxlVar3.a) != null) {
            ...
            sxl sxlVar4 = this.g;
            if (sxlVar4 != null && (linearGradient = sxlVar4.a) != null) {
