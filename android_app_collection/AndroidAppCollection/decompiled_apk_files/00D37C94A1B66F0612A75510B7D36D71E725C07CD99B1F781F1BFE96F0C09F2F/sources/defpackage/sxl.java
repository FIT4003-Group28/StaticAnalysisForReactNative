...
final class sxl {
    ...
    public sxl(float f, PointF pointF, PointF pointF2, int[] iArr, float[] fArr, int i, teb tebVar) {
        this.b = f;
        this.c = iArr;
        this.d = fArr;
        this.e = pointF;
    ...
    static PointF c(RectF rectF, int i, teb tebVar) {
        if (i != 0) {
            if (i == 1) {
            ...
            tebVar.b(22, "ElementsLinearGradientWrapper Quadrant has to be in the range 0 to 3");
