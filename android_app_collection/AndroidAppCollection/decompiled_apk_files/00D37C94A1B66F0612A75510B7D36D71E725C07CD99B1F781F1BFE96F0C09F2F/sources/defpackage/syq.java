...
final class syq implements tdn {
    ...
    public syq(syt sytVar, tfw tfwVar, tdq tdqVar, tcr tcrVar, tda tdaVar) {
        this.e = sytVar;
        this.a = tfwVar;
        this.b = tdqVar;
        this.c = tcrVar;
    ...
    public final void a(View view, tfi tfiVar) {
        this.e.d(this.e.b.b(this.a.a(), syt.g(view, tfiVar, this.b, this.c, this.d)).Q(), this.d);
    }
}
