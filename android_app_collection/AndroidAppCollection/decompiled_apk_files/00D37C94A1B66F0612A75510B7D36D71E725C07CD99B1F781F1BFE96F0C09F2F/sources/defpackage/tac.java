...
public final class tac extends Drawable {
    ...
    private final boolean a() {
        ...
        if (!aodq.r(aodtVar, 4) && !aodq.r(this.f, 6) && !aodq.r(this.f, 10) && !aodq.r(this.f, 8) && !aodq.r(this.f, 12) && !aodq.r(this.f, 14) && !aodq.r(this.f, 16) && !aodq.r(this.f, 18)) {
            return true;
        }
    ...
    protected final void onBoundsChange(Rect rect) {
        ...
        if (!a() && this.k == null) {
            ...
            if (aodtVar == null) {
                ...
                if (aodtVar.al() || ((!this.e && this.f.an()) || (this.e && this.f.ak()))) {
                    float f = this.d;
                    fArr[0] = f;
                    fArr[1] = f;
                }
