...
final class tbx extends Drawable {
    ...
    static {
        ...
        a = argb;
        int argb2 = Color.argb(168, (int) PrivateKeyType.INVALID, 229, 153);
        b = argb2;
        int argb3 = Color.argb(140, 147, 196, (int) R.styleable.AppCompatTheme_windowMinWidthMinor);
        c = argb3;
    ...
    public tbx(czt cztVar) {
        ...
        this.l = path4;
        dna i = cztVar.i();
        RectF rectF = new RectF(cztVar.b());
