...
public final class tpj extends Drawable implements Animatable {
    ...
    public tpj(float f, int i2, int i3, int[] iArr) {
        this.g = i2;
        this.x = f;
        this.w = i3;
        this.f = iArr;
        ...
        tpn.a();
        tow.b(animatorSet, new Runnable() { // from class: tpg
            @Override // java.lang.Runnable
            public final void run() {
                tpj tpjVar = tpj.this;
                tpjVar.b();
                tpjVar.d = 0.0f;
                tpjVar.c = (tpjVar.c + 216.0f) % 360.0f;
                tpjVar.e();
                int[] iArr2 = tpjVar.f;
                int i4 = iArr2[0];
                tpjVar.e = i4;
                ValueAnimator valueAnimator = tpjVar.b;
                tpjVar.e();
