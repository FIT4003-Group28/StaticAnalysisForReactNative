...
public final class tpm extends Drawable implements Animatable {
    public final int a;
    ...
    public tpm(int i, int i2, float f) {
        this.a = i;
        this.f = i2;
