...
public final class tsg {
    ...
    public tsg(Uri uri, String str, tse tseVar, int i, amuk amukVar, ampq ampqVar) {
        this.a = uri;
        this.b = str;
        this.c = tseVar;
        this.d = i;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof tsg) {
            tsg tsgVar = (tsg) obj;
            if (this.a.equals(tsgVar.a) && this.b.equals(tsgVar.b) && this.c.equals(tsgVar.c) && this.d == tsgVar.d && amxp.v(this.e, tsgVar.e) && this.f.equals(tsgVar.f)) {
                return true;
            }
        }
        return false;
