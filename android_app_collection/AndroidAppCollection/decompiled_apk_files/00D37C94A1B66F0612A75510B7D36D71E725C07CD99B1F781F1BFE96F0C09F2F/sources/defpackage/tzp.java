...
public final class tzp implements vke {
    ...
    public tzp(tzq tzqVar, String str) {
        this.a = tzqVar;
        this.b = tzq.d(str, "w");
        this.c = tzq.d(str, "c");
    }
    ...
    */
    public final void a(int r5) {
        ...
        L55:
            ...
            r5.get()
            int r5 = defpackage.typ.a
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.tzp.a(int):void");
    }
    ...
    public final void b() {
        synchronized (tzq.class) {
            tzq tzqVar = this.a;
            SharedPreferences b = uaw.b(tzqVar.a, "gms_icing_mdd_network_usage_monitor", tzqVar.b);
            SharedPreferences.Editor edit = b.edit();
            if (this.d.get() > 0) {
                edit.putLong(this.b, b.getLong(this.b, 0L) + this.d.getAndSet(0L));
            }
            if (this.e.get() > 0) {
                edit.putLong(this.c, b.getLong(this.c, 0L) + this.e.getAndSet(0L));
            }
            edit.apply();
            b.getLong(this.b, -1L);
            b.getLong(this.c, -1L);
