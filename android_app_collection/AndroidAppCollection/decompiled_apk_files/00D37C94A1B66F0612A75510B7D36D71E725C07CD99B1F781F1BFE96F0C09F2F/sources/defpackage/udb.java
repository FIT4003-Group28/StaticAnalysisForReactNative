...
final class udb extends SQLiteOpenHelper {
    /* JADX WARN: Illegal instructions before constructor call */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public udb(android.content.Context r3, long r4) {
        /*
            r2 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.udb.<init>(android.content.Context, long):void");
    }

    @Override // android.database.sqlite.SQLiteOpenHelper
    public final void onCreate(SQLiteDatabase sQLiteDatabase) {
        uev.e("ChimeThreadSQLiteHelper", "Creating SQLite Database [%s]", getDatabaseName());
    ...
    public final void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        int i3 = i;
        uev.e("ChimeThreadSQLiteHelper", "Upgrading SQLite Database [%s], from version [%d] to [%d]", getDatabaseName(), Integer.valueOf(i), Integer.valueOf(i2));
        if (i3 < 6) {
        ...
        if (i3 == 6) {
            uid.h(sQLiteDatabase, "threads", "expiration_timestamp", "INTEGER NOT NULL DEFAULT(0)");
            if (i2 <= 7) {
                return;
            }
            i3 = 7;
        ...
        if (i3 == 7) {
            uid.h(sQLiteDatabase, "threads", "locally_removed", "INTEGER NOT NULL DEFAULT(0)");
            if (i2 <= 8) {
                return;
            }
            i3 = 8;
        ...
        if (i3 < 12) {
            uid.h(sQLiteDatabase, "threads", "storage_mode", "INTEGER NOT NULL DEFAULT(0)");
            if (i2 <= 12) {
                return;
            }
            i3 = 12;
        ...
        if (i3 < 14) {
            uid.h(sQLiteDatabase, "threads", "payload_type", "TEXT");
            if (i2 <= 14) {
                return;
            }
            i3 = 14;
        ...
        if (i3 == 14) {
            uid.h(sQLiteDatabase, "threads", "thread_stored_timestamp", "INTEGER NOT NULL DEFAULT(0)");
            if (i2 <= 15) {
                return;
            }
            i3 = 15;
        ...
        if (i3 == 15) {
            uid.h(sQLiteDatabase, "threads", "creation_id", "INTEGER NOT NULL DEFAULT(0)");
            if (i2 <= 16) {
                return;
            }
            i3 = 16;
        ...
        if (i3 == 16) {
            uid.h(sQLiteDatabase, "threads", "actions", "BLOB");
            if (i2 <= 17) {
                return;
            }
            i3 = 17;
        ...
        if (i3 == 18) {
            uid.h(sQLiteDatabase, "threads", "reference", "INTEGER NOT NULL DEFAULT(0)");
        ...
        uid.h(sQLiteDatabase, "threads", "deletion_status", "INTEGER NOT NULL DEFAULT(0)");
