...
public final class uez {
    ...
    public uez(Context context, agan aganVar) {
        this.a = context;
        this.b = aganVar;
    }
    ...
    */
    public final java.util.concurrent.Future a(java.lang.String r8, int r9, int r10) {
        /*
            ...
            java.lang.String r1 = r0.getScheme()
            int r4 = r1.hashCode()
            r5 = -368816979(0xffffffffea044cad, float:-3.9985074E25)
            r6 = 2
            if (r4 == r5) goto L3d
        ...
        L67:
            r9.<init>(r8)
            ankt r8 = defpackage.anlz.p(r9)
            return r8
        L6f:
            android.content.Context r8 = r7.a     // Catch: java.io.FileNotFoundException -> L7e
            java.io.InputStream r8 = defpackage.vfq.b(r8, r0)     // Catch: java.io.FileNotFoundException -> L7e
            android.graphics.Bitmap r8 = android.graphics.BitmapFactory.decodeStream(r8)     // Catch: java.io.FileNotFoundException -> L7e
            ankt r8 = defpackage.anlz.q(r8)     // Catch: java.io.FileNotFoundException -> L7e
            goto L83
        L7e:
            r8 = move-exception
            ankt r8 = defpackage.anlz.p(r8)
        L83:
            return r8
        L84:
            agan r0 = r7.b
        ...
        L8b:
            r2 = 0
        L8c:
            yix r1 = defpackage.yix.c()
            ajmy r0 = r0.a
            android.net.Uri r8 = android.net.Uri.parse(r8)
            r0.l(r8, r1)
            agam r8 = new agam
            r8.<init>(r2, r9, r10)
            anjk r9 = defpackage.anjk.a
            ankt r8 = defpackage.anii.h(r1, r8, r9)
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.uez.a(java.lang.String, int, int):java.util.concurrent.Future");
    }
}
