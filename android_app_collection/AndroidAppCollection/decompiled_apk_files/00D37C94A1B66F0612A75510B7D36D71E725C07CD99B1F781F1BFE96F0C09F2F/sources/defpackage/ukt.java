...
final class ukt extends Property {
    public ukt(Class cls) {
    ...
    public final /* bridge */ /* synthetic */ void set(Object obj, Object obj2) {
        ...
        boolean z = true;
        aqxo.z(ringView.b != -1, "setRingThickness should be called before setCurrThickness");
        if (ringView.c == -1) {
            z = false;
        }
        aqxo.z(z, "setRingRadius should be called before setCurrThickness");
        ringView.d = intValue;
        int i = ringView.c;
        int i2 = ringView.b;
        ringView.a.reset();
