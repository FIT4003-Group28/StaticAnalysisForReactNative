...
public final class umd {
    ...
    public umd(int i, Drawable drawable, String str, int i2, View.OnClickListener onClickListener) {
        this.e = i;
        this.a = drawable;
        this.b = str;
        this.c = i2;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof umd) {
            umd umdVar = (umd) obj;
            if (this.e == umdVar.e && this.a.equals(umdVar.a) && this.b.equals(umdVar.b) && this.c == umdVar.c && this.d.equals(umdVar.d)) {
                return true;
            }
        }
        return false;
