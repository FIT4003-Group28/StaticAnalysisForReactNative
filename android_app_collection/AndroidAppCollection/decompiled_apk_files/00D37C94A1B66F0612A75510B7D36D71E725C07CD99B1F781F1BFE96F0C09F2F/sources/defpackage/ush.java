...
public final class ush {
    ...
    public usk j = usk.UNKNOWN;
    public boolean k = false;

    public final Intent a() {
        aqxo.z(this.a != null, "Can't create an intent from a null context!");
        aqxo.z(!TextUtils.isEmpty(this.b), "Client name is required");
        aqxo.z(!TextUtils.isEmpty(this.c), "Client version is required");
        aqxo.z(!TextUtils.isEmpty(this.d), "Parent account name is required");
        Intent intent = new Intent(this.a, ParentToolsActivity.class);
