...
final class ust extends WebViewClient {
    final /* synthetic */ usu a;

    public ust(usu usuVar) {
        this.a = usuVar;
    }
    ...
    */
    private final boolean a(android.net.Uri r9) {
        /*
            ...
            if (r0 == 0) goto Lb5
            usv r0 = com.google.android.libraries.parenttools.youtube.ParentToolsResult.c()
        ...
        Lb5:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ust.a(android.net.Uri):boolean");
    }
    ...
    public final void onPageFinished(WebView webView, String str) {
        ...
        usu usuVar = this.a;
        usuVar.d.setVisibility(8);
        usuVar.c.setVisibility(0);
        usq usqVar = (usq) usuVar.mJ();
        if (usqVar != null) {
            usqVar.b();
        }
    }
