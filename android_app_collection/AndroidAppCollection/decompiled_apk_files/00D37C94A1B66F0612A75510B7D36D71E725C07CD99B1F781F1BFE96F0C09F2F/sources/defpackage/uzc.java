...
final class uzc {
    ...
    public uzc(String str, Class[] clsArr) {
        this.a = str;
        this.b = clsArr;
    }
    ...
    public final boolean a(PackageManager packageManager, String str, int i, IPackageStatsObserver iPackageStatsObserver) {
        ...
        try {
            ...
            e = e;
            ((amzw) ((amzw) uzd.a.e()).i("com/google/android/libraries/performance/primes/metrics/storage/PackageStatsCapture$PackageStatsInvocation", "invoke", 119, "PackageStatsCapture.java")).v("%s for %s (%s) invocation", e.getClass().getSimpleName(), this.a, Arrays.asList(this.b));
            return false;
        } catch (NoSuchMethodException e2) {
            ((amzw) ((amzw) ((amzw) uzd.a.c()).h(e2)).i("com/google/android/libraries/performance/primes/metrics/storage/PackageStatsCapture$PackageStatsInvocation", "invoke", 'q', "PackageStatsCapture.java")).q("PackageStats getter not found");
            return false;
        } catch (Exception e3) {
            e = e3;
            ((amzw) ((amzw) uzd.a.e()).i("com/google/android/libraries/performance/primes/metrics/storage/PackageStatsCapture$PackageStatsInvocation", "invoke", 119, "PackageStatsCapture.java")).v("%s for %s (%s) invocation", e.getClass().getSimpleName(), this.a, Arrays.asList(this.b));
