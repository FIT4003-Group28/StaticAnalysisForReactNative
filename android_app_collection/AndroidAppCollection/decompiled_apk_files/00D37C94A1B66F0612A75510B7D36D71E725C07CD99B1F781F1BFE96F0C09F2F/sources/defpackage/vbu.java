...
public final class vbu extends amth implements Map {
    ...
    private vbu(java.util.Map map) {
        this.b = map;
    }

    public static vbu a() {
        if (a) {
            return new vbu(DesugarCollections.synchronizedMap(new HashMap()));
        }
        return new vbu(new ConcurrentHashMap());
    }
    ...
    @Override // defpackage.amth, defpackage.amtj
