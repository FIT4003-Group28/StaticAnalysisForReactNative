...
public final class vdt {
    ...
    private static final Logger b = Logger.getLogger(vdt.class.getName());
    ...
    static {
        ...
        hashSet.add(94);
        hashSet.add(95);
        hashSet.add(Integer.valueOf((int) PrivateKeyType.INVALID));
        hashSet.add(350);
        hashSet.add(351);
        hashSet.add(352);
        hashSet.add(358);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static vdy a(Object obj, ConcurrentHashMap concurrentHashMap) {
        ObjectInputStream objectInputStream;
        vdy vdyVar = (vdy) concurrentHashMap.get(obj);
        if (vdyVar != null) {
            return vdyVar;
        }
        String str = "/com/google/android/libraries/phonenumbers/data/PhoneNumberMetadataProto_" + obj;
        InputStream resourceAsStream = vdt.class.getResourceAsStream(str);
        ...
        try {
            try {
                ...
                try {
                    vdz vdzVar = new vdz();
                    try {
                        vdzVar.readExternal(objectInputStream);
                        try {
                        ...
                        if (list.size() != 0) {
                            ...
                            vdy vdyVar2 = (vdy) list.get(0);
                            vdy vdyVar3 = (vdy) concurrentHashMap.putIfAbsent(obj, vdyVar2);
                            return vdyVar3 != null ? vdyVar3 : vdyVar2;
                        }
