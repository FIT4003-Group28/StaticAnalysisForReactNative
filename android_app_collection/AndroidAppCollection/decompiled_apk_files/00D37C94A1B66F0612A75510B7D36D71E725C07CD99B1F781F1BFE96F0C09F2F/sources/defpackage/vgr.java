...
public abstract class vgr extends ViewGroup {
    private static final Interpolator a = new abb(5);
    private final int b;
    private boolean c;
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r14) {
        ...
        Lad:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vgr.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public vgr(Context context, AttributeSet attributeSet) {
