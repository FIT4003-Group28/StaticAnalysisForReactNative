...
public final class vqg extends Drawable {
    public static final Property a = new vqe(Integer.class);
    public static final Property b = new vqf(Integer.class);
    ...
    public vqg(Context context, float f, float f2, int i, int i2) {
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.drawText(this.h, this.d, (i + this.g.leading) - this.g.ascent, this.f);
    }
