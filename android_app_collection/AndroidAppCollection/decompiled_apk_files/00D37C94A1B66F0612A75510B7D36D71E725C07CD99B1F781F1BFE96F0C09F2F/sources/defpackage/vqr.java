...
public final class vqr {
    ...
    public vqr(EditableVideoEdits editableVideoEdits, VideoMetaData videoMetaData) {
    ...
    public final void A(double d, double d2) {
        boolean z = true;
        aqxo.p(d >= 0.0d && d < 1.0d);
        aqxo.p(d2 >= 0.0d && d2 < 1.0d);
        if (d + d2 >= 1.0d) {
            z = false;
        }
        aqxo.p(z);
    ...
    public final void q(vqs vqsVar) {
        this.c.add(vqsVar);
    }

    public final void r(Set set) {
        for (vqs vqsVar : this.c) {
            vqsVar.a(this, set);
        }
    }
    ...
    public final String toString() {
        ...
        sb.append(valueOf);
        return uwp.k(name, sb.toString());
    }

    public final void u(vqs vqsVar) {
        this.c.remove(vqsVar);
    }
    ...
    public vqr(VideoMetaData videoMetaData, long j, long j2, boolean z) {
