...
public final class vqx {
    ...
    public vqx() {
        ...
        vqw.b("Failed to attach vertex shader.");
        GLES20.glAttachShader(this.g, this.i);
        vqw.b("Failed to attach fragment shader.");
        GLES20.glLinkProgram(this.g);
        vqw.b("Failed to link shader program.");
    ...
    public final void a(int i, float[] fArr, float[] fArr2) {
        ...
        vqw.b("Failed to attach vertices.");
        GLES20.glEnableVertexAttribArray(this.c);
        vqw.b("Failed to enable vertex array.");
        GLES20.glVertexAttribPointer(this.d, 2, 5126, false, 0, (Buffer) this.k);
        vqw.b("Failed to attach texture coordinates.");
        GLES20.glEnableVertexAttribArray(this.d);
        vqw.b("Failed to enable texture coordinate array.");
    ...
    public final void b() {
        ...
        this.g = 0;
        vqw.b("Failed to delete shader program.");
        GLES20.glDeleteShader(this.h);
        this.h = 0;
        vqw.b("Failed to delete vertex shader.");
        GLES20.glDeleteShader(this.i);
        this.i = 0;
        vqw.b("Failed to delete fragment shader.");
    }
}
