...
public final class vsk extends axix {
    ...
    public final void i(ByteBuffer byteBuffer) {
        ...
        hy.M(byteBuffer, 2);
        Matcher matcher = a.matcher(hy.M(byteBuffer, F));
        if (!matcher.matches()) {
            this.c = Double.NaN;
            this.b = Double.NaN;
            return;
        ...
        double d2 = true != "-".equals(group) ? 1 : -1;
        Double.isNaN(d2);
        ...
        double parseDouble2 = Double.parseDouble(group7) + (group8 != null ? Double.parseDouble(group8) / 60.0d : 0.0d);
        if (group9 != null) {
            d = Double.parseDouble(group9) / 3600.0d;
        }
        double d4 = parseDouble2 + d;
        if (true == "-".equals(group6)) {
            i = -1;
        }
        double d5 = i;
        Double.isNaN(d5);
    ...
    protected final void j(ByteBuffer byteBuffer) {
        ...
        byteBuffer.put(hx.k(String.format(locale, "%c%02d.%04d", objArr)));
        ...
        byteBuffer.put(hx.k(String.format(locale2, "%c%03d.%04d", objArr2)));
        byteBuffer.put(hx.k("/"));
    }
}
