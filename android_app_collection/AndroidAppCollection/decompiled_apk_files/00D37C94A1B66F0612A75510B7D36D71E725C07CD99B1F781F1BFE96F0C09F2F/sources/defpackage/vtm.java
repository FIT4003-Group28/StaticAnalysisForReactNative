...
public class vtm {
    public static void b(vtg vtgVar, WritableByteChannel writableByteChannel) {
        vtgVar.a().e(writableByteChannel);
    }
    ...
    public static Map e() {
        ...
        arrayList87.add("TZ");
        hashMap.put(Integer.valueOf((int) PrivateKeyType.INVALID), arrayList87);
