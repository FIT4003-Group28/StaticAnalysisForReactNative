...
public class vv extends ListView {
    public boolean a;
    vu b;
    ...
    public vv(Context context, boolean z) {
    ...
    */
    public final boolean a(android.view.MotionEvent r17, int r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vv.a(android.view.MotionEvent, int):boolean");
    }
    ...
    public final void setSelector(Drawable drawable) {
        vt vtVar = drawable != null ? new vt(drawable) : null;
        this.j = vtVar;
        super.setSelector(vtVar);
        Rect rect = new Rect();
        if (drawable != null) {
