...
public final class vva implements SurfaceTexture.OnFrameAvailableListener, vuy {
    ...
    public vva(int i, int i2) {
        ...
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            throw new vuz("unable to get EGL display", new Object[0]);
        }
        if (!egl10.eglInitialize(this.d, new int[2])) {
            throw new vuz("unable to initialize EGL", new Object[0]);
        }
        EGLConfig[] eGLConfigArr = new EGLConfig[1];
        int[] iArr = new int[1];
        if (!egl10.eglChooseConfig(this.d, new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12352, 4, 12339, 1, 12344}, eGLConfigArr, 1, iArr)) {
            throw new vuz(String.format("Unable to retrieve list of ES2 frame buffer configurations (EGL error 0x%08x)", Integer.valueOf(egl10.eglGetError())), new Object[0]);
        }
        if (iArr[0] <= 0) {
            throw new vuz("Unable to find RGB888+recordable ES2 EGL config", new Object[0]);
        }
        ...
        if (this.e == null || eglGetError != 12288) {
            throw new vuz(String.format("Unable to create context (EGL error 0x%08x)", Integer.valueOf(eglGetError)), new Object[0]);
        }
        ...
        if (eGLContext == null || eglGetError2 != 12288) {
            throw new vuz(String.format("Unable to create surface (EGL error 0x%08x)", Integer.valueOf(eglGetError2)), new Object[0]);
        }
        ...
        if (egl10.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, eGLContext)) {
            ...
            try {
                int d = d(35633, "uniform mat4 uMVPMatrix;\nuniform mat4 uSTMatrix;\nattribute vec4 aPosition;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n    gl_Position = uMVPMatrix * aPosition;\n    vTextureCoord = (uSTMatrix * aTextureCoord).xy;\n}\n");
                try {
                    i3 = d(35632, "#extension GL_OES_EGL_image_external : require\nprecision mediump float;\nvarying vec2 vTextureCoord;\nuniform samplerExternalOES sTexture;\nvoid main() {\n    gl_FragColor = texture2D(sTexture, vTextureCoord);\n}\n");
                    try {
                        try {
                            int glCreateProgram = GLES20.glCreateProgram();
                            try {
                                if (glCreateProgram == 0) {
                                    throw new vuz("Unable to create program", new Object[0]);
                                }
                                ...
                                a("glTexParameter");
                                int i6 = this.m;
                                viu.d(Looper.myLooper() != null ? false : z);
            ...
            throw new vuz(String.format("eglMakeCurrent failed (EGL error 0x%08x)", Integer.valueOf(egl10.eglGetError())), new Object[0]);
        }
    }
    ...
    public static void a(String str) {
        ...
        throw new vuz("Failed: %s, glError: %d", str, Integer.valueOf(glGetError));
    }
    ...
    private static int b(int i, String str) {
        ...
        throw new vuz("Unable to find attribute %s", str);
    }
    ...
    private static int c(int i, String str) {
        ...
        throw new vuz("Unable to find uniform variable %s", str);
    }

    private static final int d(int i, String str) {
        int glCreateShader = GLES20.glCreateShader(i);
        if (glCreateShader == 0) {
            throw new vuz("Unable to create shader. Type: %d", Integer.valueOf(i));
        }
        ...
        throw new vuz("Could not compile shader (Type: %d):\n%s", Integer.valueOf(i), glGetShaderInfoLog);
    }
