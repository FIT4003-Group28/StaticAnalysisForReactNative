...
public final class vvx extends Drawable {
    private final Drawable b;
    private final float c;
    public final vvw a = new vvw(this);
    private final vvv d = new vvv(this);
    private final vvv e = new vvv(this);

    public vvx(Context context, int i, float f) {
        this.b = akf.a(context, i);
        this.c = f / 2.0f;
    }
