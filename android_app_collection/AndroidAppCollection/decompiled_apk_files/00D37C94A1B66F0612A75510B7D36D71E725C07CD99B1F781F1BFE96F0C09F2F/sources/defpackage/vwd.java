...
public final class vwd extends Handler {
    final /* synthetic */ VideoTrimView a;
    private float b = Float.NaN;

    public vwd(VideoTrimView videoTrimView) {
    ...
    public final void handleMessage(Message message) {
        ...
        aqxo.y(!videoTrimView3.x());
        aqxo.y(videoTrimView3.w());
        if (videoTrimView3.q.b <= videoTrimView3.n) {
            return;
        }
        long h = videoTrimView3.u == vwg.BEGIN ? videoTrimView3.h() : videoTrimView3.g();
        ...
        videoTrimView3.t = new vvt(videoTrimView3.r);
