...
public final class vxb extends vxv {
    public vxk ae;
    ...
    private final vxa ap = new vxa(this, 2);
    private final vxa ai = new vxa(this);
    private final vxa aq = new vxa(this, 1);
    ...
    public vxb() {
        ...
        if (Character.isDigit(shortMonths[0].charAt(0))) {
            ...
            aqxo.p(shortMonths.length < 12 ? false : z);
    ...
    public final Dialog oy(Bundle bundle) {
        ...
        View inflate = mJ().getLayoutInflater().inflate(R.layout.channel_creation_birthday_picker, (ViewGroup) null, false);
        ...
        aF();
        return new AlertDialog.Builder(mJ()).setView(inflate).setTitle(bundle2.getCharSequence("birthday_picker_title")).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() { // from class: vwz
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i2) {
                vxb vxbVar = vxb.this;
                vxbVar.ae.aH(vxbVar.af.get(1), vxbVar.af.get(2), vxbVar.af.get(5));
            }
        }).setNegativeButton(R.string.cancel, gzj.h).create();
    }
