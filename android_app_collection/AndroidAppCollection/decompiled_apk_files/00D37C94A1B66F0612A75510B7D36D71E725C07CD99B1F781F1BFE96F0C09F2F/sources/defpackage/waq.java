...
final class waq {
    ...
    private waq(Uri uri, MessageDigest messageDigest, long j) {
        this.b = messageDigest;
        this.a = uri;
        this.c = j;
    }

    public static waq a(ContentResolver contentResolver, Uri uri) {
        try {
            ...
            try {
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (read < 0) {
                            waq waqVar = new waq(uri, digestInputStream2.getMessageDigest(), j);
