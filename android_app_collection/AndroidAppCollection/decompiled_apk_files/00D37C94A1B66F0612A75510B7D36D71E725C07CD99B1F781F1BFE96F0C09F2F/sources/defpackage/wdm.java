...
public final class wdm {
    ...
    public wdm(wdj wdjVar, Executor executor) {
        this.a = wdjVar;
        this.b = executor;
    }

    public final void a(final String str, final AccountIdentity accountIdentity, final wdl wdlVar) {
        this.b.execute(new Runnable() { // from class: wdk
            /* JADX WARN: Code restructure failed: missing block: B:19:0x007c, code lost:
                if ("INVALID_GRANT".equals(new org.json.JSONObject(new java.lang.String(r2.b)).getJSONObject("error").getString("message")) != false) goto L6;
             */
            ...
            */
            public final void run() {
                ...
                L46:
                    ...
                    boolean r5 = r5 instanceof defpackage.cfd
                    if (r5 == 0) goto L7f
                    java.lang.Throwable r2 = r2.getCause()
                    cfd r2 = (defpackage.cfd) r2
                    cew r2 = r2.b
                    if (r2 == 0) goto L7f
                    int r5 = r2.a
                ...
                L8e:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: defpackage.wdk.run():void");
            }
        });
    }
}
