...
public class wm extends ViewGroup {
    ...
    private void forceUniformHeight(int i, int i2) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (virtualChildAt.getVisibility() != 8) {
                wl wlVar = (wl) virtualChildAt.getLayoutParams();
                if (wlVar.height == -1) {
                    int i4 = wlVar.width;
                    wlVar.width = virtualChildAt.getMeasuredWidth();
    ...
    private void forceUniformWidth(int i, int i2) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (virtualChildAt.getVisibility() != 8) {
                ...
                if (wlVar.width == -1) {
                    int i4 = wlVar.height;
                    wlVar.height = virtualChildAt.getMeasuredHeight();
    ...
    public void drawDividersHorizontal(Canvas canvas) {
        ...
        for (int i2 = 0; i2 < virtualChildCount; i2++) {
            ...
            if (virtualChildAt != null && virtualChildAt.getVisibility() != 8 && hasDividerBeforeChildAt(i2)) {
                wl wlVar = (wl) virtualChildAt.getLayoutParams();
                if (b) {
                    left2 = virtualChildAt.getRight() + wlVar.rightMargin;
                } else {
                    left2 = (virtualChildAt.getLeft() - wlVar.leftMargin) - this.mDividerWidth;
                }
        ...
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            ...
            if (virtualChildAt2 != null) {
                wl wlVar2 = (wl) virtualChildAt2.getLayoutParams();
                if (b) {
                    left = virtualChildAt2.getLeft() - wlVar2.leftMargin;
                    i = this.mDividerWidth;
                    right = left - i;
                } else {
                    right = virtualChildAt2.getRight() + wlVar2.rightMargin;
                }
            } else if (b) {
    ...
    public void drawDividersVertical(Canvas canvas) {
        ...
        for (int i = 0; i < virtualChildCount; i++) {
            ...
            if (virtualChildAt != null && virtualChildAt.getVisibility() != 8 && hasDividerBeforeChildAt(i)) {
                drawHorizontalDivider(canvas, (virtualChildAt.getTop() - ((wl) virtualChildAt.getLayoutParams()).topMargin) - this.mDividerHeight);
            }
        }
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            View virtualChildAt2 = getVirtualChildAt(virtualChildCount - 1);
            if (virtualChildAt2 == null) {
                ...
                bottom = virtualChildAt2.getBottom() + ((wl) virtualChildAt2.getLayoutParams()).bottomMargin;
            }
    ...
    public wl mo21generateDefaultLayoutParams() {
    ...
    public wl mo22generateLayoutParams(AttributeSet attributeSet) {
    ...
    public int getBaseline() {
        ...
        return i3 + ((wl) childAt.getLayoutParams()).topMargin + baseline;
    }
    ...
    */
    public void layoutHorizontal(int r25, int r26, int r27, int r28) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wm.layoutHorizontal(int, int, int, int):void");
    }
    ...
    */
    public void layoutVertical(int r18, int r19, int r20, int r21) {
        ...
        L5a:
            ...
            r5 = r1
            wl r5 = (defpackage.wl) r5
            int r1 = r5.gravity
            if (r1 >= 0) goto L76
            r1 = r11
        L76:
            int r2 = defpackage.lj.e(r17)
        ...
        Lc9:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wm.layoutVertical(int, int, int, int):void");
    }
    ...
    */
    public void measureHorizontal(int r37, int r38) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wm.measureHorizontal(int, int):void");
    }
    ...
    */
    public void measureVertical(int r29, int r30) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wm.measureVertical(int, int):void");
    }
    ...
    public wm(Context context, AttributeSet attributeSet, int i) {
        ...
        aad l = aad.l(context, attributeSet, pm.m, i, 0);
        lj.L(this, context, pm.m, attributeSet, l.b, i, 0);
        int c = l.c(1, -1);
        if (c >= 0) {
            setOrientation(c);
        }
    ...
    @Override // android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public wl mo23generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
