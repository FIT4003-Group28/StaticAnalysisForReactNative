...
public final class xcu implements xek {
    public final String a;
    private final String b;
    private final apcf c;

    public xcu(String str, apcf apcfVar, String str2) {
        if (str != null) {
            this.b = str;
            if (apcfVar != null) {
                this.c = apcfVar;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof xcu) {
            xcu xcuVar = (xcu) obj;
            if (this.b.equals(xcuVar.b) && this.c.equals(xcuVar.c) && this.a.equals(xcuVar.a)) {
                return true;
            }
        }
        return false;
