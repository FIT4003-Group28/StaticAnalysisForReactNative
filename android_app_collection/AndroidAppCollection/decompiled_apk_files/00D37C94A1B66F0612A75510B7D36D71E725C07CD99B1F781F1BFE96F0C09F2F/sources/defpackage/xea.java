...
public final class xea implements xdv {
    public final String a;
    private final String b;
    private final apcf c;

    public xea(String str, apcf apcfVar, String str2) {
        if (str != null) {
            this.b = str;
            if (apcfVar != null) {
                this.c = apcfVar;
    ...
    public static xea a(String str, String str2) {
        return new xea(str, apcf.TRIGGER_TYPE_SLOT_ID_SCHEDULED, str2);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof xea) {
            xea xeaVar = (xea) obj;
            if (this.b.equals(xeaVar.b) && this.c.equals(xeaVar.c) && this.a.equals(xeaVar.a)) {
                return true;
            }
        }
        return false;
