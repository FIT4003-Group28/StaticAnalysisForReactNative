...
public final class xen implements xcj {
    public final String a;
    private final String b;
    private final apcf c;

    public xen(String str, apcf apcfVar, String str2) {
        if (str != null) {
            this.b = str;
            if (apcfVar != null) {
                this.c = apcfVar;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof xen) {
            xen xenVar = (xen) obj;
            if (this.b.equals(xenVar.b) && this.c.equals(xenVar.c) && this.a.equals(xenVar.a)) {
                return true;
            }
        }
        return false;
    ...
    public final String toString() {
        ...
        StringBuilder sb = new StringBuilder(length + 108 + String.valueOf(valueOf).length() + str2.length());
