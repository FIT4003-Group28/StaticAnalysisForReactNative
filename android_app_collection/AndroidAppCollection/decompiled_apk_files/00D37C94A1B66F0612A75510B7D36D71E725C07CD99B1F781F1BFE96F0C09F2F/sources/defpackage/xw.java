...
public abstract class xw {
    ...
    public xw() {
        xu xuVar = new xu(this, 1);
        this.a = xuVar;
        xu xuVar2 = new xu(this);
        this.b = xuVar2;
        this.v = new aas(xuVar);
        this.w = new aas(xuVar2);
        this.y = false;
        this.z = false;
        this.A = false;
        this.B = true;
    ...
    */
    public static int ar(int r1, int r2, int r3, boolean r4) {
        ...
        L21:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.xw.ar(int, int, int, boolean):int");
    }
    ...
    */
    public static int as(int r3, int r4, int r5, int r6, boolean r7) {
        ...
        L31:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.xw.as(int, int, int, int, boolean):int");
    }

    public static xv ax(Context context, AttributeSet attributeSet, int i, int i2) {
        xv xvVar = new xv();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, qd.a, i, i2);
        xvVar.a = obtainStyledAttributes.getInt(0, 1);
        xvVar.b = obtainStyledAttributes.getInt(10, 1);
        xvVar.c = obtainStyledAttributes.getBoolean(9, false);
        xvVar.d = obtainStyledAttributes.getBoolean(11, false);
    ...
    public static final int bi(View view) {
        return ((xx) view.getLayoutParams()).d.bottom;
    }

    public static final int bj(View view) {
        Rect rect = ((xx) view.getLayoutParams()).d;
    ...
    public static final int bl(View view) {
        return ((xx) view.getLayoutParams()).d.left;
    }

    public static final int bm(View view) {
        return ((xx) view.getLayoutParams()).qa();
    }

    public static final int bn(View view) {
        return ((xx) view.getLayoutParams()).d.right;
    }

    public static final int bo(View view) {
        return ((xx) view.getLayoutParams()).d.top;
    }

    public static final void bq(View view, int i, int i2, int i3, int i4) {
        xx xxVar = (xx) view.getLayoutParams();
        Rect rect = xxVar.d;
        view.layout(i + rect.left + xxVar.leftMargin, i2 + rect.top + xxVar.topMargin, (i3 - rect.right) - xxVar.rightMargin, (i4 - rect.bottom) - xxVar.bottomMargin);
    }
    ...
    private final void c(View view, int i, boolean z) {
        ...
        if (l.B() || l.w()) {
            ...
            if (c == -1) {
                ...
                View az = xwVar.az(c);
                if (az == null) {
                    throw new IllegalArgumentException("Cannot move a child from non-existing index:" + c + xwVar.u.toString());
                }
                xwVar.aH(c);
                xx xxVar2 = (xx) az.getLayoutParams();
                yo l2 = RecyclerView.l(az);
                if (l2.v()) {
                    xwVar.u.h.b(l2);
                } else {
                    xwVar.u.h.g(l2);
                }
                xwVar.t.g(az, i, xxVar2, l2.v());
            }
        } else {
    ...
    public void X(AccessibilityEvent accessibilityEvent) {
        ...
        accessibilityEvent.setItemCount(xoVar.b());
    }
    ...
    public final void aJ(RecyclerView recyclerView, yd ydVar) {
        this.z = false;
        W(recyclerView, ydVar);
    }
    ...
    public final void aN(View view, mh mhVar) {
        yo l = RecyclerView.l(view);
        if (l == null || l.v() || this.t.k(l.a)) {
            return;
        }
        RecyclerView recyclerView = this.u;
        qf(recyclerView.d, recyclerView.M, view, mhVar);
    }
    ...
    public final void aR(yd ydVar) {
        int size = ydVar.a.size();
        for (int i = size - 1; i >= 0; i--) {
            View view = ((yo) ydVar.a.get(i)).a;
            yo l = RecyclerView.l(view);
            if (!l.A()) {
                l.n(false);
                if (l.x()) {
    ...
    public final void aS(View view, yd ydVar) {
        vf vfVar = this.t;
    ...
    public final void aT(int i, yd ydVar) {
        View az = az(i);
        aU(i);
        ydVar.i(az);
    }
    ...
    public void aj(int i, int i2, yl ylVar, we weVar) {
    }

    public void ak(int i, we weVar) {
    }
    ...
    public final int at() {
        RecyclerView recyclerView = this.u;
        xo xoVar = recyclerView != null ? recyclerView.m : null;
        if (xoVar != null) {
            return xoVar.b();
        }
        return 0;
    ...
    public final void bd(yk ykVar) {
        ...
        if (i != -1) {
            ...
            ykVar.f = true;
            ykVar.e = true;
            ykVar.g = recyclerView2.n.S(ykVar.b);
            ykVar.c.f66J.a();
            ykVar.h = true;
            return;
        }
    ...
    */
    public final boolean bg(android.support.v7.widget.RecyclerView r17, android.view.View r18, android.graphics.Rect r19, boolean r20, boolean r21) {
        ...
        Lc8:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.xw.bg(android.support.v7.widget.RecyclerView, android.view.View, android.graphics.Rect, boolean, boolean):boolean");
    }

    public boolean bh(View view, int i, int i2, xx xxVar) {
        return view.isLayoutRequested() || !this.B || !be(view.getWidth(), i, xxVar.width) || !be(view.getHeight(), i2, xxVar.height);
    }

    public final void bp(View view, Rect rect) {
        Matrix matrix;
        Rect rect2 = ((xx) view.getLayoutParams()).d;
    ...
    public void br(View view) {
        ...
        int i3 = f.top;
        int i4 = f.bottom;
        int as = as(this.H, this.F, getPaddingLeft() + getPaddingRight() + xxVar.leftMargin + xxVar.rightMargin + i + i2, xxVar.width, ad());
        int as2 = as(this.I, this.G, getPaddingTop() + getPaddingBottom() + xxVar.topMargin + xxVar.bottomMargin + i3 + i4, xxVar.height, ae());
        if (bh(view, as, as2, xxVar)) {
            view.measure(as, as2);
        }
    }
    ...
    public xx h(Context context, AttributeSet attributeSet) {
    ...
    public int oG(yd ydVar, yl ylVar) {
        return -1;
    }

    public int oH(yd ydVar, yl ylVar) {
        return -1;
    }

    public xx qd(ViewGroup.LayoutParams layoutParams) {
        if (layoutParams instanceof xx) {
            return new xx((xx) layoutParams);
        }
        if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
            return new xx((ViewGroup.MarginLayoutParams) layoutParams);
        }
        return new xx(layoutParams);
    }
    ...
    public void qf(yd ydVar, yl ylVar, View view, mh mhVar) {
    }
