...
public final class yja {
    ...
    private static final yjh b = new yjh();
    ...
    public static Set b(Context context, Uri uri) {
        ...
        if (queryIntentActivities != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Set set = yjhVar.b;
                if (set == null) {
                    yjhVar.b = new HashSet();
                    List<ResolveInfo> queryIntentActivities2 = context.getPackageManager().queryIntentActivities(yjh.a, 65536);
                    int size2 = queryIntentActivities2.size();
                    for (int i2 = 0; i2 < size2; i2++) {
                        yjhVar.b.add(queryIntentActivities2.get(i2).activityInfo.packageName);
                    }
                    set = yjhVar.b;
                }
                if (!set.contains(str)) {
    ...
    public static void c(Context context, Intent intent, Uri uri) {
        ...
        intent.putExtra("trusted_application_code_extra", PendingIntent.getActivity(context.getApplicationContext(), 0, new Intent(), zgd.M(), null));
    ...
    public static void f(Context context, Uri uri) {
        ...
        try {
            ...
            zep.d("Activity not found to view uri", e);
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:114:0x0127 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:72:0x0137  */
    /* JADX WARN: Removed duplicated region for block: B:77:0x016a A[ORIG_RETURN, RETURN] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static void i(android.app.Activity r18, java.lang.String r19, java.lang.String r20, java.lang.String r21, java.lang.String r22, boolean r23, boolean r24, boolean r25, java.util.List r26, defpackage.yjk r27, defpackage.yiu r28) {
        /*
            Method dump skipped, instructions count: 424
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.yja.i(android.app.Activity, java.lang.String, java.lang.String, java.lang.String, java.lang.String, boolean, boolean, boolean, java.util.List, yjk, yiu):void");
    }
    ...
    private static void l(Intent intent, yjk yjkVar, yiu yiuVar) {
        yjkVar.a(intent, 907, yiuVar);
    }
    ...
    public static String a(Activity activity, Intent intent) {
        if (Build.VERSION.SDK_INT < 22) {
            ...
            return uri.getHost();
        } else if (!k(activity.getReferrer())) {
            return null;
        } else {
