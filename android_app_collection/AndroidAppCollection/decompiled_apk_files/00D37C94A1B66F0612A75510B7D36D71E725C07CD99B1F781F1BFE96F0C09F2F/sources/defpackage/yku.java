...
public final class yku extends yko {
    final Map c;
    ...
    @Override // defpackage.yko, defpackage.ykg
    public final synchronized Object a(Object obj) {
        Object a = super.a(obj);
        if (a != null) {
            return a;
        }
        ykt yktVar = (ykt) this.c.get(obj);
        if (yktVar != null) {
            a = yktVar.get();
            if (a != null) {
                super.d(obj, a);
    ...
    public final synchronized Object b(Object obj) {
        ...
        b = super.b(obj);
        if (b != null) {
            this.c.put(obj, new ykt(obj, b, this.d));
        }
        return b;
    }
    ...
    public final synchronized void d(Object obj, Object obj2) {
        ...
        while (true) {
            ykt yktVar = (ykt) this.d.poll();
            if (yktVar == null) {
                break;
            }
            this.c.remove(yktVar.a);
        }
