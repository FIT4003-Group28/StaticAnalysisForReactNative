...
public class ynu extends gf {
    private final int a = R.xml.file_provider_exported_paths;

    @Override // defpackage.gf, android.content.ContentProvider
    public final void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        boolean z = false;
        boolean z2 = loadXmlMetaData == null || Build.VERSION.SDK_INT <= 23;
        if (z2) {
            ...
            sb.append(z);
            zep.m("FileProviderCompat", sb.toString());
        }
        if (z2) {
            Bundle bundle = new Bundle(1);
            bundle.putInt("android.support.FILE_PROVIDER_PATHS", this.a);
            context = new ynt(context, new ynw(context.getPackageManager(), new ynv(providerInfo.authority, bundle)));
        }
        try {
            ...
            zep.f("FileProviderCompat", sb2.toString(), e);
            throw e;
        }
    }
}
