...
public final class yqq {
    ...
    public yqq(String str) {
        ...
        aqxo.q(matcher.matches(), "Type must be in the 'maintype/subtype; parameter=value' format");
        String group = matcher.group(1);
        Pattern pattern = b;
        aqxo.q(pattern.matcher(group).matches(), "Type contains reserved characters");
        this.f = group;
        this.h = null;
        String group2 = matcher.group(2);
        aqxo.q(pattern.matcher(group2).matches(), "Subtype contains reserved characters");
        this.g = group2;
        this.h = null;
        ...
        if (group3 != null) {
            ...
            while (matcher2.find()) {
                ...
                if (group5 == null) {
                    ...
                    aqxo.q(c.matcher(group4).matches(), "Name contains reserved characters");
                    this.h = null;
    ...
    public final boolean equals(Object obj) {
        yqq yqqVar;
        return (obj instanceof yqq) && (yqqVar = (yqq) obj) != null && this.f.equalsIgnoreCase(yqqVar.f) && this.g.equalsIgnoreCase(yqqVar.g) && this.a.equals(yqqVar.a);
    }
