...
final class ysc extends UploadDataProvider {
    private final yqt a;
    private InputStream b;
    private int c;

    public ysc(yqt yqtVar) {
        this.a = yqtVar;
    }
    ...
    /* JADX WARN: Type inference failed for: r1v2, types: [yum, java.io.InputStream] */
    @Override // org.chromium.net.UploadDataProvider
