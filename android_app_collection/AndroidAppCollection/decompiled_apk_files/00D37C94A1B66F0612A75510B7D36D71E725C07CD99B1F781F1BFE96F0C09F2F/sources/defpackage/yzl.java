...
public final class yzl {
    ...
    public final int c(MotionEvent motionEvent, int i) {
        ...
        boolean z2 = i == 2 || i == 3;
        int findPointerIndex = motionEvent.findPointerIndex(this.f);
        if (zgd.P(findPointerIndex, 0, motionEvent.getPointerCount())) {
            float x = motionEvent.getX(findPointerIndex);
    ...
    public yzl(Context context, int i, int i2, int i3) {
        this.f = -1;
        aqxo.q(i >= 200, "snapVelocity cannot be less than 200");
