...
public final class zax extends LinkMovementMethod {
    private static zax a;
    ...
    public final boolean onTouchEvent(TextView textView, Spannable spannable, MotionEvent motionEvent) {
        ...
        if (actionMasked == 0 || actionMasked == 1) {
            ...
            if (clickableSpanArr.length > 0) {
                ...
                if (youTubeTextView.h && (clickableSpan instanceof zae)) {
                    zae zaeVar = (zae) clickableSpan;
                    if (actionMasked == 0) {
                        zaeVar.b = youTubeTextView.i;
                    } else {
                        zaeVar.b = 0;
                    }
                ...
                if (actionMasked == 0) {
                    ...
                    try {
                        ...
                        zep.l("Activity was not found for browser intent.");
                    }
                }
