...
public final class zdd {
    ...
    private final View.OnLayoutChangeListener b = new View.OnLayoutChangeListener() { // from class: zdc
    ...
    private final void e() {
        View view = this.d;
        if (view == null || this.c == null || !lj.al(view)) {
            return;
        }
        a();
    }
    ...
    public final void a() {
        ...
        int i7 = iArr2[0];
        int i8 = iArr2[1];
        zdf.b(this.d, this.c, new zde(new Rect(i2 - i7, i3 - i8, (width + i4) - i7, ((i5 + height) + i6) - i8), this.c, this.d));
    }
