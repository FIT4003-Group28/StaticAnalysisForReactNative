...
public final class zde extends TouchDelegate {
    private final int[] a;
    ...
    public zde(Rect rect, View view, View view2) {
        super(rect, view);
        this.a = new int[2];
        this.b = rect;
        view.getClass();
    ...
    */
    public final boolean onTouchEvent(android.view.MotionEvent r9) {
        ...
        L64:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.zde.onTouchEvent(android.view.MotionEvent):boolean");
    }
}
