...
public final class zen {
    ...
    public zen(Context context, String str) {
    ...
    public final int a(String str, int i) {
        g(str);
        return rxn.a(this.b, f(str), i);
    }

    public final String b(String str, String str2) {
        g(str);
        return rxn.d(this.b, f(str), str2);
    }

    public final void c(Executor executor, ConditionVariable conditionVariable) {
        executor.execute(new zem(this, conditionVariable));
    }

    public final void d() {
        rxn.f(this.b, this.a);
        rxn.h(this.b, 0L);
        rxn.g(this.b, "http_stats", false);
        this.c = true;
    }

    public final boolean e(String str, boolean z) {
        g(str);
        return rxn.g(this.b, f(str), z);
    }
}
