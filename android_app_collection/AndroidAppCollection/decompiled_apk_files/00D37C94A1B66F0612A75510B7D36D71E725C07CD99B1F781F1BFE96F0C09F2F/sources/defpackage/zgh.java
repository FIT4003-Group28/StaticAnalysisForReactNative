...
public final class zgh {
    private static final amqo a = aqxo.i(gsh.o);
    ...
    public static String g(Resources resources, long j) {
        if (j < 1024) {
            ...
            sb.append(j);
            return resources.getString(R.string.num_bytes_with_unit, ((alj) a.get()).b(sb.toString()), resources.getString(R.string.byte_unit_mb));
        }
        return resources.getString(R.string.num_bytes_with_unit, ((alj) a.get()).b(new String(String.valueOf(new DecimalFormat("#.##").format(((float) j) / 1024.0f)))), resources.getString(R.string.byte_unit_gb));
    }
    ...
    public static void n(String str, Object obj) {
        aqxo.q(!amps.e(str), obj);
    }

    public static String o(Resources resources, long j) {
        return ((alj) a.get()).b(resources.getString(R.string.num_bytes_with_unit, f(j), e(resources, j)));
    }
