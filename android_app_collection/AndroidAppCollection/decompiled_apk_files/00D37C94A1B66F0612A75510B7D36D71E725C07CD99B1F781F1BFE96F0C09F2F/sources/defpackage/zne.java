...
public final class zne {
    static final amuk a = amuk.v("_id", "_size", "_data", "_display_name", "duration");
    static final amuk b = amuk.u("_id", "_size", "_data", "_display_name");
    public static final amuk c = amuk.w("_id", "_size", "_data", "_display_name", "date_modified", "mime_type");
    static final amuk d = amuk.x("_id", "_size", "_data", "_display_name", "duration", "date_modified", "mime_type");
    ...
    private final DeviceLocalFile g(Cursor cursor, int i, int i2, int i3, int i4, int i5, int i6) {
        long j;
        long j2 = 0;
        long j3 = i2 >= 0 ? cursor.getLong(i2) : 0L;
        String str = "";
        String string = i3 >= 0 ? cursor.getString(i3) : str;
        ...
        long j4 = i4 >= 0 ? cursor.getLong(i4) : 0L;
        if (i5 >= 0) {
        ...
        Uri withAppendedId = ContentUris.withAppendedId(f(i), j3);
        long j5 = i6 >= 0 ? cursor.getLong(i6) : 0L;
        File file = new File(str);
        try {
            j = file.lastModified();
        } catch (SecurityException e) {
            zep.d("Security exception while trying to get last modified timestamp for a file.", e);
            j = 0;
        }
        if (j >= 0) {
            j2 = j;
        }
        znd i7 = DeviceLocalFile.i();
        i7.e(j3);
        i7.h(withAppendedId);
        i7.b(string);
        i7.a = file.getParent();
    ...
    private final List h(int i) {
        ...
        try {
            cursor = this.e.query(f(i), strArr, null, null, null);
        } catch (SQLiteException | IllegalArgumentException | SecurityException e) {
            zep.d("Error while trying to query content resolver for local media.", e);
            cursor = null;
        }
        ...
        try {
            ...
            try {
                ...
                zep.d("Error while trying to get column indexes from cursor.", e2);
            }
            return arrayList;
        } finally {
            cursor2.close();
    ...
    public final DeviceLocalFile a(Cursor cursor, int i) {
        if (cursor != null && cursor.moveToFirst()) {
            try {
                ...
                zep.d("Error while trying to get column indexes from cursor.", e);
            }
        }
        return null;
    }
    ...
    public final Cursor e(Uri uri, String[] strArr) {
        ...
        try {
            ...
            zep.d("Error while trying to query content resolver.", e);
        }
        return cursor;
    }
}
