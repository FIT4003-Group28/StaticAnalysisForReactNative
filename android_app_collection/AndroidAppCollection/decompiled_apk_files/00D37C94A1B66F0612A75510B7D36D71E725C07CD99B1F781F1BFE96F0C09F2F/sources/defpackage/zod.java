...
public final class zod {
    ...
    public zod(EGLDisplay eGLDisplay, EGLConfig eGLConfig, EGLContext eGLContext, EGLSurface eGLSurface, int i, boolean z, boolean z2) {
        this.d = eGLDisplay;
        this.c = eGLConfig;
        this.e = eGLContext;
        this.i = eGLSurface;
    ...
    public static void d(EGLSurface eGLSurface) {
        if (akzj.f(eGLSurface, EGL14.EGL_NO_SURFACE)) {
    ...
    public static void h(zod zodVar) {
        h.set(zodVar);
    }
    ...
    public static zod k(ask askVar) {
        zod zodVar = (zod) h.get();
        if (zodVar == null) {
        ...
        asc.d("glGenFramebuffers");
        int i = iArr[0];
        GLES20.glBindFramebuffer(36160, i);
        asc.d("glBindFramebuffer");
        GLES20.glFramebufferTexture2D(36160, 36064, askVar.b, askVar.a, 0);
        asc.d("glFramebufferTexture2D");
        return new zod(zodVar.d, zodVar.c, zodVar.e, zodVar.i, i, false, false);
    }

    public static zod l(int i, int i2, EGLContext eGLContext) {
        EGLConfig eGLConfig;
        int i3;
        if (eGLContext == null) {
        ...
        if (!akzj.f(eglGetDisplay, EGL14.EGL_NO_DISPLAY)) {
            ...
            if (EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1)) {
                ...
                if (akzj.f(eGLContext2, EGL14.EGL_NO_CONTEXT)) {
                ...
                zod zodVar = new zod(eglGetDisplay, eGLConfig, eGLContext2, eglCreatePbufferSurface, 0, true, true);
    ...
    public static zod m(int i, int i2) {
        return l(i, i2, null);
    }
    ...
    private static EGLContext o(EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i, EGLContext eGLContext) {
        ...
        c("eglCreateContext");
        if (akzj.f(eglCreateContext, EGL14.EGL_NO_CONTEXT)) {
            String valueOf = String.valueOf(p());
    ...
    public final zod b(SurfaceTexture surfaceTexture) {
        ...
        d(eGLSurface);
        zod zodVar = new zod(this.d, this.c, this.e, eGLSurface, 0, false, true);
        zodVar.b = surfaceTexture;
        j(eGLSurface);
        return zodVar;
    }
    ...
    public final void g() {
        ...
        int i = this.j;
        if (i != 0) {
            asc.c("glDeleteFramebuffers");
            GLES20.glDeleteFramebuffers(1, new int[]{i}, 0);
            asc.d("glDeleteFramebuffers");
        }
    }
