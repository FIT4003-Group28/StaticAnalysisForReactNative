...
public final /* synthetic */ class zpy implements aoic {
    public final /* synthetic */ zou a;

    @Override // defpackage.aoic
    public final void a(final TextureFrame textureFrame) {
        final zoi zoiVar = this.a.c;
        if (textureFrame.getTimestamp() <= zoiVar.f) {
            textureFrame.getTimestamp();
            textureFrame.release();
            return;
        }
        zoiVar.f = textureFrame.getTimestamp();
        zoiVar.a.b.post(new Runnable() { // from class: zoh
            ...
            */
            public final void run() {
                ...
                L3e:
                    ...
                    defpackage.asc.d(r9)     // Catch: java.lang.RuntimeException -> Lb1
                ...
                Ld8:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: defpackage.zoh.run():void");
            }
        });
    }
}
