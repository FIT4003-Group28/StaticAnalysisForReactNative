    ...
    public static Bitmap a(Context context, DeviceLocalFile deviceLocalFile, CancellationSignal cancellationSignal) {
        ...
        if (deviceLocalFile.a() == 2) {
            try {
                ...
                afus.c(1, 9, "Failed finding bitmap file from Uri", e);
                file = null;
            }
            if (file != null) {
                try {
                    ...
                    afus.c(1, 9, "Failed opening thumbnail file", e2);
                    bitmap = null;
                }
                if (bitmap != null) {
            ...
            try {
                ...
                if (!(e3 instanceof OperationCanceledException)) {
                    afus.c(1, 9, "Failed loading thumbnail", e3);
                }
            }
            ...
            try {
                ...
                afus.c(1, 9, "Failed retrieving document thumbnail", e4);
            }
        ...
        return (bitmap2 == null || deviceLocalFile.a() != 1 || z) ? bitmap2 : akel.D(bitmap2, contentResolver, deviceLocalFile.f());
    }
}
