...
public final class zw extends amf implements View.OnClickListener {
    public int a;
    ...
    public zw(Context context, SearchView searchView, SearchableInfo searchableInfo, WeakHashMap weakHashMap) {
    ...
    private final Drawable k(String str) {
        ...
        try {
            ...
            Drawable a = akf.a(this.l, parseInt);
            m(str2, a);
            return a;
    ...
    /* JADX WARN: Removed duplicated region for block: B:26:0x0079 A[Catch: RuntimeException -> 0x007d, TRY_LEAVE, TryCatch #0 {RuntimeException -> 0x007d, blocks: (B:11:0x001e, B:26:0x0079, B:14:0x0024, B:17:0x002b, B:19:0x0048, B:20:0x004b, B:22:0x0056, B:24:0x0062, B:23:0x005e), top: B:31:0x001e }] */
    @Override // defpackage.amc, defpackage.amd
    /*
    ...
    */
    public final android.database.Cursor a(java.lang.CharSequence r12) {
        ...
        L85:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.zw.a(java.lang.CharSequence):android.database.Cursor");
    }
    ...
    */
    public final void e(android.view.View r19, android.database.Cursor r20) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.zw.e(android.view.View, android.database.Cursor):void");
    }

    @Override // defpackage.amf, defpackage.amc
    public final View f(ViewGroup viewGroup) {
        View inflate = this.i.inflate(this.h, viewGroup, false);
        inflate.setTag(new zv(inflate));
        ((ImageView) inflate.findViewById(R.id.edit_query)).setImageResource(this.n);
        return inflate;
    }

    @Override // defpackage.amc, android.widget.BaseAdapter, android.widget.SpinnerAdapter
    public final View getDropDownView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            View h = h(viewGroup);
            if (h != null) {
                ((zv) h.getTag()).a.setText(e.toString());
            }
            return h;
        }
    }
    ...
    public final View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            View f = f(viewGroup);
            if (f != null) {
                ((zv) f.getTag()).a.setText(e.toString());
            }
            return f;
        }
    }

    @Override // defpackage.amc, android.widget.BaseAdapter, android.widget.Adapter
        ...
        try {
            ...
            if (cursor == cursor2) {
                ...
                if (cursor2 != null) {
                    ama amaVar = this.f;
                    if (amaVar != null) {
                        cursor2.unregisterContentObserver(amaVar);
                    }
                ...
                if (cursor != null) {
                    ama amaVar2 = this.f;
                    if (amaVar2 != null) {
                        cursor.registerContentObserver(amaVar2);
                    }
