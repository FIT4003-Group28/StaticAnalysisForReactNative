...
public final class zxo extends View.AccessibilityDelegate {
    final /* synthetic */ DurationMsSeekBar a;

    public zxo(DurationMsSeekBar durationMsSeekBar) {
    ...
    public final boolean performAccessibilityAction(View view, int i, Bundle bundle) {
        ...
        if (i == 4096) {
            ...
            durationMsSeekBar2.setProgress(durationMsSeekBar2.getProgress() - 100);
            return true;
        } else {
