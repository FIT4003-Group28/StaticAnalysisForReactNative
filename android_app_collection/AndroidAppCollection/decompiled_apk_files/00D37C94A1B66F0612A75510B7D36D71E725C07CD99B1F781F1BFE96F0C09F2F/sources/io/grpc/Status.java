...
public final class Status {
    ...
    public static final ayaq p;
    public static final ayaq q;
    private static final ayas s;
    ...
    public enum Code {
        ...
        Code(int i) {
            this.t = i;
            this.r = Integer.toString(i).getBytes(amoz.a);
        }
    ...
    static {
        ...
        Code.DATA_LOSS.b();
        p = ayaq.d("grpc-status", false, new aybr());
        aybs aybsVar = new aybs();
        s = aybsVar;
        q = ayaq.d("grpc-message", false, aybsVar);
    }
    ...
    public final Status c(Throwable th) {
        return akzj.f(this.r, th) ? this : new Status(this.t, this.u, th);
    }
    ...
    public final String toString() {
        ampp c2 = akzj.c(this);
        c2.b("code", this.t.name());
        c2.b("description", this.u);
        Throwable th = this.r;
        String str = th;
        if (th != null) {
            str = amqs.b(th);
    ...
    public Status withDescription(String str) {
        return akzj.f(this.u, str) ? this : new Status(this.t, str, this.r);
    }
}
