...
public final class Instant implements Temporal, TemporalAdjuster, Comparable, Serializable {
    ...
    public static Instant ofEpochMilli(long j) {
        long m;
        m = Duration$$ExternalSyntheticBackport10.m(j, 1000);
    ...
    /* renamed from: with */
    public Instant mo387with(TemporalAdjuster temporalAdjuster) {
        return (Instant) temporalAdjuster.adjustInto(this);
    }

    @Override // j$.time.temporal.Temporal
    /* renamed from: with */
    public Instant mo386with(TemporalField temporalField, long j) {
        if (temporalField instanceof ChronoField) {
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: plus */
    public Instant mo382plus(long j, TemporalUnit temporalUnit) {
        long m;
        long m2;
        long m3;
        long m4;
        if (temporalUnit instanceof ChronoUnit) {
            switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoUnit[((ChronoUnit) temporalUnit).ordinal()]) {
                ...
                case 6:
                    m2 = Duration$$ExternalSyntheticBackport11.m(j, 3600);
                    return plusSeconds(m2);
                case 7:
                    m3 = Duration$$ExternalSyntheticBackport11.m(j, 43200);
                    return plusSeconds(m3);
                case 8:
                    m4 = Duration$$ExternalSyntheticBackport11.m(j, 86400);
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: minus */
    public Instant mo381minus(long j, TemporalUnit temporalUnit) {
    ...
    public Object query(TemporalQuery temporalQuery) {
        ...
        if (temporalQuery != TemporalQueries.chronology() && temporalQuery != TemporalQueries.zoneId() && temporalQuery != TemporalQueries.zone() && temporalQuery != TemporalQueries.offset() && temporalQuery != TemporalQueries.localDate() && temporalQuery != TemporalQueries.localTime()) {
            return temporalQuery.mo404queryFrom(this);
        }
        return null;
    }
    ...
    public Temporal adjustInto(Temporal temporal) {
        return temporal.mo386with(ChronoField.INSTANT_SECONDS, this.seconds).mo386with(ChronoField.NANO_OF_SECOND, this.nanos);
    }
    ...
    private long nanosUntil(Instant instant) {
        return Clock$OffsetClock$$ExternalSyntheticBackport0.m(Duration$$ExternalSyntheticBackport11.m(Instant$$ExternalSyntheticBackport8.m(instant.seconds, this.seconds), 1000000000L), instant.nanos - this.nanos);
    }
    ...
    public long toEpochMilli() {
        ...
        long j = this.seconds;
        if (j < 0 && this.nanos > 0) {
            m2 = Duration$$ExternalSyntheticBackport11.m(j + 1, 1000);
