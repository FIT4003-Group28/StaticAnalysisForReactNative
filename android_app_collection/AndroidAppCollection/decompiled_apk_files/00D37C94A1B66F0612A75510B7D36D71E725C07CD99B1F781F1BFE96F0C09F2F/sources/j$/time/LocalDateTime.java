...
public final class LocalDateTime implements Temporal, TemporalAdjuster, ChronoLocalDateTime, Serializable {
    ...
    public static LocalDateTime ofEpochSecond(long j, int i, ZoneOffset zoneOffset) {
        ...
        m = Duration$$ExternalSyntheticBackport10.m(j + zoneOffset.getTotalSeconds(), 86400);
    ...
    public static LocalDateTime from(TemporalAccessor temporalAccessor) {
        ...
        if (temporalAccessor instanceof ZonedDateTime) {
            return ((ZonedDateTime) temporalAccessor).mo328toLocalDateTime();
        }
    ...
    public LocalDate mo302toLocalDate() {
        return this.date;
    }
    ...
    /* renamed from: with */
    public LocalDateTime mo387with(TemporalAdjuster temporalAdjuster) {
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: with */
    public LocalDateTime mo386with(TemporalField temporalField, long j) {
        if (temporalField instanceof ChronoField) {
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: plus */
    public LocalDateTime mo382plus(long j, TemporalUnit temporalUnit) {
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: minus */
    public LocalDateTime mo381minus(long j, TemporalUnit temporalUnit) {
        return j == Long.MIN_VALUE ? mo382plus(Long.MAX_VALUE, temporalUnit).mo382plus(1L, temporalUnit) : mo382plus(-j, temporalUnit);
    }
    ...
    private LocalDateTime plusWithOverflow(LocalDate localDate, long j, long j2, long j3, long j4, int i) {
        ...
        long m = (((j4 / 86400000000000L) + (j3 / 86400) + (j2 / 1440) + (j / 24)) * j5) + Duration$$ExternalSyntheticBackport10.m(j6, 86400000000000L);
    ...
    @Override // j$.time.chrono.ChronoLocalDateTime
    /* renamed from: atZone */
    public ZonedDateTime mo299atZone(ZoneId zoneId) {
    ...
    private int compareTo0(LocalDateTime localDateTime) {
        int compareTo0 = this.date.compareTo0(localDateTime.mo302toLocalDate());
