...
public final class LocalTime implements Temporal, TemporalAdjuster, Comparable, Serializable {
    ...
    /* renamed from: with */
    public LocalTime mo387with(TemporalAdjuster temporalAdjuster) {
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: with */
    public LocalTime mo386with(TemporalField temporalField, long j) {
        if (temporalField instanceof ChronoField) {
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: plus */
    public LocalTime mo382plus(long j, TemporalUnit temporalUnit) {
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: minus */
    public LocalTime mo381minus(long j, TemporalUnit temporalUnit) {
    ...
    public Temporal adjustInto(Temporal temporal) {
        return temporal.mo386with(ChronoField.NANO_OF_DAY, toNanoOfDay());
    }
