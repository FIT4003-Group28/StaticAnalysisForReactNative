...
public final class OffsetDateTime implements Temporal, TemporalAdjuster, Comparable, Serializable {
    ...
    /* renamed from: with */
    public OffsetDateTime mo387with(TemporalAdjuster temporalAdjuster) {
        if ((temporalAdjuster instanceof LocalDate) || (temporalAdjuster instanceof LocalTime) || (temporalAdjuster instanceof LocalDateTime)) {
            return with(this.dateTime.mo387with(temporalAdjuster), this.offset);
        }
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: with */
    public OffsetDateTime mo386with(TemporalField temporalField, long j) {
        if (temporalField instanceof ChronoField) {
            ...
            return with(this.dateTime.mo386with(temporalField, j), this.offset);
        }
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: plus */
    public OffsetDateTime mo382plus(long j, TemporalUnit temporalUnit) {
        if (temporalUnit instanceof ChronoUnit) {
            return with(this.dateTime.mo382plus(j, temporalUnit), this.offset);
        }
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: minus */
    public OffsetDateTime mo381minus(long j, TemporalUnit temporalUnit) {
    ...
    public Temporal adjustInto(Temporal temporal) {
        return temporal.mo386with(ChronoField.EPOCH_DAY, toLocalDate().toEpochDay()).mo386with(ChronoField.NANO_OF_DAY, toLocalTime().toNanoOfDay()).mo386with(ChronoField.OFFSET_SECONDS, getOffset().getTotalSeconds());
    }
