...
public final class OffsetTime implements Temporal, TemporalAdjuster, Comparable, Serializable {
    ...
    static {
        LocalTime.MIN.atOffset(ZoneOffset.MAX);
        LocalTime.MAX.atOffset(ZoneOffset.MIN);
    }
    ...
    /* renamed from: with */
    public OffsetTime mo387with(TemporalAdjuster temporalAdjuster) {
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: with */
    public OffsetTime mo386with(TemporalField temporalField, long j) {
        if (temporalField instanceof ChronoField) {
            if (temporalField == ChronoField.OFFSET_SECONDS) {
                return with(this.time, ZoneOffset.ofTotalSeconds(((ChronoField) temporalField).checkValidIntValue(j)));
            }
            return with(this.time.mo386with(temporalField, j), this.offset);
        }
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: plus */
    public OffsetTime mo382plus(long j, TemporalUnit temporalUnit) {
        if (temporalUnit instanceof ChronoUnit) {
            return with(this.time.mo382plus(j, temporalUnit), this.offset);
        }
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: minus */
    public OffsetTime mo381minus(long j, TemporalUnit temporalUnit) {
    ...
    public Temporal adjustInto(Temporal temporal) {
        return temporal.mo386with(ChronoField.NANO_OF_DAY, this.time.toNanoOfDay()).mo386with(ChronoField.OFFSET_SECONDS, this.offset.getTotalSeconds());
    }
