...
public final class YearMonth implements Temporal, TemporalAdjuster, Comparable, Serializable {
    ...
    /* renamed from: with */
    public YearMonth mo387with(TemporalAdjuster temporalAdjuster) {
        return (YearMonth) temporalAdjuster.adjustInto(this);
    }

    @Override // j$.time.temporal.Temporal
    /* renamed from: with */
    public YearMonth mo386with(TemporalField temporalField, long j) {
        if (temporalField instanceof ChronoField) {
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: plus */
    public YearMonth mo382plus(long j, TemporalUnit temporalUnit) {
        long m;
        long m2;
        long m3;
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: minus */
    public YearMonth mo381minus(long j, TemporalUnit temporalUnit) {
    ...
    public Temporal adjustInto(Temporal temporal) {
        ...
        return temporal.mo386with(ChronoField.PROLEPTIC_MONTH, getProlepticMonth());
    }
