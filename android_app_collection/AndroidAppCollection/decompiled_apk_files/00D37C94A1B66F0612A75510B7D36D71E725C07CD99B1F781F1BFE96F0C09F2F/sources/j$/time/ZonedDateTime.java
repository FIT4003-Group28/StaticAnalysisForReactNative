...
public final class ZonedDateTime implements Temporal, ChronoZonedDateTime, Serializable {
    ...
    public ZonedDateTime mo332withZoneSameLocal(ZoneId zoneId) {
        Objects.requireNonNull(zoneId, "zone");
    ...
    public ZonedDateTime mo331withZoneSameInstant(ZoneId zoneId) {
        Objects.requireNonNull(zoneId, "zone");
    ...
    public LocalDateTime mo328toLocalDateTime() {
        return this.dateTime;
    }

    @Override // j$.time.chrono.ChronoZonedDateTime
    /* renamed from: toLocalDate */
    public LocalDate mo327toLocalDate() {
        return this.dateTime.mo302toLocalDate();
    }
    ...
    /* renamed from: with */
    public ZonedDateTime mo387with(TemporalAdjuster temporalAdjuster) {
        if (temporalAdjuster instanceof LocalDate) {
            return resolveLocal(LocalDateTime.of((LocalDate) temporalAdjuster, this.dateTime.toLocalTime()));
        }
        if (temporalAdjuster instanceof LocalTime) {
            return resolveLocal(LocalDateTime.of(this.dateTime.mo302toLocalDate(), (LocalTime) temporalAdjuster));
        }
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: with */
    public ZonedDateTime mo386with(TemporalField temporalField, long j) {
        if (temporalField instanceof ChronoField) {
            ...
            return resolveLocal(this.dateTime.mo386with(temporalField, j));
        }
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: plus */
    public ZonedDateTime mo382plus(long j, TemporalUnit temporalUnit) {
        if (temporalUnit instanceof ChronoUnit) {
            if (temporalUnit.isDateBased()) {
                return resolveLocal(this.dateTime.mo382plus(j, temporalUnit));
            }
            return resolveInstant(this.dateTime.mo382plus(j, temporalUnit));
        }
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: minus */
    public ZonedDateTime mo381minus(long j, TemporalUnit temporalUnit) {
    ...
    public long until(Temporal temporal, TemporalUnit temporalUnit) {
        ...
        if (temporalUnit instanceof ChronoUnit) {
            ZonedDateTime mo331withZoneSameInstant = from.mo331withZoneSameInstant(this.zone);
            if (temporalUnit.isDateBased()) {
                return this.dateTime.until(mo331withZoneSameInstant.dateTime, temporalUnit);
            }
            return toOffsetDateTime().until(mo331withZoneSameInstant.toOffsetDateTime(), temporalUnit);
        }
