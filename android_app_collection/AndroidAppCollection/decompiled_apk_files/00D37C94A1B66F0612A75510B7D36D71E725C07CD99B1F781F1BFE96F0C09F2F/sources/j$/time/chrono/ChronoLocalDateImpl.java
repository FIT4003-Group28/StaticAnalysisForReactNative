...
public abstract class ChronoLocalDateImpl implements ChronoLocalDate, Temporal, TemporalAdjuster, Serializable {
    ...
    public /* synthetic */ Temporal adjustInto(Temporal temporal) {
        Temporal mo386with;
        mo386with = temporal.mo386with(ChronoField.EPOCH_DAY, toEpochDay());
        return mo386with;
    }

    @Override // j$.time.chrono.ChronoLocalDate
    /* renamed from: atTime */
    public /* synthetic */ ChronoLocalDateTime mo293atTime(LocalTime localTime) {
    ...
    /* renamed from: getEra */
    public abstract /* synthetic */ Era mo380getEra();
    ...
    abstract ChronoLocalDate mo383plusDays(long j);

    /* renamed from: plusMonths */
    abstract ChronoLocalDate mo384plusMonths(long j);

    /* renamed from: plusYears */
    abstract ChronoLocalDate mo385plusYears(long j);
    ...
    public static ChronoLocalDate ensureValid(Chronology chronology, Temporal temporal) {
        ...
        if (chronology.equals(chronoLocalDate.mo379getChronology())) {
            return chronoLocalDate;
        }
        String id = chronology.getId();
        String id2 = chronoLocalDate.mo379getChronology().getId();
    ...
    /* renamed from: with */
    public ChronoLocalDate mo387with(TemporalAdjuster temporalAdjuster) {
        return ChronoLocalDate.CC.$default$with(this, temporalAdjuster);
    }

    @Override // j$.time.chrono.ChronoLocalDate, j$.time.temporal.Temporal
    /* renamed from: with */
    public ChronoLocalDate mo386with(TemporalField temporalField, long j) {
        return ChronoLocalDate.CC.$default$with(this, temporalField, j);
    }

    @Override // j$.time.chrono.ChronoLocalDate, j$.time.temporal.Temporal
    /* renamed from: plus */
    public ChronoLocalDate mo382plus(long j, TemporalUnit temporalUnit) {
        long m;
        long m2;
        long m3;
        long m4;
        if (temporalUnit instanceof ChronoUnit) {
            switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoUnit[((ChronoUnit) temporalUnit).ordinal()]) {
                case 1:
                    return mo383plusDays(j);
                case 2:
                    m = Duration$$ExternalSyntheticBackport11.m(j, 7);
                    return mo383plusDays(m);
                case 3:
                    return mo384plusMonths(j);
                case 4:
                    return mo385plusYears(j);
                case 5:
                    m2 = Duration$$ExternalSyntheticBackport11.m(j, 10);
                    return mo385plusYears(m2);
                case 6:
                    m3 = Duration$$ExternalSyntheticBackport11.m(j, 100);
                    return mo385plusYears(m3);
                case 7:
                    m4 = Duration$$ExternalSyntheticBackport11.m(j, 1000);
                    return mo385plusYears(m4);
                case 8:
                    ChronoField chronoField = ChronoField.ERA;
                    return mo386with((TemporalField) chronoField, Clock$OffsetClock$$ExternalSyntheticBackport0.m(getLong(chronoField), j));
                default:
    ...
    @Override // j$.time.chrono.ChronoLocalDate, j$.time.temporal.Temporal
    /* renamed from: minus */
    public ChronoLocalDate mo381minus(long j, TemporalUnit temporalUnit) {
        ChronoLocalDate ensureValid;
        ensureValid = ensureValid(mo379getChronology(), Temporal.CC.$default$minus(this, j, temporalUnit));
        return ensureValid;
    }
    ...
    public long until(Temporal temporal, TemporalUnit temporalUnit) {
        ...
        ChronoLocalDate mo378date = mo379getChronology().mo378date(temporal);
        if (temporalUnit instanceof ChronoUnit) {
            switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoUnit[((ChronoUnit) temporalUnit).ordinal()]) {
                case 1:
                    return daysUntil(mo378date);
                case 2:
                    return daysUntil(mo378date) / 7;
                case 3:
                    return monthsUntil(mo378date);
                case 4:
                    return monthsUntil(mo378date) / 12;
                case 5:
                    return monthsUntil(mo378date) / 120;
                case 6:
                    return monthsUntil(mo378date) / 1200;
                case 7:
                    return monthsUntil(mo378date) / 12000;
                case 8:
                    ChronoField chronoField = ChronoField.ERA;
                    return mo378date.getLong(chronoField) - getLong(chronoField);
                default:
                    String valueOf = String.valueOf(temporalUnit);
                    StringBuilder sb = new StringBuilder(valueOf.length() + 18);
                    sb.append("Unsupported unit: ");
        ...
        return temporalUnit.between(this, mo378date);
    }
    ...
    private long monthsUntil(ChronoLocalDate chronoLocalDate) {
        if (mo379getChronology().range(ChronoField.MONTH_OF_YEAR).getMaximum() != 12) {
    ...
    public String toString() {
        ...
        sb.append(mo379getChronology().toString());
        sb.append(" ");
        sb.append(mo380getEra());
        sb.append(" ");
        sb.append(j);
        String str = "-0";
        sb.append(j2 < 10 ? str : "-");
