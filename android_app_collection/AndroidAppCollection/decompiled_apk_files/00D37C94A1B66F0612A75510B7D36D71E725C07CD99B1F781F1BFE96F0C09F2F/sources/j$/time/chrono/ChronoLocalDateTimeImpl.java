...
import j$.time.Duration$$ExternalSyntheticBackport11;
...
public final class ChronoLocalDateTimeImpl implements ChronoLocalDateTime, Temporal, TemporalAdjuster, Serializable {
    ...
    public /* synthetic */ Temporal adjustInto(Temporal temporal) {
        Temporal mo386with;
        mo386with = temporal.mo386with(ChronoField.EPOCH_DAY, mo302toLocalDate().toEpochDay()).mo386with(ChronoField.NANO_OF_DAY, toLocalTime().toNanoOfDay());
        return mo386with;
    }
    ...
    public /* synthetic */ Chronology getChronology() {
        ...
        mo379getChronology = mo302toLocalDate().mo379getChronology();
        return mo379getChronology;
    }

    @Override // j$.time.chrono.ChronoLocalDateTime, j$.time.temporal.Temporal
    /* renamed from: minus */
    public /* synthetic */ ChronoLocalDateTime mo381minus(long j, TemporalUnit temporalUnit) {
    ...
    private ChronoLocalDateTimeImpl with(Temporal temporal, LocalTime localTime) {
        ...
        return (chronoLocalDate == temporal && this.time == localTime) ? this : new ChronoLocalDateTimeImpl(ChronoLocalDateImpl.ensureValid(chronoLocalDate.mo379getChronology(), temporal), localTime);
    }

    @Override // j$.time.chrono.ChronoLocalDateTime
    /* renamed from: toLocalDate */
    public ChronoLocalDate mo302toLocalDate() {
        return this.date;
    }
    ...
    /* renamed from: with */
    public ChronoLocalDateTimeImpl mo387with(TemporalAdjuster temporalAdjuster) {
        ...
        if (temporalAdjuster instanceof ChronoLocalDateTimeImpl) {
            return ensureValid(this.date.mo379getChronology(), (ChronoLocalDateTimeImpl) temporalAdjuster);
        }
        return ensureValid(this.date.mo379getChronology(), (ChronoLocalDateTimeImpl) temporalAdjuster.adjustInto(this));
    }

    @Override // j$.time.temporal.Temporal
    /* renamed from: with */
    public ChronoLocalDateTimeImpl mo386with(TemporalField temporalField, long j) {
        if (temporalField instanceof ChronoField) {
            if (((ChronoField) temporalField).isTimeBased()) {
                return with(this.date, this.time.mo386with(temporalField, j));
            }
            return with(this.date.mo386with(temporalField, j), this.time);
        }
        return ensureValid(this.date.mo379getChronology(), temporalField.adjustInto(this, j));
    }

    @Override // j$.time.temporal.Temporal
    /* renamed from: plus */
    public ChronoLocalDateTimeImpl mo382plus(long j, TemporalUnit temporalUnit) {
        if (temporalUnit instanceof ChronoUnit) {
            switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoUnit[((ChronoUnit) temporalUnit).ordinal()]) {
                ...
                default:
                    return with(this.date.mo382plus(j, temporalUnit), this.time);
            }
        }
        return ensureValid(this.date.mo379getChronology(), temporalUnit.addTo(this, j));
    }
    ...
    private ChronoLocalDateTimeImpl plusDays(long j) {
        return with(this.date.mo382plus(j, (TemporalUnit) ChronoUnit.DAYS), this.time);
    }
    ...
    private ChronoLocalDateTimeImpl plusWithOverflow(ChronoLocalDate chronoLocalDate, long j, long j2, long j3, long j4) {
        ...
        long m = (j4 / 86400000000000L) + (j3 / 86400) + (j2 / 1440) + (j / 24) + Duration$$ExternalSyntheticBackport10.m(j5, 86400000000000L);
        long m2 = Clock$TickClock$$ExternalSyntheticBackport0.m(j5, 86400000000000L);
        return with(chronoLocalDate.mo382plus(m, (TemporalUnit) ChronoUnit.DAYS), m2 == nanoOfDay ? this.time : LocalTime.ofNanoOfDay(m2));
    }

    @Override // j$.time.chrono.ChronoLocalDateTime
    /* renamed from: atZone */
    public ChronoZonedDateTime mo299atZone(ZoneId zoneId) {
    ...
    public long until(Temporal temporal, TemporalUnit temporalUnit) {
        ...
        ChronoLocalDateTime mo355localDateTime = getChronology().mo355localDateTime(temporal);
        if (temporalUnit instanceof ChronoUnit) {
            if (temporalUnit.isTimeBased()) {
                ChronoField chronoField = ChronoField.EPOCH_DAY;
                long j = mo355localDateTime.getLong(chronoField) - this.date.getLong(chronoField);
                switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoUnit[((ChronoUnit) temporalUnit).ordinal()]) {
                    case 1:
                        j = Duration$$ExternalSyntheticBackport11.m(j, 86400000000000L);
                        break;
                    case 2:
                        j = Duration$$ExternalSyntheticBackport11.m(j, 86400000000L);
                        break;
                    case 3:
                        j = Duration$$ExternalSyntheticBackport11.m(j, 86400000L);
                        break;
                    case 4:
                        j = Duration$$ExternalSyntheticBackport11.m(j, 86400);
                        break;
                    case 5:
                        j = Duration$$ExternalSyntheticBackport11.m(j, 1440);
                        break;
                    case 6:
                        j = Duration$$ExternalSyntheticBackport11.m(j, 24);
                        break;
                    case 7:
                        j = Duration$$ExternalSyntheticBackport11.m(j, 2);
                        break;
                }
                return Clock$OffsetClock$$ExternalSyntheticBackport0.m(j, this.time.until(mo355localDateTime.toLocalTime(), temporalUnit));
            }
            ChronoLocalDate mo302toLocalDate = mo355localDateTime.mo302toLocalDate();
            if (mo355localDateTime.toLocalTime().isBefore(this.time)) {
                mo302toLocalDate = mo302toLocalDate.mo381minus(1L, (TemporalUnit) ChronoUnit.DAYS);
            }
            return this.date.until(mo302toLocalDate, temporalUnit);
        }
        Objects.requireNonNull(temporalUnit, "unit");
        return temporalUnit.between(this, mo355localDateTime);
    }
    ...
    public static ChronoLocalDateTime readExternal(ObjectInput objectInput) {
        return ((ChronoLocalDate) objectInput.readObject()).mo293atTime((LocalTime) objectInput.readObject());
    }
    ...
    @Override // j$.time.chrono.ChronoLocalDateTime
    public int hashCode() {
        return mo302toLocalDate().hashCode() ^ toLocalTime().hashCode();
    }

    @Override // j$.time.chrono.ChronoLocalDateTime
    public String toString() {
        String chronoLocalDate = mo302toLocalDate().toString();
