...
public interface ChronoZonedDateTime extends Temporal, Comparable {
    ...
    /* renamed from: minus */
    ChronoZonedDateTime mo381minus(long j, TemporalUnit temporalUnit);

    long toEpochSecond();

    /* renamed from: toLocalDate */
    ChronoLocalDate mo327toLocalDate();

    /* renamed from: toLocalDateTime */
    ChronoLocalDateTime mo328toLocalDateTime();

    LocalTime toLocalTime();

    @Override // j$.time.temporal.Temporal
    /* renamed from: with */
    ChronoZonedDateTime mo387with(TemporalAdjuster temporalAdjuster);

    /* renamed from: withZoneSameInstant */
    ChronoZonedDateTime mo331withZoneSameInstant(ZoneId zoneId);

    /* renamed from: withZoneSameLocal */
    ChronoZonedDateTime mo332withZoneSameLocal(ZoneId zoneId);
    ...
    public abstract /* synthetic */ class CC {
        ...
        public static ValueRange $default$range(ChronoZonedDateTime chronoZonedDateTime, TemporalField temporalField) {
            if (temporalField instanceof ChronoField) {
                ...
                return chronoZonedDateTime.mo328toLocalDateTime().range(temporalField);
            }
        ...
        public static int $default$get(ChronoZonedDateTime chronoZonedDateTime, TemporalField temporalField) {
            if (temporalField instanceof ChronoField) {
                ...
                return chronoZonedDateTime.mo328toLocalDateTime().get(temporalField);
            }
        ...
        public static long $default$getLong(ChronoZonedDateTime chronoZonedDateTime, TemporalField temporalField) {
            if (temporalField instanceof ChronoField) {
                ...
                return chronoZonedDateTime.mo328toLocalDateTime().getLong(temporalField);
            }
        ...
        public static Chronology $default$getChronology(ChronoZonedDateTime chronoZonedDateTime) {
            return chronoZonedDateTime.mo327toLocalDate().mo379getChronology();
        }
        ...
        public static Object $default$query(ChronoZonedDateTime chronoZonedDateTime, TemporalQuery temporalQuery) {
            ...
            return temporalQuery.mo404queryFrom(chronoZonedDateTime);
        }

        public static long $default$toEpochSecond(ChronoZonedDateTime chronoZonedDateTime) {
            return ((chronoZonedDateTime.mo327toLocalDate().toEpochDay() * 86400) + chronoZonedDateTime.toLocalTime().toSecondOfDay()) - chronoZonedDateTime.getOffset().getTotalSeconds();
        }
        ...
        public static int $default$compareTo(ChronoZonedDateTime chronoZonedDateTime, ChronoZonedDateTime chronoZonedDateTime2) {
            ...
            if (i == 0) {
                ...
                int compareTo = chronoZonedDateTime.mo328toLocalDateTime().compareTo(chronoZonedDateTime2.mo328toLocalDateTime());
                if (compareTo != 0) {
                    return compareTo;
                }
