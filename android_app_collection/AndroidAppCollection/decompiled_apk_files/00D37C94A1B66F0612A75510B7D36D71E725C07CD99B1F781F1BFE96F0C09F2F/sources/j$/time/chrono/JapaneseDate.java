...
public final class JapaneseDate extends ChronoLocalDateImpl {
    ...
    public JapaneseDate mo386with(TemporalField temporalField, long j) {
        if (temporalField instanceof ChronoField) {
            ChronoField chronoField = (ChronoField) temporalField;
            ...
            if (i == 3 || i == 8 || i == 9) {
                int checkValidIntValue = mo379getChronology().range(chronoField).checkValidIntValue(j, chronoField);
            ...
            return with(this.isoDate.mo386with(temporalField, j));
        }
        return (JapaneseDate) super.mo386with(temporalField, j);
    }

    @Override // j$.time.chrono.ChronoLocalDateImpl, j$.time.temporal.Temporal
    /* renamed from: with */
    public JapaneseDate mo387with(TemporalAdjuster temporalAdjuster) {
        return (JapaneseDate) super.mo387with(temporalAdjuster);
    }
    ...
    private JapaneseDate withYear(int i) {
        return withYear(mo380getEra(), i);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // j$.time.chrono.ChronoLocalDateImpl
    /* renamed from: plusYears  reason: collision with other method in class */
    public JapaneseDate mo385plusYears(long j) {
    ...
    public JapaneseDate mo384plusMonths(long j) {
    ...
    public JapaneseDate mo383plusDays(long j) {
        return with(this.isoDate.plusDays(j));
    }

    @Override // j$.time.chrono.ChronoLocalDateImpl, j$.time.chrono.ChronoLocalDate, j$.time.temporal.Temporal
    /* renamed from: plus  reason: collision with other method in class */
    public JapaneseDate mo382plus(long j, TemporalUnit temporalUnit) {
        return (JapaneseDate) super.mo382plus(j, temporalUnit);
    }

    @Override // j$.time.chrono.ChronoLocalDateImpl, j$.time.chrono.ChronoLocalDate, j$.time.temporal.Temporal
    /* renamed from: minus  reason: collision with other method in class */
    public JapaneseDate mo381minus(long j, TemporalUnit temporalUnit) {
        return (JapaneseDate) super.mo381minus(j, temporalUnit);
    }
