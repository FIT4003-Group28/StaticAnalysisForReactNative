...
public final class MinguoDate extends ChronoLocalDateImpl {
    ...
    */
    public j$.time.chrono.MinguoDate mo386with(j$.time.temporal.TemporalField r8, long r9) {
        /*
            r7 = this;
        ...
        L10:
            ...
            goto L53
        L25:
            j$.time.chrono.MinguoChronology r8 = r7.mo379getChronology()
            j$.time.temporal.ValueRange r8 = r8.range(r0)
            r8.checkValidValue(r9, r0)
            long r0 = r7.getProlepticMonth()
            long r9 = r9 - r0
            j$.time.chrono.MinguoDate r8 = r7.mo384plusMonths(r9)
            return r8
        L3a:
            j$.time.chrono.MinguoChronology r2 = r7.mo379getChronology()
        ...
        L94:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.time.chrono.MinguoDate.mo386with(j$.time.temporal.TemporalField, long):j$.time.chrono.MinguoDate");
    }

    @Override // j$.time.chrono.ChronoLocalDateImpl, j$.time.temporal.Temporal
    /* renamed from: with */
    public MinguoDate mo387with(TemporalAdjuster temporalAdjuster) {
        return (MinguoDate) super.mo387with(temporalAdjuster);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // j$.time.chrono.ChronoLocalDateImpl
    /* renamed from: plusYears  reason: collision with other method in class */
    public MinguoDate mo385plusYears(long j) {
    ...
    public MinguoDate mo384plusMonths(long j) {
    ...
    public MinguoDate mo383plusDays(long j) {
        return with(this.isoDate.plusDays(j));
    }

    @Override // j$.time.chrono.ChronoLocalDateImpl, j$.time.chrono.ChronoLocalDate, j$.time.temporal.Temporal
    /* renamed from: plus  reason: collision with other method in class */
    public MinguoDate mo382plus(long j, TemporalUnit temporalUnit) {
        return (MinguoDate) super.mo382plus(j, temporalUnit);
    }

    @Override // j$.time.chrono.ChronoLocalDateImpl, j$.time.chrono.ChronoLocalDate, j$.time.temporal.Temporal
    /* renamed from: minus  reason: collision with other method in class */
    public MinguoDate mo381minus(long j, TemporalUnit temporalUnit) {
        return (MinguoDate) super.mo381minus(j, temporalUnit);
    }
