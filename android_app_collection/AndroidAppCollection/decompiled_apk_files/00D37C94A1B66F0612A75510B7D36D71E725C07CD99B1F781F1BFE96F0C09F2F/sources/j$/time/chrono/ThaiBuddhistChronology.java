...
public final class ThaiBuddhistChronology extends AbstractChronology implements Serializable {
    ...
    public ThaiBuddhistDate mo378date(TemporalAccessor temporalAccessor) {
    ...
    public ChronoLocalDateTime mo355localDateTime(TemporalAccessor temporalAccessor) {
        return super.mo355localDateTime(temporalAccessor);
    }

    @Override // j$.time.chrono.AbstractChronology, j$.time.chrono.Chronology
    /* renamed from: zonedDateTime */
    public ChronoZonedDateTime mo357zonedDateTime(TemporalAccessor temporalAccessor) {
        return super.mo357zonedDateTime(temporalAccessor);
    }

    @Override // j$.time.chrono.AbstractChronology, j$.time.chrono.Chronology
    /* renamed from: zonedDateTime */
    public ChronoZonedDateTime mo356zonedDateTime(Instant instant, ZoneId zoneId) {
        return super.mo356zonedDateTime(instant, zoneId);
    }
