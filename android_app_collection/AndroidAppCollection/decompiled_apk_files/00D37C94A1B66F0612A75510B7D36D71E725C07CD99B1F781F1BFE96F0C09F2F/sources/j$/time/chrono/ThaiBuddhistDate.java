...
public final class ThaiBuddhistDate extends ChronoLocalDateImpl {
    ...
    */
    public j$.time.chrono.ThaiBuddhistDate mo386with(j$.time.temporal.TemporalField r8, long r9) {
        /*
            r7 = this;
        ...
        L10:
            ...
            goto L53
        L25:
            j$.time.chrono.ThaiBuddhistChronology r8 = r7.mo379getChronology()
            j$.time.temporal.ValueRange r8 = r8.range(r0)
            r8.checkValidValue(r9, r0)
            long r0 = r7.getProlepticMonth()
            long r9 = r9 - r0
            j$.time.chrono.ThaiBuddhistDate r8 = r7.mo384plusMonths(r9)
            return r8
        L3a:
            j$.time.chrono.ThaiBuddhistChronology r2 = r7.mo379getChronology()
        ...
        L53:
            ...
            j$.time.LocalDate r8 = r0.mo386with(r8, r9)
        ...
        L88:
            ...
            return r8
        L93:
            j$.time.chrono.ChronoLocalDate r8 = super.mo386with(r8, r9)
            j$.time.chrono.ThaiBuddhistDate r8 = (j$.time.chrono.ThaiBuddhistDate) r8
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.time.chrono.ThaiBuddhistDate.mo386with(j$.time.temporal.TemporalField, long):j$.time.chrono.ThaiBuddhistDate");
    }

    @Override // j$.time.chrono.ChronoLocalDateImpl, j$.time.temporal.Temporal
    /* renamed from: with */
    public ThaiBuddhistDate mo387with(TemporalAdjuster temporalAdjuster) {
        return (ThaiBuddhistDate) super.mo387with(temporalAdjuster);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // j$.time.chrono.ChronoLocalDateImpl
    /* renamed from: plusYears  reason: collision with other method in class */
    public ThaiBuddhistDate mo385plusYears(long j) {
    ...
    public ThaiBuddhistDate mo384plusMonths(long j) {
    ...
    public ThaiBuddhistDate mo383plusDays(long j) {
        return with(this.isoDate.plusDays(j));
    }

    @Override // j$.time.chrono.ChronoLocalDateImpl, j$.time.chrono.ChronoLocalDate, j$.time.temporal.Temporal
    /* renamed from: plus  reason: collision with other method in class */
    public ThaiBuddhistDate mo382plus(long j, TemporalUnit temporalUnit) {
        return (ThaiBuddhistDate) super.mo382plus(j, temporalUnit);
    }

    @Override // j$.time.chrono.ChronoLocalDateImpl, j$.time.chrono.ChronoLocalDate, j$.time.temporal.Temporal
    /* renamed from: minus  reason: collision with other method in class */
    public ThaiBuddhistDate mo381minus(long j, TemporalUnit temporalUnit) {
        return (ThaiBuddhistDate) super.mo381minus(j, temporalUnit);
    }
    ...
    @Override // j$.time.chrono.ChronoLocalDate
    public int hashCode() {
        return mo379getChronology().getId().hashCode() ^ this.isoDate.hashCode();
    }
