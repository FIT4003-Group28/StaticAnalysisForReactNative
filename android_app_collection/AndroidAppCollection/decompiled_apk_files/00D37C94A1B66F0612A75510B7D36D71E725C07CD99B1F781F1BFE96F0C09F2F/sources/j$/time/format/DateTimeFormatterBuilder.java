...
public final class DateTimeFormatterBuilder {
    ...
    static {
        ...
        new Comparator() { // from class: j$.time.format.DateTimeFormatterBuilder.2
    ...
    private DateTimeFormatterBuilder appendValue(NumberPrinterParser numberPrinterParser) {
        NumberPrinterParser mo388withFixedWidth;
        ...
        if (i >= 0) {
            ...
            if (numberPrinterParser.minWidth == numberPrinterParser.maxWidth && numberPrinterParser.signStyle == SignStyle.NOT_NEGATIVE) {
                mo388withFixedWidth = numberPrinterParser2.mo389withSubsequentWidth(numberPrinterParser.maxWidth);
                appendInternal(numberPrinterParser.mo388withFixedWidth());
                this.active.valueParserIndex = i;
            } else {
                mo388withFixedWidth = numberPrinterParser2.mo388withFixedWidth();
                this.active.valueParserIndex = appendInternal(numberPrinterParser);
            }
            this.active.printerParsers.set(i, mo388withFixedWidth);
        } else {
    ...
    public class NumberPrinterParser implements DateTimePrinterParser {
        ...
        NumberPrinterParser mo389withSubsequentWidth(int i) {
    ...
    final class FractionPrinterParser extends NumberPrinterParser {
        ...
        /* renamed from: withFixedWidth */
        public FractionPrinterParser mo388withFixedWidth() {
        ...
        @Override // j$.time.format.DateTimeFormatterBuilder.NumberPrinterParser
        /* renamed from: withSubsequentWidth */
        public FractionPrinterParser mo389withSubsequentWidth(int i) {
    ...
    final class InstantPrinterParser implements DateTimePrinterParser {
        ...
        public boolean format(DateTimePrintContext dateTimePrintContext, StringBuilder sb) {
            ...
            if (longValue >= -62167219200L) {
                ...
                long m = Duration$$ExternalSyntheticBackport10.m(j, 315569520000L) + 1;
