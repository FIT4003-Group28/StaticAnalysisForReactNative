    ...
    public abstract class Field extends Enum implements TemporalField {
        ...
        final class AnonymousClass1 extends Field {
            ...
            public Temporal adjustInto(Temporal temporal, long j) {
                ...
                return temporal.mo386with(chronoField, temporal.getLong(chronoField) + (j - from));
            }
        }
        ...
        final class AnonymousClass2 extends Field {
            ...
            public Temporal adjustInto(Temporal temporal, long j) {
                ...
                return temporal.mo386with(chronoField, temporal.getLong(chronoField) + ((j - from) * 3));
            }
        }
        ...
        final class AnonymousClass3 extends Field {
            ...
            public Temporal adjustInto(Temporal temporal, long j) {
                range().checkValidValue(j, this);
                return temporal.mo382plus(Instant$$ExternalSyntheticBackport8.m(j, getFrom(temporal)), ChronoUnit.WEEKS);
            }
        }
        ...
        final class AnonymousClass4 extends Field {
            ...
            public Temporal adjustInto(Temporal temporal, long j) {
                ...
                return temporal.mo387with(of.plusDays((i - of.get(chronoField)) + ((week - 1) * 7)));
            }
        }
    ...
    enum Unit implements TemporalUnit {
        ...
        public Temporal addTo(Temporal temporal, long j) {
            ...
            if (i == 1) {
                ...
                return temporal.mo386with(temporalField, Clock$OffsetClock$$ExternalSyntheticBackport0.m(temporal.get(temporalField), j));
            } else if (i == 2) {
                return temporal.mo382plus(j / 4, ChronoUnit.YEARS).mo382plus((j % 4) * 3, ChronoUnit.MONTHS);
            } else {
