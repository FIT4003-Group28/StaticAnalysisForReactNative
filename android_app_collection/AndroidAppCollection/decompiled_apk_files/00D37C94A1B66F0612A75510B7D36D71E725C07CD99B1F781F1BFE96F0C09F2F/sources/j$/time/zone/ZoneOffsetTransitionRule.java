...
public final class ZoneOffsetTransitionRule implements Serializable {
    ...
    ZoneOffsetTransitionRule(Month month, int i, DayOfWeek dayOfWeek, LocalTime localTime, boolean z, TimeDefinition timeDefinition, ZoneOffset zoneOffset, ZoneOffset zoneOffset2, ZoneOffset zoneOffset3) {
        if ($assertionsDisabled || localTime.getNano() == 0) {
            this.month = month;
            this.dom = (byte) i;
            this.dow = dayOfWeek;
            this.time = localTime;
    ...
    public static ZoneOffsetTransitionRule readExternal(DataInput dataInput) {
        ...
        return of(of, i, of2, ofSecondOfDay, i3 == 24 ? $assertionsDisabled : false, timeDefinition, ofTotalSeconds, ZoneOffset.ofTotalSeconds(i5 == 3 ? dataInput.readInt() : ofTotalSeconds.getTotalSeconds() + (i5 * 1800)), ZoneOffset.ofTotalSeconds(i6 == 3 ? dataInput.readInt() : ofTotalSeconds.getTotalSeconds() + (i6 * 1800)));
    }
    ...
    public ZoneOffsetTransition createTransition(int i) {
        ...
        if (b < 0) {
            ...
            DayOfWeek dayOfWeek = this.dow;
            if (dayOfWeek != null) {
                of = of.mo387with(TemporalAdjusters.previousOrSame(dayOfWeek));
            }
        } else {
            of = LocalDate.of(i, this.month, b);
            DayOfWeek dayOfWeek2 = this.dow;
            if (dayOfWeek2 != null) {
                of = of.mo387with(TemporalAdjusters.nextOrSame(dayOfWeek2));
            }
        }
