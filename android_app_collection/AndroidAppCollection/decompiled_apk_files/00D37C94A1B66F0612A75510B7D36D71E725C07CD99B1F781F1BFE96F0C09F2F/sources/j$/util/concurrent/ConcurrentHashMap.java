    ...
    */
    final java.lang.Object replaceNode(java.lang.Object r13, java.lang.Object r14, java.lang.Object r15) {
        ...
        L25:
            r7 = 0
            monitor-enter(r4)
            j$.util.concurrent.ConcurrentHashMap$Node r8 = tabAt(r1, r3)     // Catch: java.lang.Throwable -> Lbc
            r9 = 1
            if (r8 != r4) goto Lae
            if (r5 < 0) goto L6d
            r7 = r2
            r5 = r4
        L32:
            int r8 = r5.hash     // Catch: java.lang.Throwable -> Lbc
            if (r8 != r0) goto L62
            java.lang.Object r8 = r5.key     // Catch: java.lang.Throwable -> Lbc
            if (r8 == r13) goto L42
            if (r8 == 0) goto L62
            boolean r8 = r13.equals(r8)     // Catch: java.lang.Throwable -> Lbc
            if (r8 == 0) goto L62
        L42:
            java.lang.Object r8 = r5.val     // Catch: java.lang.Throwable -> Lbc
            if (r15 == 0) goto L50
            if (r15 == r8) goto L50
            if (r8 == 0) goto L66
            boolean r10 = r15.equals(r8)     // Catch: java.lang.Throwable -> Lbc
            if (r10 == 0) goto L66
        L50:
            if (r14 == 0) goto L55
            r5.val = r14     // Catch: java.lang.Throwable -> Lbc
            goto L67
        L55:
            if (r7 == 0) goto L5c
            j$.util.concurrent.ConcurrentHashMap$Node r3 = r5.next     // Catch: java.lang.Throwable -> Lbc
            r7.next = r3     // Catch: java.lang.Throwable -> Lbc
            goto L67
        L5c:
            j$.util.concurrent.ConcurrentHashMap$Node r5 = r5.next     // Catch: java.lang.Throwable -> Lbc
            setTabAt(r1, r3, r5)     // Catch: java.lang.Throwable -> Lbc
            goto L67
        L62:
            j$.util.concurrent.ConcurrentHashMap$Node r7 = r5.next     // Catch: java.lang.Throwable -> Lbc
            if (r7 != 0) goto L69
        L66:
            r8 = r2
        L67:
        ...
        L69:
            ...
            goto L32
        L6d:
            boolean r5 = r4 instanceof j$.util.concurrent.ConcurrentHashMap.TreeBin     // Catch: java.lang.Throwable -> Lbc
            if (r5 == 0) goto La1
            r5 = r4
            j$.util.concurrent.ConcurrentHashMap$TreeBin r5 = (j$.util.concurrent.ConcurrentHashMap.TreeBin) r5     // Catch: java.lang.Throwable -> Lbc
            j$.util.concurrent.ConcurrentHashMap$TreeNode r7 = r5.root     // Catch: java.lang.Throwable -> Lbc
            if (r7 == 0) goto L66
            j$.util.concurrent.ConcurrentHashMap$TreeNode r7 = r7.findTreeNode(r0, r13, r2)     // Catch: java.lang.Throwable -> Lbc
            if (r7 == 0) goto L66
            java.lang.Object r8 = r7.val     // Catch: java.lang.Throwable -> Lbc
            if (r15 == 0) goto L8c
            if (r15 == r8) goto L8c
            if (r8 == 0) goto L66
            boolean r10 = r15.equals(r8)     // Catch: java.lang.Throwable -> Lbc
        ...
        L8c:
            if (r14 == 0) goto L91
            r7.val = r14     // Catch: java.lang.Throwable -> Lbc
            goto L67
        L91:
            boolean r7 = r5.removeTreeNode(r7)     // Catch: java.lang.Throwable -> Lbc
            if (r7 == 0) goto L67
            j$.util.concurrent.ConcurrentHashMap$TreeNode r5 = r5.first     // Catch: java.lang.Throwable -> Lbc
            j$.util.concurrent.ConcurrentHashMap$Node r5 = untreeify(r5)     // Catch: java.lang.Throwable -> Lbc
            setTabAt(r1, r3, r5)     // Catch: java.lang.Throwable -> Lbc
            goto L67
        La1:
            boolean r3 = r4 instanceof j$.util.concurrent.ConcurrentHashMap.ReservationNode     // Catch: java.lang.Throwable -> Lbc
            if (r3 != 0) goto La6
            goto Lae
        La6:
            ...
            r13.<init>(r14)     // Catch: java.lang.Throwable -> Lbc
    ...
    */
    ...
    public final class TreeBin extends Node {
        ...
        TreeBin(TreeNode treeNode) {
            ...
            this.root = treeNode2;
            if ($assertionsDisabled || checkInvariants(treeNode2)) {
                return;
            }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:51:0x0099, code lost:
            if (j$.util.concurrent.ConcurrentHashMap.TreeBin.$assertionsDisabled != false) goto L26;
         */
        /* JADX WARN: Code restructure failed: missing block: B:53:0x00a1, code lost:
            if (checkInvariants(r12.root) == false) goto L23;
         */
        ...
        */
        final j$.util.concurrent.ConcurrentHashMap.TreeNode putTreeVal(int r13, java.lang.Object r14, java.lang.Object r15) {
            ...
            L89:
                r12.lockRoot()
                j$.util.concurrent.ConcurrentHashMap$TreeNode r13 = r12.root     // Catch: java.lang.Throwable -> Lab
                j$.util.concurrent.ConcurrentHashMap$TreeNode r13 = balanceInsertion(r13, r11)     // Catch: java.lang.Throwable -> Lab
                r12.root = r13     // Catch: java.lang.Throwable -> Lab
                r12.unlockRoot()
            L97:
                boolean r13 = j$.util.concurrent.ConcurrentHashMap.TreeBin.$assertionsDisabled
                if (r13 != 0) goto Laa
                j$.util.concurrent.ConcurrentHashMap$TreeNode r13 = r12.root
                boolean r13 = checkInvariants(r13)
                if (r13 == 0) goto La4
                goto Laa
            La4:
        ...
        /* JADX WARN: Removed duplicated region for block: B:57:0x008d A[Catch: all -> 0x00dc, TryCatch #0 {all -> 0x00dc, blocks: (B:22:0x002f, B:26:0x0038, B:29:0x003e, B:31:0x004c, B:39:0x0064, B:41:0x006a, B:42:0x006c, B:57:0x008d, B:64:0x009e, B:60:0x0095, B:62:0x0099, B:63:0x009c, B:65:0x00a4, B:69:0x00ad, B:71:0x00b1, B:73:0x00b5, B:75:0x00b9, B:79:0x00c2, B:76:0x00bc, B:78:0x00c0, B:68:0x00a9, B:45:0x0076, B:47:0x007a, B:48:0x007d, B:32:0x0051, B:34:0x0057, B:36:0x005b, B:37:0x005e, B:38:0x0060), top: B:93:0x002f }] */
        /* JADX WARN: Removed duplicated region for block: B:67:0x00a8  */
        /* JADX WARN: Removed duplicated region for block: B:68:0x00a9 A[Catch: all -> 0x00dc, TryCatch #0 {all -> 0x00dc, blocks: (B:22:0x002f, B:26:0x0038, B:29:0x003e, B:31:0x004c, B:39:0x0064, B:41:0x006a, B:42:0x006c, B:57:0x008d, B:64:0x009e, B:60:0x0095, B:62:0x0099, B:63:0x009c, B:65:0x00a4, B:69:0x00ad, B:71:0x00b1, B:73:0x00b5, B:75:0x00b9, B:79:0x00c2, B:76:0x00bc, B:78:0x00c0, B:68:0x00a9, B:45:0x0076, B:47:0x007a, B:48:0x007d, B:32:0x0051, B:34:0x0057, B:36:0x005b, B:37:0x005e, B:38:0x0060), top: B:93:0x002f }] */
        /* JADX WARN: Removed duplicated region for block: B:71:0x00b1 A[Catch: all -> 0x00dc, TryCatch #0 {all -> 0x00dc, blocks: (B:22:0x002f, B:26:0x0038, B:29:0x003e, B:31:0x004c, B:39:0x0064, B:41:0x006a, B:42:0x006c, B:57:0x008d, B:64:0x009e, B:60:0x0095, B:62:0x0099, B:63:0x009c, B:65:0x00a4, B:69:0x00ad, B:71:0x00b1, B:73:0x00b5, B:75:0x00b9, B:79:0x00c2, B:76:0x00bc, B:78:0x00c0, B:68:0x00a9, B:45:0x0076, B:47:0x007a, B:48:0x007d, B:32:0x0051, B:34:0x0057, B:36:0x005b, B:37:0x005e, B:38:0x0060), top: B:93:0x002f }] */
        /* JADX WARN: Removed duplicated region for block: B:75:0x00b9 A[Catch: all -> 0x00dc, TryCatch #0 {all -> 0x00dc, blocks: (B:22:0x002f, B:26:0x0038, B:29:0x003e, B:31:0x004c, B:39:0x0064, B:41:0x006a, B:42:0x006c, B:57:0x008d, B:64:0x009e, B:60:0x0095, B:62:0x0099, B:63:0x009c, B:65:0x00a4, B:69:0x00ad, B:71:0x00b1, B:73:0x00b5, B:75:0x00b9, B:79:0x00c2, B:76:0x00bc, B:78:0x00c0, B:68:0x00a9, B:45:0x0076, B:47:0x007a, B:48:0x007d, B:32:0x0051, B:34:0x0057, B:36:0x005b, B:37:0x005e, B:38:0x0060), top: B:93:0x002f }] */
        /* JADX WARN: Removed duplicated region for block: B:76:0x00bc A[Catch: all -> 0x00dc, TryCatch #0 {all -> 0x00dc, blocks: (B:22:0x002f, B:26:0x0038, B:29:0x003e, B:31:0x004c, B:39:0x0064, B:41:0x006a, B:42:0x006c, B:57:0x008d, B:64:0x009e, B:60:0x0095, B:62:0x0099, B:63:0x009c, B:65:0x00a4, B:69:0x00ad, B:71:0x00b1, B:73:0x00b5, B:75:0x00b9, B:79:0x00c2, B:76:0x00bc, B:78:0x00c0, B:68:0x00a9, B:45:0x0076, B:47:0x007a, B:48:0x007d, B:32:0x0051, B:34:0x0057, B:36:0x005b, B:37:0x005e, B:38:0x0060), top: B:93:0x002f }] */
        /* JADX WARN: Removed duplicated region for block: B:82:0x00cb  */
        /* JADX WARN: Removed duplicated region for block: B:87:0x00da A[ADDED_TO_REGION, ORIG_RETURN, RETURN] */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct add '--show-bad-code' argument
        */
    ...
    final class EntryIterator extends BaseIterator implements java.util.Iterator, j$.util.Iterator {
        ...
        public final Map.Entry mo416next() {
            Node node = this.next;
            if (node == null) {
                throw new NoSuchElementException();
            }
    ...
    final class KeySpliterator extends Traverser implements Spliterator {
        ...
        public KeySpliterator mo545trySplit() {
    ...
    final class ValueSpliterator extends Traverser implements Spliterator {
        ...
        @Override // j$.util.Spliterator
        /* renamed from: trySplit  reason: collision with other method in class */
        public ValueSpliterator mo545trySplit() {
            int i = this.baseIndex;
            int i2 = this.baseLimit;
            int i3 = (i + i2) >>> 1;
            if (i3 <= i) {
    ...
    final class EntrySpliterator extends Traverser implements Spliterator {
        ...
        @Override // j$.util.Spliterator
        /* renamed from: trySplit  reason: collision with other method in class */
        public EntrySpliterator mo545trySplit() {
            int i = this.baseIndex;
            int i2 = this.baseLimit;
            int i3 = (i + i2) >>> 1;
            if (i3 <= i) {
