...
abstract class AbstractShortCircuitTask extends AbstractTask {
    ...
    protected abstract Object mo522getEmptyResult();
    ...
    */
    public void compute() {
        ...
        Le:
            ...
            if (r8 == 0) goto L1f
            java.lang.Object r8 = r7.mo522getEmptyResult()
            goto L53
        L1f:
            int r8 = (r1 > r3 ? 1 : (r1 == r3 ? 0 : -1))
            if (r8 <= 0) goto L4f
            j$.util.Spliterator r1 = r0.mo545trySplit()
            if (r1 != 0) goto L2a
            goto L4f
        L2a:
            j$.util.stream.AbstractTask r2 = r7.mo523makeChild(r1)
            j$.util.stream.AbstractShortCircuitTask r2 = (j$.util.stream.AbstractShortCircuitTask) r2
            r7.leftChild = r2
            j$.util.stream.AbstractTask r8 = r7.mo523makeChild(r0)
        ...
        L45:
            ...
            goto Le
        L4f:
            java.lang.Object r8 = r7.mo521doLeaf()
        L53:
    ...
    public Object getLocalResult() {
        if (isRoot()) {
            ...
            return obj == null ? mo522getEmptyResult() : obj;
        }
