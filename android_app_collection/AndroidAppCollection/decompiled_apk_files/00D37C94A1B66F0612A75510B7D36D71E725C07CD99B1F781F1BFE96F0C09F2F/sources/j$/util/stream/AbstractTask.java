...
abstract class AbstractTask extends CountedCompleter {
    ...
    /* renamed from: doLeaf */
    public abstract Object mo521doLeaf();

    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: makeChild */
    public abstract AbstractTask mo523makeChild(Spliterator spliterator);
    ...
    public void compute() {
        ...
        while (estimateSize > targetSize && (mo545trySplit = spliterator.mo545trySplit()) != null) {
            AbstractTask mo523makeChild = abstractTask.mo523makeChild(mo545trySplit);
            abstractTask.leftChild = mo523makeChild;
            AbstractTask mo523makeChild2 = abstractTask.mo523makeChild(spliterator);
            abstractTask.rightChild = mo523makeChild2;
            abstractTask.setPendingCount(1);
            if (z) {
                spliterator = mo545trySplit;
                abstractTask = mo523makeChild;
                mo523makeChild = mo523makeChild2;
            } else {
                abstractTask = mo523makeChild2;
            }
            z = !z;
            mo523makeChild.fork();
            estimateSize = spliterator.estimateSize();
        }
        abstractTask.setLocalResult(abstractTask.mo521doLeaf());
