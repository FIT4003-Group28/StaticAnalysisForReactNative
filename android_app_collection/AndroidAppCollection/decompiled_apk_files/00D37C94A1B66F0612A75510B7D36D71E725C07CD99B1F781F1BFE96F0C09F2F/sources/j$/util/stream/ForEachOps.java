...
abstract class ForEachOps {
    ...
    abstract class ForEachOp implements TerminalOp, TerminalSink {
        ...
        public Void mo512evaluateSequential(PipelineHelper pipelineHelper, Spliterator spliterator) {
            return ((ForEachOp) pipelineHelper.wrapAndCopyInto(this, spliterator)).mo515get();
        }

        @Override // j$.util.stream.TerminalOp
        /* renamed from: evaluateParallel  reason: collision with other method in class */
        public Void mo511evaluateParallel(PipelineHelper pipelineHelper, Spliterator spliterator) {
            if (this.ordered) {
        ...
        public void compute() {
            ...
            while (true) {
                if (isKnown && sink.cancellationRequested()) {
                    break;
                } else if (estimateSize <= j || (mo545trySplit = spliterator.mo545trySplit()) == null) {
                    break;
                } else {
                    ForEachTask forEachTask2 = new ForEachTask(forEachTask, mo545trySplit);
    ...
    public final class ForEachOrderedTask extends CountedCompleter {
        ...
        private static void doCompute(ForEachOrderedTask forEachOrderedTask) {
            ...
            boolean z = false;
            while (spliterator.estimateSize() > j && (mo545trySplit = spliterator.mo545trySplit()) != null) {
                ForEachOrderedTask forEachOrderedTask2 = new ForEachOrderedTask(forEachOrderedTask, mo545trySplit, forEachOrderedTask.leftPredecessor);
            ...
            if (forEachOrderedTask.getPendingCount() > 0) {
                ...
                forEachOrderedTask.node = ((Node.Builder) forEachOrderedTask.helper.wrapAndCopyInto(pipelineHelper.makeNodeBuilder(pipelineHelper.exactOutputSizeIfKnown(spliterator), forEachOps$ForEachOrderedTask$$ExternalSyntheticLambda0), spliterator)).mo498build();
