...
abstract class MatchOps {
    ...
    public final class MatchOp implements TerminalOp {
        ...
        public Boolean mo512evaluateSequential(PipelineHelper pipelineHelper, Spliterator spliterator) {
            return Boolean.valueOf(((BooleanTerminalSink) pipelineHelper.wrapAndCopyInto((BooleanTerminalSink) this.sinkSupplier.mo515get(), spliterator)).getAndClearState());
        }

        @Override // j$.util.stream.TerminalOp
        /* renamed from: evaluateParallel */
        public Boolean mo511evaluateParallel(PipelineHelper pipelineHelper, Spliterator spliterator) {
    ...
    public final class MatchTask extends AbstractShortCircuitTask {
        ...
        public MatchTask mo523makeChild(Spliterator spliterator) {
        ...
        @Override // j$.util.stream.AbstractTask
        /* renamed from: doLeaf */
        public Boolean mo521doLeaf() {
            boolean andClearState = ((BooleanTerminalSink) this.helper.wrapAndCopyInto((BooleanTerminalSink) this.op.sinkSupplier.mo515get(), this.spliterator)).getAndClearState();
        ...
        public Boolean mo522getEmptyResult() {
