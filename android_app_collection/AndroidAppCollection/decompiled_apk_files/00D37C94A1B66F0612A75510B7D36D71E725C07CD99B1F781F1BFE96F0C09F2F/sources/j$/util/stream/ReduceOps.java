...
abstract class ReduceOps {
    ...
    public static TerminalOp makeRef(final BinaryOperator binaryOperator) {
        ...
        return new ReduceOp(StreamShape.REFERENCE) { // from class: j$.util.stream.ReduceOps.2
            ...
            public C2ReducingSink mo513makeSink() {
    ...
    public static TerminalOp makeRef(final Collector collector) {
        ...
        return new ReduceOp(StreamShape.REFERENCE) { // from class: j$.util.stream.ReduceOps.3
            @Override // j$.util.stream.ReduceOps.ReduceOp
            /* renamed from: makeSink */
            public C3ReducingSink mo513makeSink() {
    ...
    public class C3ReducingSink extends Box implements AccumulatingSink {
        ...
        @Override // j$.util.stream.Sink
        public void begin(long j) {
            this.state = this.val$supplier.mo515get();
        }
    ...
    public static TerminalOp makeRefCounting() {
        return new ReduceOp(StreamShape.REFERENCE) { // from class: j$.util.stream.ReduceOps.5
            ...
            public CountingSink mo513makeSink() {
                return new CountingSink.OfRef();
            }

            @Override // j$.util.stream.ReduceOps.ReduceOp, j$.util.stream.TerminalOp
            /* renamed from: evaluateSequential */
            public Long mo512evaluateSequential(PipelineHelper pipelineHelper, Spliterator spliterator) {
                if (StreamOpFlag.SIZED.isKnown(pipelineHelper.getStreamAndOpFlags())) {
                    return Long.valueOf(spliterator.getExactSizeIfKnown());
                }
                return (Long) super.mo512evaluateSequential(pipelineHelper, spliterator);
            }

            @Override // j$.util.stream.ReduceOps.ReduceOp, j$.util.stream.TerminalOp
            /* renamed from: evaluateParallel */
            public Long mo511evaluateParallel(PipelineHelper pipelineHelper, Spliterator spliterator) {
                if (StreamOpFlag.SIZED.isKnown(pipelineHelper.getStreamAndOpFlags())) {
                    return Long.valueOf(spliterator.getExactSizeIfKnown());
                }
                return (Long) super.mo511evaluateParallel(pipelineHelper, spliterator);
            }
    ...
    public static TerminalOp makeLong(final long j, final LongBinaryOperator longBinaryOperator) {
        ...
        return new ReduceOp(StreamShape.LONG_VALUE) { // from class: j$.util.stream.ReduceOps.10
            @Override // j$.util.stream.ReduceOps.ReduceOp
            /* renamed from: makeSink */
            public C8ReducingSink mo513makeSink() {
    ...
    public abstract class ReduceOp implements TerminalOp {
        ...
        /* renamed from: makeSink */
        public abstract AccumulatingSink mo513makeSink();
        ...
        public Object mo512evaluateSequential(PipelineHelper pipelineHelper, Spliterator spliterator) {
            return ((AccumulatingSink) pipelineHelper.wrapAndCopyInto(mo513makeSink(), spliterator)).mo515get();
        }

        @Override // j$.util.stream.TerminalOp
        /* renamed from: evaluateParallel */
        public Object mo511evaluateParallel(PipelineHelper pipelineHelper, Spliterator spliterator) {
            return ((AccumulatingSink) new ReduceTask(this, pipelineHelper, spliterator).invoke()).mo515get();
        }
    }
    ...
    public final class ReduceTask extends AbstractTask {
        ...
        public ReduceTask mo523makeChild(Spliterator spliterator) {
        ...
        @Override // j$.util.stream.AbstractTask
        /* renamed from: doLeaf */
        public AccumulatingSink mo521doLeaf() {
            return (AccumulatingSink) this.helper.wrapAndCopyInto(this.op.mo513makeSink(), this.spliterator);
        }
