...
public abstract class StreamSpliterators$AbstractWrappingSpliterator implements Spliterator {
    ...
    /* renamed from: wrap */
    abstract StreamSpliterators$AbstractWrappingSpliterator mo544wrap(Spliterator spliterator);
    ...
    public final void init() {
        if (this.spliterator == null) {
            this.spliterator = (Spliterator) this.spliteratorSupplier.mo515get();
            this.spliteratorSupplier = null;
        }
    }
    ...
    public Spliterator mo545trySplit() {
        ...
        init();
        Spliterator mo545trySplit = this.spliterator.mo545trySplit();
        if (mo545trySplit != null) {
            return mo544wrap(mo545trySplit);
        }
        return null;
    }
