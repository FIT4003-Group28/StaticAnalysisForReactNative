...
public abstract class StreamSpliterators$SliceSpliterator {
    ...
    public Spliterator trySplit() {
        ...
        if (j < j2 && this.index < j2) {
            while (true) {
                Spliterator mo545trySplit = this.s.mo545trySplit();
                if (mo545trySplit == null) {
                    return null;
                }
                long estimateSize = this.index + mo545trySplit.estimateSize();
                ...
                if (j3 >= min) {
                    ...
                    if (min >= j4) {
                        this.s = mo545trySplit;
                        this.fence = min;
                    } else {
                        long j5 = this.index;
                        if (j5 >= j3 && estimateSize <= j4) {
                            this.index = min;
                            return mo545trySplit;
                        }
                        this.index = min;
                        return makeSpliterator(mo545trySplit, j3, j4, j5, min);
                    }
                }
            }
        } else {
    ...
    abstract class OfPrimitive extends StreamSpliterators$SliceSpliterator implements Spliterator.OfPrimitive {
        ...
        protected abstract Object mo543emptyConsumer();
        ...
        public boolean tryAdvance(Object obj) {
            ...
            while (true) {
                ...
                ((Spliterator.OfPrimitive) this.s).tryAdvance(mo543emptyConsumer());
                this.index++;
            }
            if (j >= this.fence) {
                return false;
    ...
    final class OfInt extends OfPrimitive implements Spliterator.OfInt {
        ...
        /* renamed from: emptyConsumer */
        public IntConsumer mo543emptyConsumer() {
    ...
    final class OfLong extends OfPrimitive implements Spliterator.OfLong {
        ...
        @Override // j$.util.stream.StreamSpliterators$SliceSpliterator.OfPrimitive
        /* renamed from: emptyConsumer */
        public LongConsumer mo543emptyConsumer() {
    ...
    final class OfDouble extends OfPrimitive implements Spliterator.OfDouble {
        ...
        @Override // j$.util.stream.StreamSpliterators$SliceSpliterator.OfPrimitive
        /* renamed from: emptyConsumer */
        public DoubleConsumer mo543emptyConsumer() {
