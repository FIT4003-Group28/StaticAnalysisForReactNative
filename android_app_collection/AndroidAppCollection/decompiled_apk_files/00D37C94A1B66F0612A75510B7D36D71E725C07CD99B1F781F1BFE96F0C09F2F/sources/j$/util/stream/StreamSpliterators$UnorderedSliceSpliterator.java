...
abstract class StreamSpliterators$UnorderedSliceSpliterator {
    ...
    StreamSpliterators$UnorderedSliceSpliterator(Spliterator spliterator, long j, long j2) {
        this.s = spliterator;
        this.unlimited = j2 < 0 ? $assertionsDisabled : false;
    ...
    public final Spliterator trySplit() {
        ...
        if (this.permits.get() == 0 || (mo545trySplit = this.s.mo545trySplit()) == null) {
            return null;
        }
        return makeSpliterator(mo545trySplit);
    }
        ...
        public boolean tryAdvance(Consumer consumer) {
            ...
            while (permitStatus() != PermitStatus.NO_MORE && this.s.tryAdvance(this)) {
                if (acquirePermits(1L) == 1) {
                    ...
                    this.tmpSlot = null;
                    return StreamSpliterators$UnorderedSliceSpliterator.$assertionsDisabled;
                }
            }
            return false;
        }
