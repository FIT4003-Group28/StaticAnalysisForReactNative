...
abstract class Streams {
    ...
    /* loaded from: classes5.dex */
    final class StreamBuilderImpl extends AbstractStreamBuilderImpl implements Consumer {
        SpinedBuffer buffer;
        Object first;
    ...
    abstract class ConcatSpliterator implements Spliterator {
        ...
        /* renamed from: trySplit */
        public Spliterator mo545trySplit() {
            Spliterator mo545trySplit = this.beforeSplit ? this.aSpliterator : this.bSpliterator.mo545trySplit();
