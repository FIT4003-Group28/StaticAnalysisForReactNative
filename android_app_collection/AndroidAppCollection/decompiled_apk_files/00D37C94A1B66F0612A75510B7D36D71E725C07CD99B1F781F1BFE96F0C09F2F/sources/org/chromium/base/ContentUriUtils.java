...
public abstract class ContentUriUtils {
    ...
    private static AssetFileDescriptor a(String str) {
        ContentResolver contentResolver = babj.c.getContentResolver();
        ...
        try {
            ...
            bacc.f("ContentUriUtils", "Cannot open content uri: %s", str, e);
        }
        return null;
    }
    ...
    private static boolean c(Uri uri) {
        if (uri != null && DocumentsContract.isDocumentUri(babj.c, uri)) {
            try {
                Cursor query = babj.c.getContentResolver().query(uri, null, null, null, null);
    ...
    public static boolean delete(String str) {
        return babj.c.getContentResolver().delete(Uri.parse(str), null, null) > 0;
    }
    ...
    public static String getContentUriFromFilePath(String str) {
        try {
            ...
            bacc.d("ContentUriUtils", "Cannot retrieve content uri from file: %s", str, e);
            return null;
        }
    }
    ...
    */
    public static java.lang.String maybeGetDisplayName(java.lang.String r12) {
        /*
            ...
            r7 = 0
            r8 = 0
            android.content.Context r0 = defpackage.babj.c     // Catch: java.lang.Exception -> L7d
