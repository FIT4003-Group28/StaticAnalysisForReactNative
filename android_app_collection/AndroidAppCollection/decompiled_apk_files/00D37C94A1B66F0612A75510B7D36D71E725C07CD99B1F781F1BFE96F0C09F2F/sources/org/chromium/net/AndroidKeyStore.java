...
public class AndroidKeyStore {
    ...
    private static byte[] encryptWithPrivateKey(PrivateKey privateKey, String str, byte[] bArr) {
        try {
            ...
            try {
                ...
                bacc.d(TAG, "Exception while encrypting input with " + str + " and " + privateKey.getAlgorithm() + " private key (" + privateKey.getClass().getName() + "): " + e, new Object[0]);
                return null;
            }
        } catch (NoSuchAlgorithmException | NoSuchPaddingException e2) {
            bacc.d(TAG, "Cipher " + str + " not supported: " + e2, new Object[0]);
            return null;
        }
    }
    ...
    private static boolean privateKeySupportsCipher(PrivateKey privateKey, String str) {
        try {
            ...
            bacc.d(TAG, "Exception while checking support for " + str + ": " + e, new Object[0]);
            return false;
        }
    }
    ...
    private static byte[] signWithPrivateKey(PrivateKey privateKey, String str, byte[] bArr) {
        try {
            ...
            try {
                ...
                bacc.d(TAG, "Exception while signing message with " + str + " and " + privateKey.getAlgorithm() + " private key (" + privateKey.getClass().getName() + "): " + e, new Object[0]);
                return null;
            }
        } catch (NoSuchAlgorithmException e2) {
            bacc.d(TAG, "Signature algorithm " + str + " not supported: " + e2, new Object[0]);
            return null;
        }
    }
}
