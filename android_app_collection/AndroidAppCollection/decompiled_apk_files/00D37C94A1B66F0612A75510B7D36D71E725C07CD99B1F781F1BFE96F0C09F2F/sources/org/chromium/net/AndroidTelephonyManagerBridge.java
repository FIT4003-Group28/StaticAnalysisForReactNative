...
public class AndroidTelephonyManagerBridge {
    ...
    public static TelephonyManager getTelephonyManager() {
        return (TelephonyManager) babj.c.getSystemService("phone");
    }
    ...
    private void listenTelephonyServiceState(TelephonyManager telephonyManager) {
        bacy bacyVar = new bacy(this);
        this.mListener = bacyVar;
        telephonyManager.listen(bacyVar, 1);
    }
