...
public class NetworkChangeNotifier {
    ...
    private final bacf mConnectionTypeObservers = new bacf();
    ...
    private void setAutoDetectConnectivityStateInternal(boolean z, NetworkChangeNotifierAutoDetect.RegistrationPolicy registrationPolicy) {
        if (!z) {
            ...
            NetworkChangeNotifierAutoDetect networkChangeNotifierAutoDetect = new NetworkChangeNotifierAutoDetect(new badd(this), registrationPolicy);
