...
public class CronetBidirectionalStream extends ExperimentalBidirectionalStream {
    ...
    private final void g(boolean z) {
        ...
        bacc.e(str, "destroyNativeStreamLocked " + toString(), new Object[0]);
        long j = this.x;
        if (j == 0) {
            return;
        }
    ...
    private final void h(CronetException cronetException) {
        i(new baef(this, cronetException));
    }
    ...
    private void onError(int i, int i2, int i3, String str, long j) {
        ...
        if (i == 10 || i == 3) {
            h(new bagk("Exception in BidirectionalStream: " + str, i, i2, i3));
            return;
        }
        h(new baea("Exception in BidirectionalStream: " + str, i, i2));
    }

    private void onMetricsCollected(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, boolean z, long j14, long j15) {
        synchronized (this.c) {
            if (this.w == null) {
                this.w = new baen(j, j2, j3, j4, j5, j6, j7, j8, j9, j10, j11, j12, j13, z, j14, j15);
                int i = this.e;
                this.h.f(new bagl(this.j, this.n, this.w, i == 7 ? 0 : i == 5 ? 2 : 1, this.g, this.s));
            } else {
    ...
    private void onReadCompleted(ByteBuffer byteBuffer, int i, int i2, int i3, long j) {
        ...
        if (byteBuffer.position() != i2 || byteBuffer.limit() != i3) {
            h(new baem("ByteBuffer modified externally during read", null));
        } else if (i < 0 || (i4 = i2 + i) > i3) {
            h(new baem("Invalid number of bytes read", null));
        } else {
            byteBuffer.position(i4);
            baeg baegVar = this.y;
            baegVar.a = byteBuffer;
            baegVar.b = i == 0;
            i(baegVar);
        }
    }
    ...
    private void onResponseHeadersReceived(int i, String str, String[] strArr, long j) {
        try {
            this.g = new bagp(Arrays.asList(this.j), i, "", f(strArr), false, str, null, j);
            i(new baee(this, 1));
        } catch (Exception unused) {
            h(new baem("Cannot prepare ResponseInfo", null));
        }
    }

    private void onResponseTrailersReceived(String[] strArr) {
        i(new baed(this, new bago(f(strArr))));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:27:0x004e, code lost:
        h(new defpackage.baem("ByteBuffer modified externally during write", null));
     */
    ...
    */
    ...
    public final void a(CronetException cronetException) {
        ...
        synchronized (this.c) {
            ...
            try {
                ...
                bacc.d(CronetUrlRequestContext.b, "Exception notifying of failed request", e);
            }
        }
    }
        ...
        synchronized (this.c) {
            ...
            if (this.f == 10 && this.e == 4) {
                ...
                try {
                    ...
                    bacc.d(CronetUrlRequestContext.b, "Exception in onSucceeded method", e);
                }
            }
        }
    }
    ...
    public final void c(Exception exc) {
        baeb baebVar = new baeb("CalledByNative method has thrown an exception", exc);
        ...
        synchronized (this.c) {
            if (this.e == 0) {
                try {
                    ...
                    this.h.e();
                    int McDUim_I = N.McDUim_I(this.x, this, this.j, this.k, this.b, this.l, !d(str));
                    if (McDUim_I == -1) {
