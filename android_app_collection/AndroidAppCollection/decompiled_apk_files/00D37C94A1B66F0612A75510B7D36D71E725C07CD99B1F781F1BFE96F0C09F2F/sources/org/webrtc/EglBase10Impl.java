...
public class EglBase10Impl implements bams {
    ...
    public final void d(Surface surface) {
        bamo bamoVar = new bamo(surface);
        l();
        if (this.i != EGL10.EGL_NO_SURFACE) {
            throw new RuntimeException("Already has an EGLSurface");
        }
        EGLSurface eglCreateWindowSurface = this.a.eglCreateWindowSurface(this.h, this.g, bamoVar, new int[]{12344});
