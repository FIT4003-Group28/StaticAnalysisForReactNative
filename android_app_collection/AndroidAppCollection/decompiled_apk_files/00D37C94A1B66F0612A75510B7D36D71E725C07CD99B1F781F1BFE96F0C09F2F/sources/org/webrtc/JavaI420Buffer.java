...
public class JavaI420Buffer implements VideoFrame.I420Buffer {
    ...
    public static JavaI420Buffer a(int i, int i2) {
        ...
        return new JavaI420Buffer(i, i2, slice, i, slice2, i4, nativeAllocateByteBuffer.slice(), i4, new bapk(nativeAllocateByteBuffer, 1));
    }
    ...
    public static VideoFrame.Buffer c(final VideoFrame.I420Buffer i420Buffer, int i, int i2, int i3, int i4, int i5, int i6) {
        if (i3 == i5 && i4 == i6) {
            ...
            i420Buffer.getClass();
            return b(i5, i6, slice, strideY, slice2, strideU, slice3, strideV, new Runnable() { // from class: banj
