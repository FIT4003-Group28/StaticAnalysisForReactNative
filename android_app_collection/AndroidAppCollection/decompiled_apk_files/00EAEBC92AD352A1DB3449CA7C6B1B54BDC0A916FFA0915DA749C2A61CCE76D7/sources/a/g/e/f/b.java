...
public final class b {
    ...
    private final Shader f181a;

    /* renamed from: b  reason: collision with root package name */
    private final ColorStateList f182b;
    ...
    public boolean a(int[] iArr) {
        if (d()) {
            ...
            if (colorForState != this.f183c) {
                this.f183c = colorForState;
                return true;
            }
        }
        return false;
    ...
    public boolean d() {
        ...
        return this.f181a == null && (colorStateList = this.f182b) != null && colorStateList.isStateful();
    }

    public boolean e() {
        return c() || this.f183c != 0;
    }
}
