...
public class i0 extends ViewGroup {
    ...
    public static class a extends ViewGroup.MarginLayoutParams {
        ...
        public a(Context context, AttributeSet attributeSet) {
            ...
            this.f1280a = obtainStyledAttributes.getFloat(a.a.j.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.f1281b = obtainStyledAttributes.getInt(a.a.j.LinearLayoutCompat_Layout_android_layout_gravity, -1);
    ...
    public i0(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f1275d = 0;
        this.f1277f = 8388659;
        x0 a2 = x0.a(context, attributeSet, a.a.j.LinearLayoutCompat, i, 0);
        ...
        this.f1279h = a2.b(a.a.j.LinearLayoutCompat_android_weightSum, -1.0f);
        this.f1274c = a2.d(a.a.j.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
    ...
    */
    void b(int r18, int r19, int r20, int r21) {
        ...
        L59:
            ...
            r1 = r11
        L75:
            int r2 = a.g.m.v.p(r17)
            int r1 = a.g.m.d.a(r1, r2)
            r1 = r1 & 7
            if (r1 == r14) goto L8c
            r2 = 5
            if (r1 == r2) goto L89
    ...
    public a mo45generateDefaultLayoutParams() {
        int i = this.f1276e;
        if (i == 0) {
            return new a(-2, -2);
        }
    ...
    public a mo46generateLayoutParams(AttributeSet attributeSet) {
    ...
    @Override // android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public a mo47generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
    ...
    public int getBaseline() {
        ...
        int i3 = this.f1275d;
        if (this.f1276e == 1 && (i = this.f1277f & 112) != 48) {
            if (i == 16) {
                i3 += ((((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom()) - this.f1278g) / 2;
            } else if (i == 80) {
                i3 = ((getBottom() - getTop()) - getPaddingBottom()) - this.f1278g;
            }
        }
    ...
    public void setVerticalGravity(int i) {
        ...
        int i3 = this.f1277f;
        if ((i3 & 112) != i2) {
            this.f1277f = i2 | (i3 & (-113));
            requestLayout();
        }
    }

    public void setWeightSum(float f2) {
        this.f1279h = Math.max(0.0f, f2);
    }
