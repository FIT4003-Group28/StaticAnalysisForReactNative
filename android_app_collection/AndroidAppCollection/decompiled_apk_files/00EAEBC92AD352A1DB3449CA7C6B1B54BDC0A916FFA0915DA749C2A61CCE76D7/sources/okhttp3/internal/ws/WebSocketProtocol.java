...
public final class WebSocketProtocol {
    ...
    public static String acceptHeader(String str) {
        return f.d(str + ACCEPT_MAGIC).e().a();
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void toggleMask(c.C0204c c0204c, byte[] bArr) {
        int length = bArr.length;
        int i = 0;
        do {
            byte[] bArr2 = c0204c.f10141f;
            int i2 = c0204c.f10142g;
            int i3 = c0204c.f10143h;
            while (i2 < i3) {
                int i4 = i % length;
