...
class EnabledSessionAnalyticsManagerStrategy implements SessionAnalyticsManagerStrategy {
    ...
    public void setAnalyticsSettingsData(b bVar, String str) {
        this.filesSender = AnswersRetryFilesSender.build(new SessionAnalyticsFilesSender(this.kit, str, bVar.f1194a, this.httpRequestFactory, this.apiKey.a(this.context)));
    ...
    public void processEvent(SessionEvent.Builder builder) {
        ...
        if (!this.customEventsEnabled && SessionEvent.Type.CUSTOM.equals(build.type)) {
            l h = c.h();
            h.a(Answers.TAG, "Custom events tracking disabled - skipping event: " + build);
        } else if (!this.predefinedEventsEnabled && SessionEvent.Type.PREDEFINED.equals(build.type)) {
            l h2 = c.h();
            h2.a(Answers.TAG, "Predefined events tracking disabled - skipping event: " + build);
        } else if (this.eventFilter.skipEvent(build)) {
            l h3 = c.h();
            h3.a(Answers.TAG, "Skipping filtered event: " + build);
        } else {
            try {
                this.filesManager.writeEvent(build);
            } catch (IOException e) {
                l h4 = c.h();
                h4.e(Answers.TAG, "Failed to write event: " + build, e);
            }
            ...
            try {
                ...
                l h5 = c.h();
                h5.e(Answers.TAG, "Failed to map event to Firebase: " + build, e2);
            }
        }
    }
    ...
    public void sendEvents() {
        if (this.filesSender == null) {
            b.a.a.a.a.b.i.a(this.context, "skipping files send because we don't yet know the target endpoint");
            return;
        }
        b.a.a.a.a.b.i.a(this.context, "Sending all files");
        List<File> batchOfFilesToSend = this.filesManager.getBatchOfFilesToSend();
        int i = 0;
        while (batchOfFilesToSend.size() > 0) {
            try {
                b.a.a.a.a.b.i.a(this.context, String.format(Locale.US, "attempt to send batch of %d files", Integer.valueOf(batchOfFilesToSend.size())));
                ...
                b.a.a.a.a.b.i.a(context, "Failed to send batch of analytics files to server: " + e.getMessage(), e);
            }
        }
        if (i != 0) {
            return;
    ...
    void scheduleTimeBasedFileRollOver(long j, long j2) {
        if (this.rolloverFutureRef.get() == null) {
            ...
            Context context = this.context;
            b.a.a.a.a.b.i.a(context, "Scheduling time based file roll over every " + j2 + " seconds");
            try {
