...
public abstract class BaseGmsClient<T extends IInterface> {
    ...
    public final class PostInitCallback extends zza {
        ...
        protected final boolean handleServiceSuccess() {
            try {
                ...
                IInterface mo162createServiceInterface = BaseGmsClient.this.mo162createServiceInterface(this.service);
                if (mo162createServiceInterface == null) {
                    return false;
                }
                if (!BaseGmsClient.this.zza(2, 4, (int) mo162createServiceInterface) && !BaseGmsClient.this.zza(3, 4, (int) mo162createServiceInterface)) {
                    return false;
                }
    ...
    protected abstract T mo162createServiceInterface(IBinder iBinder);
