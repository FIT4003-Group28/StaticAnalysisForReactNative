...
public class GmsIntents {
    ...
    public static Intent createShareOnPlusIntent(Activity activity, String str, String str2) {
        Intent a2 = ae.a.a(activity).b(str).a((CharSequence) str2).a("text/plain").a();
        a2.setPackage("com.google.android.apps.plus");
        return isIntentResolvable(activity.getPackageManager(), a2) ? a2 : createPlayStoreIntent("com.google.android.apps.plus");
    }
    ...
    public static boolean isIntentResolvable(PackageManager packageManager, Intent intent) {
        return packageManager.resolveActivity(intent, PKIFailureInfo.notAuthorized) != null;
    }
