...
public final class WakeLockEvent extends StatsEvent {
    ...
    public final StatsEvent ReconstructCloseEvent(StatsEvent statsEvent) {
        if (statsEvent instanceof WakeLockEvent) {
            ...
            return new WakeLockEvent(wakeLockEvent).mo134setEventType(getEventType()).mo133setDurationMillis(getElapsedRealtime() - wakeLockEvent.getElapsedRealtime());
        }
        return statsEvent;
    }
    ...
    @Override // com.google.android.gms.common.stats.StatsEvent
    /* renamed from: markTimeOut  reason: collision with other method in class */
    public final WakeLockEvent mo137markTimeOut() {
        int i;
        if (this.mTimeout != 0) {
    ...
    public final StatsEvent mo133setDurationMillis(long j) {
        this.zzyf = j;
        return this;
    }
    ...
    public final StatsEvent mo134setEventType(int i) {
        this.zzxw = i;
        return this;
    }
