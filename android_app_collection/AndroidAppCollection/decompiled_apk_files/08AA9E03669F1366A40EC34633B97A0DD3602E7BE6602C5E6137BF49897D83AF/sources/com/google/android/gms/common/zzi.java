...
public final class zzi extends zzg {
    ...
    final String getErrorMessage() {
        ...
        String bytesToStringLowercase = Hex.bytesToStringLowercase(AndroidUtilsLight.getMessageDigest(McElieceCCA2KeyGenParameterSpec.SHA1).digest(this.zzbn.getBytes()));
        boolean z = this.zzbo;
