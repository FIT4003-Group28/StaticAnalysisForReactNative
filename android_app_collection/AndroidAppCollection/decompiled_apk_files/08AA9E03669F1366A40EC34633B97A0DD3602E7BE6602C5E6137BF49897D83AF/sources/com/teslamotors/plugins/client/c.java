...
/* compiled from: OwnerAPIError.java */
...
public enum c {
    ...
    static final HashMap<String, c> m = new HashMap<>();
    public static final HashSet<c> n;
    ...
    static {
        ...
        n = new HashSet<>(Arrays.asList(OWNERAPI_ERROR_UNAUTHORIZED, OWNERAPI_ERROR_ACCOUNT_LOCKED, OWNERAPI_ERROR_SERVICE_MAINTENANCE, OWNERAPI_ERROR_MOBILE_ACCESS_DISABLED, OWNERAPI_ERROR_NOT_FOUND, OWNERAPI_ERROR_TOO_MANY_REQUESTS));
        o = new HashSet<>(Arrays.asList(OWNERAPI_ERROR_UNAUTHORIZED.a(), OWNERAPI_ERROR_ACCOUNT_LOCKED.a(), OWNERAPI_ERROR_SERVICE_MAINTENANCE.a(), OWNERAPI_ERROR_MOBILE_ACCESS_DISABLED.a(), OWNERAPI_ERROR_NOT_FOUND.a(), OWNERAPI_ERROR_TOO_MANY_REQUESTS.a()));
    }
