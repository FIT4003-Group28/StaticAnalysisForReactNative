...
public class ECGOST3410ParamSetParameters extends ASN1Object {
    ...
    public ECGOST3410ParamSetParameters(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, int i, BigInteger bigInteger5) {
        this.f5639a = new ASN1Integer(bigInteger);
        this.f5640b = new ASN1Integer(bigInteger2);
    ...
    public ECGOST3410ParamSetParameters(ASN1Sequence aSN1Sequence) {
        ...
        this.f5639a = (ASN1Integer) objects.nextElement();
        this.f5640b = (ASN1Integer) objects.nextElement();
    ...
    public BigInteger getA() {
        return this.f5639a.getPositiveValue();
    }

    @Override // org.spongycastle.asn1.ASN1Object, org.spongycastle.asn1.ASN1Encodable
    public ASN1Primitive toASN1Primitive() {
        ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector();
        aSN1EncodableVector.add(this.f5639a);
        aSN1EncodableVector.add(this.f5640b);
