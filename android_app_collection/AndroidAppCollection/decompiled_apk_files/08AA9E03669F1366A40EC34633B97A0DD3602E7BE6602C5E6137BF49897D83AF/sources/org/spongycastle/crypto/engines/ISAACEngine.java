...
public class ISAACEngine implements StreamCipher {
    ...
    private void isaac() {
        ...
        for (int i3 = 0; i3 < 256; i3++) {
            ...
            switch (i3 & 3) {
                case 0:
                    this.f5655a ^= this.f5655a << 13;
                    break;
                case 1:
                    this.f5655a ^= this.f5655a >>> 6;
                    break;
                case 2:
                    this.f5655a ^= this.f5655a << 2;
                    break;
                case 3:
                    this.f5655a ^= this.f5655a >>> 16;
                    break;
            }
            this.f5655a += this.engineState[(i3 + 128) & 255];
            int[] iArr = this.engineState;
            int i5 = this.engineState[(i4 >>> 2) & 255] + this.f5655a + this.f5656b;
            iArr[i3] = i5;
