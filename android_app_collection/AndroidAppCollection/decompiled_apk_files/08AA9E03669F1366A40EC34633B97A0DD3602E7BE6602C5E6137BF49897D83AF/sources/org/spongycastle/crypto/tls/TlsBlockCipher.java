...
public class TlsBlockCipher implements TlsCipher {
    ...
    public byte[] encodePlaintext(long j, short s, byte[] bArr, int i, int i2) {
        ...
        int i8 = i4 + i2;
        if (!this.encryptThenMAC) {
            byte[] calculateMac = this.writeMac.calculateMac(j, s, bArr2, i3, i2);
    ...
    public byte[] decodeCiphertext(long j, short s, byte[] bArr, int i, int i2) {
        ...
        if (this.encryptThenMAC) {
            int i6 = i4 + i2;
            if (!Arrays.constantTimeAreEqual(this.readMac.calculateMac(j, s, bArr, i4, i2 - size), Arrays.copyOfRange(bArr, i6 - size, i6))) {
