...
public class SecT193Field {
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        jArr2[0] = j ^ (j2 << 8);
        jArr2[1] = ((((unshuffle3 & 4294967295L) ^ (jArr[3] << 32)) ^ (j3 << 8)) ^ (j2 >>> 56)) ^ (j2 << 33);
    ...
    protected static void implMulwAcc(long j, long j2, long[] jArr, int i) {
        int i2 = 7;
        long[] jArr2 = {0, j2, jArr2[1] << M01, jArr2[2] ^ j2, jArr2[2] << M01, jArr2[4] ^ j2, jArr2[3] << M01, jArr2[6] ^ j2};
        int i3 = (int) j;
        long j3 = (jArr2[(i3 >>> 3) & 7] << 3) ^ jArr2[i3 & 7];
        long j4 = 0;
        int i4 = 36;
        while (true) {
            int i5 = (int) (j >>> i4);
            long j5 = (((jArr2[i5 & 7] ^ (jArr2[(i5 >>> 3) & 7] << 3)) ^ (jArr2[(i5 >>> 6) & 7] << 6)) ^ (jArr2[(i5 >>> 9) & 7] << 9)) ^ (jArr2[(i5 >>> 12) & i2] << 12);
            j3 ^= j5 << i4;
            j4 ^= j5 >>> (-i4);
            i4 -= 15;
            if (i4 <= 0) {
