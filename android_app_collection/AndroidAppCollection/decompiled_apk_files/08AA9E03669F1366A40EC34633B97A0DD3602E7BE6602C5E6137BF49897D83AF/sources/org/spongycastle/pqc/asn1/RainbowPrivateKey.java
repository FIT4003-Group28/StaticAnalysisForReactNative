...
public class RainbowPrivateKey extends ASN1Object {
    ...
    private RainbowPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f5682vi = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(5)).getObjectAt(0)).getOctets();
        ...
        int length = this.f5682vi.length - 1;
        this.layers = new Layer[length];
        int i10 = 0;
        while (i10 < length) {
            int i11 = i10 + 1;
            this.layers[i10] = new Layer(this.f5682vi[i10], this.f5682vi[i11], RainbowUtil.convertArray(bArr[i10]), RainbowUtil.convertArray(bArr2[i10]), RainbowUtil.convertArray(bArr3[i10]), RainbowUtil.convertArray(bArr4[i10]));
            i10 = i11;
        }
    }
    ...
    public RainbowPrivateKey(short[][] sArr, short[] sArr2, short[][] sArr3, short[] sArr4, int[] iArr, Layer[] layerArr) {
        ...
        this.f5682vi = RainbowUtil.convertIntArray(iArr);
    ...
    public int[] getVi() {
        return RainbowUtil.convertArraytoInt(this.f5682vi);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector6.add(new DEROctetString(this.f5682vi));
