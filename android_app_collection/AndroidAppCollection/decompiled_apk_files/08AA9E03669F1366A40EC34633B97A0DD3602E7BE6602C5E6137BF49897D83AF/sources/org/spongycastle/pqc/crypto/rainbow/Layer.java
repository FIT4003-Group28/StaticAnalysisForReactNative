...
public class Layer {
    ...
    public Layer(byte b2, byte b3, short[][][] sArr, short[][][] sArr2, short[][] sArr3, short[] sArr4) {
        this.f5688vi = b2 & 255;
        this.viNext = b3 & 255;
        this.oi = this.viNext - this.f5688vi;
    ...
    public Layer(int i, int i2, SecureRandom secureRandom) {
        ...
        this.viNext = i2;
        this.oi = i2 - i;
        this.coeff_alpha = (short[][][]) Array.newInstance(short.class, this.oi, this.oi, this.f5688vi);
        this.coeff_beta = (short[][][]) Array.newInstance(short.class, this.oi, this.f5688vi, this.f5688vi);
        ...
        for (int i4 = 0; i4 < i3; i4++) {
            for (int i5 = 0; i5 < this.oi; i5++) {
                for (int i6 = 0; i6 < this.f5688vi; i6++) {
                    this.coeff_alpha[i4][i5][i6] = (short) (secureRandom.nextInt() & 255);
                }
            }
        }
        for (int i7 = 0; i7 < i3; i7++) {
            for (int i8 = 0; i8 < this.f5688vi; i8++) {
                for (int i9 = 0; i9 < this.f5688vi; i9++) {
    ...
    public short[][] plugInVinegars(short[] sArr) {
        short[][] sArr2 = (short[][]) Array.newInstance(short.class, this.oi, this.oi + 1);
        short[] sArr3 = new short[this.oi];
        for (int i = 0; i < this.oi; i++) {
            for (int i2 = 0; i2 < this.f5688vi; i2++) {
                for (int i3 = 0; i3 < this.f5688vi; i3++) {
        ...
        for (int i9 = 0; i9 < this.oi; i9++) {
            for (int i10 = this.f5688vi; i10 < this.viNext; i10++) {
                sArr2[i9][i10 - this.f5688vi] = GF2Field.addElem(this.coeff_gamma[i9][i10], sArr2[i9][i10 - this.f5688vi]);
            }
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f5688vi == layer.getVi() && this.viNext == layer.getViNext() && this.oi == layer.getOi() && RainbowUtil.equals(this.coeff_alpha, layer.getCoeffAlpha()) && RainbowUtil.equals(this.coeff_beta, layer.getCoeffBeta()) && RainbowUtil.equals(this.coeff_gamma, layer.getCoeffGamma()) && RainbowUtil.equals(this.coeff_eta, layer.getCoeffEta());
    }

    public int hashCode() {
        return (((((((((((this.f5688vi * 37) + this.viNext) * 37) + this.oi) * 37) + Arrays.hashCode(this.coeff_alpha)) * 37) + Arrays.hashCode(this.coeff_beta)) * 37) + Arrays.hashCode(this.coeff_gamma)) * 37) + Arrays.hashCode(this.coeff_eta);
    }
}
