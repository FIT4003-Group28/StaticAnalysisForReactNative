...
public final class ahx extends Drawable {
    public float a;
    public float b;
    ...
    public ahx(ColorStateList colorStateList, float f) {
        this.a = f;
        a(colorStateList);
        this.g = new RectF();
        this.h = new Rect();
    ...
    public final void b(Rect rect) {
        ...
        this.h.set(rect);
        if (this.c) {
            float a = ahy.a(this.b, this.a, this.d);
            this.h.inset((int) Math.ceil(ahy.b(this.b, this.a, this.d)), (int) Math.ceil(a));
            this.g.set(this.h);
        }
    }
