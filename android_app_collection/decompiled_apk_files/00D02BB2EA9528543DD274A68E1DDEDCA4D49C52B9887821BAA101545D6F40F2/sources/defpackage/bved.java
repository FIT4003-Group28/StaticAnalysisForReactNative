package defpackage;
/* compiled from: PG */
/* renamed from: bved  reason: default package */
...
public final class bved implements bvec {
    ...
    public bved(dxio<btze> dxioVar, bvrb bvrbVar) {
        this.a = dxioVar;
        this.b = bvrbVar;
        buac a = buad.a();
        this.c = a;
        dunt duntVar = dunt.OFFLINE_GET_REGION_SIZE_REQUEST;
        a.i = btyk.GMM_SERVER;
        btyp bZ = btyq.h.bZ();
        if (bZ.c) {
            bZ.bF();
