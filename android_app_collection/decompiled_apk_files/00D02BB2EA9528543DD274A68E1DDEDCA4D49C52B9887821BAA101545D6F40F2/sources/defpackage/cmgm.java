...
/* compiled from: PG */
/* renamed from: cmgm  reason: default package */
...
final class cmgm {
    ...
    */
    public static int f(int r4, int r5, int r6, int r7) {
        /*
            r0 = 4
            defpackage.cmmn.g(r4, r0)
            defpackage.cmmn.g(r5, r0)
            defpackage.cmmn.g(r6, r0)
            defpackage.cmmn.g(r7, r0)
            r0 = 0
            r1 = 1
        ...
        L33:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cmgm.f(int, int, int, int):int");
    }
