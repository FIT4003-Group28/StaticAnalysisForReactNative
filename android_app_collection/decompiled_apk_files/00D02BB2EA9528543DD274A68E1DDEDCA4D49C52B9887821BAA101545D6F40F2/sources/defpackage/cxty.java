...
/* compiled from: PG */
/* renamed from: cxty  reason: default package */
/* loaded from: classes5.dex */
final class cxty implements Runnable {
    final /* synthetic */ Stopwatch a;
    final /* synthetic */ cxrb b;
    final /* synthetic */ cxua c;

    public cxty(cxua cxuaVar, Stopwatch stopwatch, cxrb cxrbVar) {
        this.c = cxuaVar;
        this.a = stopwatch;
        this.b = cxrbVar;
    }
    ...
    public final void run() {
        ...
        if (g != 0) {
            ...
            if (cxsg.e()) {
                ...
                eaziVar3.b = 8;
                eaziVar3.a |= 1;
                long a2 = this.c.f.a("ListViewTopSuggestionsTime").a();
                if (bZ5.c) {
                    bZ5.bF();
                    bZ5.c = false;
                }
                ...
                eazcVar.a |= 1;
                eazcVar.b = size;
                long a3 = this.c.f.a("ListViewTopSuggestionsTime").a();
                if (bZ8.c) {
                    bZ8.bF();
                    bZ8.c = false;
                }
            ...
            Stopwatch a5 = this.c.f.a("TotalInitialize");
            if (!a5.c) {
                return;
            }
            a5.d();
            cxqo cxqoVar4 = this.c.f;
            eazd bZ10 = eaze.g.bZ();
            if (bZ10.c) {
                bZ10.bF();
                bZ10.c = false;
