...
public final class kf {
    ...
    public kf(kf kfVar) {
        this.a = kfVar.a;
        float[] fArr = kfVar.b;
        this.b = kg.d(fArr, fArr.length);
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    public static void a(kf[] kfVarArr, Path path) {
        int i;
        int i2;
        float[] fArr;
        char c;
        ...
        char c4 = 'm';
        int i4 = 0;
        while (i4 < kfVarArr2.length) {
            kf kfVar = kfVarArr2[i4];
            char c5 = kfVar.a;
            float[] fArr3 = kfVar.b;
            float f13 = fArr2[c3];
            float f14 = fArr2[1];
    ...
    private static void b(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        ...
        int i = 0;
        if (z2 != (atan22 >= dcyn.a)) {
            atan22 += atan22 > dcyn.a ? -6.283185307179586d : 6.283185307179586d;
        }
        Double.isNaN(d5);
        double d25 = d * d5;
        Double.isNaN(d8);
