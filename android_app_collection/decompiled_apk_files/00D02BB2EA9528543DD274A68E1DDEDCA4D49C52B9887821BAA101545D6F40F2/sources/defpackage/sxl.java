...
public class sxl implements zdq, ahvl {
    public final ahvo a;
    private final suw b;
    ...
    private final gdc e;
    private int f = 390;
    private final View.OnClickListener g = new sxj(this);
    private final View.OnClickListener h = new sxk(this);

    public sxl(ahvo ahvoVar, suw suwVar, Activity activity, cqhn cqhnVar, dxio<cztz> dxioVar, gdc gdcVar) {
        this.a = ahvoVar;
        this.b = suwVar;
        this.d = dxioVar;
        this.c = activity;
    ...
    public cqkl a() {
        if (this.a.e()) {
            if (!j().booleanValue()) {
                ...
                a.e = string;
                a.i = cjtd.a(dtyc.db);
                a.h(R.string.YES_BUTTON, cjtd.a(dtyc.dd), new gdd(this) { // from class: sxh
                    private final sxl a;
                ...
                a.e(R.string.NO_BUTTON, cjtd.a(dtyc.dc), sxi.a);
                a.b();
            } else {
                b();
            }
