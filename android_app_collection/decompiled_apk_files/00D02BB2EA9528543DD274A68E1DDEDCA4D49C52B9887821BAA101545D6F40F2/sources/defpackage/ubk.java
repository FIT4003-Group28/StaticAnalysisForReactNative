...
public final class ubk {
    ...
    public final dzsj<twf> c;
    public final dzsj<vtn> d;
    public final dzsj<tur> e;
    public final dzsj<sux> f;
    public final dzsj<cqat> g;

    public ubk(dzsj<Activity> dzsjVar, dzsj<twk> dzsjVar2, dzsj<twf> dzsjVar3, dzsj<vtn> dzsjVar4, dzsj<tur> dzsjVar5, dzsj<sux> dzsjVar6, dzsj<cqat> dzsjVar7) {
        a(dzsjVar, 1);
        this.a = dzsjVar;
        a(dzsjVar2, 2);
        this.b = dzsjVar2;
