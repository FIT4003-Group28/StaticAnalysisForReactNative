...
public class AlertController {
    ...
    final androidx.appcompat.app.h f848b;

    /* renamed from: c  reason: collision with root package name */
    private final Window f849c;
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            this.f856c = obtainStyledAttributes.getDimensionPixelOffset(a.a.j.RecycleListView_paddingBottomNoButtons, -1);
            this.f855b = obtainStyledAttributes.getDimensionPixelOffset(a.a.j.RecycleListView_paddingTopNoTitle, -1);
        }

        public void a(boolean z, boolean z2) {
            if (!z2 || !z) {
                setPadding(getPaddingLeft(), z ? getPaddingTop() : this.f855b, getPaddingRight(), z2 ? getPaddingBottom() : this.f856c);
            }
        }
    }
        ...
        */
        public void onClick(android.view.View r3) {
            ...
            L2f:
                ...
                r1 = 1
                androidx.appcompat.app.h r3 = r3.f848b
    ...
    public class b implements NestedScrollView.b {
        ...
        public void a(NestedScrollView nestedScrollView, int i, int i2, int i3, int i4) {
            AlertController.a(nestedScrollView, this.f858a, this.f859b);
        }
    }
    ...
    public class c implements Runnable {
        ...
        public void run() {
            AlertController.a(AlertController.this.A, this.f860b, this.f861c);
        }
    }
    ...
    public class d implements AbsListView.OnScrollListener {
        ...
        public void onScroll(AbsListView absListView, int i, int i2, int i3) {
            AlertController.a(absListView, this.f863a, this.f864b);
        }
    ...
    public class e implements Runnable {
        ...
        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ View f865b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ View f866c;
        ...
        @Override // java.lang.Runnable
        public void run() {
            AlertController.a(AlertController.this.f853g, this.f865b, this.f866c);
        }
    }
    ...
    public static class f {
        ...
        /* renamed from: f  reason: collision with root package name */
        public CharSequence f873f;

        /* renamed from: g  reason: collision with root package name */
        public View f874g;

        /* renamed from: h  reason: collision with root package name */
        public CharSequence f875h;
        ...
        public class a extends ArrayAdapter<CharSequence> {
            ...
            public View getView(int i, View view, ViewGroup viewGroup) {
                ...
                if (zArr != null && zArr[i]) {
                    this.f876b.setItemChecked(i, true);
                }
                return view2;
            }
        }
        ...
        public class b extends CursorAdapter {
            ...
            /* renamed from: d  reason: collision with root package name */
            final /* synthetic */ RecycleListView f880d;

            /* renamed from: e  reason: collision with root package name */
            final /* synthetic */ AlertController f881e;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            b(Context context, Cursor cursor, boolean z, RecycleListView recycleListView, AlertController alertController) {
                super(context, cursor, z);
                this.f880d = recycleListView;
                this.f881e = alertController;
                Cursor cursor2 = getCursor();
                this.f878b = cursor2.getColumnIndexOrThrow(f.this.L);
                this.f879c = cursor2.getColumnIndexOrThrow(f.this.M);
            }

            @Override // android.widget.CursorAdapter
            public void bindView(View view, Context context, Cursor cursor) {
                ((CheckedTextView) view.findViewById(16908308)).setText(cursor.getString(this.f878b));
                RecycleListView recycleListView = this.f880d;
                int position = cursor.getPosition();
                boolean z = true;
                if (cursor.getInt(this.f879c) != 1) {
                    z = false;
                }
            ...
            public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
                return f.this.f869b.inflate(this.f881e.M, viewGroup, false);
            }
        }
        ...
        public class c implements AdapterView.OnItemClickListener {
            ...
            /* renamed from: b  reason: collision with root package name */
            final /* synthetic */ AlertController f883b;

            c(AlertController alertController) {
                this.f883b = alertController;
            }

            @Override // android.widget.AdapterView.OnItemClickListener
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                f.this.x.onClick(this.f883b.f848b, i);
                if (!f.this.H) {
                    this.f883b.f848b.dismiss();
                }
            }
        }
        ...
        public class d implements AdapterView.OnItemClickListener {
            ...
            /* renamed from: b  reason: collision with root package name */
            final /* synthetic */ RecycleListView f885b;

            /* renamed from: c  reason: collision with root package name */
            final /* synthetic */ AlertController f886c;

            d(RecycleListView recycleListView, AlertController alertController) {
                this.f885b = recycleListView;
                this.f886c = alertController;
            }
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                boolean[] zArr = f.this.F;
                if (zArr != null) {
                    zArr[i] = this.f885b.isItemChecked(i);
                }
                f.this.J.onClick(this.f886c.f848b, i, this.f885b.isItemChecked(i));
            }
        }
        ...
        public f(Context context) {
            this.f868a = context;
            this.f869b = (LayoutInflater) context.getSystemService("layout_inflater");
        }
        ...
        */
        private void b(androidx.appcompat.app.AlertController r12) {
            /*
                r11 = this;
                android.view.LayoutInflater r0 = r11.f869b
                int r1 = r12.L
                r2 = 0
                ...
                android.content.Context r3 = r11.f868a
                int r4 = r12.M
            ...
            L5e:
                ...
                android.content.Context r2 = r11.f868a
        ...
        public void a(AlertController alertController) {
            ...
            CharSequence charSequence2 = this.f875h;
    ...
    private static final class g extends Handler {
        ...
        /* renamed from: a  reason: collision with root package name */
        private WeakReference<DialogInterface> f888a;

        public g(DialogInterface dialogInterface) {
            this.f888a = new WeakReference<>(dialogInterface);
        }
        ...
        public void handleMessage(Message message) {
            int i = message.what;
            if (i == -3 || i == -2 || i == -1) {
                ((DialogInterface.OnClickListener) message.obj).onClick(this.f888a.get(), message.what);
            } else if (i != 1) {
            } else {
    ...
    public AlertController(Context context, androidx.appcompat.app.h hVar, Window window) {
        ...
        this.f850d = obtainStyledAttributes.getDimensionPixelSize(a.a.j.AlertDialog_buttonIconDimen, 0);
    ...
    private void a(ViewGroup viewGroup, View view, int i, int i2) {
        View findViewById = this.f849c.findViewById(a.a.f.scrollIndicatorUp);
        View findViewById2 = this.f849c.findViewById(a.a.f.scrollIndicatorDown);
        ...
        ListView listView = this.f853g;
        if (listView != null) {
            listView.setOnScrollListener(new d(this, findViewById, view2));
            this.f853g.post(new e(findViewById, view2));
            return;
        }
        if (findViewById != null) {
            viewGroup.removeView(findViewById);
    ...
    private void b(ViewGroup viewGroup) {
        this.A = (NestedScrollView) this.f849c.findViewById(a.a.f.scrollView);
        ...
        CharSequence charSequence = this.f852f;
        if (charSequence != null) {
        ...
        viewGroup2.addView(this.f853g, indexOfChild, new ViewGroup.LayoutParams(-1, -1));
    }
    ...
    private void c(ViewGroup viewGroup) {
        ...
        boolean z = false;
        if (view == null) {
            view = this.i != 0 ? LayoutInflater.from(this.f847a).inflate(this.i, viewGroup, false) : null;
        }
        if (view != null) {
            z = true;
        }
        if (!z || !c(view)) {
            this.f849c.setFlags(131072, 131072);
        }
        if (!z) {
            viewGroup.setVisibility(8);
            return;
        }
        FrameLayout frameLayout = (FrameLayout) this.f849c.findViewById(a.a.f.custom);
        ...
        ((i0.a) viewGroup.getLayoutParams()).f1280a = 0.0f;
    }
    ...
    private void d() {
        ...
        View findViewById2;
        View findViewById3 = this.f849c.findViewById(a.a.f.parentPanel);
    ...
    private void d(ViewGroup viewGroup) {
        if (this.G != null) {
            ...
            this.f849c.findViewById(a.a.f.title_template).setVisibility(8);
            return;
        }
        this.D = (ImageView) this.f849c.findViewById(16908294);
        if (!(!TextUtils.isEmpty(this.f851e)) || !this.P) {
            this.f849c.findViewById(a.a.f.title_template).setVisibility(8);
            this.D.setVisibility(8);
            viewGroup.setVisibility(8);
            return;
        }
        this.E = (TextView) this.f849c.findViewById(a.a.f.alertTitle);
        this.E.setText(this.f851e);
        int i = this.B;
        if (i != 0) {
    ...
    public int a(int i) {
        TypedValue typedValue = new TypedValue();
        this.f847a.getTheme().resolveAttribute(i, typedValue, true);
