...
public class ActionBarContextView extends androidx.appcompat.widget.a {
    ...
    public class a implements View.OnClickListener {
        ...
        final /* synthetic */ a.a.o.b f1108b;
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        x0 a2 = x0.a(context, attributeSet, a.a.j.ActionMode, i, 0);
        a.g.m.v.a(this, a2.b(a.a.j.ActionMode_background));
        this.q = a2.g(a.a.j.ActionMode_titleTextStyle, 0);
        this.r = a2.g(a.a.j.ActionMode_subtitleTextStyle, 0);
        this.f1189f = a2.f(a.a.j.ActionMode_height, 0);
    ...
    */
    public void a(a.a.o.b r4) {
        ...
        L22:
            ...
            androidx.appcompat.widget.c r0 = r3.f1188e
            if (r0 == 0) goto L3f
            r0.c()
        L3f:
            ...
            r2 = -1
            r0.<init>(r1, r2)
            androidx.appcompat.widget.c r1 = r3.f1188e
            android.content.Context r2 = r3.f1186c
            r4.a(r1, r2)
            androidx.appcompat.widget.c r4 = r3.f1188e
            androidx.appcompat.view.menu.o r4 = r4.b(r3)
            androidx.appcompat.widget.ActionMenuView r4 = (androidx.appcompat.widget.ActionMenuView) r4
            r3.f1187d = r4
            androidx.appcompat.widget.ActionMenuView r4 = r3.f1187d
            r1 = 0
            a.g.m.v.a(r4, r1)
            androidx.appcompat.widget.ActionMenuView r4 = r3.f1187d
            r3.addView(r4, r0)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.ActionBarContextView.a(a.a.o.b):void");
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        ActionMenuView actionMenuView = this.f1187d;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (View.MeasureSpec.getMode(i) != 1073741824) {
            ...
            if (actionMenuView != null && actionMenuView.getParent() == this) {
                paddingLeft = a(this.f1187d, paddingLeft, makeMeasureSpec, 0);
            }
            LinearLayout linearLayout = this.n;
