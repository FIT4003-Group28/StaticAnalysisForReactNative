...
public class NestedScrollView extends FrameLayout implements o, a.g.m.k, t {
    ...
    private final Rect f1599c;

    /* renamed from: d  reason: collision with root package name */
    private OverScroller f1600d;

    /* renamed from: e  reason: collision with root package name */
    private EdgeEffect f1601e;

    /* renamed from: f  reason: collision with root package name */
    private EdgeEffect f1602f;
    ...
    /* loaded from: classes.dex */
    static class a extends a.g.m.a {
        a() {
        }
        ...
        public void b(View view, AccessibilityEvent accessibilityEvent) {
            ...
            a.g.m.e0.e.a(accessibilityEvent, nestedScrollView.getScrollX());
            a.g.m.e0.e.b(accessibilityEvent, nestedScrollView.getScrollRange());
        }
    }
    ...
    public static class c extends View.BaseSavedState {
        ...
        class a implements Parcelable.Creator<c> {
            ...
            public c mo66createFromParcel(Parcel parcel) {
                return new c(parcel);
            }
        ...
        public String toString() {
            return "HorizontalScrollView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " scrollPosition=" + this.f1605b + "}";
        }
    ...
    private void a(MotionEvent motionEvent) {
        ...
        if (motionEvent.getPointerId(actionIndex) == this.r) {
            ...
            this.f1603g = (int) motionEvent.getY(i);
    ...
    private boolean a(View view, int i, int i2) {
        view.getDrawingRect(this.f1599c);
        offsetDescendantRectToMyCoords(view, this.f1599c);
        return this.f1599c.bottom + i >= getScrollY() && this.f1599c.top - i <= getScrollY() + i2;
    }
    ...
    private void b(int i, int i2, int i3, boolean z) {
        ...
        if (AnimationUtils.currentAnimationTimeMillis() - this.f1598b > 250) {
            View childAt = getChildAt(0);
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) childAt.getLayoutParams();
            int scrollY = getScrollY();
            OverScroller overScroller = this.f1600d;
            ...
            if (!this.f1600d.isFinished()) {
                a();
            }
            scrollBy(i, i2);
        }
        this.f1598b = AnimationUtils.currentAnimationTimeMillis();
    }

    private void b(View view) {
        view.getDrawingRect(this.f1599c);
        offsetDescendantRectToMyCoords(view, this.f1599c);
        int a2 = a(this.f1599c);
        if (a2 != 0) {
            scrollBy(0, a2);
        }
    }
    ...
    private void c() {
        ...
        h();
        f(0);
        EdgeEffect edgeEffect = this.f1601e;
        if (edgeEffect != null) {
            edgeEffect.onRelease();
            this.f1602f.onRelease();
        }
    }
    ...
    private void d() {
        if (getOverScrollMode() == 2) {
            this.f1601e = null;
            this.f1602f = null;
        } else if (this.f1601e != null) {
        } else {
            Context context = getContext();
            this.f1601e = new EdgeEffect(context);
            this.f1602f = new EdgeEffect(context);
        }
    }
    ...
    private void f() {
        this.f1600d = new OverScroller(getContext());
        setFocusable(true);
    ...
    public boolean a(int i) {
        ...
        if (findNextFocus == null || !a(findNextFocus, maxScrollAmount, getHeight())) {
            ...
            findNextFocus.getDrawingRect(this.f1599c);
            offsetDescendantRectToMyCoords(findNextFocus, this.f1599c);
            g(a(this.f1599c));
    ...
    */
    boolean a(int r13, int r14, int r15, int r16, int r17, int r18, int r19, int r20, boolean r21) {
        ...
        L5f:
            ...
            boolean r3 = r12.d(r5)
            if (r3 != 0) goto L7e
            android.widget.OverScroller r3 = r0.f1600d
            r8 = 0
            r9 = 0
            r10 = 0
    ...
    public void b(int i) {
        if (getChildCount() > 0) {
            this.f1600d.fling(getScrollX(), getScrollY(), 0, i, 0, 0, RecyclerView.UNDEFINED_DURATION, Integer.MAX_VALUE, 0, 0);
            a(true);
        }
    }
    ...
    public boolean c(int i) {
        ...
        if (z && (childCount = getChildCount()) > 0) {
            ...
            this.f1599c.bottom = childAt.getBottom() + ((FrameLayout.LayoutParams) childAt.getLayoutParams()).bottomMargin + getPaddingBottom();
            Rect rect2 = this.f1599c;
            rect2.top = rect2.bottom - height;
        }
        Rect rect3 = this.f1599c;
    ...
    public void computeScroll() {
        ...
        this.f1600d.computeScrollOffset();
        int currY = this.f1600d.getCurrY();
        int i = currY - this.v;
        this.v = currY;
        int[] iArr = this.t;
        boolean z = false;
        ...
        if (i2 != 0) {
            ...
            if (z) {
                d();
                if (i2 < 0) {
                    if (this.f1601e.isFinished()) {
                        edgeEffect = this.f1601e;
                        edgeEffect.onAbsorb((int) this.f1600d.getCurrVelocity());
                    }
                } else if (this.f1602f.isFinished()) {
                    edgeEffect = this.f1602f;
                    edgeEffect.onAbsorb((int) this.f1600d.getCurrVelocity());
                }
            }
            a();
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.f1601e != null) {
            ...
            if (!this.f1601e.isFinished()) {
                ...
                this.f1601e.setSize(width, height);
                if (this.f1601e.draw(canvas)) {
                    v.M(this);
                }
                canvas.restoreToCount(save);
            }
            if (this.f1602f.isFinished()) {
                return;
            }
            ...
            this.f1602f.setSize(width2, height2);
            if (this.f1602f.draw(canvas)) {
                v.M(this);
            }
    ...
    public boolean e(int i) {
        ...
        int height = getHeight();
        if (z) {
            this.f1599c.top = getScrollY() + height;
            int childCount = getChildCount();
            if (childCount > 0) {
                View childAt = getChildAt(childCount - 1);
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (action != 2 || !this.k) {
            ...
            if (i != 0) {
                    ...
                    if (i == 2) {
                        ...
                        if (i2 != -1) {
                            ...
                            if (findPointerIndex == -1) {
                                ...
                                if (Math.abs(y - this.f1603g) > this.o && (2 & getNestedScrollAxes()) == 0) {
                                    this.k = true;
                                    this.f1603g = y;
                                    g();
                ...
                this.r = -1;
                h();
                if (this.f1600d.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange())) {
                    v.M(this);
                }
                f(0);
            } else {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!this.i) {
            if (this.w != null) {
                scrollTo(getScrollX(), this.w.f1605b);
                this.w = null;
            }
            if (getChildCount() > 0) {
                View childAt = getChildAt(0);
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        findFocus.getDrawingRect(this.f1599c);
        offsetDescendantRectToMyCoords(findFocus, this.f1599c);
        g(a(this.f1599c));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x0076, code lost:
        if (r23.f1600d.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange()) != false) goto L29;
     */
