...
public class j {
    ...
    public static class a {
        ...
        double[] f5990a = new double[4];

        /* renamed from: b  reason: collision with root package name */
        double[] f5991b = new double[3];

        /* renamed from: c  reason: collision with root package name */
        double[] f5992c = new double[3];

        /* renamed from: d  reason: collision with root package name */
        double[] f5993d = new double[3];

        /* renamed from: e  reason: collision with root package name */
        double[] f5994e = new double[3];
    ...
    public static void a(double[] dArr, a aVar) {
        c.d.k.a.a.a(dArr.length == 16);
        double[] dArr2 = aVar.f5990a;
        double[] dArr3 = aVar.f5991b;
        double[] dArr4 = aVar.f5992c;
        double[] dArr5 = aVar.f5993d;
        double[] dArr6 = aVar.f5994e;
        if (b(dArr[15])) {
            return;
        }
        ...
        if (!b(dArr7[0][3]) || !b(dArr7[1][3]) || !b(dArr7[2][3])) {
            b(new double[]{dArr7[0][3], dArr7[1][3], dArr7[2][3], dArr7[3][3]}, d(b(dArr8)), dArr2);
        } else {
            dArr2[2] = 0.0d;
            dArr2[1] = 0.0d;
            dArr2[0] = 0.0d;
        ...
        dArr3[0] = e(dArr9[0]);
        dArr9[0] = i(dArr9[0], dArr3[0]);
        dArr4[0] = b(dArr9[0], dArr9[1]);
        dArr9[1] = a(dArr9[1], dArr9[0], 1.0d, -dArr4[0]);
        dArr4[0] = b(dArr9[0], dArr9[1]);
        dArr9[1] = a(dArr9[1], dArr9[0], 1.0d, -dArr4[0]);
        dArr3[1] = e(dArr9[1]);
        dArr9[1] = i(dArr9[1], dArr3[1]);
        dArr4[0] = dArr4[0] / dArr3[1];
        dArr4[1] = b(dArr9[0], dArr9[2]);
        dArr9[2] = a(dArr9[2], dArr9[0], 1.0d, -dArr4[1]);
        dArr4[2] = b(dArr9[1], dArr9[2]);
        dArr9[2] = a(dArr9[2], dArr9[1], 1.0d, -dArr4[2]);
        dArr3[2] = e(dArr9[2]);
        dArr9[2] = i(dArr9[2], dArr3[2]);
        dArr4[1] = dArr4[1] / dArr3[2];
        dArr4[2] = dArr4[2] / dArr3[2];
        if (b(dArr9[0], a(dArr9[1], dArr9[2])) < 0.0d) {
        ...
        dArr6[0] = c((-Math.atan2(dArr9[2][1], dArr9[2][2])) * 57.29577951308232d);
        dArr6[1] = c((-Math.atan2(-dArr9[2][0], Math.sqrt((dArr9[2][1] * dArr9[2][1]) + (dArr9[2][2] * dArr9[2][2])))) * 57.29577951308232d);
        dArr6[2] = c((-Math.atan2(dArr9[1][0], dArr9[0][0])) * 57.29577951308232d);
    }
    ...
    public static double[] b(double[] dArr) {
        ...
        double d58 = d3 * d6;
        double d59 = d2 * d7;
        return new double[]{(d23 + (d24 * d17)) / a2, (d30 - (d31 * d17)) / a2, ((((((d32 * d15) - (d33 * d15)) + (d34 * d16)) - (d35 * d16)) - (d36 * d17)) + (d37 * d17)) / a2, ((((((d33 * d11) - (d32 * d11)) - (d34 * d12)) + (d35 * d12)) + (d36 * d13)) - (d37 * d13)) / a2, (d42 - (d43 * d17)) / a2, ((((d44 + (d45 * d16)) - (d46 * d16)) - (d47 * d17)) + (d48 * d17)) / a2, ((((((d33 * d14) - (d32 * d14)) - (d49 * d16)) + (d50 * d16)) + (d51 * d17)) - (d52 * d17)) / a2, ((((((d32 * d10) - (d33 * d10)) + (d49 * d12)) - (d50 * d12)) - (d51 * d13)) + (d52 * d13)) / a2, (d54 + (d55 * d17)) / a2, ((((((d27 * d14) - (d28 * d14)) - (d45 * d15)) + (d46 * d15)) + (d56 * d17)) - (d57 * d17)) / a2, ((((((d35 * d14) - (d34 * d14)) + (d49 * d15)) - (d50 * d15)) - (d58 * d17)) + (d17 * d59)) / a2, ((((((d34 * d10) - (d35 * d10)) - (d49 * d11)) + (d50 * d11)) + (d58 * d13)) - (d13 * d59)) / a2, ((((((d22 * d14) - (d24 * d14)) - (d41 * d15)) + (d43 * d15)) + (d53 * d16)) - (d55 * d16)) / a2, ((((((d31 * d14) - (d29 * d14)) + (d47 * d15)) - (d48 * d15)) - (d56 * d16)) + (d57 * d16)) / a2, ((((((d36 * d14) - (d14 * d37)) - (d51 * d15)) + (d15 * d52)) + (d58 * d16)) - (d16 * d59)) / a2, ((((((d37 * d10) - (d36 * d10)) + (d51 * d11)) - (d52 * d11)) - (d58 * d12)) + (d59 * d12)) / a2};
    }
