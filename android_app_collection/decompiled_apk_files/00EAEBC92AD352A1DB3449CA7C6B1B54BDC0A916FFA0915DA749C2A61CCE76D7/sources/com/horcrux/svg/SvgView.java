...
public class SvgView extends com.facebook.react.views.view.f implements com.facebook.react.uimanager.v, com.facebook.react.uimanager.w {
    ...
    public synchronized void drawChildren(Canvas canvas) {
        ...
        if (this.mAlign != null) {
            ...
            if (z) {
                width = (float) w.a(this.mbbWidth, width, 0.0d, this.mScale, 12.0d);
                height = (float) w.a(this.mbbHeight, height, 0.0d, this.mScale, 12.0d);
            }
            RectF rectF = new RectF(0.0f, 0.0f, width, height);
            if (z) {
                canvas.clipRect(rectF);
            }
            matrix = s0.a(viewBox, rectF, this.mAlign, this.mMeetOrSlice);
    ...
    public void setTintColor(Integer num) {
        this.mTintColor = num == null ? 0 : num.intValue();
        invalidate();
        clearChildCache();
    }
