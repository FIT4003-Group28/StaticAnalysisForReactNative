            ...
            if (!z || (codePointAt != 9 && codePointAt != 10 && codePointAt != 12 && codePointAt != 13)) {
                if (codePointAt == 43 && z3) {
                    ...
                    while (!cVar2.r()) {
                        ...
                        cVar.mo339writeByte(37);
                        cVar.mo339writeByte((int) HEX_DIGITS[(readByte >> 4) & 15]);
                        cVar.mo339writeByte((int) HEX_DIGITS[readByte & 15]);
                    }
                } else {
                    cVar.c(codePointAt);
                }
        ...
        while (i < i2) {
            ...
            if (codePointAt != 37 || (i3 = i + 2) >= i2) {
                ...
                if (decodeHexDigit != -1 && decodeHexDigit2 != -1) {
                    cVar.mo339writeByte((decodeHexDigit << 4) + decodeHexDigit2);
                    i = i3;
                }
                cVar.c(codePointAt);
            }
