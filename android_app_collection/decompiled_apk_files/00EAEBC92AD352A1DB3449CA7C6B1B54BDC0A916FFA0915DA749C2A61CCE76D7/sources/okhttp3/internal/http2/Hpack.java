...
public final class Hpack {
    ...
    static final class Reader {
        ...
        Reader(int i, int i2, v vVar) {
            ...
            this.source = l.a(vVar);
        }

        /* JADX INFO: Access modifiers changed from: package-private */
        public Reader(int i, v vVar) {
            this(i, i, vVar);
        }
        ...
        f readByteString() {
            ...
            return z ? f.a(Huffman.get().decode(this.source.g(readInt))) : this.source.e(readInt);
        }
    ...
    static final class Writer {
        ...
        void writeByteString(f fVar) {
            int g2;
            int i;
            if (!this.useCompression || Huffman.get().encodedLength(fVar) >= fVar.g()) {
                g2 = fVar.g();
                i = 0;
            } else {
                c cVar = new c();
            ...
            writeInt(g2, Hpack.PREFIX_7_BITS, i);
            this.out.mo330a(fVar);
        }
        ...
        public void writeHeaders(List<Header> list) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                f h2 = header.name.h();
                f fVar = header.value;
                Integer num = Hpack.NAME_TO_FIRST_INDEX.get(h2);
                if (num != null) {
                    i = num.intValue() + 1;
                    if (i > 1 && i < 8) {
                ...
                if (i == -1) {
                    ...
                    while (true) {
                        ...
                        if (Util.equal(this.dynamicTable[i5].name, h2)) {
                ...
                if (i != -1) {
                    ...
                    if (i2 == -1) {
                        this.out.mo339writeByte(64);
                        writeByteString(h2);
                    } else if (!h2.b(Header.PSEUDO_PREFIX) || Header.TARGET_AUTHORITY.equals(h2)) {
                        writeInt(i2, 63, 64);
                    } else {
                        writeInt(i2, 15, 0);
        ...
        void writeInt(int i, int i2, int i3) {
            ...
            if (i < i2) {
                ...
                this.out.mo339writeByte(i3 | i2);
                i4 = i - i2;
                while (i4 >= 128) {
                    this.out.mo339writeByte(128 | (i4 & Hpack.PREFIX_7_BITS));
                    i4 >>>= 7;
                }
                cVar = this.out;
            }
            cVar.mo339writeByte(i4);
        }
    }
