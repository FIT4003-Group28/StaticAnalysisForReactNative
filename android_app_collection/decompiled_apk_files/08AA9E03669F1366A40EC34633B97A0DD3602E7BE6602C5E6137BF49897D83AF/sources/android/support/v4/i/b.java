...
public final class b<E> implements Collection<E>, Set<E> {
    ...
    private static final int[] f441a = new int[0];

    /* renamed from: b  reason: collision with root package name */
    private static final Object[] f442b = new Object[0];

    /* renamed from: c  reason: collision with root package name */
    private static Object[] f443c;

    /* renamed from: d  reason: collision with root package name */
    private static int f444d;
    ...
    private void d(int i) {
        if (i == 8) {
            ...
            synchronized (b.class) {
                if (f443c != null) {
                    Object[] objArr2 = f443c;
                    this.h = objArr2;
                    f443c = (Object[]) objArr2[0];
    ...
    public E c(int i) {
        ...
        if (this.i <= 1) {
            ...
            if (this.g.length > 8 && this.i < this.g.length / 3) {
                ...
                if (i < this.i) {
                    int i3 = i + 1;
                    System.arraycopy(iArr, i3, this.g, i, this.i - i);
                    System.arraycopy(objArr, i3, this.h, i, this.i - i);
                }
            } else {
                this.i--;
                if (i < this.i) {
                    int i4 = i + 1;
                    System.arraycopy(this.g, i4, this.g, i, this.i - i);
                    System.arraycopy(this.h, i4, this.h, i, this.i - i);
                }
                this.h[this.i] = null;
            }
        }
    ...
    private h<E, E> b() {
        if (this.j == null) {
            this.j = new h<E, E>() { // from class: android.support.v4.i.b.1
