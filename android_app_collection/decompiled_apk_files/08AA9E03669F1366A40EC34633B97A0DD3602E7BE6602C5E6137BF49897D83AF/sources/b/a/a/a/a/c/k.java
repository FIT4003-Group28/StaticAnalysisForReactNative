...
public class k extends ThreadPoolExecutor {
    ...
    private static final int f1149a = Runtime.getRuntime().availableProcessors();

    /* renamed from: b  reason: collision with root package name */
    private static final int f1150b = f1149a + 1;

    /* renamed from: c  reason: collision with root package name */
    private static final int f1151c = (f1149a * 2) + 1;
    ...
    public static final class a implements ThreadFactory {
        ...
        public Thread newThread(Runnable runnable) {
            ...
            thread.setPriority(this.f1152a);
