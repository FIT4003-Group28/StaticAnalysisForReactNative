...
public final class e {
    ...
    private static final String f1439a = System.getProperty("line.separator");
    ...
    public static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Iterator<String> f1440a;
        ...
        public a(String str, int i) {
            this.f1440a = e.a(str, i).iterator();
        }
    ...
    public static class b {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Iterator<List<String>> f1441a;
        ...
        public String a() {
            ...
            List<String> next = this.f1441a.next();
            if (!next.isEmpty()) {
                return next.get(0);
            }
            return null;
        ...
        public List<String> b() {
            ...
            return this.f1441a.next();
        }

        public boolean c() {
            return this.f1441a.hasNext();
        }
    }
}
