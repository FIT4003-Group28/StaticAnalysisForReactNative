...
public final class MapView extends ViewGroup {
    ...
    private static final String f1629a = "MapView";
    ...
    private GestureDetector$OnDoubleTapListenerC0136i f1631c;

    /* renamed from: d  reason: collision with root package name */
    private BaiduMap f1632d;
    private ImageView e;
    private Bitmap f;
    private N g;
    private Point h;
    ...
    */
    ...
    private void a(Context context, BaiduMapOptions baiduMapOptions) {
        BMapManager.init();
        a(context, baiduMapOptions, f1630b);
        this.f1632d = new BaiduMap(this.f1631c);
        a(context);
        b(context);
    ...
    private void a(Context context, BaiduMapOptions baiduMapOptions, String str) {
        if (baiduMapOptions == null) {
            this.f1631c = new GestureDetector$OnDoubleTapListenerC0136i(context, null, str);
        } else {
            this.f1631c = new GestureDetector$OnDoubleTapListenerC0136i(context, baiduMapOptions.a(), str);
        }
        addView(this.f1631c);
        this.s = new i(this);
        this.f1631c.a().a(this.s);
    }
    ...
    public void b() {
        float f = this.f1631c.a().D().f2026a;
        if (!this.g.a()) {
            return;
        }
        boolean z = true;
        this.g.b(f > this.f1631c.a().f2057b);
        N n2 = this.g;
        if (f >= this.f1631c.a().f2056a) {
            z = false;
        }
        n2.a(z);
    }
    ...
    public final BaiduMap getMap() {
        this.f1632d.f1550a = this;
        return this.f1632d;
    }

    public final int getMapLevel() {
        return n.get((int) this.f1631c.a().D().f2026a).intValue();
    }
    ...
    public void onCreate(Context context, Bundle bundle) {
        ...
        f1630b = bundle.getString("customMapPath");
        if (bundle == null) {
    ...
    protected final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            if (childAt != null) {
                if (childAt == this.f1631c) {
                    this.f1631c.layout(0, 0, getWidth(), getHeight());
                    ...
                    if (layoutParams instanceof MapViewLayoutParams) {
                        ...
                        Point a2 = mapViewLayoutParams.f1635c == MapViewLayoutParams.ELayoutMode.absoluteMode ? mapViewLayoutParams.f1634b : this.f1631c.a().a(CoordUtil.ll2mc(mapViewLayoutParams.f1633a));
                        a(childAt);
                        int measuredWidth3 = childAt.getMeasuredWidth();
                        int measuredHeight3 = childAt.getMeasuredHeight();
                        float f5 = mapViewLayoutParams.f1636d;
                        int i12 = (int) (a2.x - (f5 * measuredWidth3));
    ...
    public final void onResume() {
        this.f1631c.onResume();
    }

    public void onSaveInstanceState(Bundle bundle) {
        if (bundle == null || this.f1632d == null) {
            return;
        }
        bundle.putParcelable("mapstatus", this.f1632d.getMapStatus());
        if (this.h != null) {
        ...
        bundle.putString("customMapPath", f1630b);
    }
