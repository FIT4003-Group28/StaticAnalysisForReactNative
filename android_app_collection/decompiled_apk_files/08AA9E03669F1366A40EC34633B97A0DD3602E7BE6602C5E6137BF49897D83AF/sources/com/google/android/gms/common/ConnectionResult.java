...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add("statusCode", zza(this.zzam)).add("resolution", this.zzan).add(BiometricAuthenticationModule.BIOMETRICS_BUNDLE_KEY_MESSAGE, this.zzao).toString();
    }
