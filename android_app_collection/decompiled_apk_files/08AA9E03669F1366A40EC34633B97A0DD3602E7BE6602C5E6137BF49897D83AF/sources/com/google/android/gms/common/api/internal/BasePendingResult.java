...
public abstract class BasePendingResult<R extends Result> extends PendingResult<R> {
    ...
    public void cancel() {
        synchronized (this.zzfa) {
            if (!this.zzfi && !this.zzfh) {
                ...
                zzb(this.zzdm);
                this.zzfi = true;
                zza((BasePendingResult<R>) mo86createFailedResult(Status.RESULT_CANCELED));
            }
        }
    }
    ...
    public abstract R mo86createFailedResult(Status status);
    ...
    public final void zzb(Status status) {
        synchronized (this.zzfa) {
            if (!isReady()) {
                setResult(mo86createFailedResult(status));
                this.zzfj = true;
            }
        }
    }
