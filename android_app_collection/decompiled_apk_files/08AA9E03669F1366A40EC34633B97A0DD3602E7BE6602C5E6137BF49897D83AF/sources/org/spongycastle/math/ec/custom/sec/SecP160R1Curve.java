...
public class SecP160R1Curve extends ECCurve.AbstractFp {
    ...
    public SecP160R1Curve() {
        ...
        this.f5680a = fromBigInteger(new BigInteger(1, Hex.decode("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFC")));
        this.f5681b = fromBigInteger(new BigInteger(1, Hex.decode("1C97BEFC54BD7A8B65ACF89F81D4D4ADC565FA45")));
