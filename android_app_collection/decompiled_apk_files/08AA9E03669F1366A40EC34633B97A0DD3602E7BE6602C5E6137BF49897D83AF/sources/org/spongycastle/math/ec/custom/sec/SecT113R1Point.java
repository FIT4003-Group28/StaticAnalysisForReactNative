...
public class SecT113R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (multiply4.isZero()) {
                return new SecT113R1Point(curve, multiply4, curve.getB().sqrt(), this.withCompression);
            }
        ...
        return new SecT113R1Point(curve, eCFieldElement4, eCFieldElement5, new ECFieldElement[]{multiply}, this.withCompression);
    }
