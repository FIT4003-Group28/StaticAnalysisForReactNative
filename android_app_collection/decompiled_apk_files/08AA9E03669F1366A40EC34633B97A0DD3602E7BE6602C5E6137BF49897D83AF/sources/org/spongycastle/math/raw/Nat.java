...
public abstract class Nat {
    ...
    public static int addBothTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        int i7 = i;
        while (i6 < i7) {
            long j2 = j + (iArr[i2 + i6] & M) + (iArr2[i3 + i6] & M) + (iArr3[i5] & M);
            iArr3[i4 + i6] = (int) j2;
            j = j2 >>> 32;
            i6++;
            i7 = i;
    ...
    public static int mul31BothAdd(int i, int i2, int[] iArr, int i3, int[] iArr2, int[] iArr3, int i4) {
        ...
        while (true) {
            long j4 = j;
            long j5 = j3 + ((iArr[i6] & M) * j) + ((iArr2[i6] & M) * j2) + (iArr3[i5] & M);
            iArr3[i4 + i6] = (int) j5;
            j3 = j5 >>> 32;
            i6++;
            if (i6 >= i) {
    ...
    public static int mulWordAddTo(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i6 = 0;
        do {
            long j3 = j2 + ((iArr[i3 + i6] & M) * j) + (iArr2[i5] & M);
            iArr2[i4 + i6] = (int) j3;
            j2 = j3 >>> 32;
            i6++;
        } while (i6 < i);
    ...
    public static int squareWordAdd(int[] iArr, int i, int i2, int[] iArr2, int i3) {
        ...
        do {
            int i6 = i2 + i5;
            long j3 = j2 + ((iArr[i + i4] & M) * j) + (iArr2[i6] & M);
            iArr2[i6] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
            i4++;
    ...
    public static int subBothFrom(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        int i7 = i;
        while (i6 < i7) {
            long j2 = j + (((iArr3[i5] & M) - (iArr[i2 + i6] & M)) - (iArr2[i3 + i6] & M));
            iArr3[i4 + i6] = (int) j2;
            j = j2 >> 32;
            i6++;
            i7 = i;
