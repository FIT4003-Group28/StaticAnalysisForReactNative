...
public class NTRUSigningKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private FGBasis generateBasis() {
        ...
        while (true) {
            ...
            if ((!z || !integerPolynomial4.resultant(i11).res.equals(BigInteger.ZERO)) && integerPolynomial4.invertFq(i5) != null) {
        ...
        bigIntPolynomial.mult(calculate.x.multiply(BigInteger.valueOf(i5)));
        BigIntPolynomial bigIntPolynomial2 = (BigIntPolynomial) resultant2.rho.clone();
        bigIntPolynomial2.mult(calculate.y.multiply(BigInteger.valueOf(-i5)));
        int i15 = 0;
