...
public class GF2nONBField extends GF2nField {
    ...
    protected void computeFieldPolynomial() {
        int i = 1;
        if (this.mType == 1) {
            this.fieldPolynomial = new GF2Polynomial(this.mDegree + 1, NetstatsParserPatterns.TYPE_BOTH_PATTERN);
    ...
    private void computeMultMatrix() {
        ...
        if ((this.mType & 7) != 0) {
            ...
            if (this.mType == 1) {
                ...
                i = this.mType == 2 ? i2 - 1 : elementOfOrder(this.mType, i2);
            }
            int i3 = 1;
            for (int i4 = 0; i4 < this.mType; i4++) {
                int i5 = i3;
            ...
            if (this.mType == 1) {
                ...
                while (i7 < i2 - 1) {
                    int i8 = i7 + 1;
                    if (this.mMult[iArr[i8]][0] == -1) {
                        this.mMult[iArr[i8]][0] = iArr[i2 - i7];
                    } else {
                        this.mMult[iArr[i8]][1] = iArr[i2 - i7];
                    }
                    i7 = i8;
                }
                ...
                for (int i10 = 1; i10 <= i9; i10++) {
                    ...
                    if (this.mMult[i11][0] == -1) {
                        this.mMult[i11][0] = (i9 + i10) - 1;
                    } else {
                        this.mMult[i11][1] = (i9 + i10) - 1;
                    }
                    int i12 = (i9 + i10) - 1;
                    if (this.mMult[i12][0] == -1) {
                        this.mMult[i12][0] = i11;
                    } else {
                        this.mMult[i12][1] = i11;
                    }
                }
                return;
            } else if (this.mType != 2) {
                ...
                while (i13 < i2 - 1) {
                    int i14 = i13 + 1;
                    if (this.mMult[iArr[i14]][0] == -1) {
                        this.mMult[iArr[i14]][0] = iArr[i2 - i13];
                    } else {
                        this.mMult[iArr[i14]][1] = iArr[i2 - i13];
                    }
                    i13 = i14;
                }
                return;
