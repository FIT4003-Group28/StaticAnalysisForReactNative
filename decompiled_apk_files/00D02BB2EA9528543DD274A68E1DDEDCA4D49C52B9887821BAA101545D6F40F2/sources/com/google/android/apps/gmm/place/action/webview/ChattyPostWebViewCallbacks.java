...
public class ChattyPostWebViewCallbacks implements WebViewCallbacks {
    public static final Parcelable.Creator<ChattyPostWebViewCallbacks> CREATOR = new becj();
    public becm a;
    ...
    public final List<bvwz> c(gga ggaVar) {
        ((beck) btsq.b(beck.class, ggaVar)).xo(this);
        becm becmVar = this.a;
        becmVar.e = true;
        return dcdc.f(becmVar);
    }
