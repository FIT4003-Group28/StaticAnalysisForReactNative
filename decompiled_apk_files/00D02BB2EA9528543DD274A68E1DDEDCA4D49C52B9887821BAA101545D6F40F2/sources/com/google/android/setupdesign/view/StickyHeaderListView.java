...
public class StickyHeaderListView extends ListView {
    ...
    private final void a(AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, dapf.m, i, 0);
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.a != null) {
            ...
            int top = view != null ? this.a.getTop() : 0;
            if (view2.getTop() + top < this.c || !view2.isShown()) {
                this.d.set(0.0f, (-top) + this.c, view2.getWidth(), (view2.getHeight() - top) + this.c);
