package defpackage;
/* compiled from: PG */
/* renamed from: buxw  reason: default package */
...
public final class buxw implements buxv {
    ...
    public buxw(dxio<btze> dxioVar, bvrb bvrbVar) {
        this.a = dxioVar;
        this.b = bvrbVar;
        buac a = buad.a();
        this.c = a;
        dunt duntVar = dunt.TACTILE_SNAP_TO_PLACE_REQUEST;
        a.i = btyk.GMM_SERVER;
        btyp bZ = btyq.h.bZ();
        if (bZ.c) {
            bZ.bF();
