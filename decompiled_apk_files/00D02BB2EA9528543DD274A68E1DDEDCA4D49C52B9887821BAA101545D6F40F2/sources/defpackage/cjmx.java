...
/* compiled from: PG */
/* renamed from: cjmx  reason: default package */
/* loaded from: classes4.dex */
public final class cjmx implements cqkv {
    final cqlg a;

    public cjmx(cqlg cqlgVar) {
        this.a = cqlgVar;
    }
    ...
    public final boolean a(cqku cqkuVar, Object obj, cqjz<?> cqjzVar) {
        ...
        ColorStateList o;
        View view = cqjzVar.c;
        if (cqkuVar instanceof cjna) {
            cjna cjnaVar = cjna.BOX_STROKE_WIDTH;
            switch (((cjna) cqkuVar).ordinal()) {
                case 0:
                    if (!(view instanceof TextInputLayout)) {
                        return false;
                    }
                    if (obj instanceof cqtv) {
                        ((TextInputLayout) view).setBoxStrokeWidth(this.a.j(view, (cqtv) obj));
                        return true;
                ...
                case 6:
                    ...
                    if ((obj != null && !(obj instanceof cqnx)) || (y = cqlg.y(view, (cqnx) obj)) == null) {
                        if (!(obj instanceof View.OnClickListener)) {
                            return false;
                        }
                        ((TextInputLayout) view).setEndIconOnClickListener((View.OnClickListener) obj);
                        return true;
                    }
                    ((TextInputLayout) view).setEndIconOnClickListener(y);
                    return true;
                case 7:
                    if (!(view instanceof TextInputLayout)) {
                        return false;
