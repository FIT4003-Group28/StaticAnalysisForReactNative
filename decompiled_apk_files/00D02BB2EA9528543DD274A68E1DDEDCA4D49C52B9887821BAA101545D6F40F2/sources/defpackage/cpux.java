...
/* compiled from: PG */
/* renamed from: cpux  reason: default package */
/* loaded from: classes5.dex */
public final class cpux implements cpuv {
    private final cpuu a = new cpuu();
    ...
    private final int c(int i, int i2, int i3, int i4, Rect rect) {
        ...
        Point d2 = d(i, i2, i3, i4, rect.bottom);
        if (d2 != null) {
            if (i2 < rect.bottom) {
                f3 = f(i, i2, d2.x, d2.y);
            } else {
                f3 = f(i3, i4, d2.x, d2.y);
            }
            if (f3 < i5) {
                i5 = f3;
            }
        }
        Point e = e(i, i2, i3, i4, rect.left);
        if (e != null && (f2 = f(i3, i4, e.x, e.y)) < i5) {
            i5 = f2;
        }
        Point e2 = e(i, i2, i3, i4, rect.right);
        return (e2 == null || (f = f(i, i2, e2.x, e2.y)) >= i5) ? i5 : f;
    }
    ...
    public final void a(CharSequence charSequence, Canvas canvas, float f, float f2, Rect rect, TextPaint textPaint, Paint.Align align, int i, float f3, boolean z) {
        float[] fArr;
        cpuy a = cpuy.a(charSequence);
        cpuu b = b(a, textPaint, align, i, f3);
    ...
    */
    public final defpackage.cpuu b(java.lang.CharSequence r17, android.text.TextPaint r18, android.graphics.Paint.Align r19, int r20, float r21) {
        /*
            Method dump skipped, instructions count: 1310
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cpux.b(java.lang.CharSequence, android.text.TextPaint, android.graphics.Paint$Align, int, float):cpuu");
    }
}
