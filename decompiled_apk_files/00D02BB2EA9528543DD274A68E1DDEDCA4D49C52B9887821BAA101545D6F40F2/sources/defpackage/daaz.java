...
/* compiled from: PG */
/* renamed from: daaz  reason: default package */
/* loaded from: classes.dex */
public final class daaz {
    ...
    public static void b(Context context, AttributeSet attributeSet, int i, int i2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, daap.c, i, i2);
    ...
    */
    public static void c(android.content.Context r5, android.util.AttributeSet r6, int[] r7, int r8, int r9, int... r10) {
        ...
        L48:
            goto L47
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.daaz.c(android.content.Context, android.util.AttributeSet, int[], int, int, int[]):void");
    }
