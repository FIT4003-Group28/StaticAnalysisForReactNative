...
public class a extends a.a.l.a.d implements androidx.core.graphics.drawable.b {
    ...
    private void a(TypedArray typedArray) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            cVar.f24d |= typedArray.getChangingConfigurations();
        }
    ...
    private boolean b(int i) {
        ...
        } else if (!(current instanceof a.s.a.a.c)) {
            if (current instanceof Animatable) {
                bVar = new b((Animatable) current);
            }
            return false;
        } else {
            bVar = new d((a.s.a.a.c) current);
        }
        bVar.c();
        this.q = bVar;
        this.s = b2;
    ...
    private int d(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        int next;
        TypedArray a2 = a.g.e.f.g.a(resources, theme, attributeSet, a.a.m.b.AnimatedStateListDrawableItem);
    ...
    private int e(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        int next;
        TypedArray a2 = a.g.e.f.g.a(resources, theme, attributeSet, a.a.m.b.AnimatedStateListDrawableTransition);
        ...
        if (a3 == null) {
            ...
            a3 = xmlPullParser.getName().equals("animated-vector") ? a.s.a.a.c.a(context, resources, xmlPullParser, attributeSet, theme) : Build.VERSION.SDK_INT >= 21 ? Drawable.createFromXmlInner(resources, xmlPullParser, attributeSet, theme) : Drawable.createFromXmlInner(resources, xmlPullParser, attributeSet);
        }
        if (a3 == null) {
            throw new XmlPullParserException(xmlPullParser.getPositionDescription() + ": <transition> tag requires a 'drawable' attribute or child tag defining a drawable");
    ...
    public void a(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        TypedArray a2 = a.g.e.f.g.a(resources, theme, attributeSet, a.a.m.b.AnimatedStateListDrawableCompat);
