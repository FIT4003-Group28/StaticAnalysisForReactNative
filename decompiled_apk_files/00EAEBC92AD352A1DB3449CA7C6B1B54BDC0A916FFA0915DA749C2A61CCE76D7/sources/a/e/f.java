...
public abstract class f<K, V> {
    ...
    final class a<T> implements Iterator<T> {
        ...
        public boolean hasNext() {
            return this.f151d < this.f150c;
        }

        @Override // java.util.Iterator
        public T next() {
            if (hasNext()) {
                T t = (T) f.this.a(this.f151d, this.f149b);
                this.f151d++;
                this.f152e = true;
                return t;
            }
    ...
    final class d implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public boolean equals(Object obj) {
            if (this.f158d) {
                ...
                Map.Entry entry = (Map.Entry) obj;
                return a.e.c.a(entry.getKey(), f.this.a(this.f157c, 0)) && a.e.c.a(entry.getValue(), f.this.a(this.f157c, 1));
            }
        ...
        public K getKey() {
            if (this.f158d) {
                return (K) f.this.a(this.f157c, 0);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
        ...
        public V getValue() {
            if (this.f158d) {
                return (V) f.this.a(this.f157c, 1);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
        ...
        public int hashCode() {
            if (this.f158d) {
                int i = 0;
                Object a2 = f.this.a(this.f157c, 0);
                Object a3 = f.this.a(this.f157c, 1);
        ...
        public V setValue(V v) {
            if (this.f158d) {
                return (V) f.this.a(this.f157c, (int) v);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
