...
public final class d {
    ...
    public static final class a {
        ...
        a(int i, int i2) {
            this.f194a = new int[]{i, i2};
            this.f195b = new float[]{0.0f, 1.0f};
        }

        a(int i, int i2, int i3) {
            this.f194a = new int[]{i, i2, i3};
            this.f195b = new float[]{0.0f, 0.5f, 1.0f};
        }

        a(List<Integer> list, List<Float> list2) {
            int size = list.size();
            this.f194a = new int[size];
            this.f195b = new float[size];
            for (int i = 0; i < size; i++) {
                this.f194a[i] = list.get(i).intValue();
                this.f195b[i] = list2.get(i).floatValue();
            }
        }
    }
    ...
    public static Shader a(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        if (b2 != 1) {
            return b2 != 2 ? new LinearGradient(a3, a4, a5, a6, a14.f194a, a14.f195b, a(b3)) : new SweepGradient(a7, a8, a14.f194a, a14.f195b);
        } else if (a13 <= 0.0f) {
            throw new XmlPullParserException("<gradient> tag requires 'gradientRadius' attribute with radial type");
        } else {
            return new RadialGradient(a7, a8, a13, a14.f194a, a14.f195b, a(b3));
        }
    }
    ...
    */
    private static a.g.e.f.d.a b(android.content.res.Resources r8, org.xmlpull.v1.XmlPullParser r9, android.util.AttributeSet r10, android.content.res.Resources.Theme r11) {
        /*
            int r0 = r9.getDepth()
            r1 = 1
            int r0 = r0 + r1
        ...
        L34:
            ...
            android.content.res.TypedArray r3 = a.g.e.f.g.a(r8, r11, r10, r3)
        ...
        L85:
            int r8 = r4.size()
            if (r8 <= 0) goto L91
            a.g.e.f.d$a r8 = new a.g.e.f.d$a
            r8.<init>(r4, r2)
            return r8
        L91:
            r8 = 0
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: a.g.e.f.d.b(android.content.res.Resources, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.content.res.Resources$Theme):a.g.e.f.d$a");
    }
}
