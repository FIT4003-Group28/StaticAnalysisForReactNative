...
public class g extends e {
    ...
    protected final Class<?> f220g;

    /* renamed from: h  reason: collision with root package name */
    protected final Constructor<?> f221h;
    ...
    private Object c() {
        try {
            return this.f221h.newInstance(new Object[0]);
    ...
    public Typeface a(Context context, CancellationSignal cancellationSignal, b.f[] fVarArr, int i) {
        ...
        Map<Uri, ByteBuffer> a4 = a.g.k.b.a(context, fVarArr, cancellationSignal);
        Object c2 = c();
        if (c2 == null) {
            return null;
        }
