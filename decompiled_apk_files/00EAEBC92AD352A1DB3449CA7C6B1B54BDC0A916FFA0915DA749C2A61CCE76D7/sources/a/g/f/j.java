...
public class j {
    ...
    private ConcurrentHashMap<Long, c.b> f222a = new ConcurrentHashMap<>();
    ...
    private void a(Typeface typeface, c.b bVar) {
        long b2 = b(typeface);
        if (b2 != 0) {
            this.f222a.put(Long.valueOf(b2), bVar);
        }
    }
    ...
    public c.b a(Typeface typeface) {
        ...
        return this.f222a.get(Long.valueOf(b2));
    }
    ...
    public Typeface a(Context context, c.b bVar, Resources resources, int i) {
        ...
        Typeface a3 = d.a(context, resources, a2.b(), a2.a(), i);
        a(a3, bVar);
        return a3;
    }
