...
class b {
    ...
    /* loaded from: classes.dex */
    public interface InterfaceC0020b<T, V> {
        int a(T t);
    ...
    private static class c<T> implements Comparator<T> {
        ...
        private final Rect f423b = new Rect();
        ...
        public int compare(T t, T t2) {
            ...
            Rect rect2 = this.f424c;
            this.f426e.a(t, rect);
            this.f426e.a(t2, rect2);
            int i = rect.top;
            int i2 = rect2.top;
            if (i < i2) {
                return -1;
    ...
    public static <L, T> T a(L l, InterfaceC0020b<L, T> interfaceC0020b, a<T> aVar, T t, int i, boolean z, boolean z2) {
        int a2 = interfaceC0020b.a(l);
        ArrayList arrayList = new ArrayList(a2);
        for (int i2 = 0; i2 < a2; i2++) {
            arrayList.add(interfaceC0020b.a(l, i2));
        }
    ...
    */
    public static <L, T> T a(L r7, a.i.b.b.InterfaceC0020b<L, T> r8, a.i.b.b.a<T> r9, T r10, android.graphics.Rect r11, int r12) {
        /*
