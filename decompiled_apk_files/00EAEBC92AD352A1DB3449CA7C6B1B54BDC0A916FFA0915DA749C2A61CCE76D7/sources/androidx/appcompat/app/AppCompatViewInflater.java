...
public class AppCompatViewInflater {
    ...
    public static class a implements View.OnClickListener {
        ...
        private void a(Context context, String str) {
            ...
            while (context != null) {
                try {
                    if (!context.isRestricted() && (method = context.getClass().getMethod(this.f890c, View.class)) != null) {
                        this.f891d = method;
                        this.f892e = context;
                        return;
                    }
            ...
            if (this.f889b.getId() == -1) {
                str2 = "";
            } else {
                str2 = " with id '" + this.f889b.getContext().getResources().getResourceEntryName(id) + "'";
            }
            throw new IllegalStateException("Could not find method " + this.f890c + "(View) in a parent or ancestor Context for android:onClick attribute defined on view " + this.f889b.getClass() + str2);
        }

        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            if (this.f891d == null) {
                a(this.f889b.getContext(), this.f890c);
            }
            try {
                this.f891d.invoke(this.f892e, view);
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (context instanceof ContextWrapper) {
            if (Build.VERSION.SDK_INT >= 15 && !v.D(view)) {
                return;
            }
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        ...
        obtainStyledAttributes.recycle();
        return resourceId != 0 ? (!(context instanceof a.a.o.d) || ((a.a.o.d) context).a() != resourceId) ? new a.a.o.d(context, resourceId) : context : context;
    }
