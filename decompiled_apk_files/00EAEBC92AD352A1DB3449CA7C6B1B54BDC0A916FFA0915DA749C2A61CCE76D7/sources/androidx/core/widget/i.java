...
public final class i {
    ...
    private static class a implements ActionMode.Callback {
        ...
        private final ActionMode.Callback f1629a;

        /* renamed from: b  reason: collision with root package name */
        private final TextView f1630b;

        /* renamed from: c  reason: collision with root package name */
        private Class<?> f1631c;

        /* renamed from: d  reason: collision with root package name */
        private Method f1632d;
        ...
        private void a(Menu menu) {
            Context context = this.f1630b.getContext();
            PackageManager packageManager = context.getPackageManager();
            if (!this.f1634f) {
                this.f1634f = true;
                try {
                    this.f1631c = Class.forName("com.android.internal.view.menu.MenuBuilder");
                    this.f1632d = this.f1631c.getDeclaredMethod("removeItemAt", Integer.TYPE);
                    this.f1633e = true;
            ...
            try {
                Method declaredMethod = (!this.f1633e || !this.f1631c.isInstance(menu)) ? menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE) : this.f1632d;
                ...
                for (int i = 0; i < a2.size(); i++) {
                    ...
                    menu.add(0, 0, i + 100, resolveInfo.loadLabel(packageManager)).setIntent(a(resolveInfo, this.f1630b)).setShowAsAction(1);
                }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f1629a.onActionItemClicked(actionMode, menuItem);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f1629a.onCreateActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public void onDestroyActionMode(ActionMode actionMode) {
            this.f1629a.onDestroyActionMode(actionMode);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            a(menu);
            return this.f1629a.onPrepareActionMode(actionMode, menu);
        }
    }
    ...
    public static void a(TextView textView, a.g.l.c cVar) {
    ...
    public static c.a e(TextView textView) {
        ...
        c.a.C0011a c0011a = new c.a.C0011a(new TextPaint(textView.getPaint()));
        if (Build.VERSION.SDK_INT >= 23) {
            c0011a.a(textView.getBreakStrategy());
            c0011a.b(textView.getHyphenationFrequency());
        }
        if (Build.VERSION.SDK_INT >= 18) {
            c0011a.a(d(textView));
        }
