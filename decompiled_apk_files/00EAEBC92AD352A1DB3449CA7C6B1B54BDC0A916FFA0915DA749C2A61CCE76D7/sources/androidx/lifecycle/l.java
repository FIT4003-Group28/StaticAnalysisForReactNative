...
public class l {
    ...
    private static Map<Class<?>, Integer> f1873a = new HashMap();

    /* renamed from: b  reason: collision with root package name */
    private static Map<Class<?>, List<Constructor<? extends c>>> f1874b = new HashMap();
    ...
    public static g a(Object obj) {
        ...
        if (!z || !z2) {
            ...
            List<Constructor<? extends c>> list = f1874b.get(cls);
            if (list.size() == 1) {
    ...
    private static int b(Class<?> cls) {
        Integer num = f1873a.get(cls);
        if (num != null) {
            return num.intValue();
        }
        int d2 = d(cls);
        f1873a.put(cls, Integer.valueOf(d2));
        return d2;
    }
    ...
    private static int d(Class<?> cls) {
        ...
        if (a2 != null) {
            f1874b.put(cls, Collections.singletonList(a2));
            return 2;
        } else if (a.f1849c.b(cls)) {
            return 1;
        } else {
            ...
            if (c(superclass)) {
                ...
                arrayList = new ArrayList(f1874b.get(superclass));
            }
            for (Class<?> cls2 : cls.getInterfaces()) {
                if (c(cls2)) {
                    ...
                    arrayList.addAll(f1874b.get(cls2));
                }
            }
            if (arrayList == null) {
                return 1;
            }
            f1874b.put(cls, arrayList);
            return 2;
        }
    }
}
