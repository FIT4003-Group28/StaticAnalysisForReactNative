...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public static abstract class c {
        ...
        final SparseIntArray f1882a = new SparseIntArray();

        /* renamed from: b  reason: collision with root package name */
        final SparseIntArray f1883b = new SparseIntArray();
        ...
        int a(int i, int i2) {
            ...
            int i3 = this.f1883b.get(i, -1);
            if (i3 != -1) {
                return i3;
            }
            int c2 = c(i, i2);
            this.f1883b.put(i, c2);
            return c2;
        }
        ...
        int b(int i, int i2) {
            ...
            int i3 = this.f1882a.get(i, -1);
            if (i3 != -1) {
                return i3;
            }
            int d2 = d(i, i2);
            this.f1882a.put(i, d2);
            return d2;
        }
        ...
        public int c(int i, int i2) {
            ...
            int i5;
            int a2;
            if (!this.f1885d || (a2 = a(this.f1883b, i)) == -1) {
                i3 = 0;
                i4 = 0;
                i5 = 0;
            } else {
                i4 = this.f1883b.get(a2);
                i5 = a2 + 1;
                i3 = a(a2) + b(a2, i2);
                if (i3 == i2) {
                    i4++;
    ...
    public GridLayoutManager(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.O = new a();
        this.P = new Rect();
        l(RecyclerView.o.a(context, attributeSet, i, i2).f1956b);
    }
    ...
    private void a(View view, int i, boolean z) {
        ...
        Rect rect = bVar.f1960b;
        int i4 = rect.top + rect.bottom + ((ViewGroup.MarginLayoutParams) bVar).topMargin + ((ViewGroup.MarginLayoutParams) bVar).bottomMargin;
        int i5 = rect.left + rect.right + ((ViewGroup.MarginLayoutParams) bVar).leftMargin + ((ViewGroup.MarginLayoutParams) bVar).rightMargin;
        int f2 = f(bVar.f1880e, bVar.f1881f);
        if (this.s == 1) {
            i3 = RecyclerView.o.a(f2, i, i5, ((ViewGroup.MarginLayoutParams) bVar).width, false);
            i2 = RecyclerView.o.a(this.u.g(), i(), i4, ((ViewGroup.MarginLayoutParams) bVar).height, true);
        } else {
            int a2 = RecyclerView.o.a(f2, i, i4, ((ViewGroup.MarginLayoutParams) bVar).height, false);
    ...
    private void a(RecyclerView.v vVar, RecyclerView.a0 a0Var, int i, boolean z) {
        ...
        while (i2 != i5) {
            View view = this.L[i2];
            b bVar = (b) view.getLayoutParams();
            bVar.f1881f = c(vVar, a0Var, l(view));
            bVar.f1880e = i4;
            i4 += bVar.f1881f;
            i2 += i3;
        }
    ...
    private void b(RecyclerView.v vVar, RecyclerView.a0 a0Var, LinearLayoutManager.a aVar, int i) {
        boolean z = i == 1;
        int b2 = b(vVar, a0Var, aVar.f1887b);
        if (z) {
            while (b2 > 0) {
                int i2 = aVar.f1887b;
                if (i2 <= 0) {
    ...
    */
    ...
    void a(RecyclerView.a0 a0Var, LinearLayoutManager.c cVar, RecyclerView.o.c cVar2) {
        ...
        for (int i2 = 0; i2 < this.J && cVar.a(a0Var) && i > 0; i2++) {
            int i3 = cVar.f1898d;
            cVar2.a(i3, Math.max(0, cVar.f1901g));
            i -= this.O.a(i3);
            cVar.f1898d += cVar.f1899e;
        }
    }
    ...
    public void a(RecyclerView.v vVar, RecyclerView.a0 a0Var, View view, a.g.m.e0.c cVar) {
        ...
        cVar.b(c.C0015c.a(i2, i, e2, f2, z, z2));
    }
