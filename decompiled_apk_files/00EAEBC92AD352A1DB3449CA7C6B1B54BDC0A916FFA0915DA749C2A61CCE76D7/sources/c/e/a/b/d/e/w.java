...
public abstract class w<E> extends x<E> implements List<E>, RandomAccess {
    ...
    private static final k0<Object> f4008c = new z(c0.f3871f, 0);

    public static <E> w<E> a(E e2, E e3, E e4, E e5, E e6, E e7, E e8, E e9) {
    ...
    public static <E> w<E> a(Object[] objArr) {
        int length = objArr.length;
        return length == 0 ? (w<E>) c0.f3871f : new c0(objArr, length);
    }

    public static <E> w<E> f() {
        return (w<E>) c0.f3871f;
    }
    ...
    public w<E> subList(int i, int i2) {
        m.a(i, i2, size());
        int i3 = i2 - i;
        return i3 == size() ? this : i3 == 0 ? (w<E>) c0.f3871f : new y(this, i, i3);
    }
    ...
    public /* synthetic */ ListIterator listIterator(int i) {
        m.b(i, size());
        return isEmpty() ? f4008c : new z(this, i);
    }
