            ...
            try {
                switch (AnonymousClass1.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        readableMapValue(jsonWriter, readableArray.mo209getMap(i));
                        break;
                    case 6:
                        readableArrayValue(jsonWriter, readableArray.mo208getArray(i));
                        break;
                    default:
            ...
            while (keySetIterator.hasNextKey()) {
                ...
                switch (AnonymousClass1.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(nextKey).ordinal()]) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        readableMapValue(jsonWriter, readableMap.mo210getMap(nextKey));
                        break;
                    case 6:
