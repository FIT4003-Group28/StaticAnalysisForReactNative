...
public class NativeModuleRegistry {
    ...
    public <T extends NativeModule> T getModule(Class<T> cls) {
        ...
        c.d.k.a.a.a(moduleHolder, aVar.name() + " could not be found. Is it defined in " + cls.getName());
        return (T) moduleHolder.getModule();
    }

    public NativeModule getModule(String str) {
        ModuleHolder moduleHolder = this.mModules.get(str);
        c.d.k.a.a.a(moduleHolder, "Could not find module with name " + str);
    ...
    public void registerModules(NativeModuleRegistry nativeModuleRegistry) {
        c.d.k.a.a.a(this.mReactApplicationContext.equals(nativeModuleRegistry.getReactApplicationContext()), "Extending native modules with non-matching application contexts.");
