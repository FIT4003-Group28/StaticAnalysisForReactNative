...
public abstract class a<V extends View> extends c<V> {
    ...
    public class RunnableC0153a implements Runnable {
        ...
        private final CoordinatorLayout f7870b;

        /* renamed from: c  reason: collision with root package name */
        private final V f7871c;

        RunnableC0153a(CoordinatorLayout coordinatorLayout, V v) {
            this.f7870b = coordinatorLayout;
            this.f7871c = v;
        }
        ...
        public void run() {
            ...
            if (this.f7871c == null || (overScroller = a.this.f7866e) == null) {
                return;
            }
            if (!overScroller.computeScrollOffset()) {
                a.this.e(this.f7870b, this.f7871c);
                return;
            }
            a aVar = a.this;
            aVar.c(this.f7870b, (CoordinatorLayout) this.f7871c, aVar.f7866e.getCurrY());
            v.a(this.f7871c, this);
        }
    }
    ...
    final boolean a(CoordinatorLayout coordinatorLayout, V v, int i, int i2, float f2) {
        Runnable runnable = this.f7865d;
        if (runnable != null) {
            v.removeCallbacks(runnable);
            this.f7865d = null;
        }
        if (this.f7866e == null) {
            this.f7866e = new OverScroller(v.getContext());
        }
        this.f7866e.fling(0, b(), 0, Math.round(f2), 0, 0, i, i2);
        if (!this.f7866e.computeScrollOffset()) {
            e(coordinatorLayout, v);
            return false;
        }
        this.f7865d = new RunnableC0153a(coordinatorLayout, v);
        v.a(v, this.f7865d);
        return true;
    }
