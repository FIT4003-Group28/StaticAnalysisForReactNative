...
public class a extends g implements b, Drawable.Callback, f.b {
    ...
    private WeakReference<InterfaceC0155a> B0;
    private float C;
    ...
    */
    ...
    private static boolean b(d dVar) {
        ...
        return (dVar == null || (colorStateList = dVar.f4788b) == null || !colorStateList.isStateful()) ? false : true;
    }
    ...
    private void h(Canvas canvas, Rect rect) {
        Paint paint = this.f0;
        if (paint != null) {
            paint.setColor(a.g.f.a.c(-16777216, 127));
            ...
            this.f0.setColor(a.g.f.a.c(-65536, 127));
            b(rect, this.h0);
            canvas.drawRect(this.h0, this.f0);
            this.f0.setColor(a.g.f.a.c(-16711936, 127));
            d(rect, this.h0);
            canvas.drawRect(this.h0, this.f0);
        }
    }
    ...
    private void i0() {
        this.A0 = this.z0 ? c.e.a.c.y.b.a(this.D) : null;
    }

    @TargetApi(21)
    private void j0() {
        this.M = new RippleDrawable(c.e.a.c.y.b.a(Q()), this.L, H0);
    }
    ...
    public void a(InterfaceC0155a interfaceC0155a) {
        this.B0 = new WeakReference<>(interfaceC0155a);
    }

    public void a(CharSequence charSequence) {
        if (this.P != charSequence) {
            this.P = a.g.l.a.b().a(charSequence);
            invalidateSelf();
        }
    }
    ...
    protected void a0() {
        InterfaceC0155a interfaceC0155a = this.B0.get();
    ...
    public void draw(Canvas canvas) {
        ...
        int i2 = this.t0;
        if (i2 < 255) {
            i = c.e.a.c.m.a.a(canvas, bounds.left, bounds.top, bounds.right, bounds.bottom, i2);
        }
        e(canvas, bounds);
        b(canvas, bounds);
        if (this.F0) {
    ...
    public void setTintMode(PorterDuff.Mode mode) {
        if (this.x0 != mode) {
            this.x0 = mode;
            this.v0 = c.e.a.c.s.a.a(this, this.w0, mode);
            invalidateSelf();
        }
    }
