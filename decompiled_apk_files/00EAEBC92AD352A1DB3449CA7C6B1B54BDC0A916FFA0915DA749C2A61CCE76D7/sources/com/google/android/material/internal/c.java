...
public class c extends ViewGroup {
    ...
    private void a(Context context, AttributeSet attributeSet) {
        ...
        this.f8131b = obtainStyledAttributes.getDimensionPixelSize(k.FlowLayout_lineSpacing, 0);
        this.f8132c = obtainStyledAttributes.getDimensionPixelSize(k.FlowLayout_itemSpacing, 0);
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
                    ...
                    i6 = a.g.m.g.b(marginLayoutParams);
                    i5 = a.g.m.g.a(marginLayoutParams);
                } else {
                    i5 = 0;
                    i6 = 0;
                }
                int measuredWidth = i8 + i6 + childAt.getMeasuredWidth();
                if (!this.f8133d && measuredWidth > i7) {
                    i9 = paddingTop + this.f8131b;
                    i8 = paddingRight;
                }
                int i11 = i8 + i6;
                ...
                i8 += i6 + i5 + childAt.getMeasuredWidth() + this.f8132c;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int measuredWidth2 = i11 + i3 + i4 + childAt.getMeasuredWidth() + this.f8132c;
