...
public abstract class v {
    ...
    public ArrayList<String> a(ArrayList<View> arrayList) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            arrayList2.add(android.support.v4.j.s.g(view));
            android.support.v4.j.s.a(view, (String) null);
        }
        return arrayList2;
    }
    ...
    public void a(View view, final ArrayList<View> arrayList, final ArrayList<View> arrayList2, final ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            String g = android.support.v4.j.s.g(view2);
            arrayList4.add(g);
            if (g != null) {
                android.support.v4.j.s.a(view2, (String) null);
                ...
                while (true) {
                    if (i2 >= size) {
                        ...
                        android.support.v4.j.s.a(arrayList2.get(i2), g);
                        break;
                    } else {
                        i2++;
                    }
        ...
        ac.a(view, new Runnable() { // from class: android.support.v4.app.v.1
            @Override // java.lang.Runnable
            public void run() {
                for (int i3 = 0; i3 < size; i3++) {
                    android.support.v4.j.s.a((View) arrayList2.get(i3), (String) arrayList3.get(i3));
                    android.support.v4.j.s.a((View) arrayList.get(i3), (String) arrayList4.get(i3));
                }
            }
        });
    }
    ...
    public void a(ArrayList<View> arrayList, View view) {
        if (view.getVisibility() == 0) {
            if (view instanceof ViewGroup) {
                ...
                if (android.support.v4.j.t.a(viewGroup)) {
    ...
    public void a(Map<String, View> map, View view) {
        if (view.getVisibility() == 0) {
            String g = android.support.v4.j.s.g(view);
            if (g != null) {
                map.put(g, view);
            }
            if (!(view instanceof ViewGroup)) {
    ...
    public void a(View view, final ArrayList<View> arrayList, final Map<String, String> map) {
        ac.a(view, new Runnable() { // from class: android.support.v4.app.v.2
            @Override // java.lang.Runnable
            public void run() {
                int size = arrayList.size();
                for (int i = 0; i < size; i++) {
                    ...
                    String g = android.support.v4.j.s.g(view2);
                    if (g != null) {
                        android.support.v4.j.s.a(view2, v.a(map, g));
                    }
                }
            }
        });
    ...
    public void a(ViewGroup viewGroup, final ArrayList<View> arrayList, final Map<String, String> map) {
        ac.a(viewGroup, new Runnable() { // from class: android.support.v4.app.v.3
            @Override // java.lang.Runnable
            public void run() {
                int size = arrayList.size();
                for (int i = 0; i < size; i++) {
                    View view = (View) arrayList.get(i);
                    android.support.v4.j.s.a(view, (String) map.get(android.support.v4.j.s.g(view)));
                }
            }
        });
    }
