...
public class v implements View.OnClickListener {
    ...
    final /* synthetic */ WearMapView f1756a;

    /* JADX INFO: Access modifiers changed from: package-private */
    public v(WearMapView wearMapView) {
        this.f1756a = wearMapView;
    }
    ...
    public void onClick(View view) {
        ...
        gestureDetector$OnDoubleTapListenerC0136i = this.f1756a.f1709d;
        D D = gestureDetector$OnDoubleTapListenerC0136i.a().D();
        D.f2026a -= 1.0f;
        gestureDetector$OnDoubleTapListenerC0136i2 = this.f1756a.f1709d;
