...
public class a {
    ...
    public static com.baidu.mapapi.model.inner.a a(String str) {
        ...
        if (bundle2 != null) {
            ...
            if (bundle3 != null) {
                aVar.f1769b = new Point((int) bundle3.getDouble("ptx"), (int) bundle3.getDouble("pty"));
            }
            Bundle bundle4 = bundle2.getBundle("ru");
            if (bundle4 != null) {
                aVar.f1770c = new Point((int) bundle4.getDouble("ptx"), (int) bundle4.getDouble("pty"));
            }
        }
        for (ParcelItem parcelItem : (ParcelItem[]) bundle.getParcelableArray("poly_line")) {
            if (aVar.f1771d == null) {
                aVar.f1771d = new ArrayList<>();
            }
            ...
            if (bundle5 != null) {
                ...
                aVar.f1771d.add(arrayList);
            }
        }
        aVar.f1771d.trimToSize();
        aVar.f1768a = (int) bundle.getDouble("type");
        return aVar;
    }
