...
public class SessionProtobufHelper {
    ...
    public static void writeSessionDevice(CodedOutputStream codedOutputStream, int i, String str, int i2, long j, long j2, boolean z, Map<p.a, String> map, int i3, String str2, String str3) {
    ...
    private static int getDeviceIdentifierSize(p.a aVar, String str) {
        return CodedOutputStream.computeEnumSize(1, aVar.h) + CodedOutputStream.computeBytesSize(2, ByteString.copyFromUtf8(str));
    }

    private static int getSessionDeviceSize(int i, ByteString byteString, int i2, long j, long j2, boolean z, Map<p.a, String> map, int i3, ByteString byteString2, ByteString byteString3) {
        int i4 = 0;
        ...
        int computeUInt32Size = computeEnumSize + CodedOutputStream.computeUInt32Size(12, i3) + (byteString2 == null ? 0 : CodedOutputStream.computeBytesSize(13, byteString2));
        if (byteString3 != null) {
    ...
    private static int getFrameSize(StackTraceElement stackTraceElement, boolean z) {
        ...
        return computeBytesSize + CodedOutputStream.computeUInt32Size(5, i);
    }
