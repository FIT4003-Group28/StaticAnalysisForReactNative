...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public static void zza(Activity activity, Dialog dialog, String str, DialogInterface.OnCancelListener onCancelListener) {
        if (activity instanceof j) {
            SupportErrorDialogFragment.newInstance(dialog, onCancelListener).show(((j) activity).e(), str);
            return;
        }
    ...
    private final void zza(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                y.c a3 = new y.c(context).a(17301642).c(resources.getString(com.google.android.gms.base.R.string.common_google_play_services_notification_ticker)).a(System.currentTimeMillis()).b(true).a(pendingIntent).a((CharSequence) errorNotificationTitle).b((CharSequence) errorNotificationMessage).c(true).a(new y.b().a(errorNotificationMessage));
                if (PlatformVersion.isAtLeastO() && PlatformVersion.isAtLeastO()) {
                    a3.b(zza(context, notificationManager));
                }
                a2 = a3.a();
            }
            switch (i) {
    ...
    public Dialog getErrorDialog(Activity activity, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        return zza(activity, i, DialogRedirect.getInstance(activity, getErrorResolutionIntent(activity, i, d.f1997a), i2), onCancelListener);
    }
    ...
    public boolean showErrorDialogFragment(Activity activity, LifecycleFragment lifecycleFragment, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        Dialog zza2 = zza(activity, i, DialogRedirect.getInstance(lifecycleFragment, getErrorResolutionIntent(activity, i, d.f1997a), i2), onCancelListener);
        if (zza2 == null) {
            return false;
        }
