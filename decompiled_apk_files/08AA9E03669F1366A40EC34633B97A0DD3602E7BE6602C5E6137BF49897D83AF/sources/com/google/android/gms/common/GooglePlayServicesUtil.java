...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    public static boolean showErrorDialogFragment(int i, Activity activity, i iVar, int i2, DialogInterface.OnCancelListener onCancelListener) {
        if (GooglePlayServicesUtilLight.isPlayServicesPossiblyUpdating(activity, i)) {
            i = 18;
        }
        ...
        Dialog zza = GoogleApiAvailability.zza(activity, i, DialogRedirect.getInstance(iVar, GoogleApiAvailability.getInstance().getErrorResolutionIntent(activity, i, d.f1997a), i2), onCancelListener);
        if (zza == null) {
            return false;
        }
