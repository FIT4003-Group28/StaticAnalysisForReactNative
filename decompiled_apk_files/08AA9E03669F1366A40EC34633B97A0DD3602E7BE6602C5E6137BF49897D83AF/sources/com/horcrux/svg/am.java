...
public abstract class am extends com.facebook.react.uimanager.g {
    ...
    final float mScale = com.facebook.react.uimanager.b.b().density;
    ...
    public o getTextRoot() {
        if (this.mTextRoot == null) {
            ...
            while (true) {
                ...
                com.facebook.react.uimanager.x parent = amVar.getParent();
                amVar = !(parent instanceof am) ? null : (am) parent;
            }
        }
    ...
    public void setMatrix(com.facebook.react.bridge.am amVar) {
        if (amVar != null) {
            int a2 = w.a(amVar, sRawMatrix, this.mScale);
            if (a2 == 6) {
    ...
    public double relativeOnWidth(String str) {
        return w.a(str, getCanvasWidth(), 0.0d, this.mScale, getFontSizeFromContext());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public double relativeOnHeight(String str) {
        return w.a(str, getCanvasHeight(), 0.0d, this.mScale, getFontSizeFromContext());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public double relativeOnOther(String str) {
        return w.a(str, Math.sqrt(Math.pow(getCanvasWidth(), 2.0d) + Math.pow(getCanvasHeight(), 2.0d)) * M_SQRT1_2l, 0.0d, this.mScale, getFontSizeFromContext());
    }
