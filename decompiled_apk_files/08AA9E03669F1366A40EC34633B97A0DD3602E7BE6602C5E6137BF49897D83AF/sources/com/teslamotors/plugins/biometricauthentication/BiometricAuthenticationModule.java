...
public class BiometricAuthenticationModule extends ReactContextBaseJavaModule {
    ...
    public BiometricAuthenticationModule(ah ahVar) {
        super(ahVar);
    }

    @al
    public void supportedBiometryTypes(af afVar) {
        android.support.v4.c.a.a fingerprintManager = getFingerprintManager(getReactApplicationContext());
        ...
        try {
            ...
            e.a(getReactApplicationContext()).a(TAG, "Failed to check biometric device support", e);
        }
        writableNativeMap.a(RESULT, writableNativeArray);
        afVar.a(writableNativeMap);
    }

    @al
    private void checkBiometricEligibility(af afVar) {
        android.support.v4.c.a.a fingerprintManager = getFingerprintManager(getReactApplicationContext());
        WritableNativeMap writableNativeMap = new WritableNativeMap();
    ...
    @al
    public void requestBiometricAuthentication(String str, String str2, String str3, af afVar) {
        android.support.v4.c.a.a fingerprintManager = getFingerprintManager(getReactApplicationContext());
        WritableNativeMap writableNativeMap = new WritableNativeMap();
    ...
    private String preFlightAuthenticationError(android.support.v4.c.a.a aVar) {
        if (aVar == null) {
            ...
            return BIOMETRICS_ERROR_NOT_AVAILABLE;
        } else if (android.support.v4.app.a.a(getReactApplicationContext(), "android.permission.USE_FINGERPRINT") != 0) {
    ...
    private void onLogMessage(String str) {
        e.a(getReactApplicationContext()).a(TAG, String.format("[BIOMETRIC SECURITY - NATIVE] %s", str));
    }

    private static android.support.v4.c.a.a getFingerprintManager(Context context) {
