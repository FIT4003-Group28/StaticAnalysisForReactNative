    ...
    private synchronized boolean send(f fVar, int i) {
        if (!this.failed && !this.enqueuedClose) {
            if (this.queueSize + fVar.h() > MAX_QUEUE_SIZE) {
                close(UIMsg.f_FUN.FUN_ID_MAP_ACTION, null);
                return false;
            }
    ...
    */
    boolean writeOneFrame() {
        ...
        L8:
            ...
            java.util.ArrayDeque<c.f> r2 = r11.pongQueue     // Catch: java.lang.Throwable -> Lab
            java.lang.Object r2 = r2.poll()     // Catch: java.lang.Throwable -> Lab
            c.f r2 = (c.f) r2     // Catch: java.lang.Throwable -> Lab
            r3 = -1
            r4 = 0
            if (r2 != 0) goto L4c
        ...
        L58:
            ...
            c.f r1 = r1.data     // Catch: java.lang.Throwable -> L56
            ...
            int r3 = r1.h()     // Catch: java.lang.Throwable -> L56
            long r5 = (long) r3     // Catch: java.lang.Throwable -> L56
            c.s r0 = r0.newMessageSink(r2, r5)     // Catch: java.lang.Throwable -> L56
            c.d r0 = c.l.a(r0)     // Catch: java.lang.Throwable -> L56
            ...
            int r0 = r1.h()     // Catch: java.lang.Throwable -> L85
        ...
        L88:
            ...
            c.f r3 = r5.reason     // Catch: java.lang.Throwable -> L56
    ...
    void writePingFrame() {
        synchronized (this) {
            ...
            try {
                webSocketWriter.writePing(f.f1286b);
            } catch (IOException e) {
                failWebSocket(e, null);
            }
        }
