...
public class DSTU4145ECBinary extends ASN1Object {
    ...
    public DSTU4145ECBinary(ECDomainParameters eCDomainParameters) {
        ...
        this.f5643a = new ASN1Integer(curve.getA().toBigInteger());
        this.f5644b = new DEROctetString(curve.getB().getEncoded());
    ...
    private DSTU4145ECBinary(ASN1Sequence aSN1Sequence) {
        ...
        int i2 = i + 1;
        this.f5643a = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(i2));
        int i3 = i2 + 1;
        this.f5644b = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(i3));
        int i4 = i3 + 1;
    ...
    public BigInteger getA() {
        return this.f5643a.getValue();
    }

    public byte[] getB() {
        return Arrays.clone(this.f5644b.getOctets());
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f5643a);
        aSN1EncodableVector.add(this.f5644b);
