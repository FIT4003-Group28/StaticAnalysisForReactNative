...
public class JPAKEParticipant {
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) {
        if (this.state >= 40) {
            ...
            this.f5647b = jPAKERound2Payload.getA();
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.p, this.q, calculateGA, this.f5647b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
            this.state = 40;
        }
    }
    ...
    public BigInteger calculateKeyingMaterial() {
        if (this.state >= 50) {
            ...
            this.password = null;
            BigInteger calculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.p, this.q, this.gx4, this.x2, calculateS, this.f5647b);
            this.x1 = null;
            this.x2 = null;
            this.f5647b = null;
            this.state = 50;
