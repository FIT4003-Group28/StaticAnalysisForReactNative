...
public class SRP6Server {
    ...
    public BigInteger generateServerCredentials() {
        ...
        this.f5650b = selectPrivateValue();
        this.B = calculateK.multiply(this.v).mod(this.N).add(this.g.modPow(this.f5650b, this.N)).mod(this.N);
        return this.B;
    }
    ...
    private BigInteger calculateS() {
        return this.v.modPow(this.u, this.N).multiply(this.A).mod(this.N).modPow(this.f5650b, this.N);
    }
    ...
    public boolean verifyClientEvidenceMessage(BigInteger bigInteger) {
        ...
        if (!SRP6Util.calculateM1(this.digest, this.N, this.A, this.B, this.S).equals(bigInteger)) {
            return false;
        }
        this.M1 = bigInteger;
        return true;
