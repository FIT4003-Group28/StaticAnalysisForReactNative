...
public abstract class LongDigest implements ExtendedDigest, EncodableDigest, Memoable {
    ...
    protected void processBlock() {
        ...
        while (i2 < 10) {
            ...
            int i5 = i4 + 1;
            long Sum12 = j11 + Sum1(j16) + Ch(j16, j13, j12) + K[i4] + this.W[i4];
            long j17 = j8 + Sum12;
            long Sum02 = Sum12 + Sum0(Sum0) + Maj(Sum0, j15, j7);
            int i6 = i5 + 1;
            long Sum13 = j12 + Sum1(j17) + Ch(j17, j16, j13) + K[i5] + this.W[i5];
            long j18 = j7 + Sum13;
            long Sum03 = Sum13 + Sum0(Sum02) + Maj(Sum02, Sum0, j15);
            int i7 = i6 + 1;
            long Sum14 = j13 + Sum1(j18) + Ch(j18, j17, j16) + K[i6] + this.W[i6];
            long j19 = j15 + Sum14;
            ...
            long j23 = Sum04 + Sum18;
            j10 = Sum18 + Sum0(Sum07) + Maj(Sum07, Sum06, Sum05);
            j8 = Sum06;
            j7 = Sum07;
            i3 = i10 + 1;
            j9 = Sum05;
