...
public class Grain128Engine implements StreamCipher {
    ...
    private int getOutputNFSR() {
        ...
        int i15 = (this.nfsr[3] << 29) | (this.nfsr[2] >>> 3);
        int i16 = (this.nfsr[3] << 28) | (this.nfsr[2] >>> 4);
        int i17 = (this.nfsr[3] << 12) | (this.nfsr[2] >>> 20);
        return ((((((((((i ^ i7) ^ i11) ^ ((this.nfsr[3] << 5) | (this.nfsr[2] >>> 27))) ^ this.nfsr[3]) ^ (i2 & i15)) ^ (i3 & i4)) ^ (i5 & i6)) ^ (i8 & i12)) ^ (i9 & i10)) ^ (i13 & i14)) ^ (i16 & i17);
    }
    ...
    private int getOutput() {
        ...
        int i14 = (this.lfsr[2] << 4) | (this.lfsr[1] >>> 28);
        int i15 = (this.lfsr[3] << 17) | (this.lfsr[2] >>> 15);
        return ((((((i ^ ((((((i12 & i11) ^ (i10 & i2)) ^ (i13 & i9)) ^ (i15 & i14)) ^ ((i2 & i9) & ((this.lfsr[3] << 1) | (this.lfsr[2] >>> 31)))) ^ ((this.lfsr[3] << 3) | (this.lfsr[2] >>> 29)))) ^ i3) ^ i4) ^ i5) ^ i6) ^ i7) ^ i8;
    }
    ...
    private void setKey(byte[] bArr, byte[] bArr2) {
        ...
        for (int i2 = 0; i2 < this.nfsr.length; i2++) {
            ...
            int i4 = i + 2;
            int i5 = i + 1;
            this.nfsr[i2] = (this.workingKey[i3] << 24) | ((this.workingKey[i4] << Tnaf.POW_2_WIDTH) & 16711680) | ((this.workingKey[i5] << 8) & CipherSuite.DRAFT_TLS_DHE_RSA_WITH_AES_128_OCB) | (this.workingKey[i] & 255);
            this.lfsr[i2] = (this.workingIV[i3] << 24) | ((this.workingIV[i4] << Tnaf.POW_2_WIDTH) & 16711680) | ((this.workingIV[i5] << 8) & CipherSuite.DRAFT_TLS_DHE_RSA_WITH_AES_128_OCB) | (this.workingIV[i] & 255);
            i += 4;
        }
    }
