    ...
    public byte[] decodeCiphertext(long j, short s, byte[] bArr, int i, int i2) {
        ...
        switch (this.nonceMode) {
            case 1:
                ...
                bArr2 = bArr;
                System.arraycopy(bArr2, i, bArr3, bArr3.length - this.record_iv_length, this.record_iv_length);
                break;
            case 2:
                TlsUtils.writeUint64(j, bArr3, bArr3.length - 8);
                for (int i3 = 0; i3 < this.decryptImplicitNonce.length; i3++) {
                    bArr3[i3] = (byte) (bArr3[i3] ^ this.decryptImplicitNonce[i3]);
                }
                bArr2 = bArr;
                break;
            default:
        ...
        try {
            ...
            int processBytes = this.decryptCipher.processBytes(bArr2, i4, i5, bArr4, 0) + 0;
