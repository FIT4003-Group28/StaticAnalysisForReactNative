...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Set getExtensionOIDs(boolean z) {
        Extensions extensions = this.f5669c.getExtensions();
        if (extensions != null) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLEntryObject) {
            return this.f5669c.equals(((X509CRLEntryObject) obj).f5669c);
        }
    ...
    public byte[] getEncoded() {
        try {
            return this.f5669c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public BigInteger getSerialNumber() {
        return this.f5669c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public Date getRevocationDate() {
        return this.f5669c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f5669c.getExtensions() != null;
    }
