...
class X509CRLObject extends X509CRL {
    ...
    private CertificateList f5670c;
    ...
    private Set getExtensionOIDs(boolean z) {
        ...
        if (getVersion() != 2 || (extensions = this.f5670c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f5670c.getTBSCertList().getExtensions();
    ...
    public byte[] getEncoded() {
        try {
            return this.f5670c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    private void doVerify(PublicKey publicKey, Signature signature) {
        if (!this.f5670c.getSignatureAlgorithm().equals(this.f5670c.getTBSCertList().getSignature())) {
    ...
    public int getVersion() {
        return this.f5670c.getVersionNumber();
    }

    @Override // java.security.cert.X509CRL
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f5670c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f5670c.getIssuer().getEncoded());
    ...
    public Date getThisUpdate() {
        return this.f5670c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public Date getNextUpdate() {
        if (this.f5670c.getNextUpdate() != null) {
            return this.f5670c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f5670c.getRevokedCertificateEnumeration();
    ...
    public byte[] getTBSCertList() {
        try {
            return this.f5670c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            throw new CRLException(e.toString());
        }
    }
    ...
    public byte[] getSignature() {
        return this.f5670c.getSignature().getOctets();
    }
    ...
    public String getSigAlgOID() {
        return this.f5670c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        Enumeration revokedCertificateEnumeration = this.f5670c.getRevokedCertificateEnumeration();
        X500Name issuer2 = this.f5670c.getIssuer();
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLObject) {
            ...
            return this.f5670c.equals(x509CRLObject.f5670c);
        }
