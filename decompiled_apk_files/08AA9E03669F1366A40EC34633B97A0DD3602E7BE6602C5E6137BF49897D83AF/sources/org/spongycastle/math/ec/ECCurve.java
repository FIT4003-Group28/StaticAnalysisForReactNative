...
public abstract class ECCurve {
    ...
    protected ECFieldElement f5680a;

    /* renamed from: b  reason: collision with root package name */
    protected ECFieldElement f5681b;
    ...
    public static abstract class AbstractFp extends ECCurve {
        ...
        protected ECPoint decompressPoint(int i, BigInteger bigInteger) {
            ...
            ECFieldElement sqrt = fromBigInteger.square().add(this.f5680a).multiply(fromBigInteger).add(this.f5681b).sqrt();
            if (sqrt == null) {
    ...
    public static class Fp extends AbstractFp {
        ...
        public Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, BigInteger bigInteger5) {
            ...
            this.f5680a = fromBigInteger(bigInteger2);
            this.f5681b = fromBigInteger(bigInteger3);
        ...
        protected Fp(BigInteger bigInteger, BigInteger bigInteger2, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger3, BigInteger bigInteger4) {
            ...
            this.r = bigInteger2;
            this.infinity = new ECPoint.Fp(this, null, null);
            this.f5680a = eCFieldElement;
            this.f5681b = eCFieldElement2;
        ...
        protected ECCurve cloneCurve() {
            return new Fp(this.q, this.r, this.f5680a, this.f5681b, this.order, this.cofactor);
        }
    ...
    public static abstract class AbstractF2m extends ECCurve {
        ...
        public boolean isKoblitz() {
            return this.order != null && this.cofactor != null && this.f5681b.isOne() && (this.f5680a.isZero() || this.f5680a.isOne());
        }
    }
    ...
    public static class F2m extends AbstractF2m {
        ...
        public F2m(int i, int i2, int i3, int i4, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
            ...
            this.f5680a = fromBigInteger(bigInteger);
            this.f5681b = fromBigInteger(bigInteger2);
            this.coord = 6;
        }
        ...
        @Override // org.spongycastle.math.ec.ECCurve
        protected ECCurve cloneCurve() {
            return new F2m(this.m, this.k1, this.k2, this.k3, this.f5680a, this.f5681b, this.order, this.cofactor);
        }
