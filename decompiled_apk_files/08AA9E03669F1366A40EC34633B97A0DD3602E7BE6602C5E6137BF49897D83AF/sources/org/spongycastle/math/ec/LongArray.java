...
class LongArray implements Cloneable {
    ...
    private static void multiplyWord(long j, long[] jArr, int i, long[] jArr2, int i2) {
        ...
        while (true) {
            ...
            if (j3 != 0) {
                if ((j3 & 1) != 0) {
                    long addShiftedUp = addShiftedUp(jArr2, i2, jArr3, 0, i, i3);
                    if (addShiftedUp != 0) {
                        int i4 = i2 + i;
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i, int[] iArr) {
        ...
        while (i7 < 16) {
            ...
            if ((i7 & 1) == 0) {
                ...
                jArr = jArr3;
                add(jArr, i6, jArr3, i8 - i6, jArr, i8, i6);
            }
            i7++;
            jArr3 = jArr;
        }
        ...
        while (i9 >= 0) {
            int i10 = 1;
            while (i10 < i2) {
                int i11 = (int) (jArr6[i10] >>> i9);
                addBoth(jArr7, i10 - 1, jArr4, iArr2[i11 & 15], jArr5, iArr2[(i11 >>> 4) & 15], i6);
                i10 += 2;
                i5 = 0;
            }
            shiftUp(jArr7, i5, i4, 8);
            i9 -= 8;
            i5 = 0;
        }
        for (int i12 = 56; i12 >= 0; i12 -= 8) {
            for (int i13 = 0; i13 < i2; i13 += 2) {
                int i14 = (int) (jArr6[i13] >>> i12);
                addBoth(jArr7, i13, jArr4, iArr2[i14 & 15], jArr5, iArr2[(i14 >>> 4) & 15], i6);
            }
            if (i12 > 0) {
    ...
    public LongArray modMultiply(LongArray longArray, int i, int[] iArr) {
        ...
        while (i6 < 16) {
            ...
            if ((i6 & 1) == 0) {
                ...
                jArr = jArr3;
                add(jArr, i5, jArr3, i7 - i5, jArr, i7, i5);
            }
            i6++;
            jArr3 = jArr;
        }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        long[] jArr3 = jArr2;
        System.arraycopy(longArray3.m_ints, 0, jArr3, i2, i3);
        int i12 = i2;
        int i13 = 1;
        while (i13 < 8) {
            int i14 = i12 + i6;
            shiftUp(jArr3, i2, jArr3, i14, i6, i13);
            i13++;
            jArr3 = jArr3;
            i12 = i14;
        }
        ...
        while (true) {
            int i16 = 0;
            do {
                long j2 = jArr4[i16] >>> i15;
                int i17 = i2;
                int i18 = 0;
                while (true) {
                    int i19 = ((int) j2) & i5;
                    if (i19 != 0) {
                        add(jArr4, iArr2[i19] + i16, jArr4, i17, i6);
                    }
                    i18++;
                    if (i18 == 8) {
                        break;
        ...
        while (true) {
            length--;
            if (length <= 1) {
                return reduceResult(jArr4, iArr2[1], i4, i, iArr);
            }
            if ((length & 1) == 0) {
                addShiftedUp(jArr4, iArr2[length >>> 1], jArr4, iArr2[length], i4, 16);
            } else {
                distribute(jArr4, iArr2[length], iArr2[length - 1], iArr2[1], i4);
            }
        }
    }
    ...
    public LongArray multiply(LongArray longArray, int i, int[] iArr) {
        ...
        while (i6 < 16) {
            ...
            if ((i6 & 1) == 0) {
                ...
                jArr = jArr3;
                add(jArr, i5, jArr, i7 - i5, jArr3, i7, i5);
            }
            i6++;
            jArr3 = jArr;
        }
    ...
    private static long interleave3_21to63(int i) {
        ...
        return ((INTERLEAVE3_TABLE[i >>> 14] & 4294967295L) << 42) | ((INTERLEAVE3_TABLE[(i >>> 7) & CertificateBody.profileType] & 4294967295L) << 21) | (i2 & 4294967295L);
    }
    ...
    private static long interleave3_13to65(int i) {
        return ((INTERLEAVE5_TABLE[i >>> 7] & 4294967295L) << 35) | (4294967295L & INTERLEAVE5_TABLE[i & CertificateBody.profileType]);
    }
    ...
    private static long interleave2_32to64(int i) {
        ...
        return ((((INTERLEAVE2_TABLE[i >>> 24] << 16) | INTERLEAVE2_TABLE[(i >>> 16) & 255]) & 4294967295L) << 32) | (4294967295L & i2);
    }
