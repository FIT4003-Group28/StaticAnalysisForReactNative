...
public class SecP160R2Curve extends ECCurve.AbstractFp {
    ...
    public SecP160R2Curve() {
        ...
        this.f5680a = fromBigInteger(new BigInteger(1, Hex.decode("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70")));
        this.f5681b = fromBigInteger(new BigInteger(1, Hex.decode("B4E134D3FB59EB8BAB57274904664D5AF50388BA")));
