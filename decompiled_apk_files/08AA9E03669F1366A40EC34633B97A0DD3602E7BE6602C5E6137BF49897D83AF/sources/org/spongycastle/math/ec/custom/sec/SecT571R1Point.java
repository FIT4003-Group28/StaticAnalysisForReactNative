...
public class SecT571R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (multiply4.isZero()) {
                return new SecT571R1Point(curve, multiply4, SecT571R1Curve.SecT571R1_B_SQRT, this.withCompression);
            }
        ...
        return new SecT571R1Point(curve, eCFieldElement4, eCFieldElement5, new ECFieldElement[]{multiply}, this.withCompression);
    }
