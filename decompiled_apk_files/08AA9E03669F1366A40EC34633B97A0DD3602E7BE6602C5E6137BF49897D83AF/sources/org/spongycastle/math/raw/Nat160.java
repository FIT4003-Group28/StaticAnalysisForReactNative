...
public abstract class Nat160 {
    ...
    public static int addTo(int[] iArr, int i, int[] iArr2, int i2, int i3) {
        ...
        iArr2[i7] = (int) j4;
        int i8 = i2 + 4;
        long j5 = (j4 >>> 32) + (iArr[i + 4] & M) + (M & iArr2[i8]);
        iArr2[i8] = (int) j5;
        return (int) (j5 >>> 32);
    }
    ...
    public static int addToEachOther(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        int i15 = i + 4;
        int i16 = i2 + 4;
        long j5 = (j4 >>> 32) + (iArr[i15] & M) + (M & iArr2[i16]);
        int i17 = (int) j5;
        iArr[i15] = i17;
        iArr2[i16] = i17;
        return (int) (j5 >>> 32);
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i3 = 5; i < i3; i3 = 5) {
            long j12 = iArr[i] & M;
            int i4 = i + 0;
            long j13 = (j12 * j) + (iArr3[i4] & M) + 0;
            iArr3[i4] = (int) j13;
            int i5 = i + 1;
            long j14 = (j13 >>> c2) + (j12 * j2) + (iArr3[i5] & M);
            iArr3[i5] = (int) j14;
            int i6 = i + 2;
            long j15 = (j14 >>> 32) + (j12 * j3) + (iArr3[i6] & M);
            iArr3[i6] = (int) j15;
            int i7 = i + 3;
            long j16 = (j15 >>> 32) + (j12 * j4) + (iArr3[i7] & M);
            iArr3[i7] = (int) j16;
            int i8 = i + 4;
            long j17 = (j16 >>> 32) + (j12 * j5) + (iArr3[i8] & M);
            iArr3[i8] = (int) j17;
    ...
    public static void mul(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i6 < 5) {
            i5 += i4;
            long j12 = iArr[i + i6] & M;
            int i7 = i5 + 0;
            long j13 = (j12 * j) + (iArr3[i7] & M) + 0;
            iArr3[i7] = (int) j13;
            int i8 = i5 + 1;
            int i9 = i6;
            long j14 = (j13 >>> 32) + (j12 * j2) + (iArr3[i8] & M);
            iArr3[i8] = (int) j14;
            int i10 = i5 + 2;
            long j15 = (j14 >>> 32) + (j12 * j3) + (iArr3[i10] & M);
            iArr3[i10] = (int) j15;
            int i11 = i5 + 3;
            long j16 = (j15 >>> 32) + (j12 * j4) + (iArr3[i11] & M);
            iArr3[i11] = (int) j16;
            int i12 = i5 + 4;
            long j17 = (j16 >>> 32) + (j12 * j5) + (iArr3[i12] & M);
            iArr3[i12] = (int) j17;
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i6 < 5) {
            ...
            long j9 = iArr[i6] & j;
            long j10 = j2;
            long j11 = (j9 * j2) + (iArr3[i] & j) + 0;
            iArr3[i6 + 0] = (int) j11;
            int i7 = i6 + 1;
            long j12 = (j11 >>> 32) + (j9 * j3) + (iArr3[i7] & M);
            iArr3[i7] = (int) j12;
            long j13 = j3;
            long j14 = (j12 >>> 32) + (j9 * j4) + (iArr3[i2] & M);
            iArr3[i6 + 2] = (int) j14;
            long j15 = (j14 >>> 32) + (j9 * j5) + (iArr3[i3] & M);
            iArr3[i6 + 3] = (int) j15;
            long j16 = (j15 >>> 32) + (j9 * j8) + (iArr3[i4] & M);
            iArr3[i6 + 4] = (int) j16;
            long j17 = (j16 >>> 32) + j7 + (iArr3[i5] & M);
            iArr3[i6 + 5] = (int) j17;
            j7 = j17 >>> 32;
            i6 = i7;
            j6 = j8;
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i9 < 5) {
            ...
            int i11 = i10 + 1;
            long j10 = j3;
            long j11 = (j9 >>> 32) + (j8 * j3) + (iArr3[i11] & M);
            iArr3[i11] = (int) j11;
            long j12 = j4;
            long j13 = (j11 >>> 32) + (j8 * j4) + (iArr3[i5] & M);
            iArr3[i10 + 2] = (int) j13;
            long j14 = (j13 >>> 32) + (j8 * j5) + (iArr3[i6] & M);
            iArr3[i10 + 3] = (int) j14;
            long j15 = (j14 >>> 32) + (j8 * j6) + (iArr3[i7] & M);
            iArr3[i10 + 4] = (int) j15;
            long j16 = (j15 >>> 32) + j7 + (iArr3[i8] & M);
            iArr3[i10 + 5] = (int) j16;
            j7 = j16 >>> 32;
            i9++;
            i10 = i11;
    ...
    public static int mulWordAddExt(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        iArr2[i7] = (int) j5;
        int i8 = i3 + 4;
        long j6 = (j5 >>> 32) + (j * (iArr[i2 + 4] & M)) + (iArr2[i8] & M);
        iArr2[i8] = (int) j6;
        return (int) (j6 >>> 32);
    }
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                long j36 = (iArr2[8] & M) + (j29 >>> 32) + (j35 >>> 32);
                int i12 = (int) j33;
                ...
                int i18 = (int) j36;
                iArr2[8] = i17 | (i18 << 1);
                iArr2[9] = (i18 >>> 31) | ((iArr2[9] + ((int) (j36 >>> 32))) << 1);
                return;
            }
            i = i4;
            i3 = i6;
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            int i13 = i11 - 1;
            long j3 = iArr[i + i11] & j;
            long j4 = j3 * j3;
            int i14 = i10 - 1;
            iArr2[i2 + i14] = ((int) (j4 >>> 33)) | (i12 << 31);
            i10 = i14 - 1;
            iArr2[i2 + i10] = (int) (j4 >>> 1);
            i12 = (int) j4;
            if (i13 <= 0) {
                long j5 = j2 * j2;
                long j6 = ((i12 << 31) & M) | (j5 >>> 33);
                iArr2[i2 + 0] = (int) j5;
                long j7 = iArr[i + 1] & M;
                long j8 = iArr2[i3] & M;
                long j9 = j6 + (j7 * j2);
                int i15 = (int) j9;
                iArr2[i2 + 1] = (i15 << 1) | (((int) (j5 >>> 32)) & 1);
                long j10 = j8 + (j9 >>> 32);
                long j11 = iArr[i + 2] & M;
                long j12 = iArr2[i4] & M;
                long j13 = iArr2[i5] & M;
                ...
                long j32 = j25 + (j2 * j28);
                int i19 = (int) j32;
                iArr2[i2 + 4] = i18 | (i19 << 1);
                int i20 = i19 >>> 31;
                long j33 = j27 + (j32 >>> 32) + (j7 * j28);
                long j34 = j30 + (j33 >>> 32) + (j28 * j11);
                long j35 = j31 + (j34 >>> 32) + (j28 * j18);
                long j36 = (iArr2[i9] & M) + (j29 >>> 32) + (j35 >>> 32);
                int i21 = (int) j33;
                ...
                int i27 = i26 >>> 31;
                int i28 = i2 + 9;
                iArr2[i28] = ((iArr2[i28] + ((int) (j36 >>> 32))) << 1) | i27;
                return;
            }
            i11 = i13;
            j = M;
