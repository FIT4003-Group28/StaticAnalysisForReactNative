...
public abstract class Nat256 {
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 8; i < i2; i2 = 8) {
            long j18 = iArr[i] & M;
            int i3 = i + 0;
            long j19 = (j18 * j) + (iArr3[i3] & M) + 0;
            iArr3[i3] = (int) j19;
            int i4 = i + 1;
            long j20 = (j19 >>> 32) + (j18 * j2) + (iArr3[i4] & M);
            iArr3[i4] = (int) j20;
            int i5 = i + 2;
            long j21 = (j20 >>> 32) + (j18 * j3) + (iArr3[i5] & M);
            iArr3[i5] = (int) j21;
            int i6 = i + 3;
            long j22 = (j21 >>> 32) + (j18 * j4) + (iArr3[i6] & M);
            iArr3[i6] = (int) j22;
            int i7 = i + 4;
            long j23 = (j22 >>> 32) + (j18 * j5) + (iArr3[i7] & M);
            iArr3[i7] = (int) j23;
            int i8 = i + 5;
            long j24 = (j23 >>> 32) + (j18 * j6) + (iArr3[i8] & M);
            iArr3[i8] = (int) j24;
            int i9 = i + 6;
            long j25 = (j24 >>> 32) + (j18 * j7) + (iArr3[i9] & M);
            iArr3[i9] = (int) j25;
            int i10 = i + 7;
            long j26 = (j25 >>> 32) + (j18 * j8) + (iArr3[i10] & M);
            iArr3[i10] = (int) j26;
    ...
    public static void mul(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i6 < 8) {
            i5 += i4;
            long j18 = iArr[i + i6] & M;
            int i7 = i5 + 0;
            long j19 = (j18 * j) + (iArr3[i7] & M) + 0;
            iArr3[i7] = (int) j19;
            int i8 = i5 + 1;
            int i9 = i6;
            long j20 = (j19 >>> 32) + (j18 * j2) + (iArr3[i8] & M);
            iArr3[i8] = (int) j20;
            int i10 = i5 + 2;
            long j21 = (j20 >>> 32) + (j18 * j3) + (iArr3[i10] & M);
            iArr3[i10] = (int) j21;
            int i11 = i5 + 3;
            long j22 = (j21 >>> 32) + (j18 * j4) + (iArr3[i11] & M);
            iArr3[i11] = (int) j22;
            int i12 = i5 + 4;
            long j23 = (j22 >>> 32) + (j18 * j5) + (iArr3[i12] & M);
            iArr3[i12] = (int) j23;
            int i13 = i5 + 5;
            long j24 = (j23 >>> 32) + (j18 * j6) + (iArr3[i13] & M);
            iArr3[i13] = (int) j24;
            int i14 = i5 + 6;
            long j25 = (j24 >>> 32) + (j18 * j7) + (iArr3[i14] & M);
            iArr3[i14] = (int) j25;
            int i15 = i5 + 7;
            long j26 = (j25 >>> 32) + (j18 * j8) + (iArr3[i15] & M);
            iArr3[i15] = (int) j26;
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i9 < 8) {
            ...
            long j11 = iArr[i9] & M;
            long j12 = j5;
            long j13 = (j11 * j) + (iArr3[i] & M) + 0;
            iArr3[i9 + 0] = (int) j13;
            int i10 = i9 + 1;
            long j14 = j2;
            long j15 = (j13 >>> 32) + (j11 * j2) + (iArr3[i10] & M);
            iArr3[i10] = (int) j15;
            long j16 = j3;
            long j17 = (j15 >>> 32) + (j11 * j3) + (iArr3[i2] & M);
            iArr3[i9 + 2] = (int) j17;
            long j18 = (j17 >>> 32) + (j11 * j4) + (iArr3[i3] & M);
            iArr3[i9 + 3] = (int) j18;
            long j19 = j4;
            long j20 = (j18 >>> 32) + (j11 * j12) + (iArr3[i4] & M);
            iArr3[i9 + 4] = (int) j20;
            long j21 = (j20 >>> 32) + (j11 * j6) + (iArr3[i5] & M);
            iArr3[i9 + 5] = (int) j21;
            long j22 = (j21 >>> 32) + (j11 * j7) + (iArr3[i6] & M);
            iArr3[i9 + 6] = (int) j22;
            long j23 = (j22 >>> 32) + (j11 * j10) + (iArr3[i7] & M);
            iArr3[i9 + 7] = (int) j23;
            long j24 = (j23 >>> 32) + j9 + (iArr3[i8] & M);
            iArr3[i9 + 8] = (int) j24;
            j9 = j24 >>> 32;
            j8 = j10;
            i9 = i10;
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        long j9 = 0;
        while (i12 < 8) {
            long j10 = iArr[i + i12] & M;
            long j11 = j;
            long j12 = (j10 * j) + (iArr3[i4] & M) + 0;
            iArr3[i13 + 0] = (int) j12;
            int i14 = i13 + 1;
            long j13 = (j12 >>> 32) + (j10 * j2) + (iArr3[i14] & M);
            iArr3[i14] = (int) j13;
            long j14 = (j13 >>> 32) + (j10 * j3) + (iArr3[i5] & M);
            iArr3[i13 + 2] = (int) j14;
            ...
            iArr3[i13 + 6] = (int) j18;
            long j19 = (j18 >>> 32) + (j10 * j8) + (iArr3[i10] & M);
            iArr3[i13 + 7] = (int) j19;
    ...
    public static long mul33Add(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        long j17 = (j15 >>> 32) + (j * j16) + j14 + (iArr2[i3 + 7] & M);
        iArr3[i4 + 7] = (int) j17;
        return (j17 >>> 32) + j16;
    }
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                iArr2[7] = i16 | (i17 << 1);
                int i18 = i17 >>> 31;
                long j78 = (j77 >>> 32) + (j73 * j6) + j66;
                long j79 = j68 + (j78 >>> 32) + (j73 * j10);
                long j80 = j70 + (j79 >>> 32) + (j73 * j17);
                long j81 = j72 + (j80 >>> 32) + (j73 * j28);
                long j82 = j75 + (j81 >>> 32) + (j73 * j41);
                long j83 = j76 + (j82 >>> 32) + (j73 * j56);
                long j84 = (iArr2[14] & M) + (j74 >>> 32) + (j83 >>> 32);
                int i19 = (int) j78;
                iArr2[8] = i18 | (i19 << 1);
                int i20 = (int) j79;
                ...
                int i30 = (int) j84;
                iArr2[14] = i29 | (i30 << 1);
                iArr2[15] = (i30 >>> 31) | ((iArr2[15] + ((int) (j84 >>> 32))) << 1);
                return;
            }
            i = i4;
            i3 = i6;
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            int i19 = i17 - 1;
            long j3 = iArr[i + i17] & j;
            long j4 = j3 * j3;
            int i20 = i16 - 1;
            iArr2[i2 + i20] = ((int) (j4 >>> 33)) | (i18 << 31);
            i16 = i20 - 1;
            iArr2[i2 + i16] = (int) (j4 >>> 1);
            i18 = (int) j4;
            if (i19 <= 0) {
                long j5 = j2 * j2;
                long j6 = ((i18 << 31) & M) | (j5 >>> 33);
                iArr2[i2 + 0] = (int) j5;
                long j7 = iArr[i + 1] & M;
                long j8 = iArr2[i3] & M;
                long j9 = j6 + (j7 * j2);
                int i21 = (int) j9;
                iArr2[i2 + 1] = (i21 << 1) | (((int) (j5 >>> 32)) & 1);
                long j10 = j8 + (j9 >>> 32);
                long j11 = iArr[i + 2] & M;
                long j12 = iArr2[i4] & M;
                long j13 = iArr2[i5] & M;
                ...
                long j57 = j53 & M;
                long j58 = (iArr2[i13] & M) + (j56 >>> 32);
                long j59 = j56 & M;
                long j60 = j48 + (j55 * j2);
                int i29 = (int) j60;
                iArr2[i2 + 6] = i28 | (i29 << 1);
                int i30 = i29 >>> 31;
                long j61 = j50 + (j60 >>> 32) + (j55 * j7);
                long j62 = j52 + (j61 >>> 32) + (j55 * j11);
                long j63 = j61 & M;
                long j64 = j54 + (j62 >>> 32) + (j55 * j18);
                long j65 = j62 & M;
                long j66 = j57 + (j64 >>> 32) + (j55 * j28);
                long j67 = j64 & M;
                long j68 = j59 + (j66 >>> 32) + (j55 * j40);
                long j69 = j66 & M;
                long j70 = j58 + (j68 >>> 32);
                long j71 = j68 & M;
                long j72 = iArr[i + 7] & M;
                long j73 = (iArr2[i14] & M) + (j70 >>> 32);
                long j74 = j70 & M;
                long j75 = M & j73;
                long j76 = j63 + (j72 * j2);
                int i31 = (int) j76;
                iArr2[i2 + 7] = i30 | (i31 << 1);
                int i32 = i31 >>> 31;
                long j77 = (j76 >>> 32) + (j7 * j72) + j65;
                long j78 = j67 + (j77 >>> 32) + (j72 * j11);
                long j79 = j69 + (j78 >>> 32) + (j72 * j18);
                long j80 = j71 + (j79 >>> 32) + (j72 * j28);
                long j81 = j74 + (j80 >>> 32) + (j72 * j40);
                long j82 = j75 + (j81 >>> 32) + (j72 * j55);
                long j83 = (iArr2[i15] & M) + (j73 >>> 32) + (j82 >>> 32);
                int i33 = (int) j77;
                iArr2[i2 + 8] = i32 | (i33 << 1);
                int i34 = i33 >>> 31;
                int i35 = (int) j78;
                ...
                int i46 = i45 >>> 31;
                int i47 = i2 + 15;
                iArr2[i47] = ((iArr2[i47] + ((int) (j83 >>> 32))) << 1) | i46;
                return;
            }
            i17 = i19;
            j = M;
