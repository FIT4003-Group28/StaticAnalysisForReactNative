...
public class NTRUSigningKeyGenerationParameters extends KeyGenerationParameters implements Cloneable {
    ...
    public NTRUSigningKeyGenerationParameters(InputStream inputStream) {
        ...
        this.f5686d = dataInputStream.readInt();
    ...
    public void writeTo(OutputStream outputStream) {
        ...
        dataOutputStream.writeInt(this.f5686d);
    ...
    public NTRUSigningParameters getSigningParameters() {
        return new NTRUSigningParameters(this.N, this.q, this.f5686d, this.B, this.beta, this.normBound, this.hashAlg);
    }

    public NTRUSigningKeyGenerationParameters clone() {
        if (this.polyType == 0) {
            return new NTRUSigningKeyGenerationParameters(this.N, this.q, this.f5686d, this.B, this.basisType, this.beta, this.normBound, this.keyNormBound, this.primeCheck, this.sparse, this.keyGenAlg, this.hashAlg);
        }
    ...
    public int hashCode() {
        ...
        int hashCode = (((((((((((((((i2 * 31) + ((int) (doubleToLongBits2 ^ (doubleToLongBits2 >>> 32)))) * 31) + this.bitsF) * 31) + this.f5686d) * 31) + this.d1) * 31) + this.d2) * 31) + this.d3) * 31) + (this.hashAlg == null ? 0 : this.hashAlg.getAlgorithmName().hashCode())) * 31) + this.keyGenAlg;
        ...
        int i6 = 1237;
        int i7 = ((((((((((i5 * 31) + ((int) (doubleToLongBits6 ^ (doubleToLongBits6 >>> 32)))) * 31) + this.polyType) * 31) + (this.primeCheck ? 1231 : 1237)) * 31) + this.q) * 31) + this.signFailTolerance) * 31;
        if (this.sparse) {
            i6 = 1231;
        }
        return i7 + i6;
    ...
    public String toString() {
        ...
        if (this.polyType == 0) {
            sb.append(" polyType=SIMPLE d=" + this.f5686d);
        } else {
