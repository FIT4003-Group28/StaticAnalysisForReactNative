...
public class NTRUSigningParameters implements Cloneable {
    ...
    public NTRUSigningParameters(int i, int i2, int i3, int i4, int i5, int i6, double d2, double d3, double d4, Digest digest) {
        this.signFailTolerance = 100;
        this.bitsF = 6;
        this.N = i;
        this.q = i2;
    ...
    public NTRUSigningParameters(InputStream inputStream) {
        ...
        this.f5687d = dataInputStream.readInt();
    ...
    public void writeTo(OutputStream outputStream) {
        ...
        dataOutputStream.writeInt(this.f5687d);
    ...
    public NTRUSigningParameters clone() {
        return new NTRUSigningParameters(this.N, this.q, this.f5687d, this.B, this.beta, this.normBound, this.hashAlg);
    }
    ...
    public int hashCode() {
        ...
        int hashCode = (((((((((((((i2 * 31) + ((int) (doubleToLongBits2 ^ (doubleToLongBits2 >>> 32)))) * 31) + this.bitsF) * 31) + this.f5687d) * 31) + this.d1) * 31) + this.d2) * 31) + this.d3) * 31) + (this.hashAlg == null ? 0 : this.hashAlg.getAlgorithmName().hashCode());
        ...
        return (((((i3 * 31) + ((int) (doubleToLongBits4 ^ (doubleToLongBits4 >>> 32)))) * 31) + this.q) * 31) + this.signFailTolerance;
    }
