...
public class BigIntPolynomial {
    ...
    private BigIntPolynomial multRecursive(BigIntPolynomial bigIntPolynomial) {
        ...
        for (int i4 = 0; i4 < multRecursive3.coeffs.length; i4++) {
            int i5 = i2 + i4;
            bigIntPolynomial8.coeffs[i5] = bigIntPolynomial8.coeffs[i5].add(multRecursive3.coeffs[i4]);
        }
        for (int i6 = 0; i6 < multRecursive2.coeffs.length; i6++) {
            int i7 = (i2 * 2) + i6;
            bigIntPolynomial8.coeffs[i7] = bigIntPolynomial8.coeffs[i7].add(multRecursive2.coeffs[i6]);
        }
